    ...
    <td class="mid_mid">
        ...
        if($_POST['save_changes'])
        {
            ...
            if($record_id)
            {
                ...
                '<br/>'.$insert_sales_invoice = " INSERT INTO `sales_product_invoice` (`sales_product_id`,`receipt_no`, `total_price`, `payable_amount`,`remaining_amount`, `paid_type`, `cust_bank_name`, `bank_id`, `cheque_detail`, `chaque_date`, `credit_card_no`,`bank_ref_no`, `admin_id`, `added_date`,`status`,`cm_id`,`total_paid`,`invoice_due_date`) VALUES ('".$record_id."','".$receipt_no."', '".$_POST['total_price']."', '".$payable_amount."','".$_POST['remaining_amount']."', '".$payment_type."', '".$cust_bank_name."', '".$bank_name."', '".$_POST['chaque_no']."', '".$sep_check_date."','".$credit_card_no."','".$bank_ref_no."', '".$_SESSION['admin_id']."', '".$added_date."','".$status."','".$cm_id1."','".$total_amnt_paid."','".$invoice_due_date."'); ";
           ...
           $bank_query=mysql_query($bank);  
                ...
                //=============SMS Send================
                "<br/>".$sel_cust="select cust_name,mobile1 from customer where cust_id ='".$cust_ids."'";
                ...
                "<br/>".$sel_sms_cnt="select * from sms_mail_configuration_map where previlege_id='147' ".$_SESSION['where']."";
                $ptr_sel_sms=mysql_query($sel_sms_cnt);
                while($data_sel_cnt=mysql_fetch_array($ptr_sel_sms))
                {
