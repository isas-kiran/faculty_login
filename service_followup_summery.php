    ...
    <td class="mid_mid">
    						...
    						if($_POST['save_changes'])
                        	{
                                ...
                                else
                                {
									...
									if($branch_name=="Pune")
									{
										$address="International School of Aesthetics and Spa, 2nd Floor, The Greens,North Main Road, Koregoan Park, Pune-411001. Location:  https://bit.ly/2yOhji6 ,Events - https://bit.ly/2O2uDTU ,Student artwork - https://bit.ly/2La2VXz ,Institute Photos: https://bit.ly/2O2qO0Q";
									}
									else if($branch_name=="Ahmedabad")
									{
										$address="International School of Aesthetics and Spa, First Floor, Zodiac Plaza,Near Nabard Flat, H.L. Comm. College Road, Navrangpura, Ahmedabad- 380 009.Tel No-:079-26300007. Location: https://bit.ly/2N28vbw ,Events: https://bit.ly/2O2uDTU ,Student artwork: https://bit.ly/2La2VXz ,Institute photos: https://bit.ly/2uzwfMx";
									}
									...
									$insert_sms="insert into sms_log_history (`name`,`mobile_no`,`sms_text`,`sms_type`,`admin_id`,`cm_id`,`added_date`) values('".$student_name."','".$mobile_no."','".$messagessss."','service_inquiry_followup','".$_SESSION['admin_id']."','".$_SESSION['cm_id']."','".date('Y-m-d H:i:s')."')";
									$ptr_sms=mysql_query($insert_sms);
									...
									setTimeout('document.location.href="service_followup_details.php?record_id=<?php echo $record_id; ?>";',700);
									</script>
                                ...
                                if($no_of_records)
                                {
									...
									?>
                                    	...
                                    	<tr><td height="10" align="right">
                                   	 	<a href="service_followup_details.php?record_id=<?php echo $record_id; ?>"><input type="button" name="back" value="Back"  /></a>
                                    	</td>
                                    	</tr>
                                    	<!--====================================Followups Details==================================================-->
                                    	<tr>
                                    		...
                                    		<tr style="padding-left:10px">
                                        		<td width="50%"><strong>Customer Name :&nbsp;&nbsp;&nbsp;</strong><? echo $data_inq['name']; ?></td>
                                        	...
                                        	<tr>
                                            	...
                                            	<td><strong>Lead Grade :&nbsp;&nbsp;&nbsp;</strong><?php echo $data_inq['lead_grade']; ?></td>
                                        	</tr>
                                        	<tr>
                                        		<td width="50%"><strong>Enquiry Date :&nbsp;&nbsp;&nbsp;</strong><?php echo $data_inq['inquiry_date']; ?></td>
                                        	    <td width="50%"><strong>Followup Date :&nbsp;&nbsp;&nbsp;</strong><?php echo $data_inq['followup_date']; ?></td>
                                        	</tr>
                                    		</table>                                   
                                    		</td>
                                        </tr>
                                    	...
                                    	<tr>
                                        	...
                                        	<?php
											$select_last_followup = " select * from service_followup_details where inquiry_id='".$record_id."' order by added_date desc limit 0,3 ";
                                    	...
                                    	<tr><th colspan="2" style="font-size:14px; font-weight:800">Update Followup Details</th></tr>
                                        	...
                                        	<tr>
                                            	...
                                            	<td width="40%"><input type="text" class="input_text datepicker" name="followup_date" id="followup_date" value="<?php if($_POST['followup_date']) echo $_POST['followup_date']; else { }?>" />
                                            	</td>
                                    		</tr>
