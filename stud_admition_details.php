...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  <tr class="head_td">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="99%" align="center">
              <tr>
                ...
                <td width="233">
                 ...
                 <?php
			   $selct_stud=mysql_query("select name from  stud_regi where student_id ='".$_GET['student_id']."'");
			  $val_fetch=mysql_fetch_array($selct_stud);
			  
			  ?>
              <td width="262" > <b> <?php echo $val_fetch['name']?> </b> </td>
              
                <td width="297" class="rightAlign" > 
    ...
    <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='course_name'))
                        {
                            ...
                            $sql_query= "SELECT * FROM stud_class_regi where 1 and student_id ='".$_GET['student_id']."'  ".$pre_keyword." ".$select_directory.""; 
                       //echo $sql_query;
  ...
  <tr class="grey_td" >
    ...
    <td width="10%"><strong>Course Name</strong></a> <?php echo $img1;?></td>
 <td width="15%"><strong>Subject Name</strong></td>
    ...
    <td width="10%" class="centerAlign"><strong>Action</strong></td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
								...
								//$_SESSION['stud_class_regi_id']=$listed_record_id;
								...
								$seelct_course=mysql_query("select * from courses where course_id= '".$val_query['course_id']."' ");
								$val_course=mysql_fetch_array($seelct_course);
						    	...
						    	$select_pay_map="select sum(amount_paid) as amount_paid from pay_fees_mapping where 
								stud_class_regi_id = '".$listed_record_id."' and student_id ='".$val_query['student_id']."'";
								$ptr_querys=mysql_query($select_pay_map);
								$val_record=mysql_fetch_array($ptr_querys);
								$amount_paid=$val_record['amount_paid'];
								
								
                                echo '<td >'.$val_stud['paid']."=======".$amount_paid."=========".'</td>';
                                echo '<td >'.$val_stud['balance'].'</td>';
                                echo '<td ><a href="add_balance.php?student_id='.$_GET['student_id'].'&course_id='.$val_query['course_id'].'&stud_class_regi_id='.$val_query['stud_class_regi_id'].'"><img src="images/add_icon.gif"></a></td>';
