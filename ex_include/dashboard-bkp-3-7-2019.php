   ...
   <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_user.php"><img src="images/bop.jpg" height="50" width="50" /><br />
     ...
     <td>
            <table border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="course_manage.php"><img src="images/icy_earth.png" /><br />
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_student.php"><img src="images/user6.png" /><br />
...
?>
   ...
   /* }
	...
	<?php 
	 ...
	 if($array_prev[$e]['privilege_id']==12)//'manage user '
    {	?>
        <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
	  ...
	  /* $sel="Select * from inquiry";
	   ...
	   ?>
        <?php if($_SESSION['type']=='A' || $_SESSION['type']=='S' || $_SESSION['type']=='C')
		  {
			  ?>
         <li><a class="qmparent" href="javascript:void(0)"><span style="color:#0088CB;">Enquiry Followup</span></a>
       ...
       <?
        ...
        <tbody>
           ...
           '.$val_select_letest['mobile1'].'
            ...
            <td class="center">
            '.$val_select_letest['followup_date'].'		
            </td>
			<td class="center">
         ...
         <?php if($_SESSION['type']=='A' || $_SESSION['type']=='S' || $_SESSION['type']=='C')
		{?>
        <li><a class="qmparent" href="javascript:void(0)"><span style="color:#0088CB;">Installment Followup</span></a>
        <ul>
        <li><span style="color:#000;"><table class="adminlist">
        <thead>
        
        <tr><th colspan="5"> <strong><font size="2px">Past Installment</font></strong></th></tr>
        <?
       ...
       <?
        ...
        <tbody>
             <?
					...
					while($val_select_letest=mysql_fetch_array($ptr_select_letest))
					{
						...
						$select_name="select name,course_id from enrollment where enroll_id='".$val_select_letest['enroll_id']."' ";
        ...
        <thead>
        <tr><th colspan="5"> <strong><font size="2px">Upcoming Installment</font></strong></th></tr>
        <?
			$select_letest="select enroll_id,installment_amount,installment_date,status from installment where 1 ".$_SESSION['where']." and installment_date >= CURDATE() and status ='not paid' order by installment_date asc limit 0,5";
			$ptr_select_letest=mysql_query($select_letest);
			if(mysql_num_rows($ptr_select_letest))
        ...
        <tbody>
          ...
          <span style="color:#000;"><table class="adminlist">
            <thead>
            <?
				 $select_letest_enrollment="select name, course_id, enroll_id, contact, added_date  from enrollment  where status='Enrolled'  ".$_SESSION['where']."  
          ...
          <span style="color:#000;"><table class="adminlist">
			...
			while( $data_batch=mysql_fetch_array($ptr_batch))
			{
			 ...
			 while($data_course=mysql_fetch_array($ptr_course))
			 {
			   ...
			   echo '<tr>
				<td class="center"><a href="add_batch.php?record_id='.$listed_record_id.'&course_batch_id='.$c_b_id.'">
				'.$data_batch['name'].'</a>
				</td>
				<td class="center">
