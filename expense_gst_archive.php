	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
              <tr>
                ...
                <!--<td width="20%">
                        ...
                        <td><a href="expense_gst_archive_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>  
						<td><a href="expense_gst_archive.php">GST On Total amount</a></td> 
            </tr>          
        </table>
        </form>	
    </td>
     ...
     <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='firstname'))
                        {
							...
							$branch_id='';
                       		...
                       		"<br/>".$sql_query= "SELECT DISTINCT(s.expense_id),s.vendor_id,s.added_date,s.expense_type_id,s.total_price FROM expense s, expense_tax_map sm WHERE 1 and s.expense_id=sm.expense_id ".$where_cm." ".$pre_keyword_i." ".$paid_from_date_i." ".$paid_to_date_i." and (sm.tax_type !='') ".$select_directory." "; 
				...
				<form method="post"  name="frmTakeAction"  action="<?php echo $_SERVER['PHP_SELF'].'?#msgbox';?>">
                     <input type="hidden" name="formAction" id="formAction" value=""/>
                      <tr class="grey_td" >
                        ...
                        <td width="40%" align="center">Expense Name</td>
						<td width="10%" align="center">Price (Excl. GST)</td>
						<td width="25%" align="center">GST in value</td>
                        ...
                        <td width="14%" align="center"><strong>Installments</strong></td>-->
                            ...
                            while($val_query=mysql_fetch_array($my_db))
                            {
								...
								"<br/>".$sel_inst_amnt="select expense_type from expense_type where 1 and expense_type_id='".$val_query['expense_type_id']."' ";
								$ptr_ins_amnt=mysql_query($sel_inst_amnt);
								$data_inst_amnt=mysql_fetch_array($ptr_ins_amnt);
								echo "<td width='40%' align='center'>".$data_inst_amnt['expense_type']."</td>";
								
								echo "<td width='10%' align='center'>".$val_query['total_price']."</td>";
								
								$totals_products_gst=0;
								echo "<td width='25%' align='center'>";
								"<br/>".$sel_inst_amnt="select * from expense_tax_map where 1 and expense_id='".$val_query['expense_id']."' and (tax_type !='' or tax_value !='')";
								$ptr_ins_amnt=mysql_query($sel_inst_amnt);
								if($total_inst=mysql_num_rows($ptr_ins_amnt))
								{
									...
									{
										if($data_inst_amnt['tax_type'])
										{
											if($data_inst_amnt['tax_type']=="CGST")
											{
												$total_cgst+=$data_inst_amnt['tax_amount'];
											}
											else if($data_inst_amnt['tax_type']=="SGST")
											{
												$total_sgst+=$data_inst_amnt['tax_amount'];
											}
											if($ins >1)
												echo"<br/>";
											echo $data_inst_amnt['tax_type']."(".$data_inst_amnt['tax_value']."%)- ".$data_inst_amnt['tax_amount'];
											
											$amount_gst +=$data_inst_amnt['tax_amount'];
								...
								echo "</td>";	
								$totals_gst +=$amount_gst;
								
								echo "<td align='center'>".$amount_gst."</td>";
