...
<title>Purchase Bank Summery</title>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
              <tr>
                ...
                <!--<td width="20%">
                        ...
                        <td><a href="purchase_summury_report_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>  
            </tr>          
        </table>
        </form>	
    </td>
		...
		echo $sql_query= "select i.*,e.* from inventory_invoice i, inventory e where 1 and i.inventory_id=e.inventory_id ".$search_cm_id." ".$pre_keyword_i." ".$pay_type." ".$bank_ids." ".$paid_from_date." ".$paid_to_date." ".$select_directory." "; 
			...
			<form method="post"  name="frmTakeAction"  action="<?php echo $_SERVER['PHP_SELF'].'?#msgbox';?>">
				<input type="hidden" name="formAction" id="formAction" value=""/>
                	<tr class="grey_td" >
						...
						?>
						<td width="10%" align="center"><strong>Receipt No.</strong></td>
                        <td width="20%" align="center"><strong>Vendor Name</strong></td>
                    ...
                    while($val_query=mysql_fetch_array($all_records))
                    {
                        ...
                        echo '<tr '.$bgcolor.'>';
                         ...
                         "<br/>".$sel_name="select name from vendor where vendor_id='".$val_query['vendor_id']."'";
                        ...
                        echo '<td align="center" width="10%">'.$val_query['invoice_id'].'</td>';
                        ...
                        while($product=mysql_fetch_array($ptr_prod))
                        {
							...
							echo'<td align="center" width="10%">'.$product['sin_product_qty'].'</td>';
							...
							echo'<td align="center" width="20%">'.$product['sin_product_total'].'</td>';
							echo '</tr>';
                        }
                        echo '</table></td>';
                        ...
                        echo "<td width='10%' align='center'>".$val_query['payable_amount']."</td>";
