    ...
    <td class="mid_mid">
        ...
        <?php
				...
				else
				{
					...
					else
					{
						...
						?><div id="statusChangesDiv" title="Record added"><center><br><p>Record added successfully</p></center></div>
							...
							setTimeout('document.location.href="manage_inword.php";',1000);
							</script>
						<?php
					}
				}
            ...
            <tr>
                ...
                <td><input type="text" name="kit_qty" id="kit_qty" style="width:200px" value="<?php if($_POST['save_changes']) echo $_POST['kit_qty']; else echo $row_record['kit_qty']; ?>" onKeyUp="cal_kit_qty();"/></td>
            </tr>
			<?php 
                            			...
                            			{ 
											...
											<table cellspacing="5" id="tbl<?php echo $t; ?>" width="100%">
												<tr>
													...
													<td width="18%" align="center"><input type="text"name="sin_product_qty<?php echo $t; ?>" id="sin_product_qty<?php echo $t; ?>" style=" width:100px" value="<?php echo $data_exclusive['sin_product_qty'] ?>" onKeyUp="getDiscount(<?php echo $t; ?>)"/></td>
