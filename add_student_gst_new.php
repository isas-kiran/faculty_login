													...
													if($_SERVER['HTTP_HOST']!="localhost" && $_SERVER['HTTP_HOST']!="localhost:81")//|| $_SERVER['HTTP_HOST']=="hindavi-1"
   													{
														...
														if(mysql_num_rows($ptr_sel))
														{
															...
															$select_email_id = " select module_type_id from sms_mail_configuration_map where id !='".$data_module['module_type_id']."' ";
															$ptr_emails = mysql_query($select_email_id);
															while($data_emails = mysql_fetch_array($ptr_emails))
															{
	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%" >
       ...
       <?php }?>
                <tr>
                    ...
                    <td width="40%"><input type="text" class="input_text datepicker" name="admission_date" id="admission_date" value="<?php if($_POST['admission_date']) echo $_POST['admission_date']; else echo date('Y-m-d'); ?>" />
                ...
                <tr>
                    ...
                    <td 40%><input type="text" class="validate[required] input_text" name="inquiry_date" id="inquiry_date"  value="<?PHP if($_POST['inquiry_date']) echo $_POST['inquiry_date']; else echo $row_record['added_date'];?>" /><br />(yyyy-mm-dd)</td>
                </tr>
                <tr>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td width="40%"><input type="text" class="input_text datepicker" name="dob" id="dob" value="<?php if($_POST['dob'])	echo $_POST['dob'];else{$arrage_date= explode('-',$row_record['dob'],3);echo $arrage_date[1].'/'.$arrage_date[2].'/'.$arrage_date[0];}?>" /></td> 
                	<td width="40%"></td>
            	</tr>   
            	<tr>
