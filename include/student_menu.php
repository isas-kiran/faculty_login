	...
	<?php
   	if($_SESSION['type'] =='AG')
   	{
        ...
        <td>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
            <?php 
                if($page_name == 'inquiry_agent.php')
                {
                ?>
                <tr>
                    <td class="tab2_left"></td>
                    <td class="tab2_mid"><a href="inquiry_agent.php" style="color:#7CA32F;">Add Enquiry </a></td>
                    <td class="tab2_right"></td>
                </tr>
                <?php
                }
                ...
                <tr>
                    <td class="tab_left"></td>
                    <td class="tab_mid"><a href="inquiry_agent.php" style="color:#666666;">Add Enquiry </a></td>
                    <td class="tab_right"></td>
                </tr>
                <?php
                }            
...
<td>
	<table border="0" cellspacing="0" cellpadding="0">
		<?php
        if($page_name == 'add_agent.php')
        {
        ?>
        <tr>
            <td class="tab2_left"></td>
            <td class="tab2_mid"><a href="add_agent.php" style="color:#7CA32F;">Add Agent</a></td>
            <td class="tab2_right"></td>
        </tr>
        <?php
        }
        ...
        <tr>
            <td class="tab_left"></td>
            <td class="tab_mid"><a href="add_agent.php" style="color:#666666;">Add Agent</a></td>
            <td class="tab_right"></td>
        </tr>
        <?php
        }
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <?php
            if($page_name == 'manage_lead.php')
            {
            ?>
            <tr>
                <td class="tab2_left"></td>
                <td class="tab2_mid"><a href="manage_lead.php" style="color:#7CA32F;">Manage Lead</a></td>
                <td class="tab2_right"></td>
            </tr>
            <?php
            }
            ...
            <tr>
                <td class="tab_left"></td>
                <td class="tab_mid"><a href="manage_lead.php" style="color:#666666;">Manage Lead</a></td>
                <td class="tab_right"></td>
            </tr>
            <?php
            }
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <?php
            if($page_name == 'add_lead.php')
            {
            ?>
            <tr>
                <td class="tab2_left"></td>
                <td class="tab2_mid"><a href="add_lead.php" style="color:#7CA32F;">Add Lead</a></td>
                <td class="tab2_right"></td>
            </tr>
            <?php
            }
            ...
            <tr>
                <td class="tab_left"></td>
                <td class="tab_mid"><a href="add_lead.php" style="color:#666666;">Add Lead</a></td>
                <td class="tab_right"></td>
            </tr>
            <?php
            }
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <?php
            if($page_name == 'import_existing_campaign_inquiries.php')
            {
            ?>
            <tr>
                <td class="tab2_left"></td>
                <td class="tab2_mid"><a href="import_existing_campaign_inquiries.php" style="color:#7CA32F;">Check Existing Enquiry</a></td>
                <td class="tab2_right"></td>
            </tr>
            <?php
            }
            ...
            <tr>
                <td class="tab_left"></td>
                <td class="tab_mid"><a href="import_existing_campaign_inquiries.php" style="color:#666666;">Check Existing Enquiry</a></td>
                <td class="tab_right"></td>
            </tr>
            <?php
            }
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <?php
            if($page_name == 'model_bank.php')
            {
            ?>
            <tr>
                <td class="tab2_left"></td>
                <td class="tab2_mid"><a href="model_bank.php" style="color:#7CA32F;">Manage Model Bank</a></td>
                <td class="tab2_right"></td>
            </tr>
            <?php
            }
            ...
            <tr>
                <td class="tab_left"></td>
                <td class="tab_mid"><a href="model_bank.php" style="color:#666666;">Manage Model Bank</a></td>
                <td class="tab_right"></td>
            </tr>
            <?php
            }
...
if($array_prev[$e][$f]['privilege_id']==340)
{
	...
	<td>
		<table border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td class="tab2_left"></td>
				<td class="tab2_mid"><a href="manage_lead.php" style="color:#7CA32F;">Manage Leads</a></td>
				<td class="tab2_right"></td>
			</tr>
			<?php
			}
			...
			<tr>
				<td class="tab_left"></td>
				<td class="tab_mid"><a href="manage_lead.php" style="color:#666666;">Manage Leads</a></td>
				<td class="tab_right"></td>
			</tr>
			<?php
			}
...
if($array_prev[$e][$f]['privilege_id']==341)
{
	...
	<td>
		<table border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td class="tab2_left"></td>
				<td class="tab2_mid"><a href="add_lead.php" style="color:#7CA32F;">Add Leads</a></td>
				<td class="tab2_right"></td>
			</tr>
			<?php
			}
			...
			<tr>
				<td class="tab_left"></td>
				<td class="tab_mid"><a href="add_lead.php" style="color:#666666;">Add Leads</a></td>
				<td class="tab_right"></td>
			</tr>
			<?php
			}
