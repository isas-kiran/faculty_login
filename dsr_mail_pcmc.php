...
//}   
		...
		$sel_inv1="select DISTINCT(bank_id) as bank_name from bank where 1 and status='Active' ".$branch_id." show_in_report!='No'";
		$ptr_amnt1=mysql_query($sel_inv1);
		if($total_bank=mysql_num_rows($ptr_amnt1))
		{
			...
			while($data_ptr_sel1=mysql_fetch_array($ptr_amnt1))
			{
				...
				$outgoing=$data_sel_expense['total_amt'] + $data_sel_recipt_out['total_amt'] +$data_inv['total_amt']+$data_cc_expense['total_amt']+$data_sel_refund['total_amt'];
				//==============================================================================================================================================
...
$message.='  </table>
 ...
 <tr style="background-color:#999;color: black">
    ...
    // <td width="15%" align="center" style="border:1px solid #CCC"><strong>Cash Received from Innocent</strong></td>
				...
				$message.= '<td align="center" style="border:1px solid #CCC">'.$opening_petty_cash.'</td> ';//(3/6/19)
...
//==================================================
$sel_total_recp="select SUM(amount) as total_amt from receipt where DATE(`added_date`) >='".$date_for_month."-01' and DATE(`added_date`) <= '".$date."' ".$branch_id."";
...
$message.='   <tr>
  ...
  $message.='</table>';
						...
						$subject = " DSR Report of Pune Branch";
						...
						try {
							...
							try {
									...
									///usr/local/bin/php -q /home/isasadmin007/isastest/faculty_login/dsr_mail.php?&send_mail=mail
									///bin/touch /home/isasadmin007/public_html/cron_test.txt >/dev/null 2>&1 && /bin/echo "Cron ran at: `date`" >> /home/isasadmin007/public_html/cron_test.txt
									$mail->Subject = 'DSR Report For PCMC Branch- '.$date.'';
