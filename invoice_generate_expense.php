...
<body>
    <div class="heightSpacer"></div>
        ...
        $sql_records= "SELECT * from expense_invoice where invoice_id ='".$record_id."'";
        ...
        $sql_record= "SELECT * FROM expense where expense_id='".$data_bill_master['expense_id']."'";
        $_SESSION['sql_articles']=$sql_record;
        if(mysql_num_rows($db->query($sql_record)))
        $row_record=$db->fetch_array($db->query($sql_record));
        
        $sel="select * from vendor where vendor_id='".$row_record['vendor_id']."'";
        $ptr_cust=mysql_query($sel);
        $data_cust=mysql_fetch_array($ptr_cust);
         //=============================================================
        $sql_records_invoice= "SELECT * FROM `expense_invoice` WHERE expense_id='".$data_bill_master['expense_id']."' order by invoice_id desc limit 1";            
    	...
    	<table align="center" border="0" width="786" style="border-left:solid #999 1px; border-right:solid #999 1px; border-top:solid #999 1px;border-radius:5px;">
        	<tr>
				...
				<td valign="top">
                    ...
                    {
                        ?>
                        <a href="invoice_generate_expense.php?record_id=<?php echo $record_id ?>&action=print" style="text-decoration:none"><input type="button" name="print" value="Print" /></a>
                        <?php 
                    } ?>
        		</td>
			</tr>
        ...
        <table align="center" border="1px"  width="786" cellpadding="0" cellspacing="0" bgcolor="#EFEFEF" style=" border:1px solid;" >
        	<tr>
                    ...
                    <table align="center" border="0" width="786" cellpadding="0"style="border-left:solid #999 1px; border-right:solid #999 1px; ">
                        ...
                        <tr>
                        	<td width="30%" height="10" style="padding-left:20px; font-size:16px;" > <strong>Vendor Name :</strong></td>
                        	<td width="30%" height="10" style="font-size:13px;"> <?php echo $data_cust['name']; ?> </td>
                        	<!--<td width="30%" rowspan="3" align="center" valign="middle" style="font-weight:bold;">-->
							<?php 
                        ...
                        <tr>
                        	<td width="30%" height="10" style="padding-left:20px; font-size:16px;" ><strong>Receipt No :</strong></font></td>
                        	<td width="30%" height="10" style="font-size:13px;"><?php echo $invoice_no; ?></td>
                        </tr>
                        <tr>
                        	<td width="" height="10" style="padding-left:20px; font-size:16px;" ><strong>Invoice No : </strong></font></td>
                        	<td width="30%" height="10" style="font-size:13px;"><?php echo $data_bill_master['invoice_id']; ?></td>
                        </tr>
                        <tr>
                        	<td width="30%" height="10" style="padding-left:20px; font-size:16px;" ><strong>GST No :</strong></font></td>
                        	<td width="30%" height="10" style="font-size:13px;"><?php echo $data_cust['gst_no'];; ?></td>
                        </tr>
                        <tr><td colspan="4" align="center"><font size="+1">Product Price Details</font></td></tr>
                   	</table>
                   		<table align="center" border="1px" width="786" cellpadding="0" cellspacing="0" bgcolor="#EFEFEF" style=" border:1px solid;" >
                    	<tr>
                        	<td width="21%" align="left"  style="padding-left:10px; width:25%"><span style="font-size:15px; font-weight:bold">Total Price</span></td>
                           	<td width="26%" width:20% align="center"><font size="2px;"><?php echo $data_bill_master['total_price']; ?></font></td>
                        </tr>
                        <tr>
                    ...
                    <table align="center" border="0" width="786" cellpadding="0" style="border-left:solid #999 1px; border-right:solid #999 1px; ">
                        <tr height="20px">
                            <td colspan="4" style="padding-left:20px; font-size:13px;"> <span>Amount In Words -: <?php echo convert_number($data_bill_master['payable_amount']) ?> Only</span></td><td></td>
                        </tr>
                    </table>
                    <table align="center" border="0" width="786" cellpadding="0" style="border-left:solid #999 1px; border-right:solid #999 1px; ">
                   	...
                   	<table align="center" border="0" width="786" cellpadding="0" style="border-left:solid #999 1px; border-right:solid #999 1px;  border-bottom:solid #999 1px;">
                        ...
                        if($fetch_pay_mode['payment_mode']=='online')
                        {
                        	...
                        	?>
                          	<tr>
                            	<td width="190" height="10" style="padding-left:20px; font-size:13px;">Payment Mode: </td><td width="196" height="10" style=" font-size:13px;" ><?php echo $data_online_trans['paymode']; ?> </td>			<td width="146"></td>
                            </tr>
                            <tr>
     					...
     					<tr>
                        	<td width="190" class="heading"  style="padding-left:20px; font-size:13px;">Total Amount Paid:</td>
                            <td width="242" height="10" style=" font-size:13px;" ><?php echo $data_bill_master['payable_amount']; ?> </td> 
                        </tr>
					</table>                                        
            		<table align="center" border="0" width="786" cellpadding="0"  style="border-left:solid #999 1px; border-right:solid #999 1px;  border-bottom:solid #999 1px;">
                        <tr height="20px"><td colspan="2"></td></tr>
                        <tr>
                        	<td width="395" align="left"><b><font size="-1">ISAS Authorised Signature(With Seal)</font></b></td>
                            <td width="383" align="right"><b><font size="-1">Customer Signature</font></b></td>
                        </tr>
                    </table>
				</table>
				<?php
