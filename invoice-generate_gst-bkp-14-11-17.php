        ...
        <?php } ?>
                        ...
                        <table align="center" border="1px"  width="786" cellpadding="0" cellspacing="0"
                        	...
                        	<tr>
                                ...
                                <td width="24%" align="left"  style="padding-left:10px;width:20%"><span style="font-size:15px; font-weight:bold">GST Tax No.</span></td><td width="29%" width:20% align="center"><font size="2px;">27AADFI5575R1ZK</font> </td>
                          </tr>
                            <tr>
                            ...
                            <tr>
                             ...
                             <tr>
                               ...
                               <td align="left"  style="padding-left:10px; width:25%"><span style="font-size:15px; font-weight:bold">CGST (<?php echo $cgst_tax; ?>%) + SGST (<?php echo $sgst_tax; ?>%)</span></td>
								<td width:20% align="center"><font size="2px;"><?php echo $data_bill_master['cgst_tax']; ?>+<?php echo $data_bill_master['sgst_tax']; ?>=<?php echo $gst; ?></font></td>
...
<tr><td style="padding-left:20px; font-size:13px;"><strong>GST No.: 27AADFI5575R1ZK</strong></td></tr>
