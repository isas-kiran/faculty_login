...
<td>
 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="tab2_left"></td>
                <td class="tab2_mid"><a href="product_summery_report.php" style="color:#7CA32F;">Product Bank Report (sales)</a></td>
                <td class="tab2_right"></td>
            </tr>
            <?php
            }
            ...
            <tr>
                <td class="tab_left"></td>
                <td class="tab_mid"><a href="product_summery_report.php" style="color:#666666;">Product Bank Report (sales)</a></td>
                <td class="tab_right"></td>
            </tr>
            <?php
            }
