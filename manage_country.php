...
/* function validme()
	 {
        ...
        <?php
        $sql_records= "SELECT * FROM countries where 1 ".$pre_transcation_id." order by name asc";
            ...
            else
            {
                ...
                for($j=1;$j<=$total_floor;$j++)
                {
                    if($_POST['sub_name'.$j] !='')
                    {
                        ...
                        $record_ids=$db->query_insert("countries",$data_record_type1);
                ...
                setTimeout('document.location.href="manage_country.php";',1000);
                </script>
                <?php
            }
        }
                ...
                <td colspan="3">
                    ...
                    <tr>
                        ...
                        <table cellpadding="5" width="100%" >
                            ...
                            {
                                var shows_data='<div id="floor_id'+idss+'"><table cellspacing="3" id="tbl'+idss+'" width="100%"><tr><td valign="top" width="10%" align="center">'+idss+'</td><td valign="top" width="40%" align="center">Enter Country Name</td><td valign="top" width="50%" align="center"><input type="text" name="sub_name'+idss+'" id="sub_name'+idss+'" style="width:90%" required/></td><input type="hidden" name="row_deleted'+idss+'" id="row_deleted'+idss+'" value="" /><tr></table></div>';
