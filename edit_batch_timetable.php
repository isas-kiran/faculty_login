...
$sel_log="select * from batch_timetable where batch_timetable_map_id='".$record_id."' and c_b_id='".$batch_id."' ";
$ptr_log=mysql_query($sel_log);
$row_record=mysql_fetch_array($ptr_log);

$course_domain_id=$row_record['course_domain_id'];
?>
				...
				?>
					...
					<tr>
						...
						<td width="40%" class="customized_select_box">
							...
							<?php
							$select_topic="select topic_id from topic where course_domain_id='".$course_domain_id."' order by topic_id";
