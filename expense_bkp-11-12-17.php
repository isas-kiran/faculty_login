...
<!---------------------------------------Payment mode------------------------------------->  
<tr>
                                <td width="15%" align="center">Date<span class="orange_font">*</span></td>
...
?><select name="bank_name" class="input_text" id="bank_name" style="width:200px" onchange="show_acc_no(this.value)">
 ...
 <tr>
 <td width="15%" class="tr-header" align="center">Enter Account No</td>
 ...
 <tr>
 <td width="15%" class="tr-header" align="center">Enter Chaque No</td>
 ...
 <tr>
 <td width="15%" class="tr-header" align="center">Enter Credit Card No</td>
 ...
 <tr>
    <td width="15%" colspan="2"><div id="expense_subcategory"></div></td>
...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  ...
  <tr class="grey_td" >
    ...
    <?php } ?>
     ...
     <td width="15%" align="center"><strong>Bank Details</strong></td>
