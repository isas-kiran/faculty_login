  ...
  <tr>
	...
	?>
              ...
              <?php if($_SESSION['type']=='S')
                ...
                <tr>
                	<td width="14%" valign="top">Show GST<span class="orange_font">*</span></td>
					...
					<tr>
                        <td colspan="6">
							...
							<tr>
								...
								<input type="radio" name="discount1" id="discount1" value="rupees" <?php if($_POST['discount1']=="rupees") {echo 'checked="checked"';}else if($data_map['disc_type']=="rupees") { echo 'checked="checked"';} ?> />in Rs/-</td>
							...
							if($record_id!='')
							{
                            	...
                            	{ 
									...
									"<br/>".$sel_tel = "select p.product_id,p.product_name,p.price,p.quantity,p.admin_id from product p, site_setting s where 1 and p.status='Active' and p.admin_id=s.admin_id ".$where_cm." order by product_id asc";//remove ".$_SESSION['user_id']." on 14/5/2018 --and s.type='ST' on 13/6/18
									$query_tel = mysql_query($sel_tel);
									$qty_in_stock='';
