	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%">
            <tr><td colspan="3" class="orange_font">* Mandatory Fields</td></tr>
			 ...
			 <td style="width: 8%;">Select branch</td> 
                <td style="width: 15%;" colspan="2" align="left" style="padding-left:0px;">
                <?php
...
<?php
				...
				<td><input style="margin-right: 0px;margin-left: 0px;width:100%;" type="button" class="input_btn" onClick="getattendance()" value="Generate" name=""  /></td>
		</tr></table>
               </tr> 
 </table>
