                    ...
                    <td width="26" align="right" style="padding-right:15px;">
                       ...
                       <td width="43" valign="top" colspan="2">
                        ...
                        <?php
                         ...
                         {
                         ?>
                        <a href="all_ques_list_print.php?syllabus_id=<?php echo $_GET['syllabus_id']; ?>&unit_id=<?php echo $_GET['unit_id']; ?>&keyword=<?php echo $_GET['keyword']; ?>&action=print" style="text-decoration:none"><input type="button" name="print" value="Print" /></a><?php } ?>
