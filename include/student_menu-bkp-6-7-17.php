...
<td class="width5"></td>
	...
	<table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="tab2_left"></td>
                <td class="tab2_mid"><a href="enroll_gst.php" style="color:#7CA32F;">Enrollment Form GST <img src="images/new.gif" /></a></td>
                <td class="tab2_right"></td>
            </tr>
            <?php
            }
            ...
            <tr>
                <td class="tab_left"></td>
                <td class="tab_mid"><a href="enroll_gst.php" style="color:#666666;">Enrollment Form GST <img src="images/new.gif" /></a></td>
                <td class="tab_right"></td>
            </tr>
            <?php
            }
...
<td>
	<table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="tab2_left"></td>
                <td class="tab2_mid"><a href="total_report.php" style="color:#7CA32F;">Today Report </a></td>
                <td class="tab2_right"></td>
            </tr>
            <?php
            }
            ...
            <tr>
                <td class="tab_left"></td>
                <td class="tab_mid"><a href="total_report.php" style="color:#666666;">Today Report</a></td>
                <td class="tab_right"></td>
            </tr>
            <?php
            }
...
<td>
	<table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="tab2_left"></td>
                <td class="tab2_mid"><a href="student_report.php" style="color:#7CA32F;">Student Report </a></td>
                <td class="tab2_right"></td>
            </tr>
            <?php
            }
            ...
            <tr>
                <td class="tab_left"></td>
                <td class="tab_mid"><a href="student_report.php" style="color:#666666;">Student Report</a></td>
                <td class="tab_right"></td>
            </tr>
            <?php
            }
...
<td>
	<table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="tab2_left"></td>
                <td class="tab2_mid"><a href="total_report.php" style="color:#7CA32F;">Todays Report</a></td>
                <td class="tab2_right"></td>
            </tr>
            <?php
            }
            ...
            <tr>
                <td class="tab_left"></td>
                <td class="tab_mid"><a href="total_report.php" style="color:#666666;">Todays Report</a></td>
                <td class="tab_right"></td>
            </tr>
            <?php
            }
