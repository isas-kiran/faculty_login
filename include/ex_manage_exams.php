...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    <td class="top_right"></td>
    				...
    				<?php 
					//======================Permanantlr removed multiple delete code=========================
					/*if($_POST['formAction'])
                    {
                        if($_POST['formAction']=="delete")
                        {
                            for($r=0;$r<count($_POST['chkRecords']);$r++)
                            {
                                ...
                                $sql_query= "SELECT exams_id,exam_number FROM ".$GLOBALS["pre_db"]."exams where exams_id ='".$del_record_id."'";
                                ...
                                if(mysql_num_rows($ptr_query))
								{
									...
									$delete_query="delete from ".$GLOBALS["pre_db"]."exams where exams_id ='".$del_record_id."'";
									$db->query($delete_query);   
									  
									$delete_query1="delete from ".$GLOBALS["pre_db"]."exams_section where exams_id ='".$del_record_id."'";
                     ...
                     <form method="post"  name="frmTakeAction" action="<?php echo $_SERVER['PHP_SELF'].'?#msgbox';?>" >
                         <input type="hidden" name="formAction" id="formAction" value=""/>
                          <tr class="grey_td" >
                            ...
                            <td width="20%" align="center"><strong>Added Date</strong></td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
								...
								{
									$select_unit_ids="select COUNT(papers_section_id) as papers_section_id from ex_papers_section where papers_id='".$fetch_paper_ids['papers_id']."'";
								...
								echo '<td align="center">'.$val_query['school_code'].'</td>';
