...
function send()
{
	...
	if(document.getElementById('net_fees'))
		...
		var net_fees ='';
	if(document.getElementById('service_tax'))
...
{    
  frm = document.jqueryForm; 
	...
	{
		var new_tax=parseFloat(new_tax);
		total_taxes=tax;
	}
	...
	//document.getElementById('down_payment_tax').value=dp_tax;
	if(new_cgst_tax >0 && new_sgst_tax >0)
	{
		down_total_taxes=down_cgast_tax+down_sgast_tax;////23-9-17	
	}
	else if(new_tax > 0)
	{
		down_total_taxes=dp_tax;////23-9-17		
	}
...
function show_bank(branch_id,vals)
{
	...
	$.ajax({
		...
		success: function(rettax)
		{
			...
			document.getElementById("down_service_id").innerHTML=sgst;
			...
			document.getElementById("down_ser_taxes").value=service_tax;
		...
		<td class="mid_mid">
			...
			<?php
                ...
                if(isset($_POST['save_changes']) && $_POST['randcheck']==$_SESSION['rand'])
                {
					...
					$down_sgst_tax_in_per= ( $_POST['down_ser_taxes'] ) ? $_POST['down_ser_taxes'] : "0";
                	...
                	<td>
                        <div id="show_cities">
                            <table width="100%">
                            	<tr>
                                    <td>
                                    <select id="city" name="city" style="width:460px">
...
<!--=================================================================================================================-->            
            ...
            <tr>
            	<td width="20%" class="heading">Service Tax<span id="down_service_id"> on down payment<?php if($_SESSION['type']!='S'){ echo $_SESSION['service_tax'];} ?></span>%<span class="orange_font">*</span><input type="hidden" id="down_ser_taxes" name="down_ser_taxes" value="<?php if($_SESSION['type']!='S'){ echo $_SESSION['service_tax'];} ?>"  /></td>
