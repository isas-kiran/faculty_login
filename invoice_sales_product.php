...
{ 
    ...
    return $res; 
						...
						$sel="select membership from customer where cust_id='".$data_record['customer_id']."'";
...
<table align="center" border="1px"  width="100%" style="border-left:solid #999 1px; border-right:solid #999 1px; border-top:solid #999 1px;border-radius:5px; border-collapse:collapse">
                        <tr>
							...
							/*if($added_date > '2019-05-11')
								...
								$gst_no='27AADFI5575R1ZK';*/
							?>
                            </table>
                            <span style="font-weight:700; font-size:12px"><?php if($_SESSION['tax_type']=='GST') echo 'GST No.- '.$gst_no;else echo 'VAT No.- '.$gst_no; ?></span>
                            </td>
                            <td width="15%" align="left" style="padding-left:10px; font-size:12px">Invoice No : <?php echo $data_record['sales_product_id'] ?><br/>
                              Date : <?php
                        ...
                        <tr><td width="50%" align="center" colspan="2"><img src="images/barcode.png" height="50px" width="100px"/></td></tr>
                        <tr height="5">
                        </tr></table>
               ...
               <table align="center" border="1px"  width="100%" style="border-left:solid #999 1px; border-right:solid #999 1px; border-top:solid #999 1px;border-radius:5px; border-collapse:collapse" cellpadding="5" cellspacing="5">
                ...
                <td colspan="2">
                	<table width="100%">
                        ...
                        <?php
						if($data_record['show_gst']!='no' && $cust_gst_no!='')
						{
                        ?>
                        <tr>
                			<td width="28%" align="center"><span style="font-size:12px; font-weight:bold">Customer <?php if($_SESSION['tax_type']=='GST') echo 'GST No.- ';else echo 'VAT No.- '; ?></span></td>
                    		<td width="72%" align="center"><span style="font-size:12px; font-weight:bold"><?php echo $cust_gst_no; ?></span></td>
                    	</tr>
                        <?php
						}
						?>
            ...
            <table align="center" border="1px"  width="100%" cellpadding="5" cellspacing="2"  style=" border:1px solid; border-collapse:collapse" >
				...
				while($data_service=mysql_fetch_array($ptr_map))
				{
					...
					'<br/>'.$total_discount_price =$data_service['base_prod_price']*$data_service['product_disc']/100;
					...
					echo '<tr>';
						...
						echo '<td align="center"><span style="font-size:10px;">'.$data_service['prod_price'].'</span></td>';
						echo '<td align="center"><span style="font-size:10px;">'.$data_service['base_prod_price'].'</span></td>';
						echo '<td width="6%" align="center"><span style="font-size:10px;">'.$data_service['product_disc'].''.$disc_type.'</span></td>';
						...
						echo '<td align="center"><span style="font-size:10px;">'.$data_service['product_qty'].'</span></td>';
						...
						echo '<td align="center"><span style="font-size:10px;">'.$data_service['sales_product_price'].'</span></td>';
				...
				?>  
                  ...
                  <tr>
                  		<td colspan="9" rowspan="2"><span style="font-size:12px;"><strong>Bill Amounts in words:  </strong><?php echo convert_number($data_record['total_price']) ?></span></td>
                  		<?php
				         ...
				         ?>
                  		...
                  		<td colspan="7"><span style="font-size:12px;"><?php echo "<strong>Discount(in %):</strong>&nbsp;".$data_record['discount'].""; ?>
						
						<?php //echo "<br/><strong>Discounted Price &emsp;=></strong>&emsp;".$data_record['tot_price_withou_tax']."<br/><br/>"; ?>
                  ...
                  <tr>
                      <td colspan="9">
                      <span style="font-size:10px;"><!--<b>* I/We here by certify that my/our registration certificate center under : -</b><br/>
                      The Maharashtra Value Added Tax Act, 2002 is in force in the date on which the sale of goods specified in this TAX INVOICE is made by me/us & that transaction of sale covered by this Tax Invoice has been effected by me/us & it shall be accounted for in the turnover of sales while filling of return & the due tax, if any, payable on the sale has been paid or shall be paid.<br/><br/>GST NO : <?php //echo $gst_no; ?>--><br/><br/><br/>
