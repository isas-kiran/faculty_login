        ...
        <tr>
            ...
            <td valign="top" class="contentRight">
                <table cellpadding="0" cellspacing="0" align="left" width="100%">
                    <tr><td class="navigation_heading"><?php  echo "Add";?> Gallery</td></tr>
				...
				if($_POST['submit'])
				{
							...
							if($icon !='')
							{
								...
								$update_icon= " update  ".$GLOBALS["pre_db"]."gallery_images set icon='' where gallery_id = '$gallery_id' ";
							...
							if($_FILES['file']['tmp_name'] !="")
							{
								...
								$insert_pdf_query ="insert into ".$GLOBALS["pre_db"]."gallery_images values(0,'$gallery_id','".$_POST['comment']."','".$_POST['tag']."','$saved_file_name','$this_icon')";
								...
								for($i=1;$i<=$extra_pdf;$i++)
								{
									...
									if($_FILES['file'.$i]['tmp_name'] !="")
									{
										...
										$insert_extra_pdf = "insert into ".$GLOBALS["pre_db"]."gallery_images values(0,'$gallery_id','".$_POST['comment'.$i]."','".$_POST['tag'.$i]."','$saved_more_file_name','$this_icon')";
                   ...
                   <tr>
                     <td  align="left" >Select Gallery </td>
					  ...
					  <option value="0"><==Select Gallery==></option>
					   <?php
					  $select_names = "select gallery_id,title from  ".$GLOBALS["pre_db"]."gallery";
                    ...
                    onKeyPress="if (!isEng){ return change(this,event);} else {return true;}" onFocus="changeCursor(this);showme();" onClick="changeCursor(this);" onKeyUp="changeCursor(this);" onKeyDown="positionChange(event);"  onblur="hideme();" /></div> <div style="display:none; position:absolute; padding-top:5%;padding-left:10%" id="hindi_images" >
