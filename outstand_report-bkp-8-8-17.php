                      ...
                      <tr class="grey_td" >
                        ...
                        <!--<td width="8%" align="center"><strong>Date</strong></td>-->
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
								...
								$sel_total_course="select enroll_id,course_id,down_payment,discount,discount,net_fees,admission_date from enrollment where 1 and ref_id='".$val_query['enroll_id']."' || enroll_id='".$val_query['enroll_id']."'";
									...
									while($data_inst_amnt=mysql_fetch_array($ptr_ins_amnt))
									{
										...
										if(mysql_num_rows($ptr_installment))
										{
											while($data_installment = mysql_fetch_array($ptr_installment))
											{
												...
												$past_rec='<img src="images/new.gif" />';
												else
												$past_rec='';
