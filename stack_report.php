...
?> 
                        ...
                        if($no_of_records)
                        {
                           ...
                           // $pager = new PS_Pagination($sql_query,$_SESSION['show_records'],$_SESSION['show_records_pages'],$query_string1);
                            ...
                            <tr><td align="left" colspan="11"><strong>Note: Default Date start from <?php echo $start_date; ?> to <?php echo $end_date; ?></strong></td></tr>
                            <tr class="grey_td" >
                            ...
                            <td width="10%" colspan="5" align="center">Enquiries not assigned</td>
                            <?php
							...
							?>
                            <td width="10%" colspan="3"><?php echo $count_unassigned; ?></td>
                            </tr>
                      		<tr class="grey_td" >
                        	<td width="5%" align="center"><strong>Sr. No.</strong></td>
                        	<td width="10%" align="center"><strong>Name</strong></td>
                        	<td width="8%" align="center"><strong>Total New Enq. Assign</strong></td>
                            <td width="8%" align="center"><strong>Total New Enq. Called</strong></td>
                            <td width="8%" align="center"><strong>Pending New Followups</strong></td>
                            <td width="8%" align="center"><strong>Completed New followups</strong></td>
                            <td width="8%" align="center"><strong>Total Pending Followups</strong></td>
                            <td width="8%" align="center"><strong>Total Followups Called</strong></td>
                            <td width="10%" align="center"><strong>Invalid/Not Intrested Enquiry</strong></td>
                            <td width="8%" align="center"><strong>Total Walkin</strong></td>
                      		...
                      		while($val_query=mysql_fetch_array($all_records))
                            {
								...
								echo'<td align="center"><a target="_blank" href="show_students.php?assigned_to='.$val_query['admin_id'].''.$sep_url_string.' ">'.$count_enq_called.'</a></td>';
								...
								$select_tot_called="select DISTINCT(student_id) from followup_details where 1 and admin_id='".$val_query['admin_id']."' ".$_SESSION['where']." ".$search_cm_id." ".$enquiry_from_date." ".$enquiry_to_date."";
