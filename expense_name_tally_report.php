...
<title>Expense Name Tally Report</title>
...
?>   
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
              <tr>
                <td class="width5"></td>
                    ...
                    <td><a href="expense_name_tally_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>
            </tr>          
        </table>
        </form>	
    </td>
	...
	$sql_query= "select * from expense where 1 ".$search_cm_id." ".$pre_keyword_i." ".$pay_type." ".$bank_ids." ".$paid_from_date." ".$paid_to_date." group by vendor_id ".$select_directory." "; //
	...
	if($no_of_records)
	{
		...
		while($val_query=mysql_fetch_array($my_db))
		{
			...
			echo '<td align="center">'.$data_name['address'].'</td>';
			echo '<td align="center">India</td>';
			echo '<td align="center"></td>';

			echo '<td align="center">Regular</td>';
			echo '<td align="center">'.$data_name['gst_no'].'</td>';
