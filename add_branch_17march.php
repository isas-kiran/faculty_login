...
if($_REQUEST['record_id'])
{
    ...
    $sql_record= "SELECT branch_name,branch_id,branch_address FROM branch where branch_id ='".$record_id."'";
  ...
  <tr>
	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%">
              ...
              <tr>
                ...
                <td width="40%"><textarea name="branch_address"><?php echo $row_record['branch_address'] ?></textarea></td> 
                <td width="40%"></td>
              </tr>  
