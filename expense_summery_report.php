...
<title>Expense Bank Summery</title>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
              <tr>
                ...
                <!--<td width="20%">
                        ...
                        <td><a href="expense_summery_report_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>  
            </tr>          
        </table>
        </form>	
    </td>
     ...
     <?php
		...
		if($no_of_records)
		{
			...
			<tr class="grey_td" >
				...
				?>
				<td width="10%" align="center"><strong>Employee Name</strong></td>
				<td width="15%" align="center"><strong>Expense Details</strong></td>
				...
				<td width="8%" align="center">Total Paid Amount</td>
				<td width="8%" align="center">Total Remaining Amount</td>
			...
			while($val_query=mysql_fetch_array($all_records))
			{
				...
				echo '<p> Expense Category :-'.$data_p['name'].'</p>';
				echo '<p> Expense Type :-'.$data_p1['expense_type'].'</p>';
				echo '<p style="text-align:left;font-weight:600">Expense Details -</p>';
				$sel_prod= " select expense_id,expense_name from expense_map where expense_id='".$val_query['expense_id']."'";
				$ptr_prod= mysql_query($sel_prod);
				while($product=mysql_fetch_array($ptr_prod))
				{
					echo '<p style="text-align:left">'.$product['expense_name'].'</p>';
				}
				echo '</td>';
				
				echo '<td align="center">'.html_entity_decode($val_query['description']).'</td>';
				...
				echo "<td align='center'>".$val_query['remianing_amount']."</td>";			
