...
/* function validme()
	 {
        ...
        <?php
        $sql_records= "SELECT * FROM cities where 1 ".$pre_transcation_id." order by name asc";
            ...
            else
            {
                ...
                for($j=1;$j<=$total_floor;$j++)
                {
                    if($_POST['sub_name'.$j] !='')
                    {
                        ...
                        $record_ids=$db->query_insert("cities",$data_record_type1);
                ...
                setTimeout('document.location.href="manage_city.php";',1000);
                </script>
                <?php
            }
        }
            ...
            <tr>
                ...
                <td>
                    <div id="show_states">
                        <table width="100%">
                            <tr>
                                <td><select id="state" name="state" style="width:460px"> <!--onchange="select_city(this.value)" -->
