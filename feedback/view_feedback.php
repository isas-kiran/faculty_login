  ...
  <tr>
    ...
    <td class="mid_mid">
                      ...
                      <?php
						...
						$sql_records= "SELECT * FROM feedback where customer_service_id=".$record_id." ";
						...
						if($no_of_records)
						{
							...
							<tr><td valign="middle" align="right">
                                    ...
                                    <?php
										...
										$sel_cust_service="select customer_id, customer_service_id,customer_invoice_no, service_price, total_cost, amount, nonmemb_discount, nonmemb_discount_type, remaining_amount from customer_service where customer_service_id='".$record_id."'";
										$quer_cust_service=mysql_query($sel_cust_service);
										$fetch_query_cust_service=mysql_fetch_array($quer_cust_service);
									
                                        $select_customer = " select cust_name, cust_id from customer where cust_id='".$fetch_query_cust_service['customer_id']."' ";
								...
								<tr align="center" class="grey_td" >
                                    ...
                                    <td width="11%" class="tr-header"><strong>Service Name.</strong></td>
									 <td width="11%" class="tr-header"><strong>Therapist Name.</strong></td>
                                    <td width="11%" class="tr-header"><strong>Question</strong></td>
                                    <td width="11%" class="tr-header"><strong>Answer</strong></td>
                                    ...
                                    while($val_record=mysql_fetch_array($all_records))
                                    {
										...
										$select_service = " select service_name from servies where service_id='".$val_record['service_id']."' ";
									  	$ptr_service=mysql_query($select_service);
										$data_service = mysql_fetch_array($ptr_service);
										
										echo "<td align='center'>".$data_service['service_name']."</td>";
										
										$select_therapist = " select name from site_setting where admin_id='".$val_record['therapist_id']."' ";
									  	$ptr_therapist=mysql_query($select_therapist);
										$data_therapist = mysql_fetch_array($ptr_therapist);
										echo "<td align='center'>".$data_therapist['name']."</td>";
										
									    echo '<td align="center">'.$val_record['que'].'</td>'; 
										
									
								        echo '<td align="center">'.$val_record['ans'].'</td>';
                                    ...
                                    ?>
                                        ...
                                        if($fetch_query_cust_service['remaining_amount'] !=0)
										{
											...
											echo '<td>';
											echo'<a href="add_cust_service_payment.php?record_id='.$record_id.'"><strong><font size="+1">Add Payment</font></strong></a>'; 
											echo '</td>';
											echo '<td>';
