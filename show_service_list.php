  ...
  <tr>
    ...
    <td class="mid_mid">
                      ...
                      <?php
						...
						$sql_records= "SELECT * FROM feedback where therapist_id='".$_REQUEST['therapist_id']."' AND ans='".$_REQUEST['type']."' ";
						...
						if($no_of_records)
						{
							...
							<tr><td valign="middle" align="right">
                                    ...
                                    <?php
										...
										$select_therapist = " select name from site_setting where admin_id='".$_REQUEST['therapist_id']."' ";
									  	$ptr_therapist=mysql_query($select_therapist);
										$data_therapist = mysql_fetch_array($ptr_therapist);
										
									?>
                                    	<tr style="padding-left:10px">
                                        	<td width="20"><strong>Therapist Name :</strong></td><td width="330"><?php echo $data_therapist['name']; ?></td>
								...
								<tr align="center" class="grey_td" >
                                    ...
                                    <td width="11%" class="tr-header"><strong>Service Name.</strong></td>
									 <td width="11%" class="tr-header"><strong>Customer Name.</strong></td>
                                    ...
                                    while($val_record=mysql_fetch_array($all_records))
                                    {
										...
										echo "<td align='center'>".$data_service['service_name']."</td>";
										 ...
										 $select_customer = " select cust_name, cust_id from customer where cust_id='".$val_record['customer_id']."' ";
									  	$ptr_customer=mysql_query($select_customer);
										$data_customer = mysql_fetch_array($ptr_customer);
										echo "<td align='center'>".$data_customer['cust_name']."</td>";
