    ...
    <td class="mid_mid">
        ...
        <?php
                        ...
                        if($_POST['save_changes'])
                        {
							...
							if($record_id=='')
							{
								  "<br/>".$sel_product="select product_name from product where product_name ='".$product_name."' and cm_id='".$cm_id."' ";
                            ...
                            else
                            {
                                ...
                                else
                                {
									...
									"<br>".$insert="INSERT INTO `log_history`(`category`, `action`, `name`, `id`, `date`, `cm_id`, `admin_id`) VALUES ('add_product','Add','".$product_name."','".$product_id."','".date('Y-m-d H:i:s')."','".$_SESSION['cm_id']."','".$_SESSION['admin_id']."')";
