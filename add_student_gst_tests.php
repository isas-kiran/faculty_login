...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
                        ...
                        else
                        {
						   ...
						   // $data_record['service_tax']=$service_tax;
                            ...
                            if($record_id)
                            {
								...
								{
									$chk_exist_="select stud_login_id from stud_login where username='$username' and pass='$pass' ";
									$ptr_chk_exists = mysql_query($chk_exist_);
								...
								{
									$update_code="update discount_coupon set redeme_date='".date('Y-m-d')."', redeme_to='".$student_id."',status='Inactive' where code='".trim($discount_coupon_code)."'";
  ...
  <!--==========================================================================================================================-->                <?php
                ...
                <!--<tr>
                	<td width="22%">Discount Price</td>
                	<td width="38%"><input type="text" readonly="readonly" class="input_text" name="disc_pr" <?php //echo $readonly; echo $bg;?> id="disc_pr" value="<?php //if($_POST['disc_pr']) echo $_POST['disc_pr']; else if($row_record['disc_pr'] !=0) echo $row_record['disc_pr']; else echo 0; ?>" />
                    </td>
                    <td width="40%"></td>
                </tr>-->
                <tr>
                ...
                <!--<tr>
                	<td width="22%">Discount Coupon Price</td>
                	<td width="38%"><input type="text" readonly="readonly" class="input_text" name="disc_coupon_pr" <?php //echo $readonly; echo $bg;?> id="disc_coupon_pr" value="<?php //if($_POST['disc_coupon_pr']) echo $_POST['disc_coupon_pr']; else if($row_record['disc_coupon_pr'] !=0) echo $row_record['disc_coupon_pr']; else echo 0; ?>" />
                    </td>
                    <td width="40%"></td>
                </tr>-->
            	<!--<tr>
...
<!--=================================================================================================================================-->
            ...
            <tr>
                ...
                <?php 
				if($record_id && $row_record['no_of_installment'] !=0)
                {
                    ?>
                    <table width="100%">
                    <?php
