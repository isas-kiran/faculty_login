                        ...
                        if(count($data->sheets[$i][cells])>0) // checking sheet not empty
                        {
                            ...
                            for($j=1;$j<=count($data->sheets[$i][cells]);$j++) // loop used to get each row of the sheet
                            {
                                ...
                                /*=====================================Check Existing Courses=========================================*/
								 ...
								 "<br/>". $select_product_cat= "select pcategory_name,pcategory_id from product_category where pcategory_name='".trim($data->sheets[0]['cells'][$i][4])."' and cm_id='".$cm_id."' and admin_id='".$admin_id."'  ";
								...
								if(mysql_num_rows($ptr_product_cat) =='' || mysql_num_rows($ptr_product_cat) ==0)
								{
									...
									{
										"<br/>".$insert_cours_cat= "insert into product_category (`pcategory_name`,`added_date`,`cm_id`,`admin_id`) values ('".trim($data->sheets[0]['cells'][$i][4])."','".date("Y-m-d H:i:s")."','".$cm_id."','".$admin_id."')  ";
                                		$ptr_cat= mysql_query($insert_cours_cat);
										$cat_id=mysql_insert_id();
										
										"<br/>".$select_sub_cat= "select sub_name,sub_id,pcategory_id from product_subcategory where sub_name='".trim($data->sheets[0]['cells'][$i][5])."' and cm_id='".$cm_id."' and admin_id='".$admin_id."'  ";
										...
										if(mysql_num_rows($ptr_sub_cat) =='' || mysql_num_rows($ptr_sub_cat) ==0)
										{
											if(trim($data->sheets[0]['cells'][$i][5]) !='')
											{
												...
												"<br/>".$insert_sub_cat= "insert into product_subcategory (`sub_name`,`pcategory_id`,`cm_id`,`admin_id`) values ('".trim($data->sheets[0]['cells'][$i][5])."','".$cat_id."','".$cm_id."','".$admin_id."')  ";
												...
												"<br/>".$insert_product= "insert into product (`product_name`,`product_code`,`pcategory_id`,`sub_id`,`description`,`size`,`unit`,`commission`,`price`,`type`,`quantity`,`brand`,`added_date`,`cm_id`,`vender`,`admin_id`) values ('".$product_name."','".$product_code."','".$cat_id."','".$sub_cat_id."','".$product_description."','".$size."','".$unit."','".$commission."','".$price."','".$type."','".$quantity."','".$brand."','".date('Y-m-d H:i:s')."','".$cm_id."','".$vendor_id."','".$admin_id."')  ";
										...
										else
										{
												...
												"<br/> eles sub cat-  ".$insert_product= "insert into product (`product_name`,`product_code`,`pcategory_id`,`sub_id`,`description`,`size`,`unit`,`commission`,`price`,`type`,`quantity`,`brand`,`added_date`,`cm_id`,`vender`,`admin_id`) values ('".$product_name."','".$product_code."','".$cat_id."','".$data_sub_cat['sub_id']."','".$product_description."','".$size."','".$unit."','".$commission."','".$price."','".$type."','".$quantity."','".$brand."','".date('Y-m-d H:i:s')."','".$cm_id."','".$vendor_id."','".$admin_id."')  ";
                                				$ptr_product= mysql_query($insert_product);
												$product_id=mysql_insert_id();
								...
								else
								{
									...
									"<br/>sel cat- ".$select_subcat_id= "select sub_name,sub_id,pcategory_id from product_subcategory where sub_name='".trim($data->sheets[0]['cells'][$i][5])."' and cm_id='".$cm_id."' and admin_id='".$admin_id."' ";
									$ptr_subcat_id= mysql_query($select_subcat_id);
									if(mysql_num_rows($ptr_subcat_id) =='' || mysql_num_rows($ptr_subcat_id) ==0)
									{
										"<br/>second category- ".$insert_sub_cat= "insert into product_subcategory (`sub_name`,`pcategory_id`,`cm_id`,`admin_id`) values ('".trim($data->sheets[0]['cells'][$i][5])."','".$data_product_cat['pcategory_id']."','".$cm_id."','".$admin_id."')  ";
										$ptr_sub_cat= mysql_query($insert_sub_cat);
										$sub_cat_id=mysql_insert_id();
										...
										$insert_product= "insert into product (`product_name`,`product_code`,`pcategory_id`,`sub_id`,`description`,`size`,`unit`,`commission`,`price`,`type`,`quantity`,`brand`,`added_date`,`cm_id`,`vender`,`admin_id`) values ('".$product_name."','".$product_code."','".$data_product_cat['pcategory_id']."','".$sub_cat_id."','".$product_description."','".$size."','".$unit."','".$commission."','".$price."','".$type."','".$quantity."','".$brand."','".date('Y-m-d H:i:s')."','".$cm_id."','".$vendor_id."','".$admin_id."')  ";
										$ptr_product= mysql_query($insert_product);
										$product_id=mysql_insert_id();
									}
									else
									{
										...
										$insert_product= "insert into product (`product_name`,`product_code`,`pcategory_id`,`sub_id`,`description`,`size`,`unit`,`commission`,`price`,`type`,`quantity`,`brand`,`added_date`,`cm_id`,`vender`,`admin_id`) values ('".$product_name."','".$product_code."','".$data_product_cat['pcategory_id']."','".$data_subcat_id['sub_id']."','".$product_description."','".$size."','".$unit."','".$commission."','".$price."','".$type."','".$quantity."','".$brand."','".date('Y-m-d H:i:s')."','".$cm_id."','".$vendor_id."','".$admin_id."')  ";
										$ptr_product= mysql_query($insert_product);
										$product_id=mysql_insert_id();
