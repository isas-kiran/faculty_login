...
<?php
	...
	try {
			...
			$mail->Username = 'info@isassystems.com';                   // SMTP username
			$mail->Password = 'info@007';                            // SMTP password
			...
			$mail->addCC("kiran@isassystems.com"); 
