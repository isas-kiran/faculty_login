...
function show_time(cur_time)
{
	...
	{*/
		...
		if(sep_hrs[1]!=00)
		{
			...
			tot_min=Number(sep_hrs[1]);
			//alert(tot_min)
			tot_min_new1=tot_min;
			new_hrs=Number(sep_hrs[0]);
		...
		{
			//alert(total_hrs);
			document.getElementById("time").value=total_hrs;
		}
...
<!-- Event Calendar demo stylesheet -->
    <link type="text/css" rel="stylesheet" href="EventCalendar/helpers/demoec53.css?v=2726" />
    <link type="text/css" rel="stylesheet" href="EventCalendar/helpers/media/layoutec53.css?v=2726" />
    <link type="text/css" rel="stylesheet" href="EventCalendar/helpers/media/elementsec53.css?v=2726" />

	<!-- helper libraries -->
	<script src="EventCalendar/helpers/jquery-1.12.2.min.js" type="text/javascript"></script>
    
	<!-- daypilot libraries -->
    <script src="EventCalendar/js/daypilot-all.minec53.js?v=2726" type="text/javascript"></script>

    <!-- daypilot themes -->
	<link type="text/css" rel="stylesheet" href="EventCalendar/themes/areasec53.css?v=2726" />    
        
	<link type="text/css" rel="stylesheet" href="EventCalendar/themes/month_whiteec53.css?v=2726" />    
	<link type="text/css" rel="stylesheet" href="EventCalendar/themes/month_greenec53.css?v=2726" />    
	<link type="text/css" rel="stylesheet" href="EventCalendar/themes/month_transparentec53.css?v=2726" />    
    <link type="text/css" rel="stylesheet" href="EventCalendar/themes/month_traditionalec53.css?v=2726" />
        
	<link type="text/css" rel="stylesheet" href="EventCalendar/themes/navigator_8ec53.css?v=2726" />    
	<link type="text/css" rel="stylesheet" href="EventCalendar/themes/navigator_whiteec53.css?v=2726" />    
        
	<link type="text/css" rel="stylesheet" href="EventCalendar/themes/calendar_transparentec53.css?v=2726" />    
	<link type="text/css" rel="stylesheet" href="EventCalendar/themes/calendar_whiteec53.css?v=2726" />    
	<link type="text/css" rel="stylesheet" href="EventCalendar/themes/calendar_greenec53.css?v=2726" />    
    <link type="text/css" rel="stylesheet" href="EventCalendar/themes/calendar_traditionalec53.css?v=2726" />

    <link type="text/css" rel="stylesheet" href="EventCalendar/themes/scheduler_8ec53.css?v=2726" />
	<link type="text/css" rel="stylesheet" href="EventCalendar/themes/scheduler_whiteec53.css?v=2726" />    
	<link type="text/css" rel="stylesheet" href="EventCalendar/themes/scheduler_greenec53.css?v=2726" />    
	<link type="text/css" rel="stylesheet" href="EventCalendar/themes/scheduler_blueec53.css?v=2726" />    
    <link type="text/css" rel="stylesheet" href="EventCalendar/themes/scheduler_traditionalec53.css?v=2726" />
	<link type="text/css" rel="stylesheet" href="EventCalendar/themes/scheduler_transparentec53.css?v=2726" />    
  ...
  <tr>
    ...
    <tr>
            ...
            <tr>
            	...
            	<td width="56%"><input type="text" class=" input_text" name="nonmemb_discount" id="nonmemb_discount" onBlur="showUser()" value="<?php if($_POST['nonmemb_discount']){echo $_POST['nonmemb_discount'];} else {echo $row_record['nonmemb_discount'];}?>" /></td> 
            	<td width="5%"></td>
            </tr>
            <tr>
            ...
            <tr>
            	...
            	<td width="15%" valign="top">Total Time <span class="orange_font">*</span></td>

             	<td width="70%"><input type="text" readonly="readonly"  class=" input_text " name="time" id="time" value="<?php if($_POST['time']) echo $_POST['time']; else echo $row_record['time'];?>" /></td> 
            ...
            <div class="main">
				...
				var nav = new DayPilot.Navigator("nav1");
					...
					$total=mysql_num_rows($ptr_name);
					$i=1;
					while($data_name=mysql_fetch_array($ptr_name))
					{
						echo '{name : "'.$data_name['name'].'", id:"'.$data_name['admin_id'].'"},';
						/*if($total < $i)
						{ echo ",";}*/
						$i++;
					}
