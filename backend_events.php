...
$stmt = $db->prepare('SELECT * FROM customer_service_map WHERE 1 and start_event_time!="" and end_event_time!="" and start_event_time is NOT NULL and end_event_time is NOT NULL and customer_service_id>3600 order by customer_service_map_id desc ' );///NOT ((end_event_time <= :start_event_time) OR (start_event_time >= :end_event_time))
