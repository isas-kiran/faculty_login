  ...
  <tr>
	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%">
              ...
              <tr>
                ...
                <td width="40%"><input type="password" maxlength="16" class="validate[required,maxSize[15]] input_text" name="c_name" id="c_name" value="<?php if($_POST['save_changes']) echo $_POST['c_name'];?>" /></td> 
                <td width="40%"></td>
              </tr>
              <tr>
                <td>New Password<span class="orange_font">*</span></td>
                <td><input type="password" maxlength="16" class="validate[required,minSize[6],maxSize[15]] input_text" name="new_name" id="new_name" value="<?php if($_POST['save_changes']) echo $_POST['new_name'];?>"/></td>
                <td width="40%"></td> 
              </tr>
              <tr>
                <td>New Confirm Password<span class="orange_font">*</span></td>
                <td><input type="password" maxlength="16" class="validate[required,minSize[6],equals[new_name]] input_text" name="new_c_name" id="new_c_name" value="<?php if($_POST['save_changes']) echo $_POST['new_c_name'];?>"  /></td>
                <td width="40%"></td> 
              </tr>  
              <tr>
                  <td>&nbsp;</td>
