...
<td>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <?php
            if($page_name=='expense_category_report.php')
            {
				?>
				<tr>
					<td class="tab2_left"></td>
					<td class="tab2_mid"><a href="expense_category_report.php" style="color:#7CA32F;">Expense Category Report</a></td>
					<td class="tab2_right"></td>
				</tr>
				<?php
            }
            else
            {
				...
				<tr>
					<td class="tab_left"></td>
					<td class="tab_mid"><a href="expense_category_report.php" style="color:#666666;">Expense Category Report</a></td>
					<td class="tab_right"></td>
				</tr>
				<?php
            }
		...
		for($e=0;$e<count($array_previ_parent);$e++)
		{
			if($array_previ_parent[$e]['privilege_id']==16) //'for only change password'
			{
				...
				{ 
					...
					else if($array_prev[$e][$f]['privilege_id']==371)
					{
						?>
						<td>
                            <table border="0" cellspacing="0" cellpadding="0">
