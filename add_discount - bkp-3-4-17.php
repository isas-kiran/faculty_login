                    ...
                    <?php
                        ...
                        else
                        {
                            ...
                            if($record_id)
                            {
                                ...
                                $where_record=" "; 
								 $update_discount = "  update discount_coupon set name='$name', start_date='$start_date', end_date='$end_date', code='$code', discount= '$discount',status='$status' where discount_coupon_id='".$record_id."' ";
