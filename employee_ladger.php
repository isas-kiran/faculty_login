...
$edit_access='';
$sel_acc="select * from edit_previleges where admin_id='".$_SESSION['admin_id']."' and privilege_id='281'";
					...
					<div id="show_type">
                        <table style="width:100%;">
                            <tr>
                                ...
                                <?php  
                                $sql_cust = "select name, admin_id from site_setting where 1 and system_status='Enabled' ".$_SESSION['where']." order by admin_id asc";
                                $ptr_cust = mysql_query($sql_cust);
                                while($data_cust = mysql_fetch_array($ptr_cust))
                                {
                                    $selecteds="";
                                    if($data_cust['admin_id']==$_REQUEST['customer_id'])
                                    {
...
<?php
						...
						{
							$where_cust_id=" and admin_id='".$_REQUEST['customer_id']."'";
						}
                        if($_REQUEST['page'])
                            $page=$_REQUEST['page'];
                        else
						...
						$sql_query= "SELECT admin_id,name,cm_id FROM site_setting where 1 ".$where_cust_id." ".$where_cm." ".$search_cm_id." ".$pre_keyword." ".$select_directory."";
                       	//echo $sql_query;
                        ...
                        if($no_of_records)
                        {
                            ...
                            {		
								...
								/*$sel_enroll="select enroll_id, name, net_fees, balance_amt, added_date from enrollment where 1 and (enroll_id='".$listed_record_id."' or ref_id='".$listed_record_id."') and type='Employee' ".$paid_from_date." ".$paid_to_date."";
								...
								*/
								$sel_products="select sales_product_id,total_price,payable_amount,remaining_amount,payment_mode_id,added_date from sales_product where customer_id='".$listed_record_id."' and type='Employee' ".$paid_from_date." ".$paid_to_date."";
								...
								//==========================================Services=====================================
								$sel_services="select customer_service_id,total_cost,payable_amount,remaining_amount,added_date from customer_service where customer_id='".$listed_record_id."' and type='Employee' ".$paid_from_date." ".$paid_to_date." ";
