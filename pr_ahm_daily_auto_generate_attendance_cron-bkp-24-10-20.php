		...
		//{
			...
			if($tot=mysql_num_rows($ptr_chk_ext))
			{
				...
				if($tot==$t)
				{
					...
					{*/
						$ins_attendace="INSERT INTO `pr_daily_attendance`(`staff_id`, `year`, `month`, `days`, `date`, `punch_in_timestamp`, `punch_out_timestamp`,`punch_in`, `punch_out`, `total_hrs`, `extra_hrs`, `branch_name`, `full_day`, `half_day`, `quarter_day`, `one_third`,`day_total`, `total_till_date`,`late_marks`, `extra_days`, `admin_id`, `cm_id`) VALUES ('".$staff_att_id."','".$year."','".$month."','".$days."','".$todays_date."','".$in."','".$out."','".$punch_in."','".$punch_out."','".$hrs_min."','".$extra_hr."','".$branch_name1."','".$full_day."','".$half_day."','".$quarter_day."','".$onethird_day."','".$day_tot."','".$total_day."','".$late_m."','0','69','".$cm_id."')";
			...
			else			//insert absent record in database
			{
				...
				{*/
				$insert_attendace="INSERT INTO `pr_daily_attendance`(`staff_id`, `year`, `month`, `days`, `date`, `punch_in_timestamp`, `punch_out_timestamp`,`punch_in`, `punch_out`, `total_hrs`, `extra_hrs`, `branch_name`, `full_day`, `half_day`, `quarter_day`, `one_third`,`day_total`, `total_till_date`,`late_marks`, `extra_days`, `admin_id`, `cm_id`) VALUES ('".$staff_att_id."','".$year."','".$month."','".$days."','".$todays_date."','','','','','','','Pune','  ','  ','  ','  ','0','0',' ','0','69','".$cm_id."')";
...
$select_exc="select * from pr_daily_attendance where month='".$month."' AND year='".$year."' AND cm_id='".$cm_id."' group by staff_id";
...
if(mysql_num_rows($ptr_fs)) 
{
	...
	<table id="example" class="table1" width="95%" cellspacing="2" cellpadding="2" width="100%" style="margin-left: 0px;border:1px solid #999">
        <thead>
            <tr bgcolor="#EBEBEB">
                <th class="th1" align="center" style="border:1px solid #CCC">Date</th>
                ...
                <th class="th1" align="center" style="border:1px solid #CCC">Extra Hrs</th>
                <th class="th1" align="center" style="border:1px solid #CCC">Full Day</th>
                <th class="th1" align="center" style="border:1px solid #CCC">Half Day</th>
                <th class="th1" align="center" style="border:1px solid #CCC">Quarter</th>
                <th class="th1" align="center" style="border:1px solid #CCC">One Third</th>
                <th class="th1" align="center" style="border:1px solid #CCC">Two Third</th>
                <th class="th1" align="center" style="border:1px solid #CCC">Over (1.25)</th>
                <th class="th1" align="center" style="border:1px solid #CCC">over (1.5)</th>
                <th class="th1" align="center" style="border:1px solid #CCC">over (2)</th>
                <th class="th1" align="center" style="border:1px solid #CCC">Day Total</th> 
                <th class="th1" align="center" style="border:1px solid #CCC">Total Till Date</th>
                <th class="th1" align="center" style="border:1px solid #CCC">Late Marks</th> 
            </tr>
	</thead>
	<tbody>	';
	...
	{ 
		$staff="select name,attendence_id from site_setting where attendence_id='".$val_query1['staff_id']."'";
		...
		/*for($i=1;$i<=$days;$i++)
		{
			...
			$message .='<tr bgcolor="#DCF0F8">
				<td align="center" style="border:1px solid #CCC" class="td1 td2" '.$datestyle.'>'.$att_date.'</td>
				...
				<td align="center" style="border:1px solid #CCC" class="td1 td2" '.$datestyle.'>'.$val_query['total_hrs'].'</td>
				<td align="center" style="border:1px solid #CCC" class="td1 td2" '.$datestyle.'>'.$val_query['extra_hrs'].'</td>
				<td align="center" style="border:1px solid #CCC" class="td1 td2" '.$datestyle.' id="chk_full_day_'.$val_query['attendance_id'].'" ><div ondblclick="return editColumn('.$val_query['attendance_id'].',"full_day")" id="edit_full_day_'.$val_query['attendance_id'].'">'.$val_query['full_day'].' &nbsp;&nbsp;&nbsp;</div></td>
				<td align="center" style="border:1px solid #CCC" class="td1 td2" '.$datestyle.' id="chk_half_day_'.$val_query['attendance_id'].'" ><div ondblclick="return editColumn('.$val_query['attendance_id'].',"half_day")" id="edit_half_day_'.$val_query['attendance_id'].'">'.$val_query['half_day'].'&nbsp;&nbsp;&nbsp;</div></td>
				<td align="center" style="border:1px solid #CCC"class="td1 td2" '.$datestyle.' id="chk_quarter_day_'.$val_query['attendance_id'].'" ><div ondblclick="return editColumn('.$val_query['attendance_id'].',"quarter_day")" id="edit_quarter_day_'.$val_query['attendance_id'].'">'.$val_query['quarter_day'].'&nbsp;&nbsp;&nbsp;</div></td>
				<td align="center" style="border:1px solid #CCC" class="td1 td2" '.$datestyle.' id="chk_one_third_'.$val_query['attendance_id'].'" ><div ondblclick="return editColumn('.$val_query['attendance_id'].',"one_third")" id="edit_one_third_'.$val_query['attendance_id'].'">'.$val_query['one_third'].'&nbsp;&nbsp;&nbsp;</div></td>
				<td align="center" style="border:1px solid #CCC" class="td1 td2" '.$datestyle.' id="chk_two_third_'.$val_query['attendance_id'].'" ><div ondblclick="return editColumn('.$val_query['attendance_id'].',"two_third")" id="edit_two_third_'.$val_query['attendance_id'].'">'.$val_query['two_third'].'&nbsp;&nbsp;&nbsp;</div></td>
				<td align="center" style="border:1px solid #CCC" class="td1 td2" '.$datestyle.' id="chk_over1_'.$val_query['attendance_id'].'" ><div ondblclick="return editColumn('.$val_query['attendance_id'].',"over1")" id="edit_over1_'.$val_query['attendance_id'].'">'.$val_query['over1'].' &nbsp;&nbsp;&nbsp;</div></td>
				<td align="center" style="border:1px solid #CCC" class="td1 td2" '.$datestyle.' id="chk_over2_'.$val_query['attendance_id'].'"><div ondblclick="return editColumn('.$val_query['attendance_id'].',"over2")" id="edit_over2_'.$val_query['attendance_id'].'">'.$val_query['over2'].' &nbsp;&nbsp;&nbsp;</div></td>
				<td align="center" style="border:1px solid #CCC" class="td1 td2" '.$datestyle.' id="chk_over3_'.$val_query['attendance_id'].'" ><div ondblclick="return editColumn('.$val_query['attendance_id'].',"over3")" id="edit_over3_'.$val_query['attendance_id'].'">'.$val_query['over3'].' &nbsp;&nbsp;&nbsp;</div></td>
				<td align="center" style="border:1px solid #CCC" class="td1 td2" '.$datestyle.' >'.$val_query['day_total'].'</td>
				<td align="center" style="border:1px solid #CCC" class="td1 td2" '.$datestyle.' >'.$val_query['total_till_date'].'</td>';
				...
				$message .='<input type="hidden" name="floor_id'.$t.'" id="floor_id'.$t.'" value="'.$val_query['attendance_id'].'" /><input type="hidden" name="days" id="days" value="'.$val_query['days'].'" />';
			$message .='</tr>';
		...
		$message .='<tr bgcolor="#C7DAF1">
			...
			<td align="center" style="border:1px solid #CCC" class="td1 td2">'.$extra_hours.'</td>
			<td align="center" style="border:1px solid #CCC" class="td1 td2">'.$tot_full_day.'</td>
			<td align="center" style="border:1px solid #CCC" class="td1 td2">'.$tot_half_day.'</td>
			<td align="center" style="border:1px solid #CCC" class="td1 td2">'.$tot_quarter_day.'</td>
			<td align="center" style="border:1px solid #CCC" class="td1 td2">'.$tot_onethird_day.'</td>
			<td align="center" style="border:1px solid #CCC" class="td1 td2"></td>
			<td align="center" style="border:1px solid #CCC" class="td1 td2"></td>
			<td align="center" style="border:1px solid #CCC" class="td1 td2"></td>
			<td align="center" style="border:1px solid #CCC" class="td1 td2"></td>
			<td align="center" style="border:1px solid #CCC" class="td1 td2">'.$day_totals.'</td>
			<td align="center" style="border:1px solid #CCC" class="td1 td2">'.$total_till_date.'</td>
			<td align="center" style="border:1px solid #CCC" class="td1 td2">'.$tot_late_mark.'</td>';
			$message .='<input type="hidden" name="floor_id'.$t.'" id="floor_id'.$t.'" value="'.$val_query['attendance_id'].'" /><input type="hidden" name="days" id="days" value="'.$val_query['days'].'" />';
		$message .='</tr>';
...
{ 
	...
	try {
			...
			$mail->Subject = 'ISAS Ahmedabad Daily Attendace is generated for '.date('Y-m-d').'';
