...
if($_REQUEST['record_id'])
{
    ...
    $sql_record= "SELECT * FROM  course_category where category_id 	='".$record_id."'";
    ...
    <td class="mid_mid">
        ...
        <?php
                        ...
                        if($_POST['save_changes'])
                        {
                            ...
                            if($record_id =='')  {
                                $select_exist_userTable = "SELECT * FROM course_category where category_name='".$category_name."'";
