        ...
        <?php
                    ...
                    <?php
                        ...
                        else
                        {
                            ...
                            if($record_id)
                            {
                                $where_record="expense_category_id='".$cat_id."'";   
                                $db->query_update("expense_category", $data_record,$where_record); 
								 ...
								 //==================================================For Type1=============================================================	                              
									...
									{ 
											...
											if($_POST['sub_name'.$j] !='' && $_POST['del_floor'.$j] !='yes')
											{ 
												    $data_record_type1['category_id']=$_GET['cat_id'];  
...
<input type="button" name="Add"  class="delBtn"  onClick="javascript:create_floor('delete');" alt="Delete(-)" >
  ...
  <tr>-->
                            <td colspan="6">
                             ...
                             <?php
							$select_exc = "select * from expense_type where category_id='".$_GET['record_id']."' order by  expense_type_id  asc ";
