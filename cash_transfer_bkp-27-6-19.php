...
<table width="100%">
<tr>
<td width="37%" class="tr-header" align="center"><span id="hide_b" style="display:none">Select To </span>Bank Name<span class="orange_font">*</span></td>
<td>
<?php 
if($_SESSION['type'] !="S")
{f
...
<tr>
    <td width="17%" class="tr-header" align="center">Amount</td>
