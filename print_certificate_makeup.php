	...
	<table align="center" >
		<tr>
        	...
        	<?php
		 	...
		 	{
		 		?>
        		<a href="print_certificate_makeup.php?action=print&record_id=<?php echo $record_id; ?>&course_id=<?php echo $course_id; ?>" style="text-decoration:none"><input type="button" name="print" value="Print" /></a>
        		<?php 
			} ?>
        	</td>
        </tr>
    ...
    <div class="">
       ...
       <?php $date=explode("/",$row_record['from_date']); 
			  ...
			  $finalday=$day."<sup>".$pre."</sup>";
		    	...
		    	$fdate=explode("/",$row_record['to_date']); 
			  $fday=$fdate[0]; 
			  if($fday==1) $pre1="st";
			  else if($fday==2) $pre1="nd";
			  else if($fday==3) $pre1="rd";
			  else $pre1="th";
			  $tdate=$fday."<sup>".$pre1."</sup>" .$month." ".$year;
			  ?>
        <div class="from_date"><?php echo $finalday1; ?></div>
		  <div class="to_date"><?php echo $tdate; ?></div>
