            ...
            <tr class="head_td">
                <td colspan="17">
                    ...
                    <tr>
						...
						{
							?>
							<lable>Default Records show from <?php echo date('d/m/Y',strtotime('-30 days'))?> to <?php echo date('d/m/Y')?></lable>
							<?php
						}
						?> 
                        </td>
	   ...
	   // $pager = new PS_Pagination($sql_query,$_SESSION['show_records'],$_SESSION['show_records_pages'],$query_string1);
        ...
        <input type="hidden" name="formAction" id="formAction" value=""/>
			<tr class="grey_td" >
				...
				{
					$select_counc="select * from site_setting where 1 and (type='A' or type='C' or type='Z') and system_status='Enabled' and admin_id='".$_SESSION['admin_id']."' ".$_SESSION['where']." ".$search_cm_id." order by admin_id asc";
				}
