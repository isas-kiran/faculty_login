...
//================================================Bank Summary===================================================== 
	...
	$message.='<tr>
					<td align="center" colspan="10">New Admission for '.$date.'</td>
				</tr>
					...
					<td colspan="12" >
						<table cellspacing="0" cellpadding="0" width="100%" style="border:1px solid #CCC">
							<tr style="background-color:#999;color: black">
								...
								<td width="25%" align="center" style="border:1px solid #CCC"><strong>Student Name</strong></td>
								<td width="25%" align="center" style="border:1px solid #CCC"><strong>Course Name</strong></td>
				...
				if(mysql_num_rows($ptr_cm))
				{
					...
					while($data_cmids=mysql_fetch_array($ptr_cm))
					{
						...
						//=====================BANK BALANCE=========================
						$sql_query="select * from enrollment where 1 and DATE(added_date)='".$date."' ".$search_cm_id." order by enroll_id desc";
...
//===============================********************* ISAS LLP ***********************===================================
				...
				if(mysql_num_rows($ptr_cm))
				{
					...
					while($data_cmids=mysql_fetch_array($ptr_cm))
					{
						...
						$sql_query1="select * from enrollment where 1 and DATE(added_date)='".$date."' ".$search_cm_id." order by enroll_id desc";
			...
			$subject =" ISAS - Todays New Enrollment - ".date('d/m/Y')."";
			...
			try {
					...
					$mail->Subject ='ISAS - Todays New Enrollment - '.date('d/m/Y').'';
