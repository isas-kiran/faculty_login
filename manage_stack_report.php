...
<?php
$edit_access='';
$sel_acc="select * from edit_previleges where admin_id='".$_SESSION['admin_id']."' and privilege_id='274'";
    	...
    	<td class="mid_mid" align="center">
							...
							<table border="0" cellspacing="0" cellpadding="0" width="99%" align="center">
								...
								if($_SESSION['type']=="S" || $_SESSION['type']=="A" || $_SESSION['type']=='Z' || $_SESSION['type']=='LD')
								{
									...
									<td width="10%" align="center" style="padding-left:0px;width: 15%;" id="staff_details">
										...
										$sle_name="select admin_id,name from site_setting where 1 ".$_SESSION['where']." ".$search_cm_id." and system_status='Enabled' and (type='C' or type='LD' or type='A') order by name asc"; 
            ...
            if($no_of_records)
            {
               ...
               // $pager = new PS_Pagination($sql_query,$_SESSION['show_records'],$_SESSION['show_records_pages'],$query_string1);
                ...
                <td width="8%" align="center"><strong>Total Walked-in (Repeated)</strong></td>
                <td width="8%" align="center"><strong>Total Walked-in (Non-Repeated)</strong></td>
                ...
                while($val_query=mysql_fetch_array($all_records))
                {
                    ...
                    echo'<td align="center"><a target="_blank" href="manage_student.php?assigned_to='.$val_query['admin_id'].'&date_by=followup_by'.$sep_url_string.' ">'.$total_foll.'</a></td>';
					...
					$select_invalid="select DISTINCT(student_id) from followup_details where 1 and(response='7' or response='8') and admin_id='".$val_query['admin_id']."' ".$_SESSION['where']." ".$search_cm_id." ".$enquiry_from_date." ".$enquiry_to_date."";
                    ...
                    //<a target="_blank" href="show_students.php?assigned_to='.$val_query['admin_id'].'&response=not_intrested'.$sep_url_string.' "></a>
					...
					$total_repeated=intval($count_rep_walkin-$count_enq_walkin);
					
					echo '<td align="center">'.$total_repeated.'</td>';
                    $total_rep_walkin +=$total_repeated;
                ...
                <tr class="" style="margin:10px"> 
                	<td colspan="17">
                    Information :<br/>
                    Total walked-in(repeated) - Total walkin between respective date - Total unique walked-in in respective dates. <br/>
                    Total walked-in(Non-repeated) - Total unique walked-in between respective dates.<br/>
                    </td>
                </tr>
                <tr class="head_td">
                	<td colspan="17">
