...
<title>Service Incomming GST</title>
	...
	?>
              <tr>
                ...
                <!--<td width="20%">
                        ...
                        <td><a href="service_incomming_gst_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>  
            </tr>          
        </table>
        </form>	
    </td>
     ...
     <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='firstname'))
                        {
							...
							$branch_id='';
                       		...
                       		"<br/>".$sql_query= "SELECT s.*,e.* FROM customer_service_invoice s,customer_service e WHERE 1 and s.customer_service_id=e.customer_service_id ".$where_cm." ".$search_cm_id." ".$where_gst_i." ".$pre_keyword_i." ".$paid_from_date_i." ".$paid_to_date_i." and (s.cgst_tax_in_percent >0 or s.sgst_tax_in_percent >0) and (s.cgst_tax >0 or s.sgst_tax >0) ".$select_directory." "; 
				...
				<form method="post"  name="frmTakeAction"  action="<?php echo $_SERVER['PHP_SELF'].'?#msgbox';?>">
                     <input type="hidden" name="formAction" id="formAction" value=""/>
                      <tr class="grey_td" >
                        ...
                        <td width="15%" align="center">Service Name</td>
						<td width="10%" align="center">Price</td>
						<td width="8%" align="center">GST in %</td>
						<td width="8%" align="center">GST in Value</td>
                        ...
                        <td width="14%" align="center"><strong>Installments</strong></td>-->
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
								...
								$sel_name="select cust_name,cust_gst_no,cm_id from customer where cust_id='".$val_query['customer_id']."'";
								...
								echo '<td align="center">'.$data_name['cust_name'].''.$gstno.'</td>';
								...
								if($total_inst=mysql_num_rows($ptr_ins_amnt))
								{
									...
									while($data_inst_amnt=mysql_fetch_array($ptr_ins_amnt))
									{
										...
										echo $s.". ".$data_product_name['service_name']."<br/>";
										$s++;
									}
								}
								echo "</td>";
								
								echo "<td width='10%' align='center'>".$val_query['discount_price']."</td>";
								echo "<td width='25%' align='center'>";
								if($val_query['cgst_tax_in_percent'])
								{
									echo "CGST (".$val_query['cgst_tax_in_percent']."%)";
									
								}
								if($val_query['sgst_tax_in_percent'])
								{
									echo " + SGST (".$val_query['sgst_tax_in_percent']."%)";
								}
								echo "</td>";	
								echo "<td width='25%' align='center'>";
								if($val_query['cgst_tax_in_percent'])
								{
									echo $val_query['cgst_tax'];
									$total_cgst +=$val_query['cgst_tax'];
								}
								if($val_query['sgst_tax_in_percent'])
								{
									echo " + ".$val_query['sgst_tax'];
									$total_sgst +=$val_query['sgst_tax'];
								}
								if($val_query['cgst_tax_in_percent'] || $val_query['sgst_tax_in_percent'])
								{
									echo " = ";
									echo $total_prod_gst =$val_query['cgst_tax']+$val_query['sgst_tax'];
								...
								echo "<td align='center'>".$total_prod_gst."</td>";
    ...
    <td colspan="15">
    	<table cellspacing="0" cellpadding="0" width="100%"  style="border:1 px solid #CCC; border-collapse:collapse">
        	<tr class="grey_td">
				...
				<td width="10%" align="center"><span style='color:red'><strong><?php echo "Total=".$totals_products_gst; ?></strong></span></td>
            </tr>
    	</table>
    </td>
