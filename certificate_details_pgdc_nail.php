...
if($_POST['save_changes'])
{
	...
	?>
	<script>
		setTimeout('document.location.href="print_certificate_pgdc_nail.php?record_id=<?php echo $record_id; ?>&course_id=<?php echo $course_id; ?>";',1000);
	</script>
	<?php
}
	?>
<div class="container">
	<img src="images/certificate_pgdc.jpg" alt="Norway" style="width:100%;">
    ...
    <div class="spa"><?php if($spa_grade!='') echo $spa_grade; ?><input type="hidden" name="spa_grade" Placeholder="Nail Grade" value="<?php if($_POST['spa_grade']!='') echo $_POST['spa_grade']; else if($spa_grade!='') echo $spa_grade; ?>" style="width:150px"></div>
	...
	<div class="from_date"><?php if($data_sel['course_start_date'])echo $data_sel['course_start_date']; ?><input type="hidden" name="from_date" id="from_date" class="datepicker" Placeholder="From" value="<?php if($_POST['from_date']!='') echo $_POST['from_date']; else if($data_sel['course_start_date']) echo $data_sel['course_start_date']; ?>" style="width:115px"></div>
	<div class="to_date"><?php if($data_sel['course_end_date'])echo $data_sel['course_end_date']; ?><input type="hidden" name="to_date" id="to_date" class="datepicker" Placeholder="To" value="<?php if($_POST['to_date']!='') echo $_POST['to_date']; else if($data_sel['course_end_date'])echo $data_sel['course_end_date']; ?>" style="width:115px"></div>
    <div class="reg_no"><?php if($data_sel['installment_display_id'])echo $data_sel['installment_display_id']; ?><input type="hidden" name="reg_no" id="reg_no" Placeholder="Reg. No:" value="<?php if($_POST['reg_no']!='') echo $_POST['reg_no']; else if($data_sel['installment_display_id'])echo $data_sel['installment_display_id']; ?>" style="width:150px"></div>
    <div class="award_on"><?php if($data_sel['certificate_date']) echo $data_sel['certificate_date']; ?><input type="hidden" name="award_on" id="award_on" Placeholder="Award on" class="datepicker" value="<?php if($_POST['award_on']!='') echo $_POST['award_on']; else if($data_sel['certificate_date'])echo $data_sel['certificate_date']; ?>" style="width:150px"></div>
