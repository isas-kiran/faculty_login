...
<title>Enrollment Bank Summery</title>
...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
    	...
    	<td colspan="17">
        	<form method="get" name="search">
                ...
                <tr>
                    ...
                    <td><a href="enrollment_summary_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>  
            	</tr>          
        		</table>
        	</form>	
    	</td>
	...
	$select_directory=' order by DATE(i.added_date) asc'; //DATE(i.added_date) asc,         
		 
		$sql_query= "select i.*, e.name,e.course_id,e.net_fees,e.installment_display_id from invoice i, enrollment e where 1 and i.enroll_id=e.enroll_id and i.status='Paid' ".$search_cm_id." ".$pre_keyword_i." ".$pay_type." ".$bank_ids." ".$paid_from_date." ".$paid_to_date." ".$select_directory." "; //and amount>0
		...
		if($no_of_records)
		{
            ...
            <td width="8%" align="center">Added Date</td>
            ...
            <td width="8%" align="center"><strong>Fees Paid</strong></td>
            <td width="8%" align="center"><strong>Payment Type</strong></td>
...
-->            <td width="8%" align="center">Payment Details</td>
            ...
            while($val_query=mysql_fetch_array($all_records))
            {
                ...
                {
                   echo "<td align='center'><strong>".$val_query['amount']."</strong></td>";
                }
                else
                {
                ...
                {
                   echo "<td align='center'><strong>".$val_query['amount']."</strong>";
                   echo "</td>";
                }
                else
                {
