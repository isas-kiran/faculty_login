				...
				if($payment_type =="select")
				{
                    ...
                    <?php
                        ...
                        else
                        {
							...
							$data_record_invoice['added_date'] = $admission_date." ".date('H:i:s');
                            ...
                            if($record_id)
                            {
                               /* $data_record['added_date'] = date('Y-m-d H:i:s');
								...
								if($row_record['no_of_installment']==$data_record['no_of_installment'])
								{
									...
									$invoice_id=$datat_invoice['invoice_id'];
								}
								else
								{
                            ...
                            else
                            {
							   ...
							   if($payment_type_val=="online")
							    ...
							    {
							   $bank="INSERT INTO `bank_records`(`bank_id`, `type`, `record_id`, `amount`, `added_date`, `cm_id`, `admin_id`) VALUES ('".$bank_name."','enrollment','".$student_id."','".$down_payment."','".date('Y-m-d H:i:s')."','".$_SESSION['cm_id']."','".$_SESSION['admin_id']."')";
							   ...
							   if($data_record['no_of_installment'] !=0)
							   {
								...
								"<br>".$insert="INSERT INTO `log_history`(`category`, `action`, `name`, `id`, `date`, `cm_id`, `admin_id`) VALUES ('enrollment','Add','".$name."','".$student_id."','".date('Y-m-d H:i:s')."','".$_SESSION['cm_id']."','".$_SESSION['admin_id']."')";
								$query=mysql_query($insert);  
							...
							$message.='<tr><td>Enrolled  from  </td><td>:</td><td>Admin Panel(Offline)<td></tr>
								...
								"<br/>".$sel_sms_cnt="select * from sms_mail_configuration_map where previlege_id='40' and cm_id='".$cm_id."'";
								$ptr_sel_sms=mysql_query($sel_sms_cnt);
								while($data_sel_cnt=mysql_fetch_array($ptr_sel_sms))
								{
              ...
              <td width="20%"class="orange_font">* Date Format should be [ DD/MM/YYYY ]</td>
            			...
            			<?php
                            ...
                            <tr>
                                  ...
                                  <td width="49%"><input type="text" id="admission_date" name="admission_date" class="input_text datepicker" value="<?php if($_POST['admission_date']) echo $_POST['admission_date']; else if($row_record['admission_date']!='')
									{
...
<input type="radio" name='paid_type' id="paid_type" value="installments_zero"  <?php if($_POST['paid_type'] =="installments_zero")  echo 'checked="checked"'; else if($row_record['paid_type'] == "installments_zero") echo 'checked="checked"';  ?> onChange="show_record()" />Installment 0% add
       ...
       <!--==========================================================================================================================-->                                           
          ...
          <tr>
                ...
                <td width="49%">
                <input type="text" class="input_text" name="concession" id="concession" value="<?php if($_POST['concession']) echo $_POST['concession']; else if($row_record['discount'] !=0) echo $row_record['discount']; else echo 0; ?>" onBlur="show_record()"/></td>                
                <td width="31%"></td>
            </tr>
            <tr>
                ...
                <td width="31%"><div id="coupon"></div><input type="hidden" name="discount_coupon_price" id="discount_coupon_price" value="<?php if($_POST['discount_coupon_price']) echo $_POST['discount_coupon_price']; else if($row_record['discount_coupon_price'] !='') echo $row_record['discount_coupon_price']; else echo 0;?>" /></td>
            </tr>
            <!--<tr>
   ...
   <!--============================================================================================================================================================-->              
											...
											<tr>
                                                ...
                                                <?php if($record_id && $row_record['no_of_installment'] !=0)
												{
													...
													?>
                                                    <tr><td width="40%" class="heading">Installment <?php echo $i; ?> </span></td><td width="40%" colspan=2""><input type="text" class="input_text" name="installments[]" id="ins_price" value='<?php if($_POST['installments']) echo $_POST['installments']; else echo $dat_installment['installment_amount'];  ?>' /></td><td><input type="text" name="installment_date[]" class="datepicker" placeholder="installment date" id="date_class<?php echo $i; ?>" value="<?php if($_POST['installment_date']) echo $_POST['installment_date']; else echo $dates ;?>"  ></td></tr>
