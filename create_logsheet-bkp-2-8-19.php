...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
	...
	?>
                      ...
                      <?php
                                $sql_records= "SELECT course_id,logsheet_id FROM logsheet where 1";
                                ...
                                if($no_of_records)
                                {
                                    ...
                                    while($val_record=mysql_fetch_array($all_records))
                                    {
										...
										echo '<td align="center"><a href="view_logsheet.php?record_id='.$listed_record_id.'" target="_blank" >'.$data_course['course_name'].'</a></td>';
                                	...
                                	<table  width="100%" style="border:0px solid gray; ">
                                        ...
                                        <table cellpadding="5" width="100%" >
                                            ...
                                            function floors(idss)
                                            {
                                            	...
                                            	var shows_data='<div id="floor_id'+idss+'"><table cellspacing="3" id="tbl'+idss+'" width="100%"><tr><td valign="top" width="10%" align="center"><input type="text" name="day'+idss+'" id="day'+idss+'" style="width:40px" value="'+idss+'" required/></td><td valign="top" width="30%" align="center"><select name="topic'+idss+'" id="topic'+idss+'" style="width:200px" ><option value="">Select Topic '+idss+'</option>'+res+'</select></td><td valign="top" width="40%" align="center"><textarea name="topic_content'+idss+'" placeholder="Topic Contetnt '+idss+'" id="topic_content'+idss+'" title="Topic Content '+idss+'" value="" style="width:100%;height:30px"></textarea></td><td valign="top" width="20%" align="center"><input type="text" name="model'+idss+'" id="model'+idss+'" ></td><input type="hidden" name="row_deleted'+idss+'" id="row_deleted'+idss+'" value="" /><tr></table></div>';
                                        ...
                                        <tr><td align="center"></td><td align="center"></td><td align="center"></td></tr>
                  						...
                  						<tr>
                                            ...
                                            <tr>
                                            <td valign="top" width="10%" align="center">Days</td>
                                            <td valign="top" width="30%" align="center">Topic</td>
                                            <td valign="top" width="40%" align="center">Topic Content</td>
                                            <td valign="top" width="10%" align="center">Model Required</td>
                                            <?php
											if($record_id)
											{
												?>
