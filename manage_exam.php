    ...
    <?php if($_POST['formAction'])
                    {
                        if($_POST['formAction']=="delete")
                        {
                            for($r=0;$r<count($_POST['chkRecords']);$r++)
                            {
                                ...
                                $sql_query= "SELECT exam_id FROM ".$GLOBALS["pre_db"]."exam where exam_id ='".$del_record_id."'";
                                if(mysql_num_rows($db->query($sql_query)))
                                    {                                                
                                        $delete_query="delete from ".$GLOBALS["pre_db"]."exam where exam_id ='".$del_record_id."'";
...
<table cellspacing="0" cellpadding="0" class="table" width="95%">  
  <tr class="head_td">
    ...
    <?php
                        ...
                        if($keyword)
                            {                            
                              $pre_keyword =" and (exam_name like '%".$keyword."%' || duration like '%".$keyword."%')";
                            }                            
                        else
                            $pre_keyword="";
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='exam_name'))
                        {
                            ...
                            $select_directory='order by exam_id desc';                      
                            $sql_query= "SELECT exam_id,exam_name,exam_desc,duration FROM exam where 1  ".$pre_keyword." ".$_SESSION['where_admin_id']." ".$select_directory.""; 
                       //echo $sql_query;
                         ...
                         <input type="hidden" name="formAction" id="formAction" value=""/>
                          <tr class="grey_td" >
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                                ...
                                $listed_record_id=$val_query['exam_id']; 
                                ...
                                echo '<td >'.$val_query['exam_desc'].'</td>';     
								echo '<td >'.$val_query['duration'].'</td>';          
								/*echo '<td >'.$val_query['exam_date'].'</td>';   */                  
                                echo '<td align="center"><a href="add_exam.php?record_id='.$listed_record_id.'" ><img src="images/edit_icon.png" title="Edit Record" class="course_example-fade"/></a>&nbsp;&nbsp;
