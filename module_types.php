    ...
    <td class="mid_mid">
     <?php 
                    if($_REQUEST['deleteRecord'])
                    {
                        ...
                        $sql_query= "SELECT module_type FROM ".$GLOBALS["pre_db"]."module_types where module_type_id='".$del_record_id."'";
                        if(mysql_num_rows($db->query($sql_query)))
                        {                           
                        $delete_query="delete from ".$GLOBALS["pre_db"]."module_types where module_type_id='".$del_record_id."'";
...
/* function validme()
	 {
		 ...
		 return true;
                      ...
                      <?php
                                $sql_records= "SELECT * FROM module_types where 1 ".$_SESSION['where']." ".$pre_transcation_id." order by module_type_id asc";
								...
								<tr align="center" class="grey_td" ><td width="7%" class="tr-header"><strong>Sr.</strong></td><td width="11%" class="tr-header"><strong>Module name</strong></td><td width="11%" class="tr-header"><strong>SMS Text</strong></td><td width="12%" class="tr-header"><strong>Action</strong></td></tr><?php
                                    while($val_record=mysql_fetch_array($all_records))
                                    {
										if($bgColorCounter%2==0)
										 ...
										 $paid_totas=0;
                                       $listed_record_id=$val_record['module_type_id'];
                                        include "include/paging_script.php";
                                        echo '<tr class="'.$bgclass.'">';
                                        echo '<td align="center">'.$sr_no.'</td>';
										echo "<td align='center'>".$val_record['module_type']."</td>";
										echo "<td align='center'>".$val_record['sms_text']."</td>";
										echo '<td align="center">';
										
										echo '<a onclick="return validationToDelete(\''.$_SERVER['PHP_SELF'].'\');" href="'.$_SERVER['PHP_SELF'].'?deleteRecord='.$listed_record_id.'"><img src="images/delete_icon.png" title="Delete Record" class="example-fade" /></a>&nbsp;&nbsp;<a href="module_types_edit.php?record_id='.$listed_record_id.'" ><img src="images/edit_icon.png" title="Edit Record" class="example-fade"/></a>&nbsp;&nbsp;';
							...
							<?php
								...
								for($j=1;$j<=$total_floor;$j++)
								{
									if($_POST['sub_name'.$j] !='')
									{
										...
										$data_record_type1['module_type'] = addslashes(trim($_POST['sub_name'.$j])); 
										$data_record_type1['sms_text'] = addslashes(trim($_POST['sms_text'.$j])); 
										$record_ids=$db->query_insert("module_types",$data_record_type1);
                                    ...
                                    <tr>
                                        ...
                                        <table cellpadding="5" width="100%" >
                                         ...
                                         <script language="javascript">
                                                    ...
                                                    {
                                                        var shows_data='<div id="floor_id'+idss+'"><table cellspacing="3" id="tbl'+idss+'" width="100%"><tr><td valign="top" width="50%" align="center"><input type="text" name="sub_name'+idss+'" id="sub_name'+idss+'" required style="width:80%" /></td><td valign="top" width="50%" align="center"><textarea style="width:80%"  name="sms_text'+idss+'" id="sms_text'+idss+'"/></textarea></td><input type="hidden" name="row_deleted'+idss+'" id="row_deleted'+idss+'" value="" /><tr></table></div>';
                ...
                <input type="button" name="Add"  class="delBtn"  onClick="javascript:create_floor('delete');" alt="Delete(-)" >
                                        ...
                                        <table width="100%" border="0" class="tbl" bgcolor="#CCCCCC" align="center"><tr><td align="center"></td><td align="center"></td><td align="center"></td><td align="center"></td><td align="center"></td></tr>
                  <tr ><td align="center" width="25%" > </td><td width="10%"> </td><td width="5%"> </td></tr>
                  <tr>
                                            <td colspan="6">
                                            <table cellspacing="3" id="tbl" width="100%">
                                            <tr>
                                            <td valign="top" width="50%" align="center">Name</td>
                                            <td valign="top" width="50%" align="center">Sms Text</td>
