            ...
            <table align="center" cellpadding="5" cellspacing="5" border="1px" bordercolor="#0066cc" style="border:1px solid #0066cc; border-collapse:collapse; font-size:9px" width="786" >
            	<tr>
                    ...
                    <td width="26" align="right" style="padding-right:15px;">
                       ...
                       Unit Name: Colour and light studies theory
                        <?php
                         if($_GET['action'] !='print')
                         {
                         ?>
                        <a href="report_all_print_ques_mgmt.php?syllabus_id=<?php echo $_GET['syllabus_id']; ?>&unit_id=<?php echo $_GET['unit_id']; ?>&keyword=<?php echo $_GET['keyword']; ?>&action=print" style="text-decoration:none"><input type="button" name="print" value="Print" /></a><?php } ?>
                    </td>
            	</tr>
           		<tr>
