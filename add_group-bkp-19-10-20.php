...
$(document).ready(function() {
    $("#send_to").change(function() {
        ...
        if(selVal == 'student') 
		{
            $("#customise").append('<table width="100%"><tr><td height="20" width="200">Select Type</td><td><select name="type" id="type" onChange="select_type();"><option value="">Select Type</option><option value="enquiry">Enquiry</option><option value="enrolled">Enrolled</option></select></td></tr></table>');
