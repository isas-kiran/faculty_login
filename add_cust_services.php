    ...
    <td class="mid_mid">
        ...
        <?php
                        ...
                        if($_POST['save_changes'])
                        {
							...
							$payment_mode_id=( ($payment_mode_id)) ? $payment_mode_id : "";
							...
							$resource=( ($_GET['resource'])) ? $_GET['resource'] : "";
							//$voucher_number='';
							//$voucher_deal_id='';
							...
							$total_type1=( ($_POST['total_type1'])) ? $_POST['total_type1'] : "0";
                            if(count($errors))
                            {
                                ?>
                                <tr>
                               ...
                               // echo '<br></br><div id="msgbox" style="width:40%;">Record updated successfully</center></div><br></br>';
								...
								else
								{
									...
									$sep_check_date=$chaque_date_exp[2].'-'.$chaque_date_exp[1].'-'.$chaque_date_exp[0];
									 ...
									 $insert_cust_service_invoice = " INSERT INTO `customer_service_invoice` (`customer_service_id`, `service_price`, `total_cost`, `amount`, `payable_amount`,`remaining_amount`, `total_paid`,`paid_type`, `bank_id`, `cust_bank_name`, `cheque_detail`, `chaque_date`, `credit_card_no`, `admin_id`, `added_date`,`status`,`cm_id`) VALUES ('".$record_id."', '".$service_price."', '".$total_cost."', '".$amount."', '".$_POST['payable_amount']."','".$_POST['remaining_amount']."', '".$_POST['payable_amount']."', '".$payment_mode_id."','".$bank_name."','".$cust_bank_name."', '".$chaque_no."', '".$sep_check_date."','".$credit_card_no."', '".$_SESSION['admin_id']."', '".date('Y-m-d H:i:s')."','".$status."','".$cm_id1."'); ";
