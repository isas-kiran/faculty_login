...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  <tr class="head_td">
    ...
    <?php
                        ...
                        if($keyword)
                            {                            
                                $select_name = "select * from courses where (course_name like '%".$keyword."%')";                                           
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='course_name'))
                        {
                            ...
                            $sql_query= "SELECT * FROM subject where 1  ".$pre_keyword." ".$_SESSION['where_admin_id']." ".$select_directory." "; 
                       //echo $sql_query;
  ...
  <tr class="grey_td" >
    ...
    <td width="21%"><a href="<?php echo $_SERVER['PHP_SELF'];?>?order=<?php echo $order."&orderby=name".$query_string;?>" class="table_font"><strong>Subject Name</strong></a> <?php echo $img1;?></td>
    
    <td width="15%"><strong>Suject Fees</strong></td>
    <td width="21%"><strong>Subject Description</strong></td>
    <td width="19%"><strong>Subject Teacher</strong></td>
    <td width="12%" class="centerAlign"><strong>Action</strong></td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                                ...
                                {
                                    $select_name = "select * from staff_regi where staff_id = '".$arr[$i]."' ";                                           
                                    $val_name = $db->fetch_array($db->query($select_name));
