...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    <td class="top_mid" valign="bottom"><?php include "include/councellor_menu.php";?></td>
...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  <tr class="head_td">
    ...
    <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='course_name'))
                        {
                            ...
                            $sql_query= "SELECT * FROM site_setting where 1  ".$pre_keyword." ".$_SESSION['cm_id_councellor']." and type='C' ".$select_directory.""; 
                       //echo $sql_query;
  ...
  <tr class="grey_td" >
    ...
    <td width="20%"><a href="<?php echo $_SERVER['PHP_SELF'];?>?order=<?php echo $order."&orderby=councellor_name".$query_string;?>" class="table_font"><strong>councellor Name</strong></a> <?php echo $img1;?></td>
    <td width="15%"><strong>Contact NO</strong></td>
    <td width="20%"><strong>Address</strong></td>
    <td width="5%"><strong>Email</strong></td>
    <td width="7%"><strong>Basic Pay</strong></td>
    <td width="7%"><strong>User Name</strong></td>
    <td width="7%"><strong>Password</strong></td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                               ...
                               /* $select_category = "select * from courses where course_id = '".$val_query['course_id']."' ";                                           
                                $val_category = $db->fetch_array($db->query($select_category));*/
                                    ...
                                    /*$select_name = "select * from admin_previleges where admin_id = '".$admin_id."' ";                                           
                                ...
                                */
                                ...
                                echo '<td ><a href="add_councellor.php?record_id='.$listed_record_id.'" class="table_font">'.$val_query['name'].'</a></td>';
                                echo '<td >'.$val_query['contact_phone'].'</td>';
                                echo '<td >'.$val_query['contact_address'].'</td>';
                                echo '<td >'.$val_query['email'].'</td>';
							    echo '<td >'.$val_query['basic_pay'].'</td>'; 
                                echo '<td >'.$val_query['username'].'</td>';
							    echo '<td >'.$val_query['pass'].'</td>';
                                echo '<td align="center"><a href="add_councellor.php?record_id='.$listed_record_id.'" ><img src="images/edit_icon.png" title="Edit Record" class="example-fade"/></a>&nbsp;&nbsp;
