  ...
  <tr class="head_td">
    ...
    <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='cust_name'))
                        {
                            ...
                            $sql_query= "SELECT * FROM customer where 1 ".$_SESSION['where']."  ".$pre_keyword." ".$select_directory.""; 
                       //echo $sql_query;
                      ...
                      <tr class="grey_td" >
                        ...
                        <td width="10%" class="centerAlign"><strong>Action</strong></td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                                ...
                                echo '<td ><a href="add_customer.php?record_id='.$listed_record_id.'" >'.$val_query['cust_name'].'</a></td>';
								
								/*echo '<td align="center">'.$val_query['gender'].'</td>';*/
								
								$birth_date_sep=explode('/',$val_query['birth_date']);
							    $sep_birth_date=$birth_date_sep[1].'/'.$birth_date_sep[0].'/'.$birth_date_sep[2];
								
								echo '<td align="center">'.$sep_birth_date.'</td>';
								
                                echo '<td align="center">'.$val_query['mobile1'].'/'.$val_query['mobile2'].'</td>';
