                                ...
                                else
                                {
									...
									for($i=1;$i<=$total_floor;$i++)
									{
										...
										if(mysql_num_rows($ptr_qty))
										{
											...
											"<br/>".$insert_consumption_map = "insert into consumption_map (`consumption_id`,`checkout_id`,`product_id`,`quantity`,`unit`,`measure`,`description`,`employee_id`,`admin_id`,`cm_id`,`added_date`) values('".$data_qty['consumption_id']."','".$record_id."','".$data_record_check_prod['product_id']."','".$data_record_check_prod['issue_qty']."','".$data_record_check_prod['unit']."','".$_POST['measure_unit'.$i]."','".$prod_desc."','".$data_record_check_prod['employee_id']."','".$_SESSION['admin_id']."','".$data_record_check_prod['cm_id']."','".$data_record_check_prod['added_date']."')";
											$ptr_consumption_map = mysql_query($insert_consumption_map);
										...
										else
										{
											...
											"<br/>".$insert_consumption = "insert into consumption (`checkout_id`,`product_id`,`quantity`,`unit`,`measure`,`description`,`employee_id`,`admin_id`,`cm_id`,`added_date`) values('".$record_id."','".$data_record_check_prod['product_id']."','".$data_record_check_prod['issue_qty']."','".$data_record_check_prod['unit']."','".$_POST['measure_unit'.$i]."','".$prod_desc."','".$data_record_check_prod['employee_id']."','".$_SESSION['admin_id']."','".$data_record_check_prod['cm_id']."','".$data_record_check_prod['added_date']."')";
											$ptr_insert_receipt = mysql_query($insert_consumption);
											$consumption_ids=mysql_insert_id();
											
											"<br/>".$insert_consumption_map = "insert into consumption_map (`consumption_id`,`checkout_id`,`product_id`,`quantity`,`unit`,`measure`,`description`,`employee_id`,`admin_id`,`cm_id`,`added_date`) values('".$consumption_ids."','".$record_id."','".$data_record_check_prod['product_id']."','".$data_record_check_prod['issue_qty']."','".$data_record_check_prod['unit']."','".$_POST['measure_unit'.$i]."','".$prod_desc."','".$data_record_check_prod['employee_id']."','".$_SESSION['admin_id']."','".$data_record_check_prod['cm_id']."','".$data_record_check_prod['added_date']."')";
											$ptr_consumption_map = mysql_query($insert_consumption_map);
											$ins_is=mysql_insert_id();
										}
                     ...
                     <tr>
                       <input type="hidden" name="no_of_floor" id="no_of_floor" class="inputText" size="1" onKeyUp="create_floor();" value="0" />
                         ...
                         <script language="javascript">
                                ...
                                {
                                    var shows_data='<div id="floor_id'+idss+'"><table cellspacing="3" id="tbl'+idss+'" width="100%"><tr><td width="16%" align="center"><input type="hidden" name="exclusive_id'+idss+'" id="exclusive_id'+idss+'" value="'+idss+'" /><select name="product_id'+idss+'" style="width:200px" id="product_id'+idss+'" onChange="show_product('+idss+');" required><option value="">Select Product</option><?php
									...
									while($data=mysql_fetch_array($query_tel))
									{
									 ...
									 ?>
									 </select></td><td width="12%" align="center"><input type="text" name="unit'+idss+'" id="unit'+idss+'" readonly="readonly" style="width:80px" /> <span id="measure'+idss+'"><input type="hidden" name="measure_unit'+idss+'" id="measure_unit'+idss+'"/> </span></td><td width="12%" align="center"><select name="select_from'+idss+'" id="select_from'+idss+'" onChange="show_product_qty('+idss+')" style="width: 110px;"><option value="">Select</option><option value="stock">Stock</option><option value="shelf">Shelf</option><option value="consumable">Consumable</option></select></td><td width="12%" align="center"><input type="text" name="quantity'+idss+'" id="quantity'+idss+'" readonly="readonly"/></td><td width="12%" align="center"><input type="text" name="issue_qty'+idss+'" id="issue_qty'+idss+'" onBlur="check_quantity('+idss+')" /><td width="12%" align="center"><div id="select_to_div'+idss+'" style="width:100px"></div></td><td width="12%" align="center"><select name="employee_id'+idss+'" id="employee_id'+idss+'" required style="width:200px"><option value="">Select Employee</option><?php
                      ...
                      <tr>
                        <td colspan="6">
                          <table cellspacing="3" id="tbl" width="100%">
                            <tr>
                                <td valign="top" align="center" width="16%" >Product Name</td>
                                ...
                                <td valign="top" width="15%" align="center">Select Employee</td>
                           </tr>
                          </table>
