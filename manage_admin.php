...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    <td class="top_mid" valign="bottom"><?php include "include/admin_menu.php";?></td>
...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  ...
  <tr class="head_td">
    ...
    <?php
                        ...
                        if($keyword)
                            {                            
                                $pre_keyword =" and (name like '%".$keyword."%' || email like '%".$keyword."%' || username like '%".$keyword."%')";
                            }                            
                        else
                            $pre_keyword="";
                        if($_REQUEST['page'])
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='name'))
                        {
                            ...
                            $sql_query= "SELECT * FROM site_setting where 1 and type = 'S' ".$pre_keyword." ".$select_directory.""; 
                       //echo $sql_query;
  ...
  <tr class="grey_td" >
    ...
    <td width="20%"><a href="<?php echo $_SERVER['PHP_SELF'];?>?order=<?php echo $order."&orderby=name".$query_string;?>" class="table_font"><strong>Name</strong></a> <?php echo $img1;?></td>
...
//                                $val_contry = $db->fetch_array($db->query($select_country));
                                ...
                                echo '<td ><a href="add_admin.php?record_id='.$listed_record_id.'" class="table_font">'.$val_query['name'].'</a></td>';
                                ...
                                echo '<td align="center"><a href="add_admin.php?record_id='.$listed_record_id.'" ><img src="images/edit_icon.png" title="Edit Record" class="example-fade"/></a>&nbsp;&nbsp;
