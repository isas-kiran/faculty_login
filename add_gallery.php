...
if($_REQUEST['record_id'])
{
    ...
    $sql_record= "SELECT title,description,event_date FROM bp_gallery where gallery_id='".$record_id."'";
                               ...
                               if($record_id)
                                {
                                    ...
                                    $db->query_update("gallery", $data_record,$where_record);
                                    echo '<br></br><div id="msgbox" style="width:40%;">Record updated successfully</center></div><br></br>';
                                }
                                else
                                {
                                    $data_record['added_date'] =date("Y-m-d H:i:s");
                                    $record_id=$db->query_insert("gallery", $data_record);
        ...
        <form method="post" id="jqueryForm" enctype="multipart/form-data">
            <table border="0" cellspacing="15" cellpadding="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td ><input type="text"  class="validate[required] input_text" name="title" id="title" 
                        value="<?php if ($_POST['save_changes']) echo $_POST['title']; else echo $row_record['title']; ?>" /></td> 
                        <td width="19%" ></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td><input type="submit" class="input_btn" value="<?php if ($record_id) echo "Update"; else  echo "Add"; ?> Photo Gallery" name="save_changes"  /></td>
                        <td></td>
                    </tr>
                </table>
        </form>
