        ...
        <!--</td>-->
                        ...
                        <table align="center" border="1px"  width="786" cellpadding="0" cellspacing="0"
                        	...
                        	<tr>
                                ...
                                <td width="24%" align="left"  style="padding-left:10px;width:20%"><span style="font-size:15px; font-weight:bold">GST Tax No.</span></td><td width="29%" width:20% align="center"><font size="2px;"><strong>27AADFI5575R1ZK</strong></font> </td>
							</tr>
                            <tr>
                                ...
                                <td align="left"  style="padding-left:10px;width:20%"><span style="font-size:15px; font-weight:bold">Invoice No.</span></td><td width:20% align="center"><font size="2px;"><?php  echo $data_bill_master['invoice_id']; ?> </font></td>
                            </tr>
                            <tr>
