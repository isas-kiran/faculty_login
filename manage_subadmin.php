  ...
  <tr class="head_td">
    ...
    <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='name'))
                        {
                            ...
                            $sql_query= "SELECT * FROM site_setting where 1 and type = 'A' ".$pre_keyword." ".$select_directory.""; 
                       //echo $sql_query;
...
//                                $val_contry = $db->fetch_array($db->query($select_country));
                                ...
                                echo '<td ><a href="add_subadmin.php?record_id='.$listed_record_id.'" class="table_font">'.$val_query['name'].'</a></td>';
                                ...
                                echo '<td align="center"><a href="add_subadmin.php?record_id='.$listed_record_id.'" ><img src="images/edit_icon.png" title="Edit Record" class="example-fade"/></a>&nbsp;&nbsp;
