...
<?php
$edit_access='';
$sel_acc="select * from edit_previleges where admin_id='".$_SESSION['admin_id']."' and privilege_id='99'";
  ...
  <tr class="head_td">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="99%" align="center">
     ...
     <?php
						...
						$sql_query= "SELECT inquiry_id,status,firstname,middlename,lastname,cm_id,mobile1,address,email_id,added_date FROM inquiry where 1 ".$_SESSION['where']." ".$search_cm_id." ".$enquiry_from_date." ".$enquiery_to_date." ".$select_directory.""; 
    				...
    				<form method="post"  name="frmTakeAction"  action="<?php echo $_SERVER['PHP_SELF'].'?#msgbox';?>">
                     <input type="hidden" name="formAction" id="formAction" value=""/>
                      <tr class="grey_td" >
                        ...
                        <td width="7%" align="center"><strong>Email Id</strong></td>
                        <td width="5%" align="center"><strong>Date</strong></td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
								...
								echo '<td align="center">'.$val_query['firstname'].' '.$val_query['middlename'].' '.$val_query['lastname'].'</td>';
