...
if($_POST['save_changes'])
{
	...
	?>
	<script>
		setTimeout('document.location.href="print_certificate_rica.php?record_id=<?php echo $record_id; ?>&course_id=<?php echo $course_id; ?>";',1000);
	</script>
	<?php
}
	?>
<div class="container">
	<img src="images/rica.jpg" alt="Certificate Keratine" style="width:100%;">
