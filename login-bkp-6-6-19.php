...
$select_acitve_logins = " select last_login_time, admin_id from site_setting where 1  "; // status= 'Active'
				...
				if((trim(strtolower($_POST['captcha'])) == $_SESSION['captcha']))
				{
					...
					if($_COOKIE[$cookiess_name]==$username || $row_site_setting['type']=="S")
					{
						...
						{*/
							...
							elseif($row_site_setting['type']=='ST')
							{
								$select_prev_admin= " select DISTINCT(previlege_parent_id) from admin_previleges where admin_id='".$_SESSION['admin_id']."'" ;
								$ptr_previlege = mysql_query($select_prev_admin);
								$array_previ =array();
							...
							elseif($row_site_setting['type']=='AC')
							{
							$select_prev_admin= " select DISTINCT(previlege_parent_id) from admin_previleges where admin_id='".$_SESSION['admin_id']."'" ;
								$ptr_previlege = mysql_query($select_prev_admin);
								$array_previ =array();
							...
							elseif($row_site_setting['type']=='Q')
							{
								$select_prev_admin= " select DISTINCT(previlege_parent_id) from admin_previleges where admin_id='".$_SESSION['admin_id']."'" ;
								$ptr_previlege = mysql_query($select_prev_admin);
								$array_previ =array();
							...
							elseif($row_site_setting['type']=='PK')
							{
								$select_prev_admin= " select DISTINCT(previlege_parent_id) from admin_previleges where admin_id='".$_SESSION['admin_id']."'" ;
								$ptr_previlege = mysql_query($select_prev_admin);
								$array_previ =array();
							...
							elseif($row_site_setting['type']=='DL')
							{
								$select_prev_admin= " select DISTINCT(previlege_parent_id) from admin_previleges where admin_id='".$_SESSION['admin_id']."'" ;
								$ptr_previlege = mysql_query($select_prev_admin);
								$array_previ =array();
