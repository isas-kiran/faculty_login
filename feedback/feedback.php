...
<link href="css/temporary.css" media="screen" rel="stylesheet" type="text/css">
...
<!-- Screens starts here -->
    ...
    <div class="wrapper feedbackscreen-1 " screen-item-count="2" id="SurveyScreen_1">
              <?php 
			  
			  $select_brch="select cm_id,staff_id from customer_service where customer_service_id='".$_REQUEST['record_id']."'";
									$ptr_brch=mysql_query($select_brch);
									$data_brch=mysql_fetch_array($ptr_brch);
			  
			  $i=0;
	$sel_cust_services="select customer_service_id,customer_id,service_id,admin_id from customer_service_map where customer_service_id ='".$_REQUEST['record_id']."'";
								...
								while($data_service=mysql_fetch_array($ptr_sel_service))
								{
									...
									$data_service_name=mysql_fetch_array($ptr_service);
									 ...
									 $select_name="select name,admin_id from site_setting where admin_id='".$data_service['admin_id']."'";
									$ptr=mysql_query($select_name);
									$data_name=mysql_fetch_array($ptr);
									
							
							
	?>
	  
            <div id="SurveyField_130903<?php echo $i; ?>" class="inner-center-panel survey-field-container single_column variable_cls_ set-5"  f-field-id="130903<?php echo $i; ?>" f-required="1" field-type="mcq_button" f-name="mcqquestion" f-input-type="" options-has-image="0" is-rating="1" field-category="F" total-option-count="4" show-num-in-sel-option="1" min-option-sel-count="1" has-skip-logic="0" is-gradient="0" is-hide-field="" allow-hide-when-filled="" hide-field-setting="0" validate-custom-error="Invalid Input" validate-term="" question-serial-tag="{{Q1}}">
                <div class="row">
    <div class="inner-center-panel mcq-option-row">
        <div class="form">
            <h2 style="font-size:25px;font-family:Source Sans Pro; color:rgb(134, 193, 50);" class="field-main-label">How would you rate the quality of your Service and Therapist ? *</h2>
            <p style="font-size:25px;font-family:Source Sans Pro; color:#DDB053;" class="direction-help-placeholder-text">
			<b>Service Name :-<?php echo $data_service_name['service_name']; ?></b></br>
			<b>Therapist Name :-<?php echo $data_name['name']."<br />"; ?></b></p>
            <div class='mcq-btn-option-container'>
                <div class='mcq-btn-option-container-left'>
                                            <button action-taken="" skip-to-screen="" hide-screen="" style="font-family:Source Sans Pro; color:#ffffff;background-color:rgb(134, 193, 50)" type="button" class="btn mcq-button" tag-choice-id="360099-10.00" tag-weight="10.00" onClick="save_values('<?php echo $data_service['customer_id']; ?>','<?php echo $data_service['customer_service_id']; ?>','<?php echo $data_service['service_id']; ?>','<?php echo $data_name['admin_id']; ?>','1','<?php echo "1_".$data_service['customer_service_id']."_".$i; ?>','Excellent','<?php echo "How would you rate the quality of your Service and Therapist"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">Excellent</button>
                                            <button action-taken="" skip-to-screen="" hide-screen="" style="font-family:Source Sans Pro; color:#ffffff;background-color:rgb(134, 193, 50)" type="button" class="btn mcq-button" tag-choice-id="360101-5.00" tag-weight="5.00" onClick="save_values('<?php echo $data_service['customer_id']; ?>','<?php echo $data_service['customer_service_id']; ?>','<?php echo $data_service['service_id']; ?>','0','1','<?php echo "1_".$data_service['customer_service_id']."_".$i; ?>','Average','<?php echo "How would you rate the quality of your Service and Therapist"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">Average</button>
                                         
                                    </div>
                <div class='mcq-btn-option-container-right'>
                                            <button action-taken="" skip-to-screen="" hide-screen="" style="font-family:Source Sans Pro; color:#ffffff;background-color:rgb(134, 193, 50)" type="button" class="btn mcq-button" tag-choice-id="360100-7.50" tag-weight="7.50" onClick="save_values('<?php echo $data_service['customer_id']; ?>','<?php echo $data_service['customer_service_id']; ?>','<?php echo $data_service['service_id']; ?>','0','1','<?php echo "1_".$data_service['customer_service_id']."_".$i; ?>','Good','<?php echo "How would you rate the quality of your Service and Therapist"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">Good</button>
                                            <button action-taken="" skip-to-screen="" hide-screen="" style="font-family:Source Sans Pro; color:#ffffff;background-color:rgb(134, 193, 50)" type="button" class="btn mcq-button" tag-choice-id="360102-2.50" tag-weight="2.50" onClick="save_values('<?php echo $data_service['customer_id']; ?>','<?php echo $data_service['customer_service_id']; ?>','<?php echo $data_service['service_id']; ?>','0','1','<?php echo "1_".$data_service['customer_service_id']."_".$i; ?>','Poor','<?php echo "How would you rate the quality of your Service and Therapist"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">Poor</button>
                                    </div>
            </div>
        </div>
    </div>
             ...
             <?php $i++; } ?>   
            <div id="SurveyField_130908" class="inner-center-panel survey-field-container single_column variable_cls_ "  f-field-id="130908" f-required="0" field-type="heading" f-name="heading" f-input-type="" options-has-image="0" is-rating="0" field-category="C" total-option-count="4" show-num-in-sel-option="1" min-option-sel-count="1" has-skip-logic="0" is-gradient="0" is-hide-field="" allow-hide-when-filled="" hide-field-setting="0" validate-custom-error="Invalid Input" validate-term="" question-serial-tag="{{Q2}}">
                <div class="row">
    <div class="inner-center-panel">
        <div class="form">
            <h2 style="font-size:25px;font-family:Source Sans Pro; color:rgb(134, 193, 50);" class="field-main-label heading"> </h2>
        </div>
    </div>
</div>            </div>
	 ...
	 <div class="clear"></div>
        ...
        <!-- Screens start here -->
		<?php 
		$select_name="select customer_service_id,customer_id from customer_service where customer_service_id ='".$_REQUEST['record_id']."'";
		...
		?>
    <div class="wrapper feedbackscreen-2 " screen-item-count="1" id="SurveyScreen_2">
                
            <div id="SurveyField_130905" class="inner-center-panel survey-field-container single_column variable_cls_ set-5"  f-field-id="130905" f-required="1" field-type="mcq_button" f-name="mcqquestion" f-input-type="" options-has-image="0" is-rating="0" field-category="F" total-option-count="5" show-num-in-sel-option="1" min-option-sel-count="1" has-skip-logic="0" is-gradient="0" is-hide-field="" allow-hide-when-filled="" hide-field-setting="0" validate-custom-error="Invalid Input" validate-term="" question-serial-tag="{{Q1}}">
                <div class="row">
    <div class="inner-center-panel mcq-option-row">
        <div class="form">
            <h2 style="font-size:25px;font-family:Source Sans Pro; color:rgb(134, 193, 50);" class="field-main-label">How would you rate the cleanliness and hygiene? *</h2>
            <p style="font-family:Source Sans Pro; color:rgb(134, 193, 50);" class="direction-help-placeholder-text"></p>
            <div class='mcq-btn-option-container'>
                <div class='mcq-btn-option-container-left'>
                                            <button action-taken="" skip-to-screen="" hide-screen="" style="font-family:Source Sans Pro; color:#ffffff;background-color:rgb(134, 193, 50)" type="button" class="btn mcq-button" tag-choice-id="360104" tag-weight="10.00" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','2','<?php echo "2_".$data_name['customer_service_id']."_1"; ?>','Excellent','<?php echo "How would you rate the cleanliness and hygiene"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">Excellent</button>
                                            <button action-taken="" skip-to-screen="" hide-screen="" style="font-family:Source Sans Pro; color:#ffffff;background-color:rgb(134, 193, 50)" type="button" class="btn mcq-button" tag-choice-id="360106" tag-weight="5.00" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','2','<?php echo "2_".$data_name['customer_service_id']."_1"; ?>','Average','<?php echo "How would you rate the cleanliness and hygiene"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">Average</button>
                                           
                                    </div>
                <div class='mcq-btn-option-container-right'>
                                            <button action-taken="" skip-to-screen="" hide-screen="" style="font-family:Source Sans Pro; color:#ffffff;background-color:rgb(134, 193, 50)" type="button" class="btn mcq-button" tag-choice-id="360105" tag-weight="7.50" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','2','<?php echo "2_".$data_name['customer_service_id']."_1"; ?>','Good','<?php echo "How would you rate the cleanliness and hygiene"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">Good</button>
                                            <button action-taken="" skip-to-screen="" hide-screen="" style="font-family:Source Sans Pro; color:#ffffff;background-color:rgb(134, 193, 50)" type="button" class="btn mcq-button" tag-choice-id="360107" tag-weight="2.50" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','2','<?php echo "2_".$data_name['customer_service_id']."_1"; ?>','Poor','<?php echo "How would you rate the cleanliness and hygiene"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">Poor</button>
                                    </div>
            </div>
        </div>
    </div>
    ...
    <div class="wrapper feedbackscreen-3 " screen-item-count="1" id="SurveyScreen_3">
            ...
            <div class="row">
                <table class="table no-border table-cell-nps ">
                    ...
                    <tr>
                               ...
                               <label style="font-family:Source Sans Pro;background-color:rgb(40, 140, 40);color:#ffffff;" class="nps-5" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','3','<?php echo "3_".$data_name['customer_service_id']."_1"; ?>','5','<?php echo "How was your overall visit in terms of value of money"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">5</label>                           
                                                ...
                                                <td action-taken="" skip-to-screen="" hide-screen="" tag-choice-id="360089" class="nps-option">
                                                 ...
                                                 <label style="font-family:Source Sans Pro;background-color:rgb(134, 193, 50);color:#ffffff;" class="nps-4" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','3','<?php echo "3_".$data_name['customer_service_id']."_1"; ?>','4','<?php echo "How was your overall visit in terms of value of money"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">4</label>       
                          
                                                                                    </td>
                                                <td action-taken="" skip-to-screen="" hide-screen="" tag-choice-id="360090" class="nps-option">
                            
                                                        
                            <label style="font-family:Source Sans Pro;background-color:rgb(84, 217, 140);color:#ffffff;" class="nps-3" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','3','<?php echo "3_".$data_name['customer_service_id']."_1"; ?>','3','<?php echo "How was your overall visit in terms of value of money"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">3</label>
                                                                                    </td>
							 ...
							 <label style="font-family:Source Sans Pro;background-color:rgb(239, 115, 115);color:#ffffff;" class="nps-2" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','3','<?php echo "3_".$data_name['customer_service_id']."_1"; ?>','2','<?php echo "How was your overall visit in terms of value of money"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">2</label>
                                                                                    </td>
                                                <td action-taken="" skip-to-screen="" hide-screen="" tag-choice-id="360092" class="nps-option">
                            
                                   <label style="font-family:Source Sans Pro;background-color:rgb(230, 72, 72);color:#ffffff;" class="nps-1" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','3','<?php echo "3_".$data_name['customer_service_id']."_1"; ?>','1','<?php echo "How was your overall visit in terms of value of money"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">1</label>                       
                            
                                                                                    </td>
                                                <td action-taken="" skip-to-screen="" hide-screen="" tag-choice-id="360093" class="nps-option">
                            
                             <label style="font-family:Source Sans Pro;background-color:rgb(246, 9, 9);color:#ffffff;" class="nps-0" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','3','<?php echo "3_".$data_name['customer_service_id']."_1"; ?>','0','<?php echo "How was your overall visit in terms of value of money"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">0</label>
    ...
    <div class="clear"></div>
        <!-- Screens start here -->
    <div class="wrapper feedbackscreen-4 " screen-item-count="1" id="SurveyScreen_4">
                
            <div id="SurveyField_130902" class="inner-center-panel survey-field-container single_column variable_cls_ set-11"  f-field-id="130901" f-required="1" field-type="NumberRating" f-name="npsquestion" f-input-type="" options-has-image="0" is-rating="0" field-category="F" total-option-count="11" show-num-in-sel-option="1" min-option-sel-count="1" has-skip-logic="0" is-gradient="0" is-hide-field="" allow-hide-when-filled="" hide-field-setting="0" validate-custom-error="Invalid Input" validate-term="" question-serial-tag="{{Q1}}">
                        <div class="row">
        <div class="inner-center-panel">
            <div class="inner-div-center">
            <h2 style="font-size:25px;font-family:Source Sans Pro; color:rgb(134, 193, 50);" class="field-main-label">How would you rate your overall visit? *</h2>
            <div class="row">
                <table class="table no-border table-cell-nps ">
                    <tr>
                        <td><span style="font-family:Source Sans Pro;color:rgb(134, 193, 50);" class="nps-help-text nps-first-help-text mobile-show-option-symbol top">Very Likely</span></td>
                    ...
                    <tr>
                         ...
                         <label style="font-family:Source Sans Pro;background-color:rgb(40, 140, 40);color:#ffffff;" class="nps-10" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','4','<?php echo "4_".$data_name['customer_service_id']."_1"; ?>','5','<?php echo "How would you rate your overall visit"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">5</label>  
                            ...
                            <label style="font-family:Source Sans Pro;background-color:rgb(134, 193, 50);color:#ffffff;" class="nps-4" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','4','<?php echo "4_".$data_name['customer_service_id']."_1"; ?>','4','<?php echo "How would you rate your overall visit"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">4</label> 
                                                                                    </td>
                                                <td action-taken="" skip-to-screen="" hide-screen="" tag-choice-id="360090" class="nps-option">
                            
                                                        
                            <label style="font-family:Source Sans Pro;background-color:rgb(84, 217, 140);color:#ffffff;" class="nps-3" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','4','<?php echo "4_".$data_name['customer_service_id']."_1"; ?>','3','<?php echo "How would you rate your overall visit"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">3</label>
                                                                                    </td>
                                                <td action-taken="" skip-to-screen="" hide-screen="" tag-choice-id="360091" class="nps-option">
							 ...
							 <label style="font-family:Source Sans Pro;background-color:rgb(239, 115, 115);color:#ffffff;" class="nps-2" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','4','<?php echo "4_".$data_name['customer_service_id']."_1"; ?>','2','<?php echo "How would you rate your overall visit"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">2</label>  
                                                                                    </td>
                                                <td action-taken="" skip-to-screen="" hide-screen="" tag-choice-id="360092" class="nps-option">
                            
                                                      
                            <label style="font-family:Source Sans Pro;background-color:rgb(230, 72, 72);color:#ffffff;" class="nps-1" onClick="save_values('<?php echo $data_name['customer_id']; ?>','<?php echo $data_name['customer_service_id']; ?>','0','0','4','<?php echo "4_".$data_name['customer_service_id']."_1"; ?>','1','<?php echo "How would you rate your overall visit"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">1</label>
                                                                                    </td>
                                                <td action-taken="" skip-to-screen="" hide-screen="" tag-choice-id="360093" class="nps-option">
                            
                            
                                                       
                             <label style="font-family:Source Sans Pro;background-color:rgb(246, 9, 9);color:#ffffff;" class="nps-0" onClick="save_values('0','<?php echo $data_name['customer_service_id']; ?>','0','0','4','<?php echo "4_".$data_name['customer_service_id']."_1"; ?>','0','<?php echo "How would you rate your overall visit"; ?>','<?php echo $data_brch['cm_id']; ?>','<?php echo $data_brch['staff_id']; ?>');">0</label>
                                                                                            <span style="font-family:Source Sans Pro;color:rgb(134, 193, 50);" class="nps-help-text nps-last-help-text mobile-hide-symbol">Very Unlikely</span>
                                                        </td>
                                            </tr>
                    <tr>
                        <td><span style="font-family:Source Sans Pro;color:#2a13bb;" class="nps-help-text nps-last-help-text mobile-show-option-symbol bottom">Very Unlikely</span></td>
                    </tr>
                </table>
                </div>
            </div>
