                                    ...
                                    <td colspan="<?php echo $tot_days; ?>">
                                    	<div class="page">
                                            <table cellspacing="0" cellpadding="0" class="table" width="100%" style="margin: 0px !important; height:650px !important;border-right: 1px solid;border-right-color: rgb(205, 205, 205);">
                                                ...
                                                echo '<td align="center" width="15%" class="grey_td" style="font-size:15px;font-weight:600; height:35px !important; margin:5px!important; ">Student Name</td>';   
                                                while($val_query=mysql_fetch_array($db_query))
                                                {
                                                    ...
                                                    echo '<td align="center" class="grey_td" style="font-size:13px;font-weight:720; height:15px !important; width:60px !important; margin:5px!important; writing-mode: sideways-lr;text-orientation: mixed;">'.$name.'</td>';   
