...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
		...
		<td class="mid_mid">
			...
			<?php
                ...
                if(isset($_POST['save_changes']))
                {
					...
					$bank_name=( true== isset($_POST['bank_name'])) ? $_POST['bank_name'] : "0";	
					$chaque_no=( true== isset($_POST['chaque_no'])) ? $_POST['chaque_no'] : "0";	
					$chaque_date= $_POST['chaque_date'];
					$tan_date = explode('/',$chaque_date);
					$chaque_date=$tan_date[2].'-'.$tan_date[1].'-'.$tan_date[0];
					$chaque_date=( true== isset($chaque_date)) ? $chaque_date : "";	
					$credit_card_no=( true== isset($_POST['credit_card_no'])) ? $_POST['credit_card_no'] : "";		
					$cust_bank_name=( true== isset($_POST['cust_bank_name'])) ? $_POST['cust_bank_name'] : "";	
					if($_POST['payment_type'] !='')
					{
						$payment_mode=( true== isset($_POST['payment_type'])) ? $_POST['payment_type'] : "";
						   ...
						   // $data_record['service_tax']=$service_tax;
                            ...
                            if($record_id)
                            {
							   ...
							   $bank_query=mysql_query($bank);  
								...
								$where_recordq="inquiry_id='".$row_record['class_id']."'"; 
	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%" >
            ...
            <?php
				$sql_sub_cat = "select * from inquiry where inquiry_id='".$row_record['class_id']."' ";
       ...
       <?php }?>
                <tr>
                    ...
                    <td width="40%"><input type="text" class="input_text datepicker" name="admission_date" id="admission_date" value="<?php if($_POST['admission_date']) echo $_POST['admission_date']; else echo date('d/m/Y'); ?>" />
                    <input type="hidden" name="cm_id" value="<? echo $row['cm_id']; ?>" /></td>
                </tr> 
                <tr>
                	<td width="20%" >Invoice No.<span class="orange_font">*</span></td>
                    <td width="40%"><input type="text" class="validate[required] input_text" name="invoice_no"  id="invoice_no"disabled="disabled"  value="<?php if($_POST['invoice_no']) echo $_POST['invoice_no']; else echo $row_record['student_id']; ?>" /> </td>
                </tr>
				<tr>
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <tr>
                    ...
                    <td width="40%"><textarea  name="per_address" style="width: 400px; height: 62px;" id="per_address" ><?php if($_POST['per_address']) echo $_POST['per_address']; else echo $row_record['permanant_address'];?></textarea></td> 
                 </tr> 
                 <tr>
                 	<td width="20%">Date Of Birth<span class="orange_font">*</span></td>
                    <td width="40%"><input type="text" class="input_text datepicker" name="dob" id="dob" value="<?php if($_POST['dob'])	echo $_POST['dob'];else{$arrage_date= explode('-',$row_record['dob'],3);echo $arrage_date[2].'/'.$arrage_date[1].'/'.$arrage_date[0];}?>" /></td> 
                	<td width="40%"></td>
            	</tr>   
            	<tr>
