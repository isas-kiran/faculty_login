<?php include '../3/inc_classes.php';?>
<!--ENROLLMENT Bank Summery-->
<?php include "../3/admin_authentication.php";?>
...
<?php include "../3/include/headHeader.php";?>
<?php include "../3/include/functions.php"; ?>
<?php include "../3/include/ps_pagination.php"; ?>
    <script type="text/javascript" src="../js/common.js"></script>
    <link rel="stylesheet" href="../3/js/development-bundle/demos/demos.css"/>
    <script src="../3/js/development-bundle/ui/jquery.ui.core.js"></script>
    <script src="../3/js/development-bundle/ui/jquery.ui.widget.js"></script>
    <script src="../3/js/development-bundle/ui/jquery.ui.datepicker.js"></script>
...
<body>
<?php include "../3/include/header.php"; ?>
<!--info start-->
<div id="info">
<!--left start-->
<?php include "../3/include/menuLeft.php"; ?>
<!--left end-->
<!--right start-->
<div id="right_info">
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    <td class="top_mid" valign="bottom"><?php include "../3/include/financial_report_menu.php";?></td>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
              <tr>
                ...
                <!--<td width="20%">
                        ...
                        <td><a href="expense_outgoing_gst_export.php<?php echo $sep_url_string; ?>"><img src="../3/images/excel.png" height="30px" width="30px"/></a></td>  
            </tr>          
        </table>
        </form>	
    </td>
     ...
     <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='firstname'))
                        {
							...
							$branch_id='';
                       		...
                       		"<br/>".$sql_query= "select i.*, e.name from invoice i, enrollment e where 1 and i.enroll_id=e.enroll_id ".$search_cm_id." ".$pre_keyword_i." ".$pay_type." ".$bank_ids." ".$paid_from_date." ".$paid_to_date." ".$select_directory." "; 
				...
				<form method="post"  name="frmTakeAction"  action="<?php echo $_SERVER['../3/PHP_SELF'].'?#msgbox';?>">
                     <input type="hidden" name="formAction" id="formAction" value=""/>
                      <tr class="grey_td" >
						...
						<td width="10%" align="center">Deposite Amount</td>
                        <td width="10%" align="center">Added Date</td>
                            ...
                            while($val_query=mysql_fetch_array($my_db))
                            {
                                ...
                                include "../3/include/paging_script.php";
                                echo '<tr '.$bgcolor.'>';
                                
								"<br/>".$sel_name="select name from enrollment where enroll_id='".$val_query['enroll_id']."'";
...
<?php include "../3/include/footer.php"; ?>
