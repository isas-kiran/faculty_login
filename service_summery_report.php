...
<title>Service Summery Report</title>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
              <tr>
                ...
                <!--<td width="20%">
                        ...
                        <td><a href="service_summery_report_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>  
            </tr>          
        </table>
        </form>	
    </td>
     ...
     <?php
						...
						?>
						<td width="5%" align="center"><strong>Receipt No.</strong></td>
						<td width="7%" align="center"><strong>Customer Name</strong></td>
                        <td width="20%" align="center">
                            <table width="100%">
                                <tr>
                                    <td align="center" width="40%">Service Name</td>
                                    <td align="center" width="10%">Quantity</td>
                                    <td align="center" width="10%">Service Price</td>
                                    <td align="center" width="10%">Discount Price</td>
                                    <td align="center" width="20%">Total</td>
                                </tr>
                            </table>
                        </td>
                        <td width="6%" align="center">Service Price</td>
                        
                        <td width="5%" align="center">CGST</td>
                        <td width="5%" align="center">SGST</td>
                        <td width="5%" align="center">IGST</td>
                        <td width="8%" align="center">Discounted Price</td>
                        <td width="8%" align="center">Total Amount</td>
                        <td width="6%" align="center">Payment Type</td>
                        <td width="8%" align="center">Bank Name</td>
						<td width="8%" align="center">Bank Details</td>
                        <td width="6%" align="center">Added Date</td>
                      </tr>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
								...
								$sel_name="select cust_name from customer where cust_id='".$val_query['customer_id']."'";
								...
								$sel_prod="select * from customer_service_map where customer_service_id='".$val_query['customer_service_id']."'";
								$ptr_prod= mysql_query($sel_prod);
								while($product=mysql_fetch_array($ptr_prod))
                                {
									echo '<tr>';
									$sel_p="select service_name from servies where service_id='".$product['service_id']."'";
									$ptr_p=mysql_query($sel_p);
									$data_p=mysql_fetch_array($ptr_p);
									echo'<td align="center" width="40%">'.$data_p['service_name'].'</td>';
									echo'<td align="center" width="10%">'.$product['service_quantity'].'</td>';
									echo'<td align="center" width="15%">'.$product['service_price'].'</td>';
									echo'<td align="center" width="15%">'.$product['discount_price'].'</td>';
									echo'<td align="center" width="15%">'.$product['total_price'].'</td>';
									echo '</tr>';
								}
								echo '</table></td>';
								...
								echo "<td align='center'>".$val_query['excluded_tax']."</td>";
								echo "<td align='center'>".round($val_query['cgst_tax'],2)."</td>";
								echo "<td align='center'>".round($val_query['sgst_tax'],2)."</td>";
								echo "<td align='center'>".round($val_query['igst_tax'],2)."</td>";
								echo "<td align='center'>".$val_query['discount_price']."</td>";
								echo "<td align='center'>".$val_query['total_cost']."</td>";
													
								echo "<td align='center'>".$data_inst_amnt['payment_mode']."</td>";
								echo "<td align='center'> Bank Name- ".$data_bank['bank_name']."<br/>Acc. No.- ".$data_bank['account_no']."</td>";
								echo "<td align='center'> ";
