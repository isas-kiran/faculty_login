    ...
    <?php if($_POST['formAction'])
                    {
                        if($_POST['formAction']=="delete")
                        {
                            for($r=0;$r<count($_POST['chkRecords']);$r++)
                            {
                                ...
                                $sql_query= "SELECT staff_id FROM ".$GLOBALS["pre_db"]."site_setting where admin_id ='".$del_record_id."'";
...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  <tr class="head_td">
              ...
              <tr>
               ...
               <!-- <td>
                    <select name="free_course" id="free_course" class="input_select_login"  style="width: 150px; ">
								...
								{
								?>
                                <option value="S">Super Sdmin</option>
                                <?php 
								}?>
    ...
    <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='course_name'))
                        {
                        	...
                        	$sql_query= "SELECT admin_id,name,contact_phone,designation,contact_address,email,username,pass FROM site_setting where admin_id !='".$_SESSION['admin_id']."' and  1  ".$pre_keyword." ".$_SESSION['where_admin_id-cm_id']." ".$select_directory.""; 
                       //echo $sql_query;
  ...
  <tr class="grey_td" >
    ...
    <td width="9%"><strong>Role</strong></td>
    ...
    <td width="7%" class="centerAlign"><strong>Action</strong></td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                                ...
                                */
                                ...
                                echo '<td ><a href="add_user.php?record_id='.$listed_record_id.'" class="table_font">'.$val_query['name'].'</a></td>';
                                ...
                                echo '<td align="center"><a href="ex_add_user.php?record_id='.$listed_record_id.'" ><img src="images/edit_icon.png" title="Edit Record" class="example-fade"/></a>&nbsp;&nbsp;
