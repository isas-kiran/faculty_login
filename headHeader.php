...
function send_sms_function($mobile,$message,$type)
{
	...
	if($type=='promotional')
	{
		echo "<br/>".$service_url ="http://123.63.33.44/sms/user/urlsms.php?username=sample1&pass=isas@007&senderid=060000&message=".urldecode($message)."&dest_mobileno=".$destination."&response=Y";
