...
$edit_access='';
$sel_acc="select * from edit_previleges where admin_id='".$_SESSION['admin_id']."' and privilege_id='277'";
            ...
            <tr>
                ...
                <td class="rightAlign" > 
					<table border="0" cellspacing="0" cellpadding="0" align="right">
						...
						<td></td>
						<td class="width5"></td>
						<!--<td><input type="text" value="<?php ///if($_REQUEST['keyword']!="Keyword") echo $_REQUEST['keyword'];?>" name="keyword" class="defaultText search_box" title="Product Name" /></td>-->
						<td class="width2"></td>
...
<?php
						...
						$sql_query= "SELECT DISTINCT(customer_id) as cust_id FROM sales_product where 1 ".$where_cm." ".$paid_from_date." ".$paid_to_date." ".$search_cm_id." ".$pre_keyword." ".$select_directory.""; 
                       //echo $sql_query;
