                           ...
                           // $pager = new PS_Pagination($sql_query,$_SESSION['show_records'],$_SESSION['show_records_pages'],$query_string1);
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                                ...
                                */
								...
								if($_SESSION['type']=='S' ||  $edit_access='yes')
								{
									echo '<td ><a href="add_salary_details.php?record_id='.$staff_id.'" class="table_font">'.$val_query['name'].'</a></td>';
								}
								else
								...
								$select_sallery="select basic_sallery, total_sal from sallery where admin_id='".$staff_id."' ";
								$query_sallery=mysql_query($select_sallery);
								$fetch_sallery=mysql_fetch_array($query_sallery);

							    echo '<td align="center"><a href="add_salary_details.php?record_id='.$staff_id.'" "><img src="images/add1-.png" height="20px" width="20px" title="Add Salary Details" class="example-fade"/></a>&nbsp;';
                                echo '</td>';
								echo '</tr>';
                                $bgColorCounter++;
                            }
