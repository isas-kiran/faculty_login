...
?>
					  ...
					  <tr>
                       ...
                       <td width="30%" style="">
							...
							$selcetexamfaculty = "select admin_id,name from site_setting where admin_id='".$row_record['faculty_id']."' ";
							
							$ptr_faculty_name=mysql_query($selcetexamfaculty );
							$faculty_name=mysql_fetch_array($ptr_faculty_name);

								$faculty_interested=$faculty_name['name'];
