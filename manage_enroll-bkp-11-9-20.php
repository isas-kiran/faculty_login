...
?>      
	<tr class="head_td">
        ...
        <form method="get" name="search">
            ...
            <tr>
                <td class="width5"></td>
                <?php
				if($_SESSION['type']=='S' || $_SESSION['type']=='S')
				{
					?>
                    <td width="20%">
                ...
                <?php if($_SESSION['type']=='S') {?><td> <a href="excel_enroll.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td><?php }?>
    ...
    <?php
						...
						if($_REQUEST['c_id'] !='')
						{
                       	...
                       	$sql_query= "SELECT * FROM enrollment where 1 ".$record_cat_id." and ref_id='0' ".$_SESSION['where']." ".$enquiry_src." ".$assigned_to." ".$from_date." ".$to_date." ".$search_cm_id." ".$pre_keyword." ".$source_id." ".$select_directory.""; 
                       	//echo $sql_query;
                        ...
                        if($no_of_records)
                        {
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
								...
								//{									
								echo '<td ><a href="manage_enroll_student.php?record_id='.$listed_record_id.'" class="table_font">'.$val_query['name'].'<br /><img src="images/mobile-phone-8-16.ico">'.$val_query['contact'].' <br /> <img src="images/mobile_home.png" width="18" height="18">'.$val_query['contact_home'].' <br /> <img src="images/mail.png">'.$val_query['mail'].' </a></td>';
								/*}
								else {
