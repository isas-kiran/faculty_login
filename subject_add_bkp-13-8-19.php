                    ...
                    if($_POST['save_changes'])
                    {
                        ...
                        else
                        {
                            ...
                            if($record_id)
                            {
								...
								{
									echo "<br/>".$insert_into_topic_map= "insert into topic_map (topic_id,course_domain_id, subject_id, admin_id, added_date) values('".$topics[$i]."','".$domain_id."','".$record_id."','".$_SESSION['admin_id']."','".date('Y-m-d H:i:s')."')";
