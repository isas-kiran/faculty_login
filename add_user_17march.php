    ...
    <td class="mid_mid">
        ...
        <?php
                    ...
                    if($_POST['save_changes'])
                    {
						...
						$chk_exist =" select username,attendence_id,email,contact_phone from site_setting where 1 and (username='".$username."' or attendence_id='".$attendence_id."' or email='".$email."' or contact_phone='".$contact_phone."') ".$admin_id." ";
