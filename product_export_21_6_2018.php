...
$objPHPExcel->getActiveSheet()->setSharedStyle($sharedStyle3, "O2:O$no_of_rows");

$objPHPExcel->getActiveSheet()->setSharedStyle($sharedStyle2, "A1:O1");
...
$objPHPExcel->setActiveSheetIndex(0);
 ...
 $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow('3','3', 'Mo No','3');
  ...
  $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow('13','3', 'Status','3');*/
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('O1', 'Staff','6');

	$select_directory='order by product_name asc';                      
	$sql_query= "SELECT * FROM `enrollment` WHERE 1 and ref_id='0' ".$_SESSION['where']." ".$search_cm_id." ".$search_admin_id." ".$pre_keyword." ".$select_directory." "; 
	...
	while($val_query=mysql_fetch_array($query_order))
	{
		...
		$objPHPExcel->getActiveSheet()->SetCellValue('O'.$rowCount, $data_name['name']);
