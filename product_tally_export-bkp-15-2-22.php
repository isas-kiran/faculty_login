 ...
 $objPHPExcel->setActiveSheetIndex()->setCellValueByColumnAndRow('3','3', 'Mo No','3');
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValueByColumnAndRow('13','3', 'Status','3');*/
	...
	while($val_query=mysql_fetch_array($query_order))
	{
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('C'.$rowCount, 'Product-S');
		...
		if($tot_prod=mysql_num_rows($ptr_prod))
		{
			while($data_prod=mysql_fetch_array($ptr_prod))
			{
				...
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('I'.$rowCount, number_format($tot_price_gst,3,'.',''));
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('J'.$rowCount, $disc);
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('K'.$rowCount, number_format($tot_disc_price_gst,3,'.',''));
				$rowCount++;
		...
		if($tot_prod=mysql_num_rows($ptr_prod))
		{
			while($data_prod=mysql_fetch_array($ptr_prod))
			{
				...
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('G'.$rowCount, 'Item');
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('H'.$rowCount, '1');
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('I'.$rowCount, number_format($tot_price_igst,3,'.',''));
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('J'.$rowCount, $disc);
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('K'.$rowCount, number_format($tot_disc_price_igst,3,'.',''));
				$rowCount++;
		...
		if($tot_prod=mysql_num_rows($ptr_prod))
		{
			while($data_prod=mysql_fetch_array($ptr_prod))
			{
				...
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('G'.$rowCount, 'Item');
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('H'.$rowCount, '1');
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('I'.$rowCount, number_format($tot_price,3,'.',''));
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('J'.$rowCount, $disc);
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('K'.$rowCount, number_format($tot_disc_price,3,'.',''));
				$rowCount++;
		...
		if($tot_cgst_num=mysql_num_rows($ptr_cgst_prod))
		{
			while($data_cgst=mysql_fetch_array($ptr_cgst_prod))
			{
				if($data_cgst['cgst_tax_in_per'] >0)
				{
					...
					$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('K'.$rowCount, number_format($tot_cgst,3,'.',''));
		...
		if($tot_sgst_num=mysql_num_rows($ptr_sgst_prod))
		{
			while($data_sgst=mysql_fetch_array($ptr_sgst_prod))
			{
				if($data_sgst['sgst_tax_in_per'] >0)
				{
					...
					$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('K'.$rowCount, number_format($tot_sgst,3,'.',''));
		...
		if($tot_igst_num=mysql_num_rows($ptr_igst_prod))
		{
			while($data_igst=mysql_fetch_array($ptr_igst_prod))
			{
				if($data_igst['igst_tax_in_per'] >0)
				{
					...
					$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('K'.$rowCount, number_format($tot_igst,3,'.',''));
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('K'.$rowCount, number_format($tot_disc_price_gst+$tot_disc_price_igst+$tot_cgst+$tot_sgst+$tot_igst,3,'.',''));
