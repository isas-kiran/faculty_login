	...
	for($i=1;$i<$number;$i++)
	{
		...
		if($_GET['Pre'] !="")
		{
			...
			if($total_rows=mysql_num_rows($query))
			{
				...
				{
					echo '<td align="center"><span style="background-color:green;padding:5px;">Present</span></td>';
					$total_found++;
					$x=$x+1;
				}
				else
				{
					echo '<td align="center"><span style="background-color:red;padding:6px;">Absent</span></td>';
					$not_found++;
					$y=$y+1;
				}
		...
		<td align="center"><?php if($array['latemark'] =="no"){?><img src="images/nolatemark.jpg" height="30px" width="30px"/><?php }else{?><img src="images/latemark.jpg" height="30px" width="30px"/><?php }?>  </td>
		<td align="center"><?php if($array['mobile_submit'] =="no") {?><img src="images/mob.png" height="30px" width="30px"/><?php }else{?><img src="images/nomob.png" height="30px" width="30px"/><?php }?> </td>
		<?php	} ?>
	  	...
	  	if(mysql_num_rows($qu))
	   	{
			...
			echo '<td align="center"><span style="background-color:green;padding:5px;">Present</span></span></td>';
			$total_found++;
			}
