...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  <tr class="head_td">
    ...
    <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='course_name'))
                        {
                            ...
                            $sql_query= "SELECT * FROM site_setting where 1  ".$pre_keyword."  ".$_SESSION['cm_id_bop']." and type='B' ".$select_directory.""; 
                       //echo $sql_query;
  ...
  <tr class="grey_td" >
    ...
    <td width="20%"><a href="<?php echo $_SERVER['PHP_SELF'];?>?order=<?php echo $order."&orderby=councellor_name".$query_string;?>" class="table_font"><strong>BOP Name</strong></a> <?php echo $img1;?></td>
    ...
    <td width="10%" class="centerAlign"><strong>Action</strong></td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                                ...
                                */
                                ...
                                echo '<td ><a href="add_bop.php?record_id='.$listed_record_id.'" class="table_font">'.$val_query['name'].'</a></td>';
                                ...
                                echo '<td align="center"><a href="add_bop.php?record_id='.$listed_record_id.'" ><img src="images/edit_icon.png" title="Edit Record" class="example-fade"/></a>&nbsp;&nbsp;
