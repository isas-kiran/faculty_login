        ...
        <form method="post" id="jqueryForm" enctype="multipart/form-data">
            ...
            <tr><td>
                    ...
                    <tr>
                        ...
                        <td width="74%" style="box-shadow: 3px 3px 3px #888888;">
                           <select id="course_id" name="course_id" class="input_select" onChange="course_ajax(this.value);">
            	...
            	<td>
                    ...
                    <tr>
                        ...
                        <td style="box-shadow: 3px 3px 3px #888888;" ><input type="text"  class="validate[required] input_text" name="exam_name" id="exam_name" value="<?php if ($_POST['save_changes']) echo $_POST['exam_name']; else echo $row_record['exam_name']; ?>" /></td> 
                        
                    </tr>
                     <tr>
                        <td valign="top">Discription</td>
                        <td style="box-shadow: 3px 3px 3px #888888;">           
                    ...
                    <tr>
                        ...
                        <td  style="box-shadow: 3px 3px 3px #888888;"><input type="text" class="input_text datepicker" name="exam_date" id="exam_date" 
                                    value="<?php 
									if($_POST['exam_date']) 
									{
