    	...
    	<td class="mid_mid" align="center">
            ...
            if($no_of_records)
            {
                ...
                while($data_ptr_sel1=mysql_fetch_array($ptr_records))
                {
					...
					"<br/>".$sel_total_inc="select SUM(amount) as total_amt from invoice where bank_name='".$data_ptr_sel1['bank_name']."' and DATE(`added_date`) = '".$date."' ".$_SESSION['where']." ".$search_cm_id." ";
					...
					$ptr_total_inc5=mysql_query($sel_total_inc5,$link1);
					...
					$tota_exp1=$data_product['total_amt']+$data_total_expense['total_amt']+$data_total_refund['total_amt'];
					echo "<br/>1- ".$data_product['total_amt']." 2- ".$data_total_expense['total_amt']." 3- ".$data_total_refund['total_amt'];
					$tota_exp_business1=$data_total_expense_business['total_amt'];
					...
					$cash_in_hands=$opening_cash1 + $data_ptr_sel['total_amt'] +$data_sel_recipt['total_amt'] +$total_service + $data_sales_product['total_amt']+$data_cash_received_sir['total_amt'] +$data_sel_voucher['total_amt']+$data_sales_membership['total_amt']+$data_sales_package['total_amt']+$data_sales_voucher['total_amt']+$data_cash_rec['total_amt']-$cash_transfer_in_petty_cash- $data_cash_from_sir_business['total_amt']- $tota_exp_business1 - $tots ;
					...
					//========================================PETTY CASH IN HAND===========================================
					$petty_cash_in_hands=intval($data_sel_recipt_petty_cash['total_amt'] + $opening_petty_cash + $cash_withdrawl_in_petty_cash + $cash_transfer_in_petty_cash - $tota_exp1 - $data_cash_from_sir_petty['total_amt']+$data_cash_received_sir_in_petty['total_amt'] - $tots1) ; //(3/6/19)
            ...
            if($no_of_records)
            {
                while($data_ptr_sel2=mysql_fetch_array($ptr_records1))
                {
					...
					$ptr_expense_bank_id=mysql_query($sel_expense,$link2);
					$data_sel_expense=mysql_fetch_array($ptr_expense_bank_id);
					...
					$ptrinv=mysql_query($sel_inv,$link2);
					$data_inv=mysql_fetch_array($ptrinv);
					...
					"<br/>".$sel_total_inc="select SUM(amount) as total_amt from invoice where bank_name='".$data_ptr_sel2['bank_name']."' and DATE(`added_date`) = '".$date."' ".$_SESSION['where']." ".$search_cm_id." ";
					...
					$ptr_total_inc5=mysql_query($sel_total_inc5,$link2);
					$data_total_inc5=mysql_fetch_array($ptr_total_inc5);
					...
					$opening_cash1=0;
					$opening_petty_cash=0; //(3/6/19)
					"<br/>".$sele_yest_bal="select cash_in_hand,petty_cash_in_hand from dsr where 1 ".$_SESSION['where']." ".$search_cm_id." and added_date = '".$prv_date."'  order by dsr_id desc limit 0,1"; //where added_date = '".$prv_date."'
					...
					$tota_exp2=$data_product['total_amt']+$data_total_expense['total_amt']+$data_total_refund['total_amt'];
					
					$tota_exp_business2=$data_total_expense_business['total_amt'];
					//===================Cash Deposited in Bank===============================
					$sel_dist_bank_id="Select DISTINCT(bank_id) from receipt where added_date='".$date."' and bank_id !='' and (category ='cash_transfer' and category !='voucher' and cash_transfer_mode !='inword' and cash_transfer_mode !='cash_to_cash') and cash_type='business_cash' and payment_mode_id='1' ".$_SESSION['where']." ".$search_cm_id." ";// 29-12-17 category !='cash_transfer'
					...
					$total_cash_product= $data_sel_recipt['total_amt'];
					//========================================BUSINESS CASH IN HAND===========================================
					$cash_in_hands=$opening_cash1 + $data_ptr_sel['total_amt'] +$data_sel_recipt['total_amt'] +$total_service + $data_sales_product['total_amt']+$data_cash_received_sir['total_amt'] +$data_sel_voucher['total_amt']+$data_sales_membership['total_amt']+$data_sales_package['total_amt']+$data_sales_voucher['total_amt']+$data_cash_rec['total_amt']-$cash_transfer_in_petty_cash- $data_cash_from_sir_business['total_amt']- $tota_exp_business2 - $tots ;
					
					//========================================PETTY CASH IN HAND===========================================
					$petty_cash_in_hands=intval($data_sel_recipt_petty_cash['total_amt'] + $opening_petty_cash + $cash_withdrawl_in_petty_cash + $cash_transfer_in_petty_cash - $tota_exp2 - $data_cash_from_sir_petty['total_amt']+$data_cash_received_sir_in_petty['total_amt'] - $tots1) ; //(3/6/19)
					//==========================================================================================================
					echo '<td align="center" style="border:1px solid #CCC">'.round($cash_in_hands,2).'</td> <input type="hidden" name="cash_in_hand" value="'.round($cash_in_hands,2).'"  />';
					echo '<td align="center" style="border:1px solid #CCC">'.round($petty_cash_in_hands,2).'</td> <input type="hidden" name="petty_cash_in_hand" value="'.round($petty_cash_in_hands,2).'" >';	//(3/6/19)
					//===============================================================
            ...
            if($no_of_records)
            {
               	...
               	while($data_ptr_sel3=mysql_fetch_array($ptr_records3))
                {
					...
					$ptr_expense_bank_id=mysql_query($sel_expense,$link3);
					$data_sel_expense=mysql_fetch_array($ptr_expense_bank_id);
					...
					"<br/>".$sel_total_inc="select SUM(amount) as total_amt from invoice where bank_name='".$data_ptr_sel3['bank_name']."' and DATE(`added_date`) = '".$date."' ".$_SESSION['where']." ".$search_cm_id." ";
					...
					$ptr_total_inc5=mysql_query($sel_total_inc5,$link3);
					$data_total_inc5=mysql_fetch_array($ptr_total_inc5);
					...
					$tota_exp3=$data_product['total_amt']+$data_total_expense['total_amt']+$data_total_refund['total_amt'];
					
					$tota_exp_business3=$data_total_expense_business['total_amt'];
					//===================Cash Deposited in Bank===============================
					$sel_dist_bank_id="Select DISTINCT(bank_id) from receipt where added_date='".$date."' and bank_id !='' and (category ='cash_transfer' and category !='voucher' and cash_transfer_mode !='inword' and cash_transfer_mode !='cash_to_cash') and cash_type='business_cash' and payment_mode_id='1' ".$_SESSION['where']." ".$search_cm_id." ";// 29-12-17 category !='cash_transfer'
					...
					$total_cash_product= $data_sel_recipt['total_amt'];
					//========================================BUSINESS CASH IN HAND===========================================
					$cash_in_hands=$opening_cash1 + $data_ptr_sel['total_amt'] +$data_sel_recipt['total_amt'] +$total_service + $data_sales_product['total_amt']+$data_cash_received_sir['total_amt'] +$data_sel_voucher['total_amt']+$data_sales_membership['total_amt']+$data_sales_package['total_amt']+$data_sales_voucher['total_amt']+$data_cash_rec['total_amt']-$cash_transfer_in_petty_cash- $data_cash_from_sir_business['total_amt']- $tota_exp_business3 - $tots ;
					//========================================PETTY CASH IN HAND===========================================
					$petty_cash_in_hands=intval($data_sel_recipt_petty_cash['total_amt'] + $opening_petty_cash + $cash_withdrawl_in_petty_cash + $cash_transfer_in_petty_cash - $tota_exp3 - $data_cash_from_sir_petty['total_amt']+$data_cash_received_sir_in_petty['total_amt'] - $tots1) ; //(3/6/19)
					//==========================================================================================================
					echo '<td align="center" style="border:1px solid #CCC">'.round($cash_in_hands,2).'</td> <input type="hidden" name="cash_in_hand" value="'.round($cash_in_hands,2).'"  />';
					echo '<td align="center" style="border:1px solid #CCC">'.round($petty_cash_in_hands,2).'</td> <input type="hidden" name="petty_cash_in_hand" value="'.round($petty_cash_in_hands,2).'" >';	//(3/6/19)
					//===============================================================
