...
<table cellspacing="0" cellpadding="0" class="table" width="99%">
  <tr class="head_td">
    <td colspan="15">
        <form method="get" name="search">
        	...
        	<table border="0" cellspacing="0" cellpadding="0" width="99%" align="center" class="table" >
                ...
                $exp=explode('-',$data_b_details['date']);
                ...
                <tr style="padding-left:10px">
                    ...
                    <td width="50%"><strong>Day :&nbsp;&nbsp;&nbsp;</strong><?php echo $data_b_details['day']; ?></td>
                </tr>
                <tr style="padding-left:10px">
                ...
                <tr>
                    <td colspan="2" width="100%"><strong>Topics :&nbsp;&nbsp;&nbsp;</strong><?php //echo $data_enroll['added_date']; 
                        $sele_batch="select * from batch_timetable where day='".$_REQUEST['day']."' and c_b_id='".$record_id."' ";
    ...
    <?php
						...
						$sql_query= "SELECT * FROM student_course_batch_map where 1 and c_b_id='".$record_id."' ".$pre_keyword." "; 
                        ...
                        if($no_of_records)
                        {
                            ...
                            <!--<tr align="center" class="grey_td" >
                                <td width="5%" class="tr-header"><strong>Student Name</strong></td>
                            </tr>-->
                           ...
                           <!-- <tr align="center" class="grey_td" >
                          	...
                          	<tr class="grey_td" >
                            <td width="25%" class="tr-header" align="center"><strong>Topic Name</strong></td>
                            <td width="25%" class="tr-header" align="center"><strong>Topic Content</strong></td>
                            <td width="15%" class="tr-header" align="center"><strong>Topic Completed</strong></td>
