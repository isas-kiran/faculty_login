...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0">
            <?php 
            if($page_name =='subject_manage.phpp')
            {
            ?>
            <tr>
...
<td>
	<table border="0" cellspacing="0" cellpadding="0">
            <?php 
            if($page_name == 'manage_course_faq.php')
            {
            ?>
            <tr>
                <td class="tab2_left"></td>
                <td class="tab2_mid"><a href="manage_course_faq.php" style="color:#7CA32F;">Manage Course Faq </a></td>
                <td class="tab2_right"></td>
            </tr>
            <?php
            }
            ...
            <tr>
                <td class="tab_left"></td>
                <td class="tab_mid"><a href="manage_course_faq.php" style="color:#666666;">Manage Course Faq </a></td>
                <td class="tab_right"></td>
            </tr>
            <?php
            }            
...
<td>
	<table border="0" cellspacing="0" cellpadding="0">
            <?php 
            if($page_name == 'add_course_faq.php')
            {
            ?>
            <tr>
                <td class="tab2_left"></td>
                <td class="tab2_mid"><a href="add_course_faq.php" style="color:#7CA32F;">Add Course Faq </a></td>
                <td class="tab2_right"></td>
            </tr>
            <?php
            }
            ...
            <tr>
                <td class="tab_left"></td>
                <td class="tab_mid"><a href="add_course_faq.php" style="color:#666666;">Add Course Faq </a></td>
                <td class="tab_right"></td>
            </tr>
            <?php
            }            
