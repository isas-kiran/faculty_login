...
$select_exc = "select * from pr_staff_salary_management where branch_name='".$_REQUEST['branch_name']."' AND month='".$_REQUEST['month']."' AND year='".$_REQUEST['year']."' AND staff_id='".$_REQUEST['staff']."' AND payment_action=1";
						 ...
						 $select_staff = "select attendence_id,admin_id,name,company_name,contact_address,dob,joining_date,designation1,department from site_setting where attendence_id='".$_REQUEST['staff']."' "; 
...
<table id="customer-order" style="overflow: visible;width:70%;" class="table1">
 ...
 <table class="table2" style="overflow: visible;width:100%;border-collapse: collapse;border: 0px solid;">
  ...
  <tr>
    <td class="td1" style="width:50%" colspan="3">Department: <?php echo $staff['department']; ?>	
  ...
  <tr>
    ...
    <td class="td1" style="width:50%" colspan="2">Designation: <?php echo $staff['designation1']; ?>.	
	
</td>
    
  </tr>
  <tr>
    <td class="td1" style="width:50%" colspan="3">Date Of Birth: <?php echo date('d-m-Y',strtotime($staff['dob'])); ?>
...
Special Allowance 1 
 ...
 <td class="td1 td2">	
 <?php echo $rent_Detail['specia_allowance1'];  ?>
</td>
 <td class="td1" rowspan="7">	
</td>
 <td class="td1 td2" rowspan="7">
</td>
  </tr>
...
Special Allowance 2
 ...
 <td class="td1 td2">	
 <?php echo $rent_Detail['specia_allowance2'];  ?>
</td>
...
$bank_detail = "select bank_name from bank where bank_id='".$payment['bank_name']."'"; 
							$bank = $db->fetch_array($db->query($bank_detail));
?>
  <td class="td1 td2"><?php echo $bank['bank_name']; ?>
</td>
