...
<title><?php if($record_id) echo "Edit"; else echo "Add";?> councellor</title>
  ...
  <tr>
	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%">
            ...
            <tr>
                ...
                <td width="40%">
                    <input type="text" class="validate[required] input_text" name="councellor_name" id="councellor_name" value="<?php if($_POST['save_changes']) echo $_POST['councellor_name']; else echo $row_record['name'];?>" />
                </td> 
                <td width="40%"></td>
            </tr>  
            <tr>
