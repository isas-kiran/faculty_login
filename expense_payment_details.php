...
<title>Expense Payment Details</title>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
    ...
    <td class="mid_mid">
                      	...
                      	<?php
						$sql_records= "SELECT * FROM expense_invoice where expense_id=".$record_id." ";
						...
						{ 
							...
							<tr><td valign="middle" align="right">
                                    ...
                                    <tr style="padding-left:10px">
                                        <td width="20"><strong>Vendor Name :</strong></td><td width="330"><?php echo $data_customer['name']; ?></td>
                                    </tr>
                                    </table>
                                    </td></tr>
								...
								<tr align="center" class="grey_td" >
                                    ...
                                    while($val_record=mysql_fetch_array($all_records))
                                    {
										if($bgColorCounter%2==0)
                                    		...
                                    		$bgcolor=""; 
										 $enroll_id=$val_record['expense_id'];
										 $paid_totas=0;
									    ...
									    echo '<td align="center">'.$fetch_query_sales['amount_wo_tax'].'</td>'; 
									    echo '<td align="center">'.$fetch_query_sales['discount'].'</td>';
									    echo '<td align="center">'.$fetch_query_sales['total_price'].'</td>';
										...
										onclick=\"window.open('invoice_generate_expense.php?record_id=".$val_record['invoice_id']."','View Invoice','scrollbars=yes','resizable=yes','width=900,height=600')\" style='cursor:pointer' >
										</td>";
										echo "<td align='center'><img src='images/print1.jpeg'
								onclick=\"window.open('invoice_generate_expense.php?record_id=".$val_record['invoice_id']."&action=print','View Invoice','width=750,height=700')\"style='cursor:pointer'title='Print Invoice' border='0'></td>";
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                        <?php
                                        if($fetch_query_sales['remaining_amount'] >0 || $fetch_query_sales['remaining_amount']=='')
										{
											echo '<td>';
											echo'<a href="add_expense_payment.php?record_id='.$record_id.'"><strong><font size="+1">Add Payment</font></strong></a>'; 
											echo '</td>';
											echo '<td>';
											echo  '<a href="add_expense_payment.php?record_id='.$record_id.'">
