...

                        {
							...
							if($record_id=='')

							 {
								  ...
								  $sel_product="select product_name from product where product_name ='".$product_name."' ";
