...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  <tr class="head_td">
    ...
    <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='course_name'))
                        {
                            ...
                            echo $sql_query= "SELECT * FROM courses where 1  ".$pre_keyword." ".$select_directory.""; 
                       //echo $sql_query;
  ...
  <tr class="grey_td" >
    ...
    <td width="20%"><a href="<?php echo $_SERVER['PHP_SELF'];?>?order=<?php echo $order."&orderby=course_name".$query_string;?>" class="table_font"><strong>Course Name</strong></a> <?php echo $img1;?></td>
    <td width="15%"><strong>Course Category</strong></td>
    <td width="20%"><strong>Course Level</strong></td>
    <td width="5%"><strong>Course Type</strong></td>
    <td width="20%"><strong>Course Author</strong></td>
    <td width="10%" class="centerAlign"><strong>Action</strong></td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                                ...
                                $select_category = "select * from course_category where category_id = '".$val_query['category_id']."' ";                                           
                                ...
                                {
                                    $select_name = "select * from PB_user where user_id = '".$arr[$i]."' ";                                           
                                    $val_name = $db->fetch_array($db->query($select_name));
                                ...
                                echo '<td >'.$val_query['course_level'].'</td>';
