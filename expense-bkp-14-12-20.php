  ...
  <tr class="grey_td" >
	...
	<?php } ?>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
								...
								echo '<br/><b><span style="float:left">Payble Amount -</span><span style="float:right">'.round($val_query['payable_amount']).'</span></b>';
								echo '<br/><b><span style="float:left">Remaining Amount -</span><span style="float:right">'.round($val_query['remaining_amount']).'</span></b>';
								echo'</td>';
