      ...
      <tr>
         ...
         <tr>
			 ...
			 <tr>
						...
						echo '<td style="width: 25%;">Travelling Allowance <input type="radio" name="traveling_type" id="traveling_type" '.$checked1.' value="percentage" />in %
									<input type="radio" name="traveling_type" id="traveling_type" '.$checked.' value="rupees" />in Rs/-</td></td><td>';
						?>
						...
						echo '<td style="width: 25%;">Medical Allowance <input type="radio" name="medical_type" id="medical_type" '.$checked1.' value="percentage" />in %
									<input type="radio" name="medical_type" id="medical_type" '.$checked.' value="rupees" />in Rs/-</td></td><td>';
						?>
                		...
                		<?php
						if($row_record['special_allowance1_type']=="rupees") { $checked="checked='checked'"; } else  { $checked1="checked='checked'"; }
						echo '<td style="width: 25%;">Special Allowance1 <input type="radio" name="special_allowance1_type" id="special_allowance1_type" '.$checked1.' value="percentage" />in %
									<input type="radio" name="special_allowance1_type" id="special_allowance1_type" '.$checked.' value="rupees" />in Rs/-</td></td><td>';
						?>
                		...
                		<?php
						if($row_record['special_allowance2_type']=="rupees") { $checked="checked='checked'"; } else  { $checked1="checked='checked'"; }
						echo '<td style="width: 25%;">Special Allowance2 <input type="radio" name="special_allowance2_type" id="special_allowance2_type" '.$checked1.' value="percentage" />in %
									<input type="radio" name="special_allowance2_type" id="special_allowance2_type" '.$checked.' value="rupees" />in Rs/-</td></td><td>';
						?>
	   ...
	   <td width="7%"><strong>House Rent Allowance (%)</strong></td>
	    <td width="7%"><strong>Traveling Allowance </strong></td>
		 <td width="7%"><strong>Medical Allowance </strong></td>
		  <td width="7%"><strong>Special Allowance1</strong></td>
		   <td width="7%"><strong>Special Allowance2 </strong></td>
...
function getmonthdays(i)
{
 ...
 function get_total()
 {
	 ...
	 var tot=parseFloat(basic_sal_per)+parseFloat(house_rent_per)+parseFloat(travelling_per)+parseFloat(medical_per)+parseFloat(special_allowance1)+parseFloat(special_allowance2);
	/*  if(tot>100)
	 {
		 alert('Invalid Input');
		  $('#basic_sal_per').val('');
