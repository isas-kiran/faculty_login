              ...
              <tr>
                ...
                <td class="rightAlign" > 
                    <table border="0" cellspacing="0" cellpadding="0" align="right">
                        ...
                        $sql_query= "SELECT * FROM student_complaint where complaint_id='0' ".$where_status." ".$search_cm_id." ".$enquiry_from_date." ".$enquiery_to_date."  ".$pre_keyword." ".$select_directory.""; 
                        //echo $sql_query;
                        ...
                        if($no_of_records)
                        {
                           ...
                           // $pager = new PS_Pagination($sql_query,$_SESSION['show_records'],$_SESSION['show_records_pages'],$query_string1);
                            ...
                            <tr class="grey_td" >
                                ...
                                <td width="8%"><strong>Contact No  </strong></td>
