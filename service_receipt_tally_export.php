...
$total_found =0;	
	...
	$sel_for_Num_rows="select i.*, e.ext_invoice_no,e.type,e.customer_id from customer_service_invoice i, customer_service e where 1 and i.customer_service_id=e.customer_service_id  ".$search_cm_id." ".$pre_keyword_i." ".$pay_type." ".$bank_ids." ".$paid_from_date." ".$paid_to_date." ".$select_directory." "; //and amount>0
	//and amount>0
 ...
 $objPHPExcel->setActiveSheetIndex()->setCellValueByColumnAndRow('3','3', 'Mo No','3');
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValueByColumnAndRow('13','3', 'Status','3');*/
	...
	{		
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('D'.$rowCount, 'Service');
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('H'.$rowCount, 'Service Amount Collected');	
	...
	header('Content-Disposition: attachment;filename="Service Receipt Tally Report.xls"');
