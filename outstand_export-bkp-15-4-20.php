...
$total_found =0;	
	...
	if($_GET['order'] !='' && ($_GET['orderby']=='firstname'))
	{
  	...
  	$sel_for_Num_rows="SELECT DISTINCT(e.enroll_id),e.name FROM enrollment e, installment i WHERE 1  and e.enroll_id=i.enroll_id ".$where_cm." ".$search_cm_id_i." ".$installment_from_date_i." ".$installment_to_date_i." ".$pre_keyword." ".$select_directory."  ";
...
$objPHPExcel->setActiveSheetIndex(0)->setSharedStyle($sharedStyle2, "A4:I4");
...
$objPHPExcel->setActiveSheetIndex(0);
 ...
 $objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow('3','3', 'Mo No','3');
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow('13','3', 'Status','3');*/
	...
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('F'.$rowCount, $monthly_expected);
