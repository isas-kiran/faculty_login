...
<body>
    <div class="heightSpacer"></div>
						...
						//echo "cgst".$cgst_tax=$data_bill_master['cgst_tax_in_per'];
						...
						//echo $data_bill_master['course_id'];
                         ...
                         $val_course= $db->fetch_array($db->query($select_course));
							...
							$data_branch_name=mysql_fetch_array($ptr_branch_name);
							 ...
							 $select_tax="select service_tax from general_settings where branch_name='".$data_branch_name['branch_name']."' ";
							 $ptr_taxx=mysql_query($select_tax);
							 $data_taxx=mysql_fetch_array($ptr_taxx);
							 
							if($row_record['service_taxes_in_percent']=='')
							$service_taxes=$row_record['service_taxes_in_percent'];
							else
							$service_taxes=$data_taxx['service_tax'];
							...
							if(trim($data_bill_master['cgst_tax_in_per'])>0)
									$cgst_tax=$data_bill_master['cgst_tax_in_per'];
							else
								$cgst_tax=$data_taxx['cgst'];
							
							if(trim($data_bill_master['sgst_tax_in_per'])>0)
								$sgst_tax=$data_bill_master['sgst_tax_in_per'];
							else
								$sgst_tax=$data_taxx['sgst'];
							
							$total_paid_gst=$data_bill_master['total_paid_gst'];
							$gst=$data_bill_master['cgst_tax']+$data_bill_master['sgst_tax'];
        ...
        <?php } ?>
                        ...
                        <table align="center" border="1px"  width="786" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
						        ...
						        $time_in_12_hour_format  = DATE("h:i:s A", strtotime($added_date));
										echo 	"Time: ".$time_in_12_hour_format."";
                                          ...
                                          <td width="" height="10" style="padding-left:20px; font-size:13px;">Center Name</td><td width="" height="10" style="font-size:13px;" ><?php echo $_SESSION['branch_name']; ?> </td>
											  ...
											  ?>
											  <tr>
                                              	<td width="" height="10" style="padding-left:20px; font-size:13px;">Customer GST  no.</td><td width="" height="10" style="font-size:13px;"><?php echo $row_record['cust_gst_no']; ?> </td>
                                              </tr>
											  <?php
											  }
											  ?>
                             ...
                             <tr>
                                ...
                                <td align="left"  style="padding-left:10px; width:25%"><span style="font-size:15px; font-weight:bold">Service Tax (<?php echo $service_taxes; ?>%)</span></td>
            ...
            <table align="center" border="0" width="786" cellpadding="0" style="border-left:solid #999 1px; border-right:solid #999 1px;  border-bottom:solid #999 1px;">
                                             ...
                                             <!-- <tr>
                                              ...
                                              <tr>
                                               ...
                                               <?php 
												...
												{
													if($data_bill_master['bank_name'] !='select')
													$select_for_bank_name = " select bank_name from bank  where bank_id='".$data_bill_master['bank_name']."' ";
													$ptr_bank_name= mysql_query($select_for_bank_name);
													$data_bank_names = mysql_fetch_array($ptr_bank_name);
												?>
                                              <tr>
                                              	<td width="190" height="10" style="padding-left:20px; font-size:13px;">Bank Name: </td><td width="196" height="10" style=" font-size:13px;" ><?php echo $data_bank_names['bank_name']; ?> </td>
                                              <td width="146"></td>
                                              </tr>
                                              <tr>
             ...
             <td width="190" height="10" style="padding-left:20px; font-size:13px;">Bank Reference ID: </td><td width="196" height="10" style=" font-size:13px;" ><?php echo $data_online_trans['bank_ref_id']; ?> </td>
                                              ...
                                              <!--<tr><td></td></tr>-->
                                               <?php }?>
     <tr><td width="190" class="heading"  style="padding-left:20px; font-size:13px;">Pay Amount:</td><td width="242" height="10" style=" font-size:13px;" ><?php echo $amount; ?> </td> </tr>  
	 <?php 
	 if(trim($data_bill_master['cgst_tax_in_percent'])>0 || $data_bill_master['cgst_tax']>0)
	 {		 ?>
<tr><td width="190" class="heading" style="padding-left:20px; font-size:13px;"><span>CGST (<?php echo $cgst_tax; ?>%) + SGST (<?php echo $sgst_tax; ?>%)</span></td><td align=""><font size="2px;"><?php echo $data_bill_master['cgst_tax']; ?>+<?php echo $data_bill_master['sgst_tax']; ?>=<?php echo $gst; ?></font></td> </tr>
<tr><td style="padding-left:20px; font-size:13px;">GST No. (27AADFI5575R1ZK)</td></tr>
