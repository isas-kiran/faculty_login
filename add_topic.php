...
if($_REQUEST['record_id'])
{
    $record_id=$_REQUEST['record_id'];
     $sql_record= "SELECT subject_id,topic_name,duration,description,course_domain_id FROM topic where topic_id='".$record_id."' ";
...
<!--        <script src="../js/jquery.custom/development-bundle/jquery-1.4.2.js"></script>-->
	...
	function add_degree(no) //for add a degree
	{
		...
		{
			var value='<div id="'+i+'"><table class="table_class" width="100%"  cellspacing="0" cellpadding="2"> <tr><td width="30%"><input type="text" name="topic_name'+i+'"class="input_text" /></td><td width="20%"><input type="text" name="duration'+i+'" class="input_text" /></td><td width="30%"><input type="text" name="description'+i+'"  class="input_text" /></td><td width="20%"><input type="text" name="model_req'+i+'" class="input_text" /></td></tr></table></div> <div id="'+next+'"></div>';
    ...
    <td class="mid_mid">
        ...
        <?php
                    ...
                    if($_POST['save_changes'])
                    {
                        ...
                        {
							$success=0;
							$errors[$i++]="Enter Domain name";
                        }
						
						if($record_id=='')
						{
							$select_ext_topic="select topic_name from topic where topic_name='".$topic_name."' and course_domain_id='".$domain_name."' ";
				...
				//===========================================End Multiple Course PDF===========================================================
                        ...
                        else
                        {
							...
							$data_record_batch_extra1['model_required']=$_POST['model_req'];
							$data_record_batch_extra1['course_domain_id'] =$domain_name;
						   //===============================CM ID for Super Admin===============
                            ...
                            else
                            {
								...
								for($i=0;$i<=$no_of_extra;$i++)
								{
									...
									$data_record_batch_extra['course_domain_id']=$_POST['domain_id'];
									$data_record_batch_extra['model_required']=$_POST['model_req'.$i];
									$data_record_batch_extra1['added_date'] = date('Y-m-d H:i:s');
				...
				?>
             	<tr>
                	<td width="20%"> Select Domain</td>
               		<td width="80%" class="customized_select_box"> 
                ...
                <td width="80%">
                	<table width="100%">
                		<tr>
                        	<td width="30%" align="center">Topic Name </td>
                            <td width="20%" align="center">Duration </td>
                            <td width="30%" align="center">Description </td>
                            <td width="20%" align="center">Model Req. </td>
							<?php if($record_id =='')
							{ ?>
                                <td width="150" > 
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="model_req"  class="input_text" value="<?php if($_POST['save_changes']) echo $_POST['description']; else echo $row_record['model_req'];?>" /></td>
                        </tr>
                	</table>
