...
<tr>
    <td>	
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td class="top_left_home"></td> 
                <td class="top_mid_home"></td>
                <td class="top_right_home"></td>
            </tr>
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="account_details.php"><img src="images/man_acc_icon2.png" /><br />
                    <span class="green_font">My Account </span></a></td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
                <td class="bottom_left_home"></td>
                <td class="bottom_mid_home"></td>
                <td class="bottom_right_home"></td>
            </tr>
        </table>
    </td>
   <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_user.php"><img src="images/users.png" height="50" width="50" /><br />
                    <span class="green_font">Manage User</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
   ...
   <!-- <td>
            <table border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_admin.php"><img src="images/supadmin.jpg" height="50" width="50" /><br />
                    <span class="green_font">Manage SuperAdmin</span></a>
                </td>
                <td class="mid_right_home" valign="bottom">
                
                <img src="images/mid_right_img.jpg" /></td>
              </tr>
              <tr>
                <td class="bottom_left_home"></td>
                <td class="bottom_mid_home"></td>
     ...
     <td>
            <table border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="course_manage.php"><img src="images/scourses.png" width="50" height="50" /><br />
                    <span class="green_font">Manage Courses</span></a>
                </td>
                <td class="mid_right_home" valign="bottom">
    ...
    <!--<td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="subject_manage.php"><img src="images/city.png" /><br />
                    <span class="green_font">Manage Subject</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <!--<td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="staff_manage.php"><img src="images/teacher.png" /><br />
                    <span class="green_font">Manage Staff </span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_student.php"><img src="images/student.png" width="50" height="50" /><br />
                    <span class="green_font">Manage Student</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <!--<tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_subadmin.php"><img src="images/Faq-64.png" /><br />
                    <span class="green_font">Manage SubAdmin</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
   ...
   <!-- <td>
    <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_download.php"><img src="images/news-subscribe.png" /><br />
                    <span class="green_font">Manage Download </span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
       ...
       <!-- <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_question.php"><img src="images/course.png" /><br />
                    <span class="green_font">Manage Question </span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <!--<td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_exam.php"><img src="images/book.png" /><br />
                    <span class="green_font">Manage Exam </span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_paper.php"><img src="images/Question_mark.png" /><br />
                    <span class="green_font">Manage Question Paper </span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_admition.php"><img src="images/sitemap.png" /><br />
                    <span class="green_font">Take Admission For Class </span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <!--<td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_photo.php"><img src="images/gallery.jpeg" /><br />
                  <span class="green_font">Manage Picture Gallery</span></a>
              </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_vedio_gallery.php"><img src="images/video_icon.jpeg" /><br />
                  <span class="green_font">Manage Video Gallery</span></a>
              </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <!--<td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_menu.php"><img src="images/man_cat_icon2.png" /><br />
                  <span class="green_font">Manage Menu</span></a>
              </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_pages.php"><img src="images/pages.jpg" /><br />
                  <span class="green_font">Manage Pages</span></a>
              </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <!--<td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_slider.php"><img src="images/banner_design.png" /><br />
                    <span class="green_font">Manage Slider</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_testimonial.php"><img src="images/testimonial_manage.png" /><br />
                  <span class="green_font">Manage Testimonials </span></a>
              </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_notice.php"><img src="images/manage_menu.png" /><br />
                    <span class="green_font">Manage Notice </span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_source.php"><img src="images/settings.png" width="50" height="50" /><br />
                    <span class="green_font">General Settings </span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="privilages_manage.php"><img src="images/psecurity.png" width="50" height="50" /><br />
                    <span class="green_font">Manage Previlages </span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_sms.php"><img src="images/sms.png" width="50" height="50" /><br />
                    <span class="green_font">SMS Log</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_report.php"><img src="images/mreport.png" width="50" height="50" /><br />
                    <span class="green_font">Manage Report</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="receipt.php"><img src="images/expense.png" width="50" height="50"/><br />
                    <span class="green_font">Manage Expense and Bank</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_cust_services.php"><img src="images/service.png" height="50" width="50" /><br />
                    <span class="green_font">Manage Services </span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_product_category.php"><img src="images/product.png" width="50" height="50"/><br />
                    <span class="green_font">Manage Product </span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_complaint.php"><img src="images/complaint.png" width="50" height="50" /><br />
                    <span class="green_font">Manage Complaint</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="add_system_parameters.php"><img src="images/payroll.png" width="50" height="50" /><br />
                    <span class="green_font">Payroll</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_event.php"><img src="images/event.png" width="50" height="50" /><br />
                    <span class="green_font">Manage Event</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="enroll_incomming_gst.php"><img src="images/financial.png" width="50" height="50" /><br />
                    <span class="green_font">Financial Report</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="batch_specific.php"><img src="images/sms.png" width="50" height="50" /><br />
                    <span class="green_font">Sms and Email</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_campaign.php"><img src="images/campaign.png" width="50" height="50" /><br />
                    <span class="green_font">Campaign</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
     ...
     <!--<td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_councellor.php"><img src="images/councellor.png" height="50" width="50" /><br />
                    <span class="green_font">Manage Councellor  </span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
    ...
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_bop.php"><img src="images/bop.jpg" height="50" width="50"/><br />
                    <span class="green_font">Manage BOP</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
            <tr>
...
if($_REQUEST['record_id'])
{
   ...
   $array_prev=$_SESSION['privilege_id_parent']; // array for privillage
//echo print_r($array_prev);
$x=1;
...
?>
		...
		<?php
        if($array_prev[$e]['privilege_id']==1) //'for only change password'
        {?>
    <td>	
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
    ...
    if($array_prev[$e]['privilege_id']==2)//'my courses'
    {?>
    <td>
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
   ...
   <?php 
   /* }
    if($array_prev[$e]['privilege_id']==3)//' manage subject'
    {*/?>
    ...
    if($array_prev[$e]['privilege_id']==3)//'maange student'
    {?>
    ...
    if($array_prev[$e]['privilege_id']==4)//'manage download'
    {?>
    ...
    if($array_prev[$e]['privilege_id']==5  )//'manage exam courses = 2 also'
    {?>
    ...
    <!--<td>
        ...
        <?php 
   /* }
    if($array_prev[$e]['privilege_id']==8)//'manage quation papaer'
    {*/?>
       <!-- <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
    ...
    if($array_prev[$e]['privilege_id']==12)//'my account'
    {*/?>
        <!--<td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
    ...
    if($array_prev[$e]['privilege_id']==6)//'mamange video Gallery'
    {?>
    <!--<td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
    ...
    if($array_prev[$e]['privilege_id']==7)//'Manage Menu'
    {?>
    <!--<td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
    ...
    if($array_prev[$e]['privilege_id']==8)//'Manage Pages'
    {?>
    <!--<td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
    ...
    if($array_prev[$e]['privilege_id']==9)//'manage Slider'
    {?>
    <!--<td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
    ...
    if($array_prev[$e]['privilege_id']==10)//'Manage Testominial'
    {?>
    <!--<td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
    ...
    if($array_prev[$e]['privilege_id']==11)//'Manage Notice'
    {?>
    <!--<td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_testimonial.php"><img src="images/manage_menu.png" /><br />
                    <span class="green_font">Manage Notice  </span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
    ...
    if($array_prev[$e]['privilege_id']==12)//'General setting'
    {?>
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
    ...
    if($array_prev[$e]['privilege_id']==13)//'Manage Previlages'
    {?>
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
	...
	<?php 
	 ...
	 if($array_prev[$e]['privilege_id']==14)//'manage user '
    {	?>
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
    ...
    <?php 
	 ...
	 if($array_prev[$e]['privilege_id']==15)//'manage SMMS '
    {	?>
        <td>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
    ...
    <?php 
	 ...
	 if($array_prev[$e]['privilege_id']==16)//'manage Report '
    {	?>
        <td>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
    ...
    <?php 
	 ...
	 if($array_prev[$e]['privilege_id']==17)//'manage Expense and Bank '
    {	?>
        <td>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
    ...
    <?php 
	 ...
	 if($array_prev[$e]['privilege_id']==18)//'manage Service '
    {	?>
        <td>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
    ...
    <?php 
	 ...
	 if($array_prev[$e]['privilege_id']==19)//'manage Product '
    {	?>
        <td>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
	...
	?>
    <?php
	if($array_prev[$e]['privilege_id']==158) //'for complaint'
	{?>
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
            ...
            <tr>
                <td class="mid_left_home" valign="bottom"><img src="images/mid_left_img.jpg" width="50" height="50" /></td>
                <td class="mid_mid_home centerAlign">
                    <a href="manage_complaint.php"><img src="images/complaint.png" /><br />
                    <span class="green_font">Manage Complaint</span></a>
                </td>
                <td class="mid_right_home" valign="bottom"><img src="images/mid_right_img.jpg" /></td>
            </tr>
	...
	?>
    <?php
	if($array_prev[$e]['privilege_id']==203) //'for payroll
	{?>
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
	...
	if($array_prev[$e]['privilege_id']==191) //'for only change password'
	{?>
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
	...
	if($array_prev[$e]['privilege_id']==196) //'for only change password'
	{?>
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
	...
	if($array_prev[$e]['privilege_id']==226) //'for only change password'
	{?>
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
	...
	if($array_prev[$e]['privilege_id']==235) //'for only change password'
	{?>
    <td>
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
...
<!--=============================================================END===============================================================================-->
		...
		{
			?>
			<li><a class="qmparent" href="javascript:void(0)"><span style="color:#0088CB;">Enquiry Followup By Call (<?php echo date('d-M-y', strtotime('-3 days'))." to ".date('d-M-y')?>)</span></a>
			<ul>
			<li><span style="color:#000;" ><table class="adminlist">
			<thead>
			<?php
			/*$select_letest="select f.inquiry_id as inquiry_id, f.firstname as firstname, f.course_id as course_id, f.mobile1 as mobile1, f.followup_date as followup_date, f.added_date as added_date from inquiry  f, stud_regi s_r  where 1 ".$_SESSION['f_cm_id']." and ( f.followup_date >= '".date('Y-m-d')."' and  f.followup_date <='".date('Y-m-d', strtotime('+2 days'))."') and s_r.status='Enquiry' and f.inquiry_id=s_r.student_id order by  f.followup_date desc limit 0,5";*/
			
			/*echo $select_letest="select f.inquiry_id as inquiry_id, f.firstname as firstname, f.course_id as course_id, f.mobile1 as mobile1, s_r.followup_date as followup_date, s_r.added_date as added_date,s_r.lead_category_followup as lead_category_followup  from inquiry  f, followup_details s_r  where 1 ".$_SESSION['f_cm_id']." and ( f.followup_date >= '".date('Y-m-d')."' and  f.followup_date <='".date('Y-m-d', strtotime('+2 days'))."') and f.inquiry_id=s_r.student_id group by s_r.student_id desc limit 0,5";*/
			
			$sele_latest="select inquiry_id,firstname, course_id, mobile1 from inquiry where status = 'Enquiry' and lead_category_followup='phone_followup' and (followup_date >= '".date('Y-m-d', strtotime('-3 days'))."' and followup_date <='".date('Y-m-d')."') ".$_SESSION['where']." order by followup_date desc "; //followup_date <= '".date('Y-m-d', strtotime('+2 days'))."' and  
			...
			if(mysql_num_rows($ptr_select_letest))
			{
				...
				{
					$sele_latest_rec="select followup_date,lead_category_followup, added_date,lead_grade,response,admin_id,cm_id from followup_details where student_id = '".$val_select_letest['inquiry_id']."' and  (followup_date >= '".date('Y-m-d', strtotime('-3 days'))."' and followup_date <='".date('Y-m-d')."') ".$_SESSION['where']." order by followup_id desc";//followup_date <= '".date('Y-m-d', strtotime('+2 days'))."' and 
					...
					$sel_branch_name="select name,branch_name from site_setting where  cm_id='".$val_select_letest_rec['cm_id']."'";
		...
		{
			?>
			<li><a class="qmparent" href="javascript:void(0)"><span style="color:#0088CB;">Enquiry Followup By Walk-in (<?php echo date('d-M-y', strtotime('-3 days'))." to ".date('d-M-y')?>)</span></a>
			<ul>
			<li><span style="color:#000;"><table class="adminlist">
			<thead>
			<?php
			//( echo date('d-M-y')." to ".date('d-M-y', strtotime('+2 days')))
			/*$select_letest="select f.inquiry_id as inquiry_id, f.firstname as firstname, f.course_id as course_id, f.mobile1 as mobile1, f.followup_date as followup_date, f.added_date as added_date from inquiry  f, stud_regi s_r  where 1 ".$_SESSION['f_cm_id']." and ( f.followup_date >= '".date('Y-m-d')."' and  f.followup_date <='".date('Y-m-d', strtotime('+2 days'))."') and s_r.status='Enquiry' and f.inquiry_id=s_r.student_id order by  f.followup_date desc limit 0,5";*/
			
			/*echo $select_letest="select f.inquiry_id as inquiry_id, f.firstname as firstname, f.course_id as course_id, f.mobile1 as mobile1, s_r.followup_date as followup_date, s_r.added_date as added_date,s_r.lead_category_followup as lead_category_followup  from inquiry  f, followup_details s_r  where 1 ".$_SESSION['f_cm_id']." and ( f.followup_date >= '".date('Y-m-d')."' and  f.followup_date <='".date('Y-m-d', strtotime('+2 days'))."') and f.inquiry_id=s_r.student_id group by s_r.student_id desc limit 0,5";*/
			
			$sele_latest="select inquiry_id,firstname, course_id, mobile1 from inquiry where status = 'Enquiry' and lead_category_followup='walkin_followup' and (followup_date >= '".date('Y-m-d', strtotime('-3 days'))."' and followup_date <= '".date('Y-m-d')."') ".$_SESSION['where']." order by followup_date desc";//and  '".date('Y-m-d', strtotime('+2 days'))."'
			$ptr_select_letest=mysql_query($sele_latest);
			if($val_select_inquiry=mysql_num_rows($ptr_select_letest))
			{
			...
			if(mysql_num_rows($ptr_select_letest))
			{
				while($val_select_letest=mysql_fetch_array($ptr_select_letest))
				{
					$sele_latest_rec="select followup_date,lead_category_followup, added_date,lead_grade,response,cm_id,admin_id from followup_details where student_id = '".$val_select_letest['inquiry_id']."' and (followup_date >= '".date('Y-m-d', strtotime('-3 days'))."' and followup_date <= '".date('Y-m-d')."') ".$_SESSION['where']." order by followup_id desc";//, strtotime('+2 days')
					$ptr_select_letest_rec=mysql_query($sele_latest_rec);
					$val_select_letest_rec=mysql_fetch_array($ptr_select_letest_rec);	
		...
		{
			?>
			<li><a class="qmparent" href="javascript:void(0)"><span style="color:#0088CB;">Campaign Enquiries (<?php echo date('d-M-y', strtotime('-3 days'))." to ".date('d-M-y')?>)</span></a>
			<ul>
			<li><span style="color:#000;"><table class="adminlist">
			<thead>
			<?php
			...
			$sele_latest="select * from inquiry where status = 'Enquiry' and campaign_id!='' and (DATE(added_date) >= '".date('Y-m-d', strtotime('-3 days'))."' and DATE(added_date) <= '".date('Y-m-d')."') ".$_SESSION['where']." order by added_date desc";//and  '".date('Y-m-d', strtotime('+2 days'))."'
			$ptr_select_letest=mysql_query($sele_latest);
			if($val_select_inquiry=mysql_num_rows($ptr_select_letest))
			{
			?>
			...
			if(mysql_num_rows($ptr_select_letest))
			{
				while($val_select_letest=mysql_fetch_array($ptr_select_letest))
				{
					...
					echo'<td><a href="manage_student.php?record_id='.$val_select_letest['inquiry_id'].'">
					'.$val_select_letest['firstname'].' '.$val_select_letest['lastname'].' <br/></a></td>
        ...
        <?php if($_SESSION['type']=='A' || $_SESSION['type']=='S' || $_SESSION['type']=='C')
		{?>
			<li><a class="qmparent" href="javascript:void(0)"><span style="color:#0088CB;">Pending & Upcomming Installments</span></a>
			<ul>
			<li><span style="color:#000;"><table class="adminlist">
			<thead>
			
			<?php
			$select_letest="select enroll_id,installment_amount,installment_date,status from installment where 1 ".$_SESSION['where']." and installment_date < '".date('Y-m-d')."' and installment_date !='' and installment_date!='0000-00-00' and installment_date!='--' and installment_id NOT IN( select installment_id from installment_followup_details where DATE(added_date) ='2018-01-15') and  status ='not paid' order by installment_date asc";
	...
	?>		
        <?php if($_SESSION['type']=='A' || $_SESSION['type']=='S' || $_SESSION['type']=='C')
		{?>
			<li><a class="qmparent" href="javascript:void(0)"><span style="color:#0088CB;">Todays/Past Installment Followup</span></a>
			<ul>
			<li><span style="color:#000;"><table class="adminlist">
			<thead>
			...
			$select_letest="select enroll_id,name,contact,mail,course_id,added_date,installment_followup_date from enrollment where installment_followup_date!='' and installment_followup_date <'".date('Y-m-d')."' ".$_SESSION['where']." order by installment_followup_date asc";
			$ptr_select_letest=mysql_query($select_letest);
			if(mysql_num_rows($ptr_select_letest))
			{
				?>
        ...
        <?php
			...
			$select_letest="select enroll_id,name,contact,mail,course_id,added_date,installment_followup_date from enrollment where installment_followup_date!='' and installment_followup_date >= '".date('Y-m-d')."' and installment_followup_date <='".date('Y-m-d')."' ".$_SESSION['where']." order by installment_followup_date asc";
        ...
        <thead>
        <?php
			$select_letest="select inquiry_id,firstname, course_id, mobile1, added_date from inquiry where 1 ".$_SESSION['where']." and status='Enquiry' order by  inquiry_id desc limit 0,5";
			$ptr_select_letest=mysql_query($select_letest);
			if(mysql_num_rows($ptr_select_letest))
			{
		?>
