...
<tr><td>Email :learn@isasbeautyschool.com, info@isasbeautyschool.com</td></tr>
                        ...
                        <table align="center" border="1px" width="786" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                            	<td align="left"  style="padding-left:10px; width:20%"><span style="font-size:18px; font-weight:bold">Last Receipt No</span></td><td width:20%>#<?php  echo $invoice_no; ?></td>
                            ...
                            <tr>
                            	<td align="left"  style="padding-left:10px; width:20%"><span style="font-size:18px; font-weight:bold">Roll No</span></td><td width:20%><? echo $enroll_id; ?></td>
						        ...
						        $time_in_12_hour_format  = DATE("h:i:s A", strtotime($added_date));
										echo 	"Time: ".$time_in_12_hour_format."";
											 ?></td>
                                              ...
                                              <tr>
                                              	<td width="" height="10" >Center Name</td><td width="" height="10" ><?php echo $_SESSION['branch_name']; ?> </td>
                                              </tr>
                                              <tr>
                                		...
                                		<td width="24%" align="left"  style="padding-left:10px;width:20%"><span style="font-size:18px; font-weight:bold">Service Tax (14%)</span></td>
                           				...
                           				<tr>
                            				<td align="left"  style="padding-left:10px; width:20%"><span style="font-size:18px; font-weight:bold">Installment Fees</span></td>
                            			...
                            			<tr>
                                			...
                                			<td align="left"  style="padding-left:10px;width:20%"><span style="font-size:18px; font-weight:bold">Balance Fees</span></td>
            ...
            <table align="center" border="0" width="786" cellpadding="0" class="left_border right_border bottom_border">
                                              ...
                                              <tr>
                                              	<td width="283" height="10" >Cheque No</td><td width="482" height="10" ><?php echo  $data_bill_master['cheque_detail']; ?> </td>
                                              </tr>
                                               <tr>
                                              	<td width="283" height="10" >Cheque Date</td><td width="482" height="10" ><?php echo $data_bill_master['chaque_date']; ?> </td>
                                              </tr>
                                               <?php }?>
