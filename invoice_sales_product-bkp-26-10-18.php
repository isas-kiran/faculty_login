...
<table align="center" border="1px"  width="100%" style="border-left:solid #999 1px; border-right:solid #999 1px; border-top:solid #999 1px;border-radius:5px; border-collapse:collapse">
                        <tr>
						   ...
						   if($_SESSION['type']=='S')
						   {
							   ...
							   $select_branch_address="select branch_address,gst_no from branch where branch_name='".$data_cm_id['branch_name']."'";
            ...
            <table align="center" border="1px"  width="100%" cellpadding="5" cellspacing="2"  style=" border:1px solid; border-collapse:collapse" >
				...
				while($data_service=mysql_fetch_array($ptr_map))
				{
					...
					$total_prod_qty=$data_service['base_prod_price']*$data_service['product_qty'];
				...
				?>  
                  ...
                  <tr>
				         ...
				         ?>
                  		...
                  		<td colspan="7"><span style="font-size:12px;"><?php echo "<strong>Discount(in %):</strong>&nbsp;".$data_record['discount']."<br/><strong>Discounted Price &emsp;=></strong>&emsp;".$data_record['tot_price_withou_tax']."<br/><br/>"; ?>
                  ...
                  <tr>
                      ...
                      GST NO : 27AADFI5575R1ZK<br/><br/><br/>
