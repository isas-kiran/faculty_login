...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
    ...
    <td class="mid_mid" align="center">
        ...
        {
			$select_st="select admin_id from site_setting where type='ST' and cm_id='".$_SESSION['cm_id']."'";
			$ptr_st=mysql_query($select_st);
			$data_st_cm=mysql_fetch_array($ptr_st);
			
            $search_admin_id=" and admin_id='".$data_st_cm['admin_id']."'";
            $search_admin_id_S=" and p.admin_id='".$data_st_cm['admin_id']."'";
        }
      ...
      <tr class="grey_td" >
        ...
        ?>
            ...
            while($val_query=mysql_fetch_array($all_records))
            {
                ...
                $select_prod_cat="select pcategory_name,pcategory_id from product_category where pcategory_id='".$val_query['pcategory_id']."' and cm_id='".$val_query['cm_id']."'";
