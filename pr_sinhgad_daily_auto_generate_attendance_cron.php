...
<title id="title">Sinhgad Auto Generate Attendance</title>
...
<?php
	$branch_name='ISAS Singhgad Road';
	$year=date('Y');
	...
	$branch_name1='ISAS Singhgad Road';
	$cm_id=174;
...
{ 
	...
	try {
			...
			$mail->Subject = 'ISAS Sinhgad Daily Attendace is generated for '.date('Y-m-d').'';
