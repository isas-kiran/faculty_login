...
<html>
    ...
    <?php } ?>
      ...
      <table>
        ...
        <tr>
          <td>Success URI: </td>
          <td colspan="3"><input name="surl" value="<?php echo (empty($posted['surl'])) ? 'http://isasbeautyschool.org/faculty_login/paywitheasebuzz/response.php' : $posted['surl'] ?>" size="64" /></td>
        </tr>
        <tr>
          <td>Failure URI: </td>
          <td colspan="3"><input name="furl" value="<?php echo (empty($posted['furl'])) ? 'http://isasbeautyschool.org/faculty_login/paywitheasebuzz/response.php' : $posted['furl'] ?>" size="64" /></td>
        </tr>
        <tr>
