...
<body>
    <div class="heightSpacer"></div>
         ...
         <table align="center" border="0" width="786" cellpadding="0"style="border-left:solid #999 1px; border-right:solid #999 1px; ">
            ...
            <tr>
            	<td width="" height="10" style="padding-left:20px; font-size:13px;">Course Name</td><td width="" height="10" style="font-size:13px;"><?php echo  $val_course['course_name']; if($row_record['cm_id']=='60' || $row_record['cm_id']=='3' || $row_record['cm_id']=='4' ||$row_record['cm_id']=='5' || $row_record['cm_id']=='6' || $row_record['cm_id']=='7') echo ' (Toolkit Included)';?> </td>
            </tr>
            <!--<tr>
