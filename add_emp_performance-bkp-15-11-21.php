        ...
        <?php
			...
			if($success==0)
			{
                ...
                <tr>
                    ...
                    <td width="30%">Yes<input type="radio" name="class_start_time_r"  onchange="calculate_cst(this.value)" id="class_start_time_r" class="input_radio" value="yes"> No<input type="radio" name="class_start_time_r" onchange="calculate_cst(this.value)" id="class_start_time_r" class="input_radio" value="no"> </td>
                ...
                <tr>
                    ...
                    <td>Yes<input type="radio" name="class_end_time_r" id="class_end_time_r" onchange="calculate_cet(this.value)" class="input_radio" value="yes"> No<input type="radio" name="class_end_time_r" id="class_end_time_r" onchange="calculate_cet(this.value)" class="input_radio" value="no"> </td>
                ...
                <tr>
                    ...
                    <td>Yes<input type="radio" name="faculty_grooming_r" id="faculty_grooming_r" onchange="calculate_fg(this.value)" class="input_radio" value="yes"> No<input type="radio" name="faculty_grooming_r" id="faculty_grooming_r" onchange="calculate_fg(this.value)" class="input_radio" value="no"></td>
                ...
                <tr>
                    <td>Logsheet Send </td>
                    <td>Yes<input type="radio" name="logsheet_send_r" id="logsheet_send_r" onchange="calculate_ls(this.value)" class="input_radio" value="yes"> No<input type="radio" name="logsheet_send_r" id="logsheet_send_r" onchange="calculate_ls(this.value)" class="input_radio" value="no"></td>
                ...
                <tr>
                    ...
                    <td>Yes<input type="radio" name="mobile_used_r" id="mobile_used_r" onchange="calculate_mubh(this.value)" class="input_radio" value="yes"> No<input type="radio" name="mobile_used_r" id="mobile_used_r" onchange="calculate_mubh(this.value)" class="input_radio" value="no"> </td>
                ...
                <tr>
                    ...
                    <td>Yes<input type="radio" name="timetable_followed_r" id="timetable_followed_r" onchange="calculate_tf(this.value)" class="input_radio" value="yes"> No<input type="radio" name="timetable_followed_r" id="timetable_followed_r" onchange="calculate_tf(this.value)" class="input_radio" value="no"> </td>
                ...
                <tr>
                    ...
                    <td>Yes<input type="radio" name="student_decoram_r" id="student_decoram_r" onchange="calculate_sd(this.value)" class="input_radio" value="yes"> No<input type="radio" name="student_decoram_r" id="student_decoram_r" onchange="calculate_sd(this.value)" class="input_radio" value="no"> </td>
                    ...
                    <td width="100%">
                        <table width="80%">
                            <tr>
                                ...
                                <td width="30%">Yes<input type="radio" name="late_login_without_info"  onchange="calculate_llwi(this.value)" id="late_login_without_info" class="input_radio" value="yes"> No<input type="radio" name="late_login_without_info" onchange="calculate_llwi(this.value)" id="late_login_without_info" class="input_radio" value="no"> </td>
                            ...
                            <tr>
                                ...
                                <td>Yes<input type="radio" name="absent_without_info" id="absent_without_info" onchange="calculate_awi(this.value)" class="input_radio" value="yes"> No<input type="radio" name="absent_without_info" id="absent_without_info" onchange="calculate_awi(this.value)" class="input_radio" value="no"> </td>
                            ...
                            <tr>
                                ...
                                <td>Yes<input type="radio" name="early_checkout_info" id="early_checkout_info" onchange="calculate_ecwi(this.value)" class="input_radio" value="yes"> No<input type="radio" name="early_checkout_info" id="early_checkout_info" onchange="calculate_ecwi(this.value)" class="input_radio" value="no"></td>
                            ...
                            <tr>
                                ...
                                <td>Yes<input type="radio" name="misconduct_with_staff" id="misconduct_with_staff" onchange="calculate_mws(this.value)" class="input_radio" value="yes"> No<input type="radio" name="misconduct_with_staff" id="misconduct_with_staff" onchange="calculate_mws(this.value)" class="input_radio" value="no"></td>
                            ...
                            <tr>
                                ...
                                <td>Yes<input type="radio" name="misconduct_with_student" id="misconduct_with_student" onchange="calculate_mwst(this.value)" class="input_radio" value="yes"> No<input type="radio" name="misconduct_with_student" id="misconduct_with_student" onchange="calculate_mwst(this.value)" class="input_radio" value="no"> </td>
                            ...
                            <tr>
                                ...
                                <td>Yes<input type="radio" name="logsheet_not_checked" id="logsheet_not_checked" onchange="calculate_lnc(this.value)" class="input_radio" value="yes"> No<input type="radio" name="logsheet_not_checked" id="logsheet_not_checked" onchange="calculate_lnc(this.value)" class="input_radio" value="no"> </td>
                            ...
                            <tr>
                                <td>Other Issue</td>
                                <td>Yes<input type="radio" name="other_issue" id="other_issue" onchange="calculate_oi(this.value)" class="input_radio" value="yes"> No<input type="radio" name="other_issue" id="other_issue" onchange="calculate_oi(this.value)" class="input_radio" value="no"> </td>
                ...
                <tr>
                    ...
                    <td>
                        <textarea type="text" name="comments" style="height:50px" class="input_text" id="comments" title="comments" value="<?php if($_POST['comments']) echo $_POST['comments']; else echo $row_record['comments']; ?>"> </textarea>
                    </td>
                </tr>
                <tr>
