...
<?php
	...
	$sql_query= "select * from site_setting where 1 and (type='C' or type='A') and system_status='Enabled' and email='isas.sadiya@gmail.com' ".$branch_id."  ".$pre_keyword." "; 
	...
	while($val_query=mysql_fetch_array($ptr_db))
	{
		...
		$sql_query= "select * from site_setting where 1 and (type='C' or type='A') and admin_id='".$data_main_query['admin_id']."' and system_status='Enabled' ".$branch_id."  ".$pre_keyword." "; 
		$ptr_db=mysql_query($sql_query);*/
	...
	$subject ="Hi ".$val_query['name']." Your Today's Daily Stack Report Is Ready";
	...
	//===================================================//21-12-17=====================================================
		...
		try {
				...
				echo $emailss=trim($val_query['email']);
				$mail->addCC("$emailss"); 
				...
				$mail->Subject = 'Hi '.$val_query['name'].' Your Today`s Daily Stack Report Is Ready ';
