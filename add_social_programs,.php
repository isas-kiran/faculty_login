...
if($_REQUEST['record_id'])
{
    ...
    $sql_record= "SELECT * FROM bp_pages where page_id='".$record_id."'";
  ...
  <tr>
                               ...
                               if($record_id)
                                {
                                   ///print_r($data_record); //    exit;
                                    $where_record=" page_id='".$record_id."'";
                                    $db->query_update("pages", $data_record,$where_record);
                                    echo '<br></br><div id="msgbox" style="width:40%;">Record updated successfully</center></div><br></br>';
                                }
                                else
                                {
                                    $data_record['added_date'] =date("Y-m-d H:i:s");
                                    $record_id=$db->query_insert("pages", $data_record);
	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%">
              ...
              <tr>
                ...
                <td width="70%"><input type="text"  class="validate[required] input_text" name="title" id="title" value="<?php if($_POST['save_changes']) echo $_POST['title']; else echo $row_record['page_title'];?>" /></td> 
                <td width="10%"></td>
              </tr>
             <tr>
