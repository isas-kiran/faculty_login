...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <!-- ================================================Start Table=============================================================================================-->
<?php
 $sql_query= "select inquiry_id,firstname,middlename,lastname, course_id from inquiry where inquiry_id = '$record_id'"; 
  ...
  <tr class="head_td">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="99%" align="center">
              <tr>
                ...
                <td  align="right"><a href="followup_summery.php?record_id= <?php echo $record_id; ?>"><input type="button" name="update_followup" value="Update Followup" /></a></td>
