...
<?php
	...
	try {
			...
			$mail->Subject = 'ISAS Ahmedabad Attendace is generated for Month '.$prv_month.' '.$year.'';
			$message='Hi, <br/>I would like to inform you that <b>"ISAS Ahmedabad"</b> Attendance is generated by system automatically for month '.$prv_month.' '.$year.' . Please check.';
