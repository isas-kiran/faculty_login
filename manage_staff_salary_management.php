...
<?php
$edit_access='';
$sel_acc="select * from edit_previleges where admin_id='".$_SESSION['admin_id']."' and privilege_id='220'";
...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  ...
  <tr class="head_td">
    ...
    <?php
						...
						$sql_query= "SELECT u.attendence_id,u.name,o.staff_salary_id,o.year,o.staff_id,o.month,o.days_in_month,o.final_paid_days,o.absent_days,o.days_in_month,o.per_day_amount,o.salary_to_be_paid,o.after_professional_tax,o.tds,o.advance_deduction,o.after_deduction,o.expence_deduction,o.after_expence_deduction,o.incentive_on_service,o.incentive_on_product,o.event_incentive,o.course_incentive,o.other_incentive,o.salary,o.working_days,o.branch_name FROM site_setting u, pr_staff_salary_management o where 1 ".$where." ".$pre_keyword." AND o.employee_id=u.admin_id ORDER BY o.staff_salary_id DESC"; 
							...
							<?php if($_SESSION['type']=='S' || $edit_access='yes')
                            {
								...
								while($val_query=mysql_fetch_array($all_records))
								{
									...
									*/
									...
									Final Paid Days :-  '.$val_query['final_paid_days'].'</br></td>';
									...
									<!--<td >
									<?php     
									/*if($val_query['payment_mode']=='Online') { ?>
