...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function show_bank(branch_id)
	{
		...
		var bank_data="action=inquiry&branch_id="+branch_id+"&admin_id="+<?php echo $_SESSION['admin_id']; ?>;
		//alert(bank_data);
		$.ajax({
          		...
          		<tr>
         			<td colspan="2"><form method="post" id="jqueryForm" name="jqueryForm" enctype="multipart/form-data" onSubmit="return validme()">
              			<table border="0" cellspacing="15" cellpadding="0" width="100%">
							...
							<tr>
								<?php
								$select_email_id= "select email from site_setting where 1 cm_id='".$_SESSION['cm_id']."' and type='A' and email !='' ";					$ptr_emails = mysql_query($select_email_id);
                			...
                			<?php }
                       		...
                       		<?php }?>
                				...
                				<tr>
									...
									<td width="44%"><input readonly="readonly" type="hidden" class="input_text datepicker" <?php echo $redonly; ?> name="inquiry_date" id="inquiry_date" 	value="<?php 
                        ...
                        <input type="radio" name ="lead_category" id="lead_category" value="walkin" <?php if($_POST['lead_category'] == "walkin") echo 'checked="checked"'; else if($row_record['lead_category'] == "walkin") echo 'checked="checked"'; ?> /> Walk-in</td>
                    			...
                    			<tr>
                                    ...
                                    <select id="course_id" name="course_id" onChange="ajax_course(this.value);" class="input_text">
                                       <option value="">Select</option>
                                       <?php
                    			...
                    			<tr>
                        			...
                        			<td width="44%"><input readonly="readonly" type="text" <?php echo $readonly; echo $bg;?> class=" input_text" name="total_fees" id="total_fees" value="<?php if($_POST['total_fees'])echo $_POST['total_fees']; else echo $row_record['total_fees'];?>"/></td>
                        			<td width="34%"></td>
                      			</tr>
                    			<tr>
                            ...
                            $(".custom_cuorse_submit").click(function(){
                                ...
                                $.ajax({
                                    ...
                                    success: function (html)
                                    {
                                        ...
                                        $("#total_fees").val(course_with_tax);
