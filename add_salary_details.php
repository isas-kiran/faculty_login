...
if($_REQUEST['record_id'])
{
    ...
    if(mysql_num_rows($db->query($sql_record)))
    	...
    	$record_id=0;
	$attendance_id=$row_record2['attendence_id'];
	$emp_id=$row_record2['admin_id'];
	
	$select_sallery_details="select * from pr_add_salary_details where employee_id='".$emp_id."' and cm_id='".$row_record2['cm_id']."'";
	$sallery_details=mysql_query($select_sallery_details);
	$row_record=mysql_fetch_array($sallery_details);
	
	$select_sallery_details1="select * from pr_add_incentive_details where employee_id='".$emp_id."' and admin_id='".$record_id."'";
...
function validme()
{
	...
	if(frm.travelling_allowance.value=='')
	{
		disp_error +='Enter Travelling Allowance \n';
		document.getElementById('travelling_allowance').style.border = '1px solid #f00';
		frm.travelling_allowance.focus();
		error='yes';
	}
	...
	if(frm.esic.value=='')
	{
		...
		document.getElementById('esic').style.border = '1px solid #f00';
		frm.esic.focus();
		error='yes';
	}
	...
	if(frm.total_salary.value!=frm.salary.value)
	{
		disp_error +='Gross Salary and Total Salary should not match \n';
		document.getElementById('salary').style.border = '1px solid #f00';
		frm.salary.focus();
		document.getElementById('total_salary').style.border = '1px solid #f00';
		frm.total_salary.focus();
		error='yes';
	}
	if(error=='yes')
	{
    ...
    <table width="100%" cellspacing="0" cellpadding="0">  
        <?php
				...
				if($_POST['save_changes'])
				{
					...
					$basic_sal_type=( ($_POST['basic_sal_type'])) ? $_POST['basic_sal_type'] : "";
					$basic_sal_per=( ($_POST['basic_sal_per'])) ? $_POST['basic_sal_per'] : "";
					$house_rent_type=( ($_POST['house_rent_type'])) ? $_POST['house_rent_type'] : "";
					$house_rent_per=( ($_POST['house_rent_per'])) ? $_POST['house_rent_per'] : "";
					$house_rent_allowance=( ($_POST['house_rent_allowance'])) ? $_POST['house_rent_allowance'] : "0";
					$traveling_type=( ($_POST['traveling_type'])) ? $_POST['traveling_type'] : "0";
					...
					$education_type=( ($_POST['education_type'])) ? $_POST['education_type'] : "0";
					$education_per=( ($_POST['education_per'])) ? $_POST['education_per'] : "0";
					$education_allowance=( ($_POST['education_allowance'])) ? $_POST['education_allowance'] : "0";
					$medical_type=( ($_POST['medical_type'])) ? $_POST['medical_type'] : "0";
					$medical_per=( ($_POST['medical_per'])) ? $_POST['medical_per'] : "0";
					$medical_allowance=( ($_POST['medical_allowance'])) ? $_POST['medical_allowance'] : "0";
					$executive_type=( ($_POST['executive_type'])) ? $_POST['executive_type'] : "0";
					$executive_per=( ($_POST['executive_per'])) ? $_POST['executive_per'] : "0";
					$executive_allowance=( ($_POST['executive_allowance'])) ? $_POST['executive_allowance'] : "0";
					$special_allowance1_type=( ($_POST['special_allowance1_type'])) ? $_POST['special_allowance1_type'] : "0";
					$special_allowance_1_per=( ($_POST['special_allowance_1_per'])) ? $_POST['special_allowance_1_per'] : "0";
					$special_allowance_1=( ($_POST['special_allowance_1'])) ? $_POST['special_allowance_1'] : "0";
					$total_salary=( ($_POST['total_salary'])) ? $_POST['total_salary'] : "";
					$proffessional_tax=( ($_POST['proffessional_tax'])) ? $_POST['proffessional_tax'] : "0";
					$esic=( ($_POST['esic'])) ? $_POST['esic'] : "0";
					$esic_cal=( ($_POST['esic_cal'])) ? $_POST['esic_cal'] : "";
					$pf_cal=( ($_POST['pf_cal'])) ? $_POST['pf_cal'] : "";
					$pf_basis=( ($_POST['pf_basis'])) ? $_POST['pf_basis'] : "0";
					$pf=( ($_POST['pf'])) ? $_POST['pf'] : "0";
					$tds=( ($_POST['tds'])) ? $_POST['tds'] : "0";
					$after_dedduction_salary=( ($_POST['after_dedduction_salary'])) ? $_POST['after_dedduction_salary'] : "0";
                    ...
                    else
                    {
						...
						$data_record['basic_sal_type']=$basic_sal_type;
						$data_record['basic_sal_per']=$basic_sal_per;
						$data_record['house_rent_type']=$house_rent_type;
						$data_record['house_rent_per']=$house_rent_per;
						$data_record['house_rent_allowance']=$house_rent_allowance;
						
						$data_record['traveling_type']=$traveling_type;
						$data_record['travelling_per']=$travelling_per;
						$data_record['travelling_allowance']=$travelling_allowance;
						$data_record['education_type'] = $education_type;
						$data_record['education_per'] = $education_per;
						$data_record['education_allowance'] = $education_allowance;
						$data_record['medical_type'] = $medical_type;
						$data_record['medical_per'] = $medical_per;
						$data_record['medical_allowance'] = $medical_allowance;
						
						$data_record['special_allowance_type'] = $special_allowance1_type;
						$data_record['special_allowance_per'] = $special_allowance_1_per;
						$data_record['special_allowance'] = $special_allowance_1;
						$data_record['executive_type'] = $executive_type;
						$data_record['executive_per'] = $executive_per;
						...
						$data_record['esic_cal'] =$esic_cal;
						$data_record['pf_cal'] =$pf_cal;
						$data_record['esic'] =$esic;
						$data_record['pf_basis'] =$pf_basis;
						$data_record['pf'] =$pf;
						$data_record['tds'] =$tds;
                        $data_record['after_dedduction_salary'] =$after_dedduction_salary;
						...
						$data_record['added_date'] = $added_date;
						$data_record['staff_id'] = $_POST['staff_id'];
						$data_record['employee_id'] = $_GET['record_id'];
						$data_record['bank_name'] = $bank_name;
						
						//-------------------------------------
						$data_record1['staff_id'] = $_POST['staff_id'];
						$data_record1['employee_id'] = $_GET['record_id'];
					    ...
					    $cm_id=$row_record2['cm_id'];
						$data_record['cm_id']=$cm_id;
						$data_record['branch_name']=$row_record2['branch_name'];

						$for_update ="select * from pr_add_salary_details where employee_id='".$emp_id."' ";
						$ptr_fs = mysql_query($for_update);
						if(mysql_num_rows($ptr_fs)) 
						{						
							$where_record="employee_id='".$emp_id."'";
						...
						{					
							...
							$data_record1['record_id']=$attendance_id;
					...
					{
						$data_record3['c_from'] = $_POST['c_from'.$c];
						$data_record3['c_to'] = $_POST['c_to'.$c];
						$data_record3['c_percentage'] = $_POST['c_percentage'.$c];
						
						$data_record3['staff_id'] = $_REQUEST['admin1'];
						$data_record3['admin_id'] = $_SESSION['admin_id'];
						$data_record3['cm_id'] = $cm_id;
						$data_record3['record_id'] = $attendance_id;
						...
						{
							//echo ">>>>>>>>>>>>>>>>>>>>>>>>>>here";
							$insert_details1=$db->query_insert("pr_add_course_incentive_details", $data_record3);
                        }
					}
					echo '<br></br><div id="msgbox" style="width:40%;">Record Updated successfully</center></div><br></br>';		
                }
        			...
        			<form method="post" name="jqueryForm" id="jqueryForm" enctype="multipart/form-data" >
                    	...
                    	<table border="0" cellspacing="15" cellpadding="0" width="100%">
                            ...
                            <tr>
                            	...
                            	<td width="20%">
                                <input type="text" onKeyUp="getsalcal();" class="validate[required] input_text" name="salary" id="salary" value="<?php if($_POST['save_changes']) echo $_POST['salary']; else echo $row_record['salary'];?>" /></td> 
		                        <td width="40%"></td>
                        	</tr> 
                            <tr>
                                <td width="20%">Basic Salary<span class="orange_font"></span> <input  class="basic_sal_type" <?php if($_POST['basic_sal_type']=='percentage') echo 'checked="checked"'; else if($row_record['basic_sal_type']=='percentage') echo 'checked="checked"'; else echo 'checked="checked"'; ?> type="radio" onClick="getsalcal();" name="basic_sal_type" id="basic_sal_type" value="percentage" />in % <!--<input <?php //if($_POST['basic_sal_type']=='rupees') echo 'checked="checked"';else if($row_record['basic_sal_type']=='rupees') echo 'checked="checked"'; ?>  type="radio" onClick="getsalcal();" class="basic_sal_type" name="basic_sal_type" id="basic_sal_type" value="rupees" />in Rs/---></td>
                                <td width="20%"><input class="input_text"  onKeyUp="getsalcal();" type="text" name="basic_sal_per" id="basic_sal_per" value="<?php if($_POST['basic_sal_per'])echo $_POST['basic_sal_per'] ;else echo $row_record['basic_sal_per']; ?>" /></td>
                                <td width="40%">
                            ...
                            <tr>
                                <td width="20%">House Rent Allowance<span class="orange_font"></span> <input <?php if($_POST['house_rent_type']=='percentage') echo 'checked="checked"';else if($row_record['house_rent_type']=='percentage') echo 'checked="checked"'; else echo 'checked="checked"'; ?> onClick="getsalcal();" type="radio" name="house_rent_type" id="house_rent_type" value="percentage" />in % <!--<input <?php //if($_POST['house_rent_type']=='rupees') echo 'checked="checked"';else if($row_record['house_rent_type']=='rupees') echo 'checked="checked"'; ?> onClick="getsalcal();" type="radio" name="house_rent_type" id="house_rent_type" value="rupees" />in Rs/---></td>
                                <td width="20%"><input class="input_text" onKeyUp="getsalcal();" type="text" name="house_rent_per" id="house_rent_per" value="<?php if($_POST['house_rent_per'])echo $_POST['house_rent_per'] ;else echo $row_record['house_rent_per']; ?>" /></td>
                                <td width="40%"><input type="text" class="validate[required] input_text" readonly="readonly" onKeyUp="get_total();" name="house_rent_allowance" id="house_rent_allowance" value="<?php if($_POST['save_changes']) echo $_POST['house_rent_allowance']; else echo $row_record['house_rent_allowance'];?>" /></td>
                            </tr> 
                            <tr>
                                <td width="20%">Conveyance Allowance<span class="orange_font"></span> <input <?php if($_POST['traveling_type']=='percentage') echo 'checked="checked"';else if($row_record['traveling_type']=='percentage') echo 'checked="checked"'; else echo 'checked="checked"'; ?> onClick="getsalcal();" type="radio" name="traveling_type" id="traveling_type" value="percentage" />in %<input <?php if($_POST['traveling_type']=='rupees') echo 'checked="checked"';else if($row_record['traveling_type']=='rupees') echo 'checked="checked"'; ?> type="radio" onClick="getsalcal();" name="traveling_type" id="traveling_type" value="rupees" />in Rs/-</td>
                                <td width="20%"><input class="input_text" onKeyUp="getsalcal();" type="text" name="travelling_per" id="travelling_per" value="<?php if($_POST['travelling_per'])echo $_POST['travelling_per'] ;else echo $row_record['travelling_per'];?>" /></td>
                                <td width="40%">
                                    <input type="text" class="input_text" readonly="readonly" onKeyUp="get_total();" name="travelling_allowance" id="travelling_allowance" value="<?php if($_POST['save_changes']) echo $_POST['travelling_allowance']; else echo $row_record['travelling_allowance'];?>" />
                                </td>
                            </tr>
                            <tr>
                                <td width="20%">Education Allowance <input <?php if($_POST['education_type']=='percentage') echo 'checked="checked"';else if($row_record['education_type']=='percentage') echo 'checked="checked"'; else echo 'checked="checked"'; ?> type="radio" onClick="getsalcal();"  name="education_type" id="education_type" value="percentage" />in %<input type="radio" <?php if($_POST['education_type']=='rupees') echo 'checked="checked"';else if($row_record['education_type']=='rupees') echo 'checked="checked"'; ?> onClick="getsalcal();" name="education_type" id="education_type" value="rupees" />in Rs/-</td>
                                <td width="20%"><input class="input_text" onKeyUp="getsalcal();" type="text" name="education_per" id="education_per" value="<?php if($_POST['education_per'])echo $_POST['education_per'] ;else echo $row_record['education_per'];?>" /></td>
                                <td width="40%">
                                    <input type="text" class="input_text" readonly="readonly" onKeyUp="get_total();" name="education_allowance" id="education_allowance" value="<?php if($_POST['save_changes']) echo $_POST['education_allowance']; else echo $row_record['education_allowance'];?>" />
                                </td> 
                            </tr>
                            <tr>
                                <td width="20%">Medical Allowance <input <?php if($_POST['medical_type']=='percentage') echo 'checked="checked"';else if($row_record['medical_type']=='percentage') echo 'checked="checked"'; else echo 'checked="checked"'; ?> type="radio" onClick="getsalcal();" name="medical_type" id="medical_type" value="percentage" />in %<input type="radio" <?php if($_POST['medical_type']=='rupees') echo 'checked="checked"';else if($row_record['medical_type']=='rupees') echo 'checked="checked"';?> onClick="getsalcal();" name="medical_type" id="medical_type" value="rupees" />in Rs/-</td>
                                <td width="20%"><input class="input_text" onKeyUp="getsalcal();" type="text" name="medical_per" id="medical_per" value="<?php if($_POST['medical_per'])echo $_POST['medical_per'] ;else echo $row_record['medical_per'];?>" /></td>
                                <td width="40%">
                                    <input type="text" class="input_text" readonly="readonly" onKeyUp="get_total();" name="medical_allowance" id="medical_allowance" value="<?php if($_POST['save_changes']) echo $_POST['medical_allowance']; else echo $row_record['medical_allowance'];?>" />
                                </td>
                            </tr>
                            <tr>
                                <td width="20%">Executive Allowance <input <?php if($_POST['executive_type']=='percentage') echo 'checked="checked"';else if($row_record['executive_type']=='percentage') echo 'checked="checked"'; else echo 'checked="checked"'; ?> type="radio" onClick="getsalcal();" name="executive_type" id="executive_type" value="percentage" />in %<input type="radio" <?php if($_POST['executive_type']=='rupees') echo 'checked="checked"';else if($row_record['executive_type']=='rupees') echo 'checked="checked"'; ?> onClick="getsalcal();" name="executive_type" id="executive_type" value="rupees" />in Rs/-</td>
                                <td width="20%"><input class="input_text" onKeyUp="getsalcal();" type="text" name="executive_per" id="executive_per" value="<?php if($_POST['executive_per'])echo $_POST['executive_per'] ;else echo $row_record['executive_per'];?>" /></td>
                                <td width="40%">
                                    <input type="text" class="input_text" readonly="readonly" onKeyUp="get_total();" name="executive_allowance" id="executive_allowance" value="<?php if($_POST['save_changes']) echo $_POST['executive_allowance']; else echo $row_record['company_allowance'];?>" />
                                </td> 
                                <td width="40%"></td>
                            </tr>
                            <tr>
                                <td width="20%">Special Allowance <input <?php if($_POST['special_allowance1_type']=='percentage') echo 'checked="checked"';else if($row_record['special_allowance_type']=='percentage') echo 'checked="checked"'; else echo 'checked="checked"'; ?> onClick="getsalcal();" type="radio" name="special_allowance1_type" id="special_allowance1_type" value="percentage" />in %<input <?php if($_POST['special_allowance1_type']=='rupees') echo 'checked="checked"';else if($row_record['special_allowance_type']=='rupees') echo 'checked="checked"'; ?> type="radio" onClick="getsalcal();" name="special_allowance1_type" id="special_allowance1_type" value="rupees" />in Rs/-</td>
                                <td width="20%"><input readonly="readonly" class="input_text" onKeyUp="getsalcal();" type="text" name="special_allowance_1_per" id="special_allowance_1_per" value="<?php if($_POST['special_allowance_1_per'])echo $_POST['special_allowance_1_per'] ;else echo $row_record['special_allowance_per'];?>" /></td>
                            ...
                            <tr>
                                ...
                                <td width="20%">
                                    <input type="text"  onKeyUp="getsalcal();" class="input_text" name="proffessional_tax" id="proffessional_tax"  value="<?php if($_POST['proffessional_tax']) echo $_POST['proffessional_tax']; else if($row_record['proffessional_tax']>0) echo $row_record['proffessional_tax']; else echo 0;?>" />
                                </td> 
                                <td width="40%"></td>
                            </tr>
                            <tr>
                                <td width="20%">ESIC<span class="orange_font"></span> <input type="radio" onclick="getsalcal()" name="esic_cal" id="esic_cal2" <?php if($_POST['esic_cal']=='yes') echo 'checked="checked"';else if($row_record['esic_cal']=='yes') echo 'checked="checked"'; else echo 'checked="checked"'; ?> value="yes" />Yes &nbsp;<input type="radio" onclick="getsalcal()" <?php if($_POST['esic_cal']=='no') echo 'checked="checked"';else if($row_record['esic_cal']=='no') echo 'checked="checked"';  ?> name="esic_cal" id="esic_cal1" value="no" />No</td>
                                <td width="20%">
                                    <input type="text" <?php if($_SESSION['type']!='S') echo 'readonly="readonly"' ?> class="input_text" name="esic" id="esic" onKeyUp="getsalcal();" value="<?php if($_POST['save_changes']) echo $_POST['esic']; else echo $row_record['esic'];?>" />
                                </td> 
                                <td width="40%">Salary <= 21000</td>
                            </tr>
                            <tr>
                                <td width="20%">Basic of PF<span class="orange_font"></span></td>
                                <td width="20%">
                                    <input type="text" readonly="readonly" class="input_text" name="pf_basis" id="pf_basis" value="<?php if($_POST['save_changes']) echo $_POST['pf_basis']; else echo $row_record['pf_basis'];?>" />
                                </td> 
                                <td width="40%"></td>
                            </tr>
                            <tr>
                                <td width="20%">PF @ 12%<span class="orange_font"></span><input type="radio" onclick="getsalcal()" name="pf_cal" id="pf_cal2" <?php if($_POST['pf_cal']=='yes') echo 'checked="checked"'; else if($row_record['pf_cal']=='yes') echo 'checked="checked"';  else echo 'checked="checked"'; ?> value="yes" />Yes &nbsp;<input type="radio" onclick="getsalcal()" <?php if($_POST['pf_cal']=='no') echo 'checked="checked"';else if($row_record['pf_cal']=='no') echo 'checked="checked"';  ?> name="pf_cal" id="pf_cal1" value="no" />No</td>
                                <td width="20%">
                                <input type="text" class="input_text" readonly="readonly" name="pf" id="pf" value="<?php if($_POST['save_changes']) echo $_POST['pf']; else echo $row_record['pf'];?>" />
                                </td> 
                                <td width="40%">Salary <= 15000</td>
                            </tr>
                            <tr>
                                <td width="20%">Total Deduction<span class="orange_font"></span></td>
                                <td width="20%" id="total_deduction"></td> 
                                <td width="40%"></td>
                            </tr>
                            <tr>
                                <td width="20%">After Diduction <span class="orange_font"></span></td>
                                <td width="20%" id="after_diduction"></td> 
                                <td width="40%"></td>
                            </tr>
                            <tr>
                                <td width="20%">Income Tax (TDS)<span class="orange_font"></span></td>
                                <td width="20%">
                                    <input type="text" onKeyUp="getsalcal();" class="input_text" name="tds" id="tds" value="<?php if($_POST['save_changes']) echo $_POST['tds']; else echo $row_record['tds'];?>" />
                                </td> 
                                <td width="40%"></td>
                            </tr>            
                            <tr>
                                <td width="20%">After Deduction (Net Salary)<span class="orange_font"></span></td>
                                <td width="20%">
                                    <input type="text" readonly="readonly" class="input_text" name="after_dedduction_salary" id="after_dedduction_salary" value="<?php if($_POST['save_changes']) echo $_POST['after_dedduction_salary']; else echo $row_record['after_dedduction_salary'];?>" />
                                </td> 
                                <td width="40%"></td>
                            </tr>
                            ...
                            <tr>
			             	...
			             	<tr>
                                ...
                                <td width="20%">
                                    <input type="text" class="input_text" name="pan_number" id="pan_number" maxlength="10" size="10" value=" <?php if($_POST['save_changes']) echo $_POST['pan_number']; else echo $row_record['pan_number'];?>" />
                                </td> 
                                <td width="40%"></td>
                            </tr>
                            ...
                            <?php 
                            $for_update2 = "select * from pr_add_course_incentive_details where staff_id = '".$emp_id."' order by c_id asc";
                            ...
                            else
                            {
                                ...
                                <td align="right">
                                <input type="button" name="Add"  class="addBtn" onClick="javascript:create_type2('add_type2');" alt="Add(+)" > 
                                <input type="button" name="Add"  class="delBtn"  onClick="javascript:create_type2('delete_type2');" alt="Delete(-)" >
                                </td></tr>
                                <input type="hidden" name="total_type2" id="total_type2"  value="0" />
                                <?php 
                            }?>
                            <tr><td align="center" width="25%" ><div id="create_type2"></div> </td><td width="10%"> </td><td width="5%"> </td></tr>
                            </table>
                            </td>
                        </tr>
                        <!--=================================END TABLE for Course================================-->  
                        ...
                        <tr>
							<td colspan="2">
                                    ...
                                    <table width="100%" border="0" class="tbl" bgcolor="#CCCCCC" align="center"><tr><td align="center"></td><td align="center"></td><td align="center"></td></tr>
                                    <?php 
                                    $for_update1 = "select * from pr_add_service_incentive_details where staff_id = '".$emp_id."' order by s_id asc";
                                    $ptr_fs1 = mysql_query($for_update1);
									...
									else
									{
                                        ...
                                        <td align="left"><input type="button" name="Add"  class="addBtn" onClick="javascript:create_floor('add');" alt="Add(+)" > 
                                ...
                                <!--============================NEW TABLE 2 START===========================-->   
                               	<!--<tr>
                                	<td width="10%"><strong>Course Incentive</strong><span class="orange_font">*</span></td>
                                </tr>
                                <tr>
                    				<td colspan="2">
                                    ...
                                    <tr>
                                        ...
                                        function type1(idss)
                                        {
                                        	//res_tax= document.getElementById("res_tax").value;
                                            //alert(idss);
                                            var shows_data='<div id="type1_id'+idss+'"><table cellspacing="3" id="tbl'+idss+'" width="100%"><tr><td valign="top" width="10%"><input type="hidden" name="exclusive_id'+idss+'" id="exclusive_id'+idss+'" value="" />From</td><td valign="top" width="10%" ><input type="text" name="c_from'+idss+'" id="c_from'+idss+'" /></td><td style="width:10%;">To</td><td valign="top" width="10%" ><input type="text" name="c_to'+idss+'" id="c_to'+idss+'" /></td><td style="width:10%;">Percentage</td><td valign="top" width="10%" ><input type="text" name="c_percentage'+idss+'" id="c_percentage'+idss+'" /></td><input type="hidden" name="row_deleted'+idss+'" id="row_deleted'+idss+'" value="" /><tr></table></div>';
                                        	...
                                        	<td colspan="7">
                                            	<table cellspacing="3" id="tbl" width="100%">
                                                    ...
                                                    <tr>
                                                        <td colspan="7">
                                                        <?php
                                                        /*$select_exc = "select * from pr_add_course_incentive_details where record_id = '".$_REQUEST['record_id']."' order by c_id asc";
                                                        ...
                                                        { 
                                                            $slab_id= $data_exclusive['c_id'];
                                                            ?> 
                                                            <div class="type1" id="type1_id<?php echo $s; ?>">
                                                            <table cellspacing="5" id="tbl<?php echo $s; ?>" width="100%">
                                                                <tr>
                                                                    <td width="8%" align="center">From &nbsp;&nbsp;&nbsp;
                                                                    <input type="text" name="c_from<?php echo $s; ?>" id="c_from<?php echo $s; ?>" style=" width:100px" value="<?php echo $data_exclusive['c_from'] ?>" />
                                                                    </td>
                                                                    <td width="8%" align="center">To &nbsp;&nbsp;&nbsp;
                                                                    <input type="text" name="c_to<?php echo $s; ?>" id="c_to<?php echo $s; ?>" style=" width:100px" value="<?php echo $data_exclusive['c_to'] ?>" />
                                                                    </td>
                                                                    <td width="8%" align="center">Percentage &nbsp;&nbsp;&nbsp;
                                                                    <input type="text" name="c_percentage<?php echo $s; ?>" id="c_percentage<?php echo $s; ?>" style=" width:100px" value="<?php echo $data_exclusive['c_percentage'] ?>" />
                                                                    </td>
                                                                    ...
                                                                    {
                                                                        ?>
                                                                        <input type="hidden" name="total_course[]" id="total_course<?php echo $s; ?>" />
                                                                        <input type="hidden" name="type1_id<?php echo $s; ?>" id="type1_id<?php echo $s; ?>" value="<?php echo $data_exclusive['inv_tax_map_id'] ?>" />
                                                                        <input type="button" title="Delete Options(-)" onClick="delete_course(<?php echo $s; ?>,'total_type1');" class="delBtn" name="del">
                                    ...
                                    <tr>
                                        ...
                                        <tr>
                                        	<td align="center" width="25%" ><div id="create_type1"></div> </td><td width="10%"> </td><td width="5%"> </td>
                                        </tr>
                                        </table>
                                    </td>
                                    </tr>-->
...
function get_total()
{
	...
	var house_rent =$("#house_rent_allowance").val();
	var travelling_allowance =$("#travelling_allowance").val();
	var medical_allowance =$("#medical_allowance").val();
	var special_allowance =$("#special_allowance_1").val();
	var company_allowance =$("#special_allowance_2").val();
	
	var total = Number(parseInt(basic_sal)+parseInt(house_rent)+parseInt(travelling_allowance)+parseInt(medical_allowance)+parseInt(special_allowance)+parseInt(company_allowance));
...
function getsalcal()
{
	...
	var education_per =$("#education_per").val();
	var executive_per =$("#executive_per").val();
	var special_allowance_1_per =$("#special_allowance_1_per").val();
	
	var travelling_allowance =$("#travelling_allowance").val();
    var medical_allowance =$("#medical_allowance").val();
	var special_allowance1 =$("#special_allowance1").val();
	var executive_allowance =$("#executive_allowance").val();
	
	var basic_sal_type =frm.basic_sal_type.value;
	
	//var basic_sal_type =$(".basic_sal_type").val();
	var house_rent_type =frm.house_rent_type.value; //$("#house_rent_type").val();
	var traveling_type =frm.traveling_type.value; //$("#traveling_type").val();
	var education_type =frm.education_type.value; //$("#education_type").val();
	var medical_type =frm.medical_type.value; //$("#medical_type").val();
	var executive_type =frm.executive_type.value; //$("#executive_type").val();
	var special_allowance1_type =frm.special_allowance1_type.value; //$("#special_allowance1_type").val();
	
	//alert(basic_sal_type);
	...
	{
	    var hr=(b_salary*house_rent_per)/100;	
	}
	$('#house_rent_allowance').val(hr);
	//alert(traveling_type);
	...
	if(education_type=="rupees")
	{
	    var ed=parseFloat(education_per);
	}
	else
	{
		var ed=(salary*education_per)/100;
	}
	$('#education_allowance').val(ed);
	...
	if(executive_type=="rupees")
	{
	    var sp2=parseFloat(executive_per);
	}
	else
	{
	    var sp2=(salary*executive_per)/100;	
	}
	$('#executive_allowance').val(sp2);
	
	/*if(special_allowance1_type=="rupees")
	{
	    var sp1=parseFloat(special_allowance_1_per);
	}
	else
	{
	    var sp1=(salary*special_allowance_1_per)/100;	
	}*/
	var special_all=parseFloat(salary)- (parseFloat(b_salary)+parseFloat(hr)+parseFloat(tr)+parseFloat(ed)+parseFloat(md)+parseFloat(sp2));
	$('#special_allowance_1_per').val(special_all);
	$('#special_allowance_1').val(special_all);
	//alert(special_all);
	var total_salary=parseFloat(b_salary)+parseFloat(hr)+parseFloat(tr)+parseFloat(ed)+parseFloat(md)+parseFloat(special_all)+parseFloat(sp2);
	$('#total_salary').val(total_salary);
	
	var proffessional_tax =frm.proffessional_tax.value;
	
	var esic_cal =frm.esic_cal.value;
	if(esic_cal=="yes")
	{
		var esic=0;
		if(salary <=21000)
		{
			esic=(total_salary*0.75)/100;	
		}
		$('#esic').val(esic);
	}
	else
	...
	pf_basis=parseInt(b_salary+tr+ed+md+sp2+sp1);
	$('#pf_basis').val(pf_basis);
	//alert(pf_basis);
	var pf_cal =frm.pf_cal.value;
	if(pf_cal=="yes")
	{
		var pf=0;
		if(pf_basis <=15000)
		{
			pf=Number(parseInt(pf_basis*0.12));	
		}
		$('#pf').val(pf);
	}
	else
	...
	//alert(proffessional_tax+'--'+esic+'--'+pf);
	var total_deductions=parseInt(proffessional_tax)+parseInt(esic)+parseInt(pf);
	//alert(total_deductions);
	$('#total_deduction').html(total_deductions);
	
	var after_diduction = parseInt(total_salary - total_deductions);
	
	$('#after_diduction').html(after_diduction);
	
	var tds =frm.tds.value;
	var after_dedduction_salary= parseInt(after_diduction-tds);
	$('#after_dedduction_salary').val(after_dedduction_salary);
	//alert(total_salary);
