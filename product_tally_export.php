 ...
 $objPHPExcel->setActiveSheetIndex()->setCellValueByColumnAndRow('3','3', 'Mo No','3');
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValueByColumnAndRow('13','3', 'Status','3');*/
	...
	while($val_query=mysql_fetch_array($query_order))
	{
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('C'.$rowCount, 'Product');
		...
		if($tot_prod=mysql_num_rows($ptr_prod))
		{
			while($data_prod=mysql_fetch_array($ptr_prod))
			{
				...
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('E'.$rowCount, 'Sales @ '.$data_prod['total_gst'].'%');	
		...
		if($tot_prod=mysql_num_rows($ptr_prod))
		{
			while($data_prod=mysql_fetch_array($ptr_prod))
			{
				...
				if($val_query['discount'] >0 && $val_query['discount_type']=='percentage')
				{
					$tot_disc=$data_prod['total_val'] * $val_query['discount'];
		...
		if($tot_prod=mysql_num_rows($ptr_prod))
		{
			while($data_prod=mysql_fetch_array($ptr_prod))
			{
				...
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('E'.$rowCount, 'Sales @ 0%');	
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('F'.$rowCount, 'Item');
				$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('G'.$rowCount, '1');
		...
		if($tot_cgst_num=mysql_num_rows($ptr_cgst_prod))
		{
			while($data_cgst=mysql_fetch_array($ptr_cgst_prod))
			{
				if($data_cgst['cgst_tax_in_per'] >0)
				{
					...
					$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('E'.$rowCount, 'Output CGST '.$data_cgst['cgst_tax_in_per'].'%');	
					...
					//$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('M'.$rowCount, number_format($data_cgst['cgst_total'],3,'.',''));
					$rowCount++;
					$total_amnts +=number_format($data_cgst['cgst_total'],3,'.','');
					$k++;
				}
			}
		}
		...
		if($tot_sgst_num=mysql_num_rows($ptr_sgst_prod))
		{
			while($data_sgst=mysql_fetch_array($ptr_sgst_prod))
			{
				if($data_sgst['sgst_tax_in_per'] >0)
				{
					...
					$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('E'.$rowCount, 'Output SGST '.$data_sgst['sgst_tax_in_per'].'%');	
					$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('F'.$rowCount, '');
					$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('G'.$rowCount, '');
					$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('H'.$rowCount, '');
					$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('I'.$rowCount, '');
					...
					//$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('M'.$rowCount, number_format($data_sgst['sgst_total'],3,'.',''));
					$rowCount++;
					$total_amnts +=number_format($data_sgst['sgst_total'],3,'.','');
					$k++;
				}
			}
		}
		...
		if($tot_igst_num=mysql_num_rows($ptr_igst_prod))
		{
			while($data_igst=mysql_fetch_array($ptr_igst_prod))
			{
				if($data_igst['igst_tax_in_per'] >0)
				{
					...
					$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('E'.$rowCount, 'Output IGST '.$data_igst['igst_tax_in_per'].'%');	
					$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('F'.$rowCount, '');
					$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('G'.$rowCount, '');
					$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('H'.$rowCount, '');
					$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('I'.$rowCount, '');
					...
					//$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('M'.$rowCount, number_format($data_igst['igst_total'],3,'.',''));
					$rowCount++;
					$total_amnts +=number_format($data_igst['igst_total'],3,'.','');
					$k++;
				}
			}
		}
		...
		//$valsn=$tot_disc_price_gst.'-'.$tot_disc_price_igst.'-'.$tot_cgst.'-'.$tot_sgst.'-'.$tot_igst;
		$tots_price=number_format($total_price,3,'.','');
		$diff= $total_actual - $tots_price;
		
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('J'.$rowCount, number_format($tot_disc_price_gst+$tot_disc_price_igst+$tot_cgst+$tot_sgst+$tot_igst,3,'.',''));
		//$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('M'.$rowCount, number_format($total_price,3,'.',''));
		//$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('N'.$rowCount, $diff);
		//$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('O'.$rowCount, $valsn);
		//==========================================================		
		$k++;
