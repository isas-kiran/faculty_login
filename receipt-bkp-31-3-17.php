    ...
    <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='receipt_id'))
                        {
                            ...
                            $select_directory='order by receipt_id desc';                      
                          	$sql_query= "SELECT * FROM receipt where 1  ".$_SESSION['where_admin_id']." ".$pre_keyword." ".$from_date." ".$to_date." and category !='cash_transfer' ".$select_directory." "; 
                       //echo $sql_query;
