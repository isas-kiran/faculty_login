...
function show_mobiles_no(value)
{
	//alert(value);
 ...
 <form method="get" id="jqueryForm1" name="jqueryForm1" enctype="multipart/form-data" action="add_cust_services.php" >
	<table border="0" cellspacing="15" cellpadding="0" width="100%">
        ...
        if($_POST['save_changes'])
		{
			...
			$customer_name=( ($_POST['customer_id'])) ? $_POST['customer_id'] : "0";
			$mobile=( ($_POST['realtxt'])) ? $_POST['realtxt'] : "";
			...
			if($payment_mode_id !="1" || $payment_mode_id !="3" ||$payment_mode_id !="5")
			{
				...
				$chaque_date=( ($_POST['chaque_date'])) ? $_POST['chaque_date'] : "";
			}
			$cm_id1='0';
			if($_SESSION['type']=='S')
			{
			...
			else
			{
				...
				if($record_id)
				{
					"</br>".$ins_cust="insert into customer(`branch_name`,`cust_name`,`mobile1`,`cm_id`,`added_date`) values ('".$branch_name."','".$customer_name."','".$mobile."','".$cm_id1."','".date('Y-m-d H:i:s')."')";
					...
					"</br>".$insert_cust_service_invoice = " INSERT INTO `customer_service_invoice` (`customer_service_id`, `service_price`, `total_cost`, `amount`, `payable_amount`,`remaining_amount`, `total_paid`,`paid_type`, `bank_id`, `cheque_detail`, `chaque_date`, `credit_card_no`, `admin_id`, `added_date`,`status`,`cm_id`) VALUES ('".$record_id."', '".$service_price."', '".$total_cost."', '".$amount."', '".$payable_amount."','".$remaining_amount."', '".$payable_amount."', '".$payment_mode_id."','".$bank_name."', '".$chaque_no."', '".$sep_check_date."','".$credit_card_no."', '".$_SESSION['admin_id']."', '".date('Y-m-d H:i:s')."','".$status."','".$cm_id1."'); ";
					...
					"<br>".$insert="INSERT INTO `log_history`(`category`, `action`, `name`, `id`, `date`, `cm_id`, `admin_id`) VALUES ('add_customer_service','Add','".$name."','".$ins_id."','".date('Y-m-d H:i:s')."','".$_SESSION['cm_id']."','".$_SESSION['admin_id']."')";
				...
				else
				{
					...
					"<br>".$insert="INSERT INTO `log_history`(`category`, `action`, `name`, `id`, `date`, `cm_id`, `admin_id`) VALUES ('add_customer_service','Add','".$fetch['cust_name']."','".$ins_id."','".date('Y-m-d H:i:s')."','".$_SESSION['cm_id']."','".$_SESSION['admin_id']."')";
					$query=mysql_query($insert);
        ...
        <div class="new_custom_course" style="display: none;">
            ...
            <table border="0" cellspacing="15" cellpadding="0" width="100%">
                      ...
                      <?php if($_SESSION['type']=='S')
                            ...
                            ?>
                              <tr>
                                ...
                                echo ' <select id="branch_name" name="branch_name" style="width:200px" class="input_text" onchange="show_bank(this.value)">';
					...
					<tr>
						...
						<td width="49%"><input type="text" name="sac_code" id="sac_code" style="width:200px" class="input_text" value="<?php if($_POST['sac_code']) echo $_POST['sac_code']; else echo $data_sac_code['sac_code']; ?>"  />
						</td>
					</tr>
					<tr>
						<td>Enter Mobile no.</td>
						<td><input type="text" id="realtxt" style="width:200px" class="input_text" name="realtxt" value="<?php if($_POST['realtxt']) echo $_POST['realtxt']; else echo $row_record['mobile']; ?>"></td>
					</tr> 
					<tr>
						<td width="20%" valign="top">Enter Customer Name<span class="orange_font">*</span></td>
						<td width="70%"  class="customized_select_box" id="sel_cust">
						<input type="text" name="customer_id" id="customer_id" class="input_text" style="width:200px;" value="<?php if($_POST['customer_id']) echo $_POST['customer_id']; else echo $row_record['name']; ?>">
						<td width="10%"></td>
					</tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <table  width="100%" style="border:1px solid gray; ">
                            ...
                            <table cellpadding="5" width="100%" >
                             ...
                             <script language="javascript">
                                        ...
                                        {
                                            var shows_data='<div id="floor_id'+idss+'"><table cellspacing="3" id="tbl'+idss+'" width="100%"><tr><td valign="top" width="21%" align="center"><input type="hidden" name="exclusive_id'+idss+'" id="exclusive_id'+idss+'" value="'+idss+'" /><select name="service_id'+idss+'" id="service_id'+idss+'" style="width:140px" onChange="getprice(this.value,'+idss+')"><option value="">Select Service</option><?php
											...
											$("#service_id"+idss+"").chosen({allow_single_deselect:true});
											$("#staff_id"+idss+"").chosen({allow_single_deselect:true});
                                            return shows_data;
						...
						<input type="hidden" name="total_service_time" id="total_service_time" value="<?php echo $total_service_time; ?>" />
                     </td>
                 </tr>
                     <tr>
                   ...
                   <!--============================================================END TABLE 2=========================================-->
                    ...
                    <tr>
                          <td>&nbsp;</td>
                          <td><input type="submit" class="input_btn"  value="Book Customer Service" name="save_changes"  /></td>
...

            {
                ...
                $(".customer_details_submit").click(function(){
        ...
        <div class="new_customer_add" style="display: none;">
            <form method="post" id="jqueryForm" name="discount" enctype="multipart/form-data">
                <table border="0" cellspacing="15" cellpadding="0" width="100%">
                    ...
                    <tr>
                        <td></td>
                        <td><input type="button" class="inputButton customer_details_submit" value="Submit" name="submit"/>&nbsp;
