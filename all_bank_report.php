...
<title>All Bank Summery Report</title>
              ...
              <tr>
                ...
                <!--<td width="20%">
                       ...
                       <!-- <td width="10%" align="center">
                        ...
                        <td><a href="all_bank_summury_report_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>  
            </tr>          
        </table>
        </form>	
    </td>
     ...
     <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='firstname'))
                        {
							...
							$branch_id='';
                       		    ...
                       		    "<br/>".$sql_query= "select * from bank_records where 1 ".$pre_keyword_i." ".$bank_ids." ".$paid_from_date." ".$paid_to_date." ".$select_directory." "; 
                     ...
                     <input type="hidden" name="formAction" id="formAction" value=""/>
                      <tr class="grey_td" >
						...
						<td width="10%" align="center">Credit</td>
							...
							<td width="10%" align="center">Debit</td>
                        ...
                        <td width="10%" align="center">Added Date</td>
							...
							//	$ptr_ins_amnt=mysql_query($sel_inst_amnt);
								...
								echo '<td align="center" width="10%">'.$val_query['type'].'</td>';
							...
							//	echo "<td width='10%' align='center'>".$data_inst_amnt['payment_mode']."</td>";
								...
								{
								echo "<td width='10%' align='center'>".$credit=$val_query['amount']."</td>";
								$totals_credit +=intval($credit);
								}
								else 
								{
								echo "<td width='10%' align='center'>0</td>";	
								}
								if($val_query['type']=='expense' || $val_query['type']=='purchase')
								{
								echo "<td width='10%' align='center'>".$debit=$val_query['amount']."</td>";
    ...
    <td colspan="15">
    	<table cellspacing="0" cellpadding="0" width="100%"  style="border:1 px solid #CCC; border-collapse:collapse">
        	<tr class="grey_td">
                ...
                <td width="60%" align="center" colspan="3"><strong>Total</strong></td>
				<td width="5%" align="center"><span style='color:green'><strong><?php echo $totals_credit; ?></strong></span></td>
				
				<td width="45%" align="center"><span style='color:red'><strong><?php echo $totals_debit; ?></strong></span></td>
            </tr>
    	</table>
    </td>
