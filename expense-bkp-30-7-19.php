...
<!---------------------------------------Payment mode------------------------------------->  
<?php 
//echo "added-date-".$row_expense['added_Date'];
    ...
    <?php				
						...
						if($_GET['record_id'] !='')
						{
							$record_cat_id="and expense_id='".$_GET['record_id']."' ";
                          	...
                          	$sql_query= "SELECT * FROM expense where 1 ".$record_cat_id." ".$where_expense." ".$_SESSION['where']." ".$pre_keyword." ".$from_date." ".$to_date." ".$select_directory." "; 
                       //echo $sql_query;
