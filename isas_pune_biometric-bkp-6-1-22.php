...
// date 6-1-2020
	...
	$sql_user = "select * from pr_pune_biometric_attendance where UserId='".trim($UserId)."' and ServiceTagId='".$ServiceTagId."' and DATE(PunchTime)='".date($ChkPunchTime)."' order by ID desc";
