...
<body>
    <div class="heightSpacer"></div>
        ...
        <tr>
        	<?php
			?>
            <td valign="top" width="185"><img src="images/<?php echo $logo; ?>" width="160" height="100" /></td>
            <td style="font-size:14px;">Receipt No: <?php echo $invoice_no; ?> <br/> 
            	Invoice No: <?php echo $row_record['customer_invoice_no']; ?> <br/> 
                Date : <?php echo $data_bill_master['added_date']; ?><br/>
                GST No : <?php echo $data_branch_name['gst_no']; ?>
            </td>
        </tr>
        <tr>
	...
	<table align="center" border="1px"  width="450" cellpadding="0" cellspacing="0" bgcolor="#EFEFEF" style=" border:1px solid;" >
        ...
        <table align="center" border="1px " width="450" cellpadding="5" cellspacing="5" bgcolor="#EFEFEF" style="border-left:solid 0.6mm; border-right:solid 0.6mm; border-collapse:collapse " >
            ...
            <?php
			if($row_record['gst_type']=='m_igst')
			{
				?>
				<tr>
					<td width="21%" align="left"  style="padding-left:10px; width:25%">IGST(<?php echo $row_record['igst_tax_in_percent']; ?>%)</td>
                    <td width="26%" width:20% align="center"><?php echo $row_record['igst_tax'];?></td>
				  </tr> 
				  <?php
			}
			else
			{ 
				if($row_record['cgst_tax'] >0 || $row_record['sgst_tax'] >0)
				{
					?>
					<tr>
						<td width="21%" align="left"  style="padding-left:10px; width:25%">CGST(<?php echo $row_record['cgst_tax_in_percent']; ?>%) + SGST(<?php echo $row_record['sgst_tax_in_percent'] ?>%)</td>
                        <td width="26%" width:20% align="center"><?php echo $row_record['cgst_tax'] + $row_record['sgst_tax'];?></td>
					</tr> 
					<?php
				}
				else if($row_record['service_tax_in_percent'] > 0)
				{
					?>
					<tr>
						<td width="21%" align="left" style="padding-left:10px; width:25%">VAT (<?php echo $row_record['service_tax_in_percent']; ?>%) </td>
                        <td width="26%" width:20% align="center"><?php echo $row_record['service_tax'] ?></td>
					</tr> 
					<?php
				}
			}
