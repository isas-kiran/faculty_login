			...
			function add_degree(no) //for add a degree
					 {
						...
						else
						{
					 	...
					 	var value='<div id="'+i+'"><table class="table_class" width="100%"  cellspacing="0" cellpadding="2"> <tr><td ><input type="text" name="topic_name'+i+'"class="input_text" /></td><td ><input type="text" name="duration'+i+'" class="input_text" /></td><td ><input type="text" name="description'+i+'"  class="input_text" /></td><td ><input type="file" name="course_pdf'+i+'" class="input_text" /></td><td><input type="file" name="course_video'+i+'" class="input_text"  /></td></tr></table></div> <div id="'+next+'"></div>';
                        ...
                        else
                        {
                          ...
                          /*  if($file_uploaded)
                            ...
                            else
                            {
									...
									$data_record_batch['subject_id']=$subject;
            ...
            <!--========================================================================-->
             <tr>
              ...
              <tr>
                ...
                <td width="20%"> Add Batch </td>.
                <td width="80%">
                <table width="802">
                <tr><td width="129">Topic Name </td><td width="129">Duration </td><td width="129">Description </td><td width="144">Pdf </td><td width="144">Video </td>
                <td width="150" > 
                ...
                <tr>
                <td> <input type="text" name="topic_name"  class="input_text" value="<?php if($_POST['save_changes']) echo $_POST['topic_name']; else echo $row_record['topic_name'];?>"/></td><td><input type="text" name="duration"  class="input_text" value="<?php if($_POST['save_changes']) echo $_POST['duration']; else echo $row_record['duration'];?>" /></td><td><input type="text" name="description"  class="input_text" value="<?php if($_POST['save_changes']) echo $_POST['description']; else echo $row_record['description'];?>" /></td>
                <?
				if(!$record_id)
				{
				?>
