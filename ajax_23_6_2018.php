...
//=============================================================EXPENSE CATEGORY==============================================================================
			if($action=='show_expense_cat')
			{
				...
				echo '<table width="93%"><tr>';
				if($_POST['type']!='for_exp_report') { echo '<td width="10%" align="center">Select Expense Type</td>'; } 
				echo '<td width="45%"><select name="expense_type" id="expense_type" style="width: 200px;">'; 
...
//=============================================================Campaign ==============================================================================
			if($action=='show_campaign')
			{
				...
				$sel_expense = "select * from campaign where branch_name='".$branch."'";
				$ptr_expense = mysql_query($sel_expense);
				
				
				echo '<select name="campaign_name" id="campaign_name" style="width: 200px;" class="input_select_login">'; 
			...
			if($action=='show_campaign_type')
			{
				...
				$type=$_POST['type'];
				$sel_expense = "select * from campaign where branch_name='".$branch."' and campaign_for='".$type."'";
				$ptr_expense = mysql_query($sel_expense);
...
if($action=='get_staff')
{
	...
	<?php
	echo $sel_staff = "select admin_id,attendence_id,name from site_setting where 1 AND attendence_id!='' AND branch_name='".$_POST['branch_name']."' order by attendence_id asc";	 
