...
<td style="text-align:right" > <a href="manage_paper.php"><input type="button" name="back" value="Back"/></a> </td>
<td colspan="2">
...
<img src="images/delete_icon.png" title="Delete Record" class="example-fade" /></a>&nbsp;&nbsp;                    
        ...
        <td></td>
       <td><?php echo $j; ?>)</td>
       <td ><font color="#00CC00"><?php  if($option_ans=='y')echo $option_title; else echo "No Answer Selected"; ?></font></td>
