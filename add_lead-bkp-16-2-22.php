            ...
            if(isset($_POST['submit']) && $_SESSION['name']!='')
            {
				...
				else
				{
					...
					else
					{
						...
						"<br>".$insert="INSERT INTO `log_history`(`category`, `action`, `name`, `id`, `date`, `cm_id`, `admin_id`) VALUES ('inquiry','Add_lead','".$firstname." ".$middlename." ".$lastname."','".$record_id."','".date('Y-m-d H:i:s')."','".$_SESSION['cm_id']."','".$_SESSION['admin_id']."')";
						$query=mysql_query($insert);    
						//---------Send Message-------------
