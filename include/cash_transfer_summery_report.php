     ...
     <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='firstname'))
                        {
							...
							$branch_id='';
                       		   ...
                       		   "<br/>".$sql_query= "select * from receipt where 1 ".$search_cm_id." ".$pre_keyword_i." ".$pay_type." ".$bank_ids." ".$paid_from_date." ".$paid_to_date." ".$select_directory." "; 
				...
				<form method="post"  name="frmTakeAction"  action="<?php echo $_SERVER['PHP_SELF'].'?#msgbox';?>">
                     <input type="hidden" name="formAction" id="formAction" value=""/>
                      <tr class="grey_td" >
						...
						<td width="20%" align="center"><strong>Expense Details</strong></td>
                        ...
                        <td width="10%" align="center">Added Date</td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                                ...
                                echo '<tr '.$bgcolor.'>';
								 ...
								 "<br/>".$sel_name="select name from site_setting where admin_id='".$val_query['employee_id']."'";
								...
								echo '<td align="center" width="20%">'.$val_query['category'].'</td>';
