...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
		...
		if($_POST['formAction'])
		{
			if($_POST['formAction']=="delete")
			{
				for($r=0;$r<count($_POST['chkRecords']);$r++)
				{
					...
					$sql_query= "SELECT voucher_id FROM ".$GLOBALS["pre_db"]."voucher where voucher_id ='".$del_record_id."'";
                ...
                <table  width="75%" style="border:1px solid gray; ">
                    ...
                    <table cellpadding="5" width="100%" >
                     ...
                     <script language="javascript">
                                ...
                                {
                                    var shows_data='<div id="floor_id'+idss+'"><table cellspacing="3" id="tbl'+idss+'" width="100%"><tr><td valign="top" width="4%" align="center"><input type="hidden" name="exclusive_id'+idss+'" id="exclusive_id'+idss+'" value="'+idss+'" /><select name="service_id'+idss+'" id="service_id'+idss+'" style="width:140px"><option value="">Select Service</option><?php
									...
									if($total=mysql_num_rows($query_tel))
									{
									 ...
									 ?>
									 </select></td><td width="3%" align="center"><input type="text" name="service_qty'+idss+'" id="service_qty'+idss+'" style=" width:100px" /></td><td valign="top" width="8%" align="center"><input type="hidden" name="total_services[]" id="total_services'+idss+'" /></td><input type="hidden" name="row_deleted'+idss+'" id="row_deleted'+idss+'" value="" /><tr></table></div>';
    ...
    <tr>
                              ...
                              <tr>
                                <td width="34%" align="center"><table cellspacing="5" id="tbl<?php echo $t; ?>2" width="100%">
                                  <tr>
                                    ...
                                    <select name="service_id<?php echo $t; ?>" id="service_id<?php echo $t; ?>" style="width:140px" >
                                    ...
                                    <td width="34%" align="center"><input type="text" name="service_qty<?php echo $t; ?>" id="service_qty<?php echo $t; ?>" style=" width:100px" value="<?php echo $data_exclusive['quantity'] ?>" /></td>
         ...
         <tr>
         	<td colspan="3">
            <div id="quantity_div" <?php if($row_record['category'] == "amount" || $_POST['category'] == "amount" ) echo 'style="display:block"'; else echo 'style="display:none"'; ?>>
            	<table width="56%">
                <tr>
                	<td width="36%" valign="top">Quantity<span class="orange_font"></span></td>
         			<td width="42%"><input type="text" name="quantity" id="quantity" value="<?php if($_POST['save_changes']) echo $_POST['quantity']; else echo $row_record['quantity_for_amount'];?>" /></td> 
            		<td width="22%"></td>
                </tr>
                </table>
         	</div>
         ...
         <tr>
            ...
            <td width="70%"><input type="text"  class="datepicker" name="start_date"  id="start_date" value="<?php if($_POST['save_changes']) echo $_POST['start_date']; else echo $row_record['start_date'];?>" /></td> 
              <td width="10%"></td>
         </tr>
         
         <tr>
         	<td width="20%" valign="top">End Date <span class="orange_font"></span></td>
         	<td width="70%"><input type="text"  class="datepicker" name="end_date" id="end_date" value="<?php if($_POST['save_changes']) echo $_POST['end_date']; else echo $row_record['end_date'];?>" /></td> 
            <td width="10%"></td>
         </tr>
         <tr>
           		<td>Amount:</td>
                <td><input type="text" name="amount" onkeyup="show_tax(this.value)" id="amount" value="<?php if($_POST['amount']) echo $_POST['amount']; else echo $row_record['amount'];?>" required/></td>
         </tr>
         <tr>      
    ...
    <tr>
       ...
       <!--============================================================END TABLE 2=========================================-->
         <tr>
           		<td>Final Amount:</td>
                <td><input type="text" name="total_cost" id="total_cost" value="<?php if($_POST['total_cost']) echo $_POST['total_cost']; else echo $row_record['total_cost'];?>" required/></td>
         </tr>
         <tr>
         		<td>&nbsp;</td>
                <td><input type="submit" required class="input_btn" value="<?php if($record_id) echo "Update"; else echo "Add";?> Voucher" name="save_changes"  /></td>
                <td></td>
         </tr>
        </table>
        </form>
...
<?php } ?>
    ...
    <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='voucher_id'))
                        {
                            ...
                            $sql_query= "SELECT * FROM voucher where 1 ".$pre_keyword." ".$select_directory." "; 
                       //echo $sql_query;
  ...
  <tr class="grey_td" >
    ...
    <td width="10%"><strong>Service Tax</strong></td>
    ...
    <td width="10%" class="centerAlign"><strong>Action</strong></td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                                ...
                                echo '<td ><a href="add_voucher.php?record_id='.$listed_record_id.'" class="table_font">'.$val_query['category'].'</a></td>';
								echo '<td >'.$val_query['deal_name'].'</td>';
								echo '<td >'.$val_query['amount'].'</td>';
								echo '<td >'.$val_query['service_tax'].'</td>';
