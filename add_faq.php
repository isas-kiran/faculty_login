...
if($_REQUEST['record_id'])
{
    ...
    $sql_record= "SELECT * FROM PB_faq where faq_id='".$record_id."'";
...
<title><?php if($record_id) echo "Edit"; else echo "Add";?> Faq</title>
                               ...
                               if($record_id)
                                {
                                   ///print_r($data_record); //    exit;
                                    $where_record=" faq_id='".$record_id."'";
                                    $db->query_update("faq", $data_record,$where_record);
                                    echo '<br></br><div id="msgbox" style="width:40%;">Record updated successfully</center></div><br></br>';
                                }
                                else
                                {
                                    $data_record['added_date'] =date("Y-m-d H:i:s");
                                    $record_id=$db->query_insert("faq", $data_record);
...
<!--              <textarea name="description" id="description" class="validate[required] input_textarea" rows="4"><?php //if($_POST['save_changes']) echo $_POST['description']; else echo $row_record['description'];?></textarea>-->
              ...
              <tr>
                  <td>&nbsp;</td>
                  <td><input type="submit" class="input_btn" value="<?php if($record_id) echo "Update"; else echo "Add";?> Faq" name="save_changes"  /></td>
                  <td></td>
              </tr>
        </table>
        </form>
