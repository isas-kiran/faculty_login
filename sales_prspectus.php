  ...
  <tr>
	...
	if($_POST['save_changes'])
	{
		...
		else
        {
			...
			{
			 	$insert_for_receipt = "insert into receipt (`category`,`bank_id`,`amount_wo_tax`,`amount`,`added_date`,`payment_mode_id`,`chaque_no`,`chaque_date`,`cust_bank_name`,`credit_card_no`,`description`,`cm_id`,`voucher`,`sac_code`,`admin_id`) values('".$data_record['category']."','".$data_record['bank_id']."','".$data_record['amount_wo_tax']."','".$data_record['amount']."','".$added_date."','".$payment_mode_id."','".$chaque_no."','".$date."','".$cust_bank_name."','".$credit_card_no."','".$description."','".$cm_id."','".$data_record['voucher']."','".$sac_code."','".$_SESSION['admin_id']."')";
...
?>	
	<form name="save" method="post">
		...
		<? if($_SESSION['type']=='S')
		{
			?>
			<tr>
			<td align="center" width="15%">Select Branch</td>
	...
	<tr>
        <td width="15%" align="center">Select Product</td>
        <td width="25%">
            <select name="product_id" id="product_id">
            <option value="">Select Product</option>
            <?php 
            $sel_prod="select product_id,product_name,quantity,admin_id from product where quantity > 0 ".$_SESSION['user_id']." ".$_SESSION['where']." order by product_id asc";
	...
	<tr>
		<td colspan="3">
			...
			<table width="100%">
				<tr>
					<td width="15%" class="tr-header" align="center">ISAS Bank Name</td>
					<td>
						<?php 
						if($_SESSION['type'] !="S")
						{
			...
			<table width="100%">
				<tr>
					 <td class="tr-header" width="15%" style="width:200px" align="center">Enter Chaque No.</td>
				...
				<tr>
					<td width="15%" class="tr-header" align="center">Enter Chaque Date</td>
			...
			<table width="100%">
                <tr>
                    <td width="15%" class="tr-header" align="center">Customer Bank Name</td>
				...
				<tr>
					<td width="15%" class="tr-header" align="center">Customer Credit Card No</td>
