...
{    
	...
	if(course_exist !='')
	{
		...
		total_f=parseInt(total_f-pre_inst);
...
//============================================================
	...
	var res_str = display_id.substring(5, 9);
								...
								if(mysql_num_rows($ptr_invs))
								{
									while($data_invs=mysql_fetch_array($ptr_invs))
									{
										...
										else
										{
											...
											"<br/>".$update_invs="update invoice set balance_amt='".$bal_amnt."' where invoice_id='".$data_invs['invoice_id']."'";
											$ptr_updatess=mysql_query($update_invs);
										}
									}
									$invoice_id='0';
