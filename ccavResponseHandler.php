...
<?php
	...
	$workingKey='18544833468045A949EC2CEAFDB7BCA0';		//Working Key should be provided here.
	...
	if($order_status==="Success")
	{
		...
		$invoice_subject = " Invoice for the course '$course_name' enrollment  at isasbeautyschool.com on ".date('d/m/Y H:i:s')." From Staff" ;
        ...
        <?php
        ?><script>
        setTimeout('document.location.href="manage_enroll.php";',4000);
        </script>
        <?php
