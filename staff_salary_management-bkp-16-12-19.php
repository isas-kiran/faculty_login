                    ...
                    <?php
                        ...
                        else
                        {
                            ...
                            if($record_id)
                            {
								...
								"<br>".$insert="INSERT INTO `log_history`(`category`, `action`, `name`, `id`, `date`, `cm_id`, `admin_id`) VALUES ('staff_salary','Update','Staff Salary','".$record_id."','".date('Y-m-d H:i:s')."','".$_SESSION['cm_id']."','".$_SESSION['admin_id']."')";
								...
								$where1="staff_id='".$data_staff['admin_id']."' AND month='".$month1."' AND Year='".$year."'";
								...
								$db->query_update("pr_advance_installments", $data_update,$where3);
											...
											"<br>".$insert="INSERT INTO `log_history`(`category`, `action`, `name`, `id`, `date`, `cm_id`, `admin_id`) VALUES ('staff_salary','Add','Staff Salary','".$del_record_id."','".date('Y-m-d H:i:s')."','".$_SESSION['cm_id']."','".$_SESSION['admin_id']."')";
									$query=mysql_query($insert);  
...
?>
         <tr>
                ...
                <td width="40%">
                    <input type="text" readonly class="validate[required] input_text" name="salary" id="salary" value="<?php if($_POST['save_changes']) echo $_POST['salary']; else echo $row_record['salary'];?>" />
                </td> 
                <td width="40%"></td>
            </tr> 
		...
		<table class="bank" style="display:none;" border="0" cellspacing="15" cellpadding="0" width="100%">
            ...
            { ?>
            <td><input type="submit" class="input_btn" onclick="return validme()" value="<?php if($record_id) echo "Update"; else echo "Add";?> Salary" name="save_changes"  id="save_changes"/></td>
			<?php } ?>
            <td></td>
            </tr>
			</table>
