...
function change_type(type)
{
	if(type=="Basic")
	{
		document.getElementById('show_cf').style.display="none";
	}
	else
	{
		document.getElementById('show_cf').style.display="block";
	}
}
</script>
</head>
    ...
    <img src='images/print1.jpeg'
								onclick="window.open('invoice-generate-company.php?action=print','View Invoice')" style='cursor:pointer'title='Print Invoice' border='0'>
                                    ...
                                    while($val_record=mysql_fetch_array($all_records))
                                    {
									   ...
									   ?>
                                       <tr><td width="37%"><strong>Pay type</strong></td><td width="63%" align="left"><input type="radio" onclick="change_type(this.val)" name="pay_type" id="pay_type" value="Basic" >Basic <input type="radio" onclick="change_type(this.val)" name="pay_type" id="pay_type" value="CF_loan" >CF loan</td>
                                       </tr>
                                        ...
                                        <tr>
                                        	<td colspan="3" id="show_cf" style="display:none">
                                            	<table width="100%">
                                                	<tr>
                                                    	<td width="25%">Difference Amount</td>
                                                        <td width="60%"><input type="text" class="validate[required] input_text" name="diff_amnt" id="diff_amnt"  value="<?php if($_POST['diff_amnt']) echo $_POST['diff_amnt']; else echo $row_record['diff_amnt'];?>" /></td>
                                                    </tr>
                                                    <tr>
                                                    	<td width="25%">Intrest Amount</td>
                                                        <td width="60%"><input type="text" class="validate[required] input_text" name="intrest_amnt" id="intrest_amnt"  value="<?php if($_POST['intrest_amnt']) echo $_POST['intrest_amnt']; else echo $row_record['intrest_amnt'];?>" /></td>
                                                    </tr>
                                                    <tr>
                                                    	<td width="25%">GST</td>
                                                        <td width="60%"><input type="text" class="validate[required] input_text" name="gst_amnt" id="gst_amnt"  value="<?php if($_POST['gst_amnt']) echo $_POST['gst_amnt']; else echo $row_record['gst_amnt'];?>" /></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
