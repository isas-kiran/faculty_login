...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  ...
  <tr class="head_td">
    ...
    <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='name'))
                        {
                            ...
                            $select_directory='order by discount_coupon_id asc';                      
                            $sql_query= "SELECT discount_coupon_id,name,code,discount,start_date,end_date,status FROM discount_coupon where 1  ".$_SESSION['where']." ".$pre_keyword." ".$select_directory." "; 
                       //echo $sql_query;
  ...
  <tr class="grey_td" >
    ...
    <td width="13%" class="centerAlign"><a href="<?php echo $_SERVER['PHP_SELF'];?>?order=<?php echo $order."&orderby=name".$query_string;?>" class="table_font"><strong>Name</strong></a> <?php echo $img1;?></td>
    <td width="12%" class="centerAlign"><strong>Code</strong></td>
   <td width="11%" class="centerAlign"><strong>Discount(in %)</strong></td>
    
   <td width="12%" class="centerAlign"><strong>Start Date</strong></td>
    <td width="12%" class="centerAlign"><strong>End Date</strong></td>
    <td width="13%" class="centerAlign"><strong>Status</strong></td>
    <td width="14%" class="centerAlign"><strong>Action</strong></td>
					...
					echo '</select>';
					echo '</td>';
                                echo '<td align="center"><a href="add_discount.php?record_id='.$listed_record_id.'" ><img src="images/edit_icon.png" title="Edit Record" class="example-fade"/></a>&nbsp;&nbsp;
