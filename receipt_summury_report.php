	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
              <tr>
                ...
                <!--<td width="20%">
                        ...
                        <td><a href="receipt_summury_report_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>  
            </tr>          
        </table>
        </form>	
    </td>
     ...
     <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='firstname'))
                        {
							...
							$branch_id='';
                       		    ...
                       		    "<br/>".$sql_query= "select * from receipt where 1 and category !='cash_transfer' ".$pre_keyword_i." ".$category." ".$bank_ids." ".$paid_from_date." ".$paid_to_date." ".$select_directory." "; 
