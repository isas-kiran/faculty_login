...
data1='action=add_students&branch_name='+branch_name+'&admission_date='+admission_date+'&invoice_no='+invoice_no+'&inquiry_date='+inquiry_date+'&name='+name+'&contact='+contact+'&mail='+mail+'&qualification='+qualification+'&username='+username+'&pass='+pass+'&photo='+photo+'&address='+address+'&per_address='+per_address+'&dob='+dob+'&source='+source+'&admission_remark='+admission_remark+'&course_id='+course_id+'&toal_fees='+toal_fees+'&concession='+concession+'&discount_coupon='+discount_coupon+'&discount_coupon_price='+discount_coupon_price+'&net_fees='+net_fees+'&service_tax='+service_tax+'&fees='+fees+'&down_payment='+down_payment+'&down_payment_tax='+down_payment_tax+'&down_payment_wo_tax='+down_payment_wo_tax+'&installment_on='+installment_on+'&dropdown='+dropdown+'&cust_bank_name='+cust_bank_name+'&account_no='+account_no+'&chaque_no='+chaque_no+'&chaque_date='+chaque_date+'&credit_card_no='+credit_card_no+'&final_amt='+final_amt+'&total_amt='+total_amt+'&payment_type='+payment_type+"&users_mail="+users_mail+"&email_text_msg="+email_text_msg;
//alert(data1);
$.ajax({
    ...
    <td class="mid_mid">
        ...
        <?php
                    ...
                    if(isset($_POST['save_changes']))
                    {
						...
						$cust_gst_no=( true== isset($_POST['cust_gst_no'])) ? $_POST['cust_gst_no'] : "";
       ...
       <?php }?>
            	...
            	<tr>
					...
					while($data_cat = mysql_fetch_array($ptr_course_cat))
					{
						...
						{
							?>
							<option value = "<?php echo $data_src['campaign_id']?>" <?php if($_POST['source'] == $data_src['campaign_id']) echo "selected"; else if ( $data_src['campaign_id'] == $row_record['source']) echo "selected";?> > <?php echo $data_src['campaign_name'] ?> </option>
							<?
						}
						echo "</optgroup>";
					}?>
