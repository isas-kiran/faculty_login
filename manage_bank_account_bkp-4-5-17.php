...
function check_voucher(values,bank_id,cm_id)
{
	...
	success: function (html)
	{
		//alert(html);
                      ...
                      <?php
                                $sql_records= "SELECT * FROM bank where 1 ".$_SESSION['where']." ".$pre_transcation_id." order by bank_id asc";
								...
								<tr align="center" class="grey_td" ><td width="7%" class="tr-header"><strong>Sr.</strong></td><td width="11%" class="tr-header"><strong>Bank Name</strong></td><td width="11%" class="tr-header"><strong>Branch</strong></td><td width="11%" class="tr-header"><strong>Account No.</strong></td><? if($_SESSION['type']=='S')
	{ ?><td width="8%"><strong>Center</strong></td><? }?><td width="8%"><strong>Is Credit Card</strong></td><td width="8%"><strong>Is paytm</strong></td><td width="8%"><strong>Is Vouchers</strong></td><td width="12%" class="tr-header"><strong>Action</strong></td></tr><?php
							...
							<?php
								...
								else
								{
									...
									if($record_id)
									{
										...
										{
												$update_bank = "update bank set `bank_name`='".$data_record['bank_name']."',`branch`='".$data_record['branch']."',`account_no`='".$data_record['account_no']."',`added_date`='".date('Y-m-d H:i:s')."',`cm_id`='".$cm_id."' where bank_id='".$record_id."'";
									...
									else
									{
										if($data_record['bank_name'] !='')
										{
												$insert_for_prevelgegeis = "insert into bank (`bank_name`,`branch`,`account_no`,`added_date`,`cm_id`) values('".$data_record['bank_name']."','".$data_record['branch']."','".$data_record['account_no']."','".date('Y-m-d H:i:s')."','".$cm_id."')";
