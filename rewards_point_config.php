		...
		//alert(html);
                      ...
                      <?php
							...
							if(isset($_POST['save_changes']))
							{
								...
								$sel_rew="select reward_point_id from reward_point_config where cm_id='".$cm_id."' ".$rec_id." ";
						...
						<tr>
                            <tr>
                            	<td width="52%" class="tr-header" align="center">Enter Rupees</td>
                                 <td width="25%" class="customized_select_box">
                      			<input type="text" name="rupees" id="rupees" value="<?php if($_POST['rupees']) echo $_POST['rupees']; else echo $row_record['rupees']; ?>" >
								</td>
                               <!--<td width="20%" ><input type="button" onClick="ajax_kit()" value="Add New Item" /></td> -->
                            </tr>
                            <tr>
                            	<td width="52%" class="tr-header" align="center">Reward Point </td>
                                <td width="25%" class="customized_select_box">
                      			<input type="text" name="reward_point" id="reward_point" value="<?php if($_POST['reward_point']) echo $_POST['reward_point']; else echo $row_record['reward_point']; ?>">
                            </td>
                               <!--<td width="20%" ><input type="button" onClick="ajax_kit()" value="Add New Item" /></td> -->
                            </tr>
                            <tr>
