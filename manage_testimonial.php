...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    <td class="top_mid" valign="bottom"><?php include "include/testimonial_menu.php";?></td>
    ...
    <?php       if($_POST['formAction'])
                    {
                        if($_POST['formAction']=="delete")
                        {
                            for($r=0;$r<count($_POST['chkRecords']);$r++)
                            {
                                ...
                                $sql_query= "SELECT testi_id FROM ".$GLOBALS["pre_db"]."testimonial where testi_id ='".$del_record_id."'";
                                if(mysql_num_rows($db->query($sql_query)))
                                    {                                                
                                        $delete_query="delete from ".$GLOBALS["pre_db"]."testimonial where testi_id='".$del_record_id."'";
...
<!--                                <option value="Active">Active</option>
    ...
    <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='name'))
                        {
                            ...
                            $select_directory='order by testi_id desc';                      
                            $sql_query= "SELECT * FROM testimonial where 1  ".$pre_keyword." ".$select_directory.""; 
                       //echo $sql_query;
    ...
    <form method="post"  name="frmTakeAction" action="<?php echo $_SERVER['PHP_SELF'].'?#msgbox';?>" >
                     <input type="hidden" name="formAction" id="formAction" value=""/>
                      <tr class="grey_td" >
                        ...
                        <td width="5%"><a href="<?php echo $_SERVER['PHP_SELF'];?>?order=<?php echo $order."&orderby=name".$query_string;?>" class="table_font"><strong>Name</strong></a> <?php echo $img1;?></td>
                       ...
                       <td width="15%"><strong>Tag</strong></td>
                        ...
                        <td width="10%" class="centerAlign"><strong>Action</strong></td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                                ...
                                $listed_record_id=$val_query['testi_id']; 
                                ...
                                echo '<td ><a href="add_pages.php?record_id='.$listed_record_id.'" >'.$val_query['page_title'].'</a></td>';
                                echo '<td >'.$post.'</td>';
