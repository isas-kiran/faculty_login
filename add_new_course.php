...
function send()
	{
		...
		data1='action=add_new_course&name='+name+'&dob='+dob+'&address='+address+'&contact='+contact+'&mail='+mail+'&qualification='+qualification+'&photo='+photo+'&paid_type='+paid_type+'&source='+source+'&admission_remark='+admission_remark+'&course_id='+course_id+'&admission_date='+admission_date+'&total_fees='+total_fees+'&discount_coupon='+discount_coupon+'&concession='+concession+'&discount_type='+discount_type+'&down_payment='+down_payment+'&chaque_no='+chaque_no+'&chaque_date='+chaque_date+'&credit_card_no='+credit_card_no+'&cust_bank_name='+cust_bank_name+'&payment_type='+payment_type+'&installment_on='+installment_on+'&net_fees='+net_fees+'&fees='+fees+'&down_payment_tax='+down_payment_tax+'&down_payment_wo_tax='+down_payment_wo_tax+'&dropdown='+dropdown+'&branch_name='+branch_name+'&final_amt='+final_amt+"&users_mail="+users_mail+"&email_text_msg="+email_text_msg;
		//alert(data1);
		$.ajax({
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
        ...
        <?php
                    ...
                    <?php
...

                        {
							...
							$data_record_invoice['added_date']=$added_date;
                            ...
                            if($record_id)
                            {
							   ...
							   // $student_id= mysql_insert_id();
								...
								echo "course_id <br/>".$data_record_invoice['enroll_id']=$courses_id;
...

							   {
							    ...
							    "<br>".$insert="INSERT INTO `log_history`(`category`, `action`, `name`, `id`, `date`, `cm_id`, `admin_id`) VALUES ('add_new_course','Add','".$name."','".$record_id."','".date('Y-m-d H:i:s')."','".$_SESSION['cm_id']."','".$_SESSION['admin_id']."')";
	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%">
            ...
            <td><a href="add_new_course_gst.php?record_id=<?php echo $_GET['record_id']; ?>" ><input type="button" class="input_btn"  value="Add Course with GST Calulation" name="gst"  /></a></td>
            </tr>
            ...
            ?>
                       ...
                       <?php }?>
                            ...
                            <tr>
                                          ...
                                          <td width="40%"><input type="text" name="admission_date" id="admission_date" class="input_text datepicker" value="<?php if($_POST['admission_date']) echo $_POST['admission_date']; else echo date("d/m/Y");/*if($row_record['admission_date']!='')
