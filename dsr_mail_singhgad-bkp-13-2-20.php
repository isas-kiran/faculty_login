...
//=====================================================================================================================================================================
 ...
 <tr style="background-color:#999;color: black">
    ...
    <td width="10%" align="center" style="border:1px solid #CCC"><strong>Cash Deposited in Bank</strong></td>
    ...
    // <td width="15%" align="center" style="border:1px solid #CCC"><strong>Cash Received from Innocent</strong></td>
				...
				$sel_dist_bank_id="Select DISTINCT(bank_id) from receipt where added_date='".$date."' and bank_id !='' and (category ='cash_transfer' and category !='voucher' and cash_transfer_mode !='inword' and cash_transfer_mode!='cash_to_cash') ".$branch_id."";
				...
				{
					$sel_cash_from_bank="select SUM(amount) as total_amt from receipt where bank_id ='".$data_dist_bank_id['bank_id']."' and category ='cash_transfer' and cash_transfer_mode ='outword' and added_date='".$date."' ".$branch_id." ";
					$ptr_cash_from_bank=mysql_query($sel_cash_from_bank);
					$data_cash_from_bank=mysql_fetch_array($ptr_cash_from_bank);
					
					$sel_bank_amnt="select SUM(amount) as total_amt from receipt where bank_id ='".$data_dist_bank_id['bank_id']."' and category ='cash_transfer' and cash_transfer_mode ='bank_to_bank' and added_date='".$date."' ".$branch_id." ";// 29-12-17 category !='cash_transfer'
				...
				$message.= "<strong>Total : ".$tots.'</strong>';
				$message.= '</td>';
