     ...
     <?php
                        ...
                        if($no_of_records)
                        {
                           ...
                           // $pager = new PS_Pagination($sql_query,$_SESSION['show_records'],$_SESSION['show_records_pages'],$query_string1);
                            ...
                            <tr class="grey_td" >
                            <td width="10%" colspan="3" align="center" align="center">Total Enquiry</td>
                            <?php
							...
							?>
                            <td width="10%" colspan="2" align="center"><?php echo $count_total; ?></td>
                            <td width="10%" colspan="3" align="center">Enquiries not assigned</td>
                            <?php
							...
							?>
                            <td width="10%" colspan="2" align="center"><?php echo $count_unassigned; ?></td>
                            </tr>
                      		<tr class="grey_td" >
                      		...
                      		while($val_query=mysql_fetch_array($all_records))
                            {
								...
								echo "<br/>".$select_pend_followups="select inquiry_id from inquiry where 1 and (followup_date='' or followup_date is NULL) and employee_id='".$val_query['admin_id']."' ".$_SESSION['where']." ".$search_cm_id." ".$followup_from_date." ".$followup_to_date."";
                            ...
                            <td align="center"><strong><?php echo $total_pending; ?></strong></td>
                            <td align="center"><strong><?php echo $total_completed; ?></strong></td>
                            <td align="center"><strong><?php echo $total_new_followups; ?></strong></td>
