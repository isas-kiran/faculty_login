				...
				<form method="post"  name="frmTakeAction"  action="<?php echo $_SERVER['PHP_SELF'].'?#msgbox';?>">
                     <input type="hidden" name="formAction" id="formAction" value=""/>
                      <tr class="grey_td" >
						...
						<td width="25%" align="center"><strong>Vendor Name</strong></td>
                        <td width="25%" align="center">Expense Name</td>
						<td width="12%" align="center">Price (Excl. TDS)</td>
						<td width="12%" align="center">TDS in % / Rs/-</td>
						<td width="10%" align="center"><strong>Total TDS</strong></td>
                        ...
                        <td width="14%" align="center"><strong>Installments</strong></td>-->
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
								...
								echo '<td align="center" width="25%">'.$data_name['name'].''.$gstno.'</td>';
								...
								echo "<td width='25%' align='center'>".$data_inst_amnt['expense_type']."</td>";
								echo "<td width='12%' align='center'>".$val_query['total_price']."</td>";
								echo "<td width='12%' align='center'>".$val_query['tds_percent']."</td>";
								echo "<td width='10%' align='center'>".$val_query['tds_value']."</td>";
