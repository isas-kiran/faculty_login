...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  ...
  <tr class="grey_td" >
   ...
   // if($_SESSION['type']=='S' || $_SESSION['type']=='A' || $_SESSION['type']=='F')
	...
	<td width="6%" align="center"><strong>Followup details</strong></td>
	...
	?>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                               ...
                               /* echo '<td ><a href="enroll.php?record_id='.$listed_record_id.'" class="table_font">'.$val_query['name'].'<br /> <img src="images/mobile-phone-8-16.ico">'.$val_query['contact'].' <br /> <img src="images/mail.png">'.$val_query['mail'].'</a></td>';*/
								...
								//if($_SESSION['type']=='S')
								//{ 
								echo '<td><center><a href="view-logsheet.php?record_id='.$listed_record_id.'"><img src="images/logsheet.png" border="0" title="View Logsheet" height="30px" width="30px"></a></center></td>';
								 //}
								echo '<td><center><a href="invoice-summary.php?record_id='.$listed_record_id.'"><img src="images/view_bill.jpg" border="0" width="30px" height="30px" title="View Payment"></a></center></td>';
								if($val_query['ref_id'] ==0)
								{
								...
								echo '<td><center><a href="installment_followup_details.php?record_id='.$listed_record_id.'&show=false">
