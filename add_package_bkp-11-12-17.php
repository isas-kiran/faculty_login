                                    ...
                                    <select name="service_id<?php echo $t; ?>" id="service_id<?php echo $t; ?>" style="width:140px" onChange="getprice(this.value,'<?php echo $t; ?>')">
                                      ...
                                      <?php
										...
										if($total=mysql_num_rows($query_tel))
										{
										 ...
										 ?>
                                    </select></td><input type="hidden" name="sin_service_price<?php echo $t; ?>" id="sin_service_price<?php echo $t; ?>" style=" width:100px" value="<?php $data_exclusive['service_price'] ?>" />
                                    <td width="25%" align="center"><input type="text" name="service_qty<?php echo $t; ?>" id="service_qty<?php echo $t; ?>" style=" width:100px" value="<?php echo $data_exclusive['quantity'] ?>" /></td>
                                    <td width="25%" align="center"><input type="text" name="sin_service_total<?php echo $t; ?>" id="sin_service_total<?php echo $t; ?>" style=" width:100px" value="<?php echo $data_exclusive['price'] ?>" /></td>
