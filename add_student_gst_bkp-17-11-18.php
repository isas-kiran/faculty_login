...
m =document.getElementById('qualification');
...
data1='action=add_students&branch_name='+branch_name+'&admission_date='+admission_date+'&invoice_no='+invoice_no+'&inquiry_date='+inquiry_date+'&name='+name+'&contact='+contact+'&mail='+mail+'&qualification='+qualification+'&username='+username+'&pass='+pass+'&photo='+photo+'&address='+address+'&per_address='+per_address+'&dob='+dob+'&source='+source+'&admission_remark='+admission_remark+'&course_id='+course_id+'&toal_fees='+toal_fees+'&concession='+concession+'&discount_coupon='+discount_coupon+'&discount_coupon_price='+discount_coupon_price+'&net_fees='+net_fees+'&fees='+fees+'&down_payment='+down_payment+'&down_payment_tax='+down_payment_tax+'&down_payment_wo_tax='+down_payment_wo_tax+'&installment_on='+installment_on+'&dropdown='+dropdown+'&cust_bank_name='+cust_bank_name+'&account_no='+account_no+'&chaque_no='+chaque_no+'&chaque_date='+chaque_date+'&credit_card_no='+credit_card_no+'&final_amt='+final_amt+'&total_amt='+total_amt+'&payment_type='+payment_type+"&users_mail="+users_mail+"&email_text_msg="+email_text_msg;
//alert(data1);
$.ajax({
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
		...
		<td class="mid_mid">
			...
			<?php
                ...
                if(isset($_POST['save_changes']))
                {
					...
					$invoice_no=( true== isset($_POST['invoice_no'])) ? $_POST['invoice_no'] : "0";
						   ...
						   // $data_record['service_tax']=$service_tax;
                            ...
                            if($record_id)
                            {
							   ...
							   $bank_query=mysql_query($bank);  
								...
								$where_record_inv="enroll_id='". $courses_id."'";
	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%" >
       ...
       <?php }?>
                <tr>
                    ...
                    <td width="40%"><?php if($_POST['admission_date']) echo $_POST['admission_date']; else echo date('d/m/Y'); ?>
                    ...
                    <input type="hidden" name="cm_id" value="<?php echo $row['cm_id']; ?>" /></td>
                </tr> 
                <tr>
                	<td width="20%" >Invoice No.<span class="orange_font">*</span></td>
                    <td width="40%"><input type="text" class="validate[required] input_text" name="invoice_no"  id="invoice_no"disabled="disabled"  value="<?php if($_POST['invoice_no']) echo $_POST['invoice_no']; else echo $row_record['inquiry_id']; ?>" /> </td>
                </tr>
				<tr>
                ...
                <tr>
					...
					<td 40%><input type="text" class="validate[required] input_text datepicker" name="inquiry_date" id="inquiry_date"  value="<?PHP if($_POST['inquiry_date']) echo $_POST['inquiry_date']; else if($enqs_date !='') {$arrage_date= explode('-',$enqs_date,3);echo $arrage_date[2].'/'.$arrage_date[1].'/'.$arrage_date[0];} else echo date('d/m/Y');?>" /><br />(dd/mm/yyyy)</td>
                </tr>
                <tr>
                	<td width="20%">Student Name<span class="orange_font">*</span></td>
                    <td width="40%"><input type="text" class="validate[required] input_text" name="name"  id="name" value="<?php if($_POST['name']) echo $_POST['name']; else echo $row_record['firstname']." ".$row_record['middlename']." ".$row_record['lastname'];?>" /></td> 
                </tr> 
                <tr>
                	<td width="20%">Contact No<span class="orange_font">*</span></td>
                    <td width="40%"><input type="text" class="validate[required] input_text" name="contact" id="contact" value="<?php if($_POST['contact']) echo $_POST['contact']; else echo $row_record['mobile1'];?>" onKeyPress="return isNumber(event)" maxlength="12"/></td> 
                    <td width="40%"><b>Note-</b> Should be 10-12 digit allowed. </td>
                </tr>
                <tr>
                	<td width="20%">Email Id<span class="orange_font">*</span></td>
                    <td width="40%"><input type="text" class="input_text" name="mail" id="mail" value="<?php if($_POST['mail']) echo $_POST['mail']; else echo $row_record['email_id'];?>" onBlur="validateEmail(this.value);" /></td> 
                    <td width="40%"></td>
                </tr>
                <tr>
                 ...
                 <tr>
                    ...
                    <td width="40%"><textarea  name="address" id="address" style="width: 400px; height: 62px;" ><?php if($_POST['address']) echo $_POST['address']; else echo $row_record['address'];?></textarea></td> 
                 </tr> 
                  <tr>
                 	<td width="20%">Permanant Address<span class="orange_font"></span></td>
                    <td width="40%"><textarea  name="per_address" style="width: 400px; height: 62px;" id="per_address" ><?php if($_POST['per_address']) echo $_POST['per_address']; else echo $row_record['address'];?></textarea></td> 
                 </tr> 
                 <tr>
                 	<td width="20%">Date Of Birth<span class="orange_font">*</span></td>
                    <td width="40%"><input type="text" class="input_text datepicker" name="dob" id="dob" value="<?php if($_POST['dob'])	echo $_POST['dob'];else{$arrage_date= explode('-',$row_record['birth_date'],3);echo $arrage_date[2].'/'.$arrage_date[1].'/'.$arrage_date[0];}?>" /></td> 
                	<td width="40%"></td>
            	</tr>   
            	<tr>
  ...
  <!--==========================================================================================================================-->                                           
                ...
                <tr>
                    ...
                    <td width="40%"><div id="coupon"></div><input type="hidden" name="discount_coupon_price" id="discount_coupon_price" value="<?php if($_POST['discount_coupon_price']) echo $_POST['discount_coupon_price']; else echo 0;?>" /></td>
                    </tr>
