...
$objPHPExcel->getProperties()->setCreator("Maarten Balliauw")
	...
	$select_directory='order by enroll_id desc';                      
  	...
  	$sel_enroll="SELECT * FROM enrollment where 1 ".$_SESSION['where']." ".$where_course." ".$where_assign_to." ".$where_added_by." ".$search_cm_id." ".$pre_from_date." ".$pre_to_date."  ".$select_directory."";
	...
	$objPHPExcel->setActiveSheetIndex(0)->setSharedStyle($sharedStyle1, "U5:T$no_of_rows");
	
	$objPHPExcel->setActiveSheetIndex(0)->setSharedStyle($sharedStyle2, "A4:U4");
	...
	$objPHPExcel->setActiveSheetIndex(0)->getStyle('U1:U'.$objPHPExcel->setActiveSheetIndex(0)->getHighestRow())->getAlignment()->setWrapText(true); 
	...
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('D4', 'Contact No.','5');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('E4', 'Contact No 2.','5');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('F4', 'Email','5');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('G4', 'Course Name','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('H4', 'Total Price','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('I4', 'Down Payment','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('J4', 'Balance Fees','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('K4', 'Installments','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('L4', 'Assign to','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('M4', 'Added by','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('N4', 'Date','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('O4', 'Enroll Key Id','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('P4', 'Enroll Id','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('Q4', 'Enroll No','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('R4', 'Bill No','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('S4', 'Receipt Details','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('T4', 'Total Paid','6');
	...
	$sql_query="SELECT * FROM enrollment where 1 ".$_SESSION['where']." ".$where_course." ".$where_assign_to." ".$where_added_by." ".$search_cm_id." ".$pre_from_date." ".$pre_to_date." ".$select_directory."";
	...
	while($val_query=mysql_fetch_array($query_order))
	{
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('D'.$rowCount, $val_query['contact']);	
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('E'.$rowCount, $val_query['contact_home']);	
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('F'.$rowCount, $val_query['mail']);	
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('G'.$rowCount, $val_course['course_name']);	
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('H'.$rowCount, $val_query['net_fees']);
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('I'.$rowCount, $val_query['down_payment']);		
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('L'.$rowCount, $data_assign['name']);
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('M'.$rowCount, $data_added['name']);				
		/************************************Item rate******************************************/
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('N'.$rowCount, $val_query['added_date']);	
		/************************************Plan Date******************************************/
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('O'.$rowCount, $val_query['enroll_id']);	
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('P'.$rowCount, $val_query['installment_display_id']);
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('Q'.$rowCount, $val_query['ext_invoice_no']);
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('R'.$rowCount, $val_query['enroll_id']);
		$select_installments = " SELECT * FROM `invoice` where enroll_id ='".$val_query['enroll_id']."' ";
		$ptr_installment = mysql_query($select_installments);
		if($total=mysql_num_rows($ptr_installment))
		{
			$mm='';
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('S'.$rowCount, $mm);		
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('T'.$rowCount, $val_query['paid']);	
		$k++;
		$rowCount++;
		$sr++;
}
