...
$edit_access='';
$sel_acc="select * from edit_previleges where admin_id='".$_SESSION['admin_id']."' and privilege_id='279'";
					...
					<div id="show_type">
                        ...
                        <table style="width:100%;">
                            <tr>
                                ...
                                {
                                    $selecteds="";
                                    if($data_cust['cust_id']==$_REQUEST['customer_id'])
                                    {
...
<?php
                        ...
                        if($keyword)
                            $pre_keyword=" and (cust_name like '%".$keyword."%')";
                        else
                            $pre_keyword="";
						...
						{
							$where_cust_id=" and cust_id='".$_REQUEST['customer_id']."'";
						}
                        if($_REQUEST['page'])
                            $page=$_REQUEST['page'];
                        else
						...
						$sql_query= "SELECT cust_id,cust_name,cm_id FROM customer where 1 ".$where_cust_id." ".$where_cm." ".$search_cm_id." ".$pre_keyword." ".$select_directory.""; 
                       //echo $sql_query;
                        ...
                        if($no_of_records)
                        {
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
								...
								echo '<td align="center">'.$val_query['cust_name'].'</td>';
								...
								$sel_products="select sales_product_id,total_price,payable_amount,remaining_amount,payment_mode_id,added_date from sales_product where customer_id='".$listed_record_id."'and type='Customer' ".$paid_from_date." ".$paid_to_date."";
