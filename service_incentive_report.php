...
<title>Service Report (Therapist Wise)</title>
  ...
  <tr class="head_td">
    ...
    <?php
						...
						if($_REQUEST['therapist_name']!='')
							{
								$therapist_name=" and csm.admin_id='".$_REQUEST['therapist_name']."'";
							}
							else
							{
								$therapist_name='';
                        ...
                        <td width="10%" align="center"><strong>Added Date</strong></td>
                            ...
                            while($val_querys=mysql_fetch_array($all_records))
                            {
								...
								$sgst=9;
								 ...
								 "</br>".$total_taxable_value = $val_querys['total_price'] / $new_total_tax;
								 "</br>".$total_gst =$val_querys['total_price'] - $total_taxable_value;
