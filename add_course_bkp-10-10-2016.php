...

{
    ...
    $sql_record= "SELECT course_id,course_name,course_description,course_duration,category_id,course_price FROM courses where course_id='".$record_id."' ";
                           ...
                           /* if($file_uploaded)
...

                            {
...

									{
										...
										'<br>'. $selet_query_for_subject_id = " select subject_id from topic where topic_id ='".$topics[$i]."' ";
...
//                            $discount['for_edit']=$_POST['discount_course'];
	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%">
            ...
            <td width="10%">Select Subject<span class="orange_font">*</span></td>
