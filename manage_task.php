  ...
  <tr class="head_td">
    ...
    <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='name'))
                        {
                            ...
                            $select_directory='order by action_counc_id desc';                      
                           $sql_query= "SELECT * FROM action_councellor where 1 ".$pre_keyword." ".$select_directory.""; 
                       //echo $sql_query;
...
-->  </tr>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                                ...
                                $select_enroll = "select * from enrollment where enroll_id = '".$val_query['enroll_id']."' ";
                                $val_name = $db->fetch_array($db->query($select_enroll));
                                include "include/paging_script.php";
                                $listed_record_id=$val_name['enroll_id']; 
                                echo '<tr '.$bgcolor.' >
                                      <td align="center"><input type="checkbox" name="chkRecords[]" value="'.$listed_record_id.'"></td>';
                                echo '<td align="center">'.$sr_no.'</td>';  
								//echo $val_name["action_status"];
								
								//===============================================================================
									//action_status is done in enroolment when bop click on done button
									//
								//===============================================================================
								if($val_name["action_status"]=="pending")
								{                           
                                	echo '<td > <a href="action_bop.php?record_id='.$listed_record_id.'" class="table_font">'.$val_name['name'].'</a></td>';
								}
								else 
								{
                               ...
                               /* echo '<td >'.$val_query['contact'].'</td>';
								...
								echo '<td >'.$val_query['mail'].'</td>';
								echo '<td >'.$val_query['username'].'</td>';
								echo '<td >'.$val_query['pass'].'</td>';*/
								
								if($val_name['action_status']=='done')
								{
								echo '<td style="color:#00CC00; " align="center">'.$val_name['action_status'].'</td>';
								}
								else
								echo '<td style="color:#FF0000;" align="center">'.$val_name['action_status'].'</td>';
								if(!$val_name['name']=='')
								{
								...
								/*echo '<td align="center"><a href="view_student.php?record_id='.$listed_record_id.'" ><img src="images/edit_icon.png" title="Edit Record" class="example-fade"/></a>&nbsp;&nbsp;
