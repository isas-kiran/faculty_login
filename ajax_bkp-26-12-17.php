...
//=============================================================EXPENSE CATEGORY==============================================================================
			if($action=='show_expense_cat')
			{
				...
				echo '<table width="100%"><tr><td width="29%" align="center">Select Expense Type</td><td width="45%"><select name="expense_type" id="expense_type">';
			...
			if($action=='check_loyalty_points')
			{
				...
				if(mysql_num_rows($ptr_rewards))
				{
					...
					if(mysql_num_rows($ptr_max))
					{
						...
						echo '<table width="99%"><tr><td width="24%">Reward Points</td><td><input type="text" readonly name="redeme_points" id="redeme_points" value="'.$rewards_point.'"></td></tr><tr><td width="24%">Redemption value</td><td><input type="text" readonly name="redemptoin_value" id="redemptoin_value" value="'.$reward_amount.'"></td></tr></table>';
					}
					else
						echo "Rewards point is not sufficient to redeme. Please earn More Rewards Point";
				}
				else
					echo "You have No Rewards Point";
			}
//===============================================================END Loyalty Points==========================================================================================
//==========================================================================================================================================================
