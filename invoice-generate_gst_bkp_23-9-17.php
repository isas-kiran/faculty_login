    ...
    <div class="heightSpacer"></div>
						...
						//echo $data_bill_master['course_id'];
                         ...
                         $val_course= $db->fetch_array($db->query($select_course));
							...
							if(trim($row_record['cgst_tax_in_percent'])>0)
								$cgst_tax=$row_record['cgst_tax_in_percent'];
							else
								$cgst_tax=$data_taxx['cgst'];
							
							if(trim($row_record['sgst_tax_in_percent'])>0)
								$sgst_tax=$row_record['sgst_tax_in_percent'];
							else
								$sgst_tax=$data_taxx['sgst'];
							$gst=$row_record['cgst_tax']+$row_record['sgst_tax'];
                        ...
                        <table align="center" border="1px"  width="786" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td width:20% align="center"><font size="2px;"><?php echo $row_record['cgst_tax']; ?>+<?php echo $row_record['sgst_tax']; ?>=<?php echo $gst; ?></font></td>
                            </tr>
                           	<tr>
                            	...
                            	<td width="21%" width:20% align="center"> <font size="2px;"><?php  echo $row_record['total_fees']; ?></font></td>
