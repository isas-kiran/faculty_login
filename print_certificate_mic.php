...
.beauty_grade {
    ...
    transform: translate(-50%, -50%);
	width: 140px;
	border-bottom: 2px solid #69291a;
	text-align: center;
	height: 32px;
}
.makup_grade_desc {
...
?>
	...
	<table align="center" >
		<tr>
        	...
        	<?php
		 	...
		 	{
		 		?>
        		<a href="print_certificate_mic.php?action=print&record_id=<?php echo $record_id; ?>&course_id=<?php echo $course_id; ?>" style="text-decoration:none"><input type="button" name="print" value="Print" /></a> 
        		<?php 
			} ?>
        	</td>
        </tr>
    ...
    <div class="">
        ...
        <div class="course_name">Master Program in Cosmetology</div>
        ...
        <div class="spa_grade_desc">Spa Therapies <span class="spa_grade">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php if($spa_grade!='') echo $spa_grade; else echo $row_record['spa_grade']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
        <div class="nail_grade_desc">Nail Technology <span class="nail_grade">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php if($nail_grade!='') echo $nail_grade; else echo $row_record['nail_grade']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
        <div class="salon_grade_desc">Salon Management <span class="salon_grade">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php if($salon_grade!='') echo $salon_grade; else echo $row_record['salon_grade']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
