    	...
    	<td colspan="17">
            ...
            ?>
           	<tr>
                ...
                <td><a href="enrollment_receipt_tally_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>
            </tr>          
        </table>
        </form>	
    </td>
	...
	if($no_of_records)
	{
        ...
        <tr class="grey_td" >
            ...
            while($val_query=mysql_fetch_array($my_db))
            {
				...
				echo '<td align="center">'.$data_name['name'].' - '.$val_query['enroll_id'].'</td>';
				echo '<td align="center">'.round($val_query['amount'],2).'</td>';
				echo '<td align="center">Student Fees Collected</td>';
