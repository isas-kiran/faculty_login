    ...
    <?php       if($_POST['formAction'])
                    {
                        if($_POST['formAction']=="delete")
                        {
                            for($r=0;$r<count($_POST['chkRecords']);$r++)
                            {
                                ...
                                $sql_query= "SELECT kit_id FROM kit where kit_id ='".$del_record_id."'";
                                if(mysql_num_rows($db->query($sql_query)))
                                    {                                                
                                        $delete_query="delete from kit where kit_id='".$del_record_id."'";
                                        $db->query($delete_query);  
										
										$delete_query1="delete from kit_items_map where kit_id='".$del_record_id."'";
...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  ...
  <tr class="head_td">
    ...
    <?php
                        ...
                        if($keyword)
                            $pre_keyword=" and (kit_name like '%".$keyword."%' )";
                        else
                            $pre_keyword="";
                        ...
                        if($_GET['orderby']=='kit_name' )
                            $img1 = $img;

                        if($_GET['order'] !='' && ($_GET['orderby']=='kit_name'))
                        {
                            ...
                            $sql_query= "SELECT kit_id, kit_name, cm_id FROM kit where 1  ".$_SESSION['where']." ".$pre_keyword." ".$select_directory." "; 
                       //echo $sql_query;
  ...
  <tr class="grey_td" >
    ...
    <td width="20%" align="center"><a href="<?php echo $_SERVER['PHP_SELF'];?>?order=<?php echo $order."&orderby=kit_name".$query_string;?>" class="table_font">
    <strong>Kit Name</strong></a> <?php echo $img1;?></td>
    ...
    <td width="10%" class="centerAlign"><strong>Action</strong></td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                                ...
                                echo '<td align="center">'.$val_query['kit_name'].'</td>';
                                ...
                                echo '<td align="center"><a href="add_kit.php?record_id='.$listed_record_id.'" ><img src="images/edit_icon.png" title="Edit Record" class="example-fade"/></a>&nbsp;&nbsp;
