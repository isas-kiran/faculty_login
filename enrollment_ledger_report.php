...
<title>Enrollment GST Ledger Report</title>
...
?>   
	...
	?>
              <tr>
                ...
                <!--<td width="20%">
                        ...
                        <td><a href="enrollment_ledger_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>  
            </tr>          
        </table>
        </form>	
    </td>
	...
	if($_GET['order'] !='' && ($_GET['orderby']=='firstname'))
	{
		...
		$select_directory=' order by DATE(i.added_date) asc,DATE(i.invoice_id) desc';                     
		 
		"<br/>".$sql_query= "select i.*, e.name,e.course_id,e.installment_display_id from invoice i, enrollment e where 1 and i.enroll_id=e.enroll_id  ".$search_cm_id." ".$pre_keyword_i." ".$pay_type." ".$bank_ids." ".$paid_from_date." ".$paid_to_date." ".$select_directory." "; //and amount>0
		...
		if($no_of_records)
		{
            ...
            <td width="8%" align="center">Receipt No.</td>
            <td width="8%" align="center">Receipt Date</td>
            <td width="8%" align="center">Enroll Id</td>
            <td width="15%" align="center"><strong>Student Name</strong></td>
            <td width="15%" align="center"><strong>Course Name</strong></td>
            <td width="8%" align="center"><strong>Net fees</strong></td>
            <td width="8%" align="center"><strong>CGST</strong></td>
            <td width="8%" align="center"><strong>SGST</strong></td>
            <td width="8%" align="center"><strong>Total Fees</strong></td>
            <td width="8%" align="center"><strong>Payment Mode</strong></td>
            <!--<td width="8%" align="center">Chaque</td>
            <td width="8%" align="center">Credit Card</td>
            <td width="8%" align="center">Online</td>
-->            <td width="8%" align="center">Payment Details</td>
            ...
            while($val_query=mysql_fetch_array($my_db))
            {
				...
				{
					echo '<td align="center" >'.$val_query['enroll_id'].'</td>';
				}
				else
				{
					echo '<td align="center" >'.$val_query['invoice_id'].'</td>';
				}
				...
				echo '<td align="center">'.$val_query['cgst_tax'].'</td>';
				...
				echo "<td align='center'>".intval($val_query['amount']+$val_query['cgst_tax']+$val_query['sgst_tax'])."</td>";
            ...
            <tr class="grey_td">
                ...
                <td align="center"><span style='color:red'><strong><?php echo $total_cgst; ?></strong></span></td>
                <td align="center"><span style='color:red'><strong><?php echo $total_sgst; ?></strong></span></td>
