...
?>
		mail1[0]='vyavaharekiran@gmail.com';
		mail1[1]='erp.isas@gmail.com';
		<?php
if($_SESSION['type']!='S')
{
...
{								  
	...
	var drop =document.getElementById('payment_type');
