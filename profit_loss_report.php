						...
						<tr class="head_td">
                            ...
                            if($diff)
                            {
                                ...
                                for($i=0;$i<$data_difs;$i++)
                                {
                                    ...
                                    //========================Enrollment==========================
                                    echo '<td align="left">';
                                    $sel_inv="select amount,enroll_id,paid_type from invoice where DATE(added_date)='".$newdates."' and amount>0 ".$paid_type." ".$bank_ids." ".$search_cm_id." ";
                                   ...
                                   echo '<td align="center">';
									...
									{
                                    	$sel_exp="select amount,payment_mode_id from expense where DATE(added_date)='".$newdates."' and amount>0 ".$paymode_type." ".$banks_id." ".$search_cm_id."";
									}
