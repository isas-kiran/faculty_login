...
<title>Enrollment GST Tally Report</title>
...
?>   
    		...
    		<form method="get" name="search">
				<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
                    ...
                    <tr>
                        ...
                        <td><a href="enrollment_tally_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>
                    </tr>          
				</table>
			</form>	
    	</td>
	...
	if($no_of_records)
	{
        ...
        <tr class="grey_td" >
            ...
            <td width="15%" align="center"><strong>Student Name</strong></td>
            ...
            <!--<td width="12%" align="center">Product</td>
            <td width="6%" align="center"><strong>Quantity</strong></td>
            <td width="8%" align="center"><strong>Rate</strong></td>
            <td width="6%" align="center"><strong>Disc Rate</strong></td>
            ...
            <td width="8%" align="center">Payment Details</td>-->
            </tr>
            ...
            while($val_query=mysql_fetch_array($my_db))
            {
                ...
                $sel_course_name="select course_name from courses where course_id='".$val_query['course_id']."'";
				...
				//echo '<td align="center" >'.$val_query['installment_display_id'].'</td>';
				...
				echo '<td align="center" >'.trim($data_name['name']).' - '.trim($val_query['enroll_id']).'</td>';
				echo '<td colspan="6"><table width="100%" class="table11"><tr>';
				
				$total_cgst +=$val_query['cgst_tax'];
				echo '<td align="center" width="20%">Sales @ '.($val_query['cgst_tax_in_percent']+$val_query['sgst_tax_in_percent']).'%</td>';
				$total_sgst +=$val_query['sgst_tax'];
				//echo '<td align="center">'.$val_query['sgst_tax'].'</td>';
				echo '<td align="center" width="40%">'.$data_course_name['course_name'].'</td>';
				echo '<td align="center" width="10%">1</td>';
				
				$total_net +=$val_query['net_fees'];
				//$total_amnt =number_format($val_query['net_fees']-$val_query['cgst_tax']-$val_query['sgst_tax'],2,'.','');
                ...
                echo '<td align="center" width="10%">'.number_format($Original_Cost,3,'.','').'</td>';
				echo '<td align="center" width="10%">0</td>';
				echo "<td align='center' width='10%'>".number_format($Original_Cost,3,'.','')."</td>";
				...
				echo '</tr>';
				echo '<tr>';
				echo '<td align="center">Output CGST '.$val_query['cgst_tax_in_percent'].' %</td>';
				echo '<td align="center"></td>';
				echo '<td align="center"></td>';
				echo '<td align="center"></td>';
				echo '<td align="center"></td>';
				echo '<td align="center">'.number_format($total_gst_amnt,3,'.','').'</td>';
				echo '</tr>';
				echo '<tr>';
				echo '<td align="center">Output SGST '.$val_query['sgst_tax_in_percent'].' %</td>';
				echo '<td align="center"></td>';
				echo '<td align="center"></td>';
				echo '<td align="center"></td>';
				echo '<td align="center"></td>';
				...
				echo '<td align="center"></td>';
				echo '<td align="center"></td>';
				echo '<td align="center">'.number_format($Original_Cost+$total_gst_amnt+$total_gst_amnt,3,'.','').'</td>';// $val_query['net_fees']
				echo '</tr>';
				echo '</table></td>';
...
//                    echo "<br/>Bank Name- ".$data_bank['bank_name']."<br/>Acc. No.- ".$data_bank['account_no']."<br/> Ref No.- ".$val_query['bank_ref_no']."<br/>";
                ...
                $totals_tds +=number_format($val_query['amount'],2);
            ...
            <tr class="grey_td">
                ...
                <td align="center"><span style='color:red'><strong><?php echo number_format($total_net,2,'.',''); ?></strong></span></td>
                <td align="center"><span style='color:red'><strong>0</strong></span></td>
                <td align="center"><span style='color:red'><strong><?php echo number_format($total_amnt,2,'.',''); ?></strong></span></td>
