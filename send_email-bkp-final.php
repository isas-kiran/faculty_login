<?php 
/*15-3-21 - Change in Installlment mail*/
...
<?php require 'PHPMailer-5.2.14/class.phpmailer.php';	
	...
	try {
		...
		$mail->Username = 'infoisas@isasbeautyschool.com';                   // SMTP username
        $mail->Password = 'Isas!@!007';                            // SMTP password
		...
		$mail->addReplyTo('info@isasbeautyschool.com', 'ISAS');  //Set an alternative reply-to address
		...
		if($_POST['action']=='inquiry')
		{
			...
			$sel_branch="select old_branch_address,branch_name from branch where branch_name='".$_POST['branch_name']."'";
			$ptr_br=mysql_query($sel_branch);
			...
			{
				$address= '<strong>Our Address: </strong>International School of Aesthetics and Spa, 2nd Floor, The Greens,North Main Road, Koregoan Park, Pune-411001. <br/>Website: <a href="https://isasbeautyschool.com" target="_blank" >https://isasbeautyschool.com</a>  ';
				//<br/>Location: <a href="https://bit.ly/2yOhji6" target="_blank" >https://bit.ly/2yOhji6</a>  <br/>Events - <a href="https://bit.ly/2O2uDTU" target="_blank" >https://bit.ly/2O2uDTU</a> <br/> Student artwork - <a href="https://bit.ly/2La2VXz" target="_blank" >https://bit.ly/2La2VXz</a>  <br/>Institute Photos: <a href="https://bit.ly/2O2qO0Q" target="_blank" >https://bit.ly/2O2qO0Q</a>
			}
			else if($_POST['branch_name']=="Ahmedabad")
			{
				$address= '<strong>Our Address: </strong>International School of Aesthetics and Spa, First Floor, Zodiac Plaza,Near Nabard Flat, H.L. Comm. College Road, Navrangpura, Ahmedabad- 380 009.Tel No-:079-26300007. <br/>Website: <a href="https://isasbeautyschool.com" target="_blank" >https://isasbeautyschool.com</a> ';
				//<br/>Location: <a href="https://bit.ly/2N28vbw" target="_blank" >https://bit.ly/2N28vbw</a> <br/>Events: <a href="https://bit.ly/2O2uDTU" target="_blank" >https://bit.ly/2O2uDTU<a/> <br/>Student artwork: <a href="https://bit.ly/2La2VXz" target="_blank" >https://bit.ly/2La2VXz</a> <br/>Institute photos: <a href="https://bit.ly/2uzwfMx" target="_blank" >https://bit.ly/2uzwfMx</a>
			}
			else if($_POST['branch_name']=="ISAS PCMC")
			{
				$address= '<strong>Our Address: </strong>Hari A1,Next to ABS Gym, Pimple Nilakh, Pune 411027. <br/>Website: <a href="https://isasbeautyschool.com" target="_blank" >https://isasbeautyschool.com</a> ';
				//<br/>Location: <a href="https://bit.ly/2Ke26fQ" target="_blank" >https://bit.ly/2Ke26fQ</a> <br/>Events - <a href="https://bit.ly/2O2uDTU" target="_blank" >https://bit.ly/2O2uDTU</a> <br/>Student artwork: <a href="https://bit.ly/2La2VXz" target="_blank">https://bit.ly/2La2VXz" target="_blank</a> <br/>Institute photos: <a href="https://bit.ly/2LrF6JM" target="_blank" >https://bit.ly/2LrF6JM</a>
			}*/
			$address=$data_br['old_branch_address'];
			
			$search_by=array("student_name", "course_name", "branch_name", "mobile_no","address");
			$replace_by=array(ucwords($_POST['firstname'].' '.$_POST['lastname']), $data_course['course_name'], $_POST['branch_name'], $staff_contact,$address);
			$messagessss = str_replace($search_by, $replace_by, $email_text_msg);
			$message .=$messagessss;
			
			//$message.='<tr><td colspan="2" width="100%%" align="left">Hello '.$_POST['firstname'].' '.$_POST['lastname'].', Thank you for showing interest in '.$data_course['course_name'].' course. We appreciate your inquiry with our '.$_POST['branch_name'].' branch. For more details you can get touch with us on  <a href="tel:'.$staff_contact.'">'.$staff_contact.'</a> .<br/><br/> '.$address.'</td></tr>';
				
			$message.='<tr></tr></table>';
			$message.='<table style="max-width:600px;min-width:280px;border:1px solid #cccccc" cellspacing="0" cellpadding="0" border="0" align="center">
					<tbody>
					<tr>
					  <td height="20"></td>
					</tr>
		...
		if($_POST['action']=='add_new_course')
		{
			...
			$mail->Subject = $_POST['name'].' has Upgraded Course to '.$_POST['course_id'].' ( '. $_POST['branch_name'].' Branch)';
			$message.= '<table cellpadding="3" align="left" cellspacing="3" width="100%" style="color:black;" >';
			...
			$search_by=array("student_name", "course_name", "branch_name", "mobile_no","address");
			$replace_by=array(ucwords($_POST['name']), $data_course['course_name'], $_POST['branch_name'], $staff_contact,$address);
			$messagessss = str_replace($search_by, $replace_by, $email_text_msg);
			$message .=$messagessss;
		...
		if($_POST['action']=='add_inventory')
		{
			...
			//$mail->addBCC($_POST['mail']); 
			$mail->Subject ='Product Purchase From '.$cust_name.' in '.$branch_names.' branch on '.date('Y-m-d').'';
			$message .='
			<table align="center" border="1px"  width="100%" style="border-left:solid #999 1px; border-right:solid #999 1px; border-top:solid #999 1px;border-radius:5px; border-collapse:collapse">
            	<tr>
                  	<td valign="top" width="15%" rowspan=2><img src="https://bit.ly/2ScNBbg" width="150" height="120" title="Isasbeautyschool "/></td>
		...
		if($_POST['action']=='enroll')
		{
			...
			//$mail->addBCC($_POST['mail']); 
			$mail->Subject = 'Congratulatation '.$_POST['name'].'! Your Enrollment With ISAS Beauty School Is Successfully Placed.';
			...
			//$message .='<tr><td colspan="2" width="100%%" align="left">Congratulations <strong>'.$_POST['name'].'</strong> .<br/>You have been admitted to ISAS international Beauty School, '.$_POST['branch_name'].'. We are pleased to welcome you to ISAS family and are excited to get you started on your next step. We look forward to provide you with a fruitful learning experience and are happy to assist you along the way. This is your official letter of admission, so please retain this e-mail for your records as it contains important information. Attached is the handbook which will help you to understand the rules and regulations of ISAS International Beauty School. Your batch start date will be soon informed by our team.In case you have any queries, please write to us at info@isasbeautyschool.com or reach at below address <br/>'.$address.'<br/><br/>All the best<br/>Thanks & warm regards<br/>ISAS International beauty school</td></tr>';
			...
			if($_POST['action']=='add_payment')
			{
				...
				if(trim($_POST['users_mail']) !='')
				{
					...
					//$mail->addBCC($_POST['mail']); 
				$mail->Subject = 'Hi, '.$_POST['name'].' Your Installment Amount For Course '.$_POST['course_name'].' Is Received Successfully  - ISAS ('.$_POST['branch_name'].') ';
				/*$message= '
				<table cellpadding="3" align="left" cellspacing="3" width="100%" border="1" style="border-collapse: collapse;background-color:#98bb49 " >
				...
				$message.='<tr></tr></table>';*/
				$message.= 'Hi, '.$_POST['name'].' <br/> Your Installment Amount For Course '.$_POST['course_name'].' Is Received Successfully. ';
			}
