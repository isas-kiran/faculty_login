...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
    ...
    <td class="mid_mid">
                        ...
                        <tr><td colspan="2">
							<table align="center" border="1px" width="100%" cellpadding="2" cellspacing="0" bgcolor="#EFEFEF" >
                        	<tr bgcolor="#A8A8A8">
                            	<td width="18%" align="left"  style="padding-left:10px;"><span style=" font-weight:bold">Course Fee</span></td>
                            ...
                            <tr>
                                ...
                                <td align="left"  style="padding-left:10px;"><span style="font-weight:bold"><?php echo $col_paid.$data_select['paid_status']; ?></span></td>
                         ...
                         <?php
						$sel_outstand="select * from enroll_outstanding where enroll_id='".$record_id."'";
						...
						if(mysql_num_rows($ptr_outstand))
						{
							...
							<tr>
								<td colspan="2">
									<table align="center" border="1px" width="100%" cellpadding="2" cellspacing="0" bgcolor="#EFEFEF" >
									<tr bgcolor="#A8A8A8">
										<td width="20%" align="left"  style="padding-left:10px;"><span style=" font-weight:bold">Type</span></td>
										<td width="20%" align="left"  style="padding-left:10px;"><span style="font-weight:bold">Amount</span></td>      
										<td width="45%" align="left"  style="padding-left:10px;"><span style="font-weight:bold">Reason</span></td>
									</tr>
									<tr>
										<td align="left"  style="padding-left:10px;"><span style="font-weight:bold"><?php echo $data_outstand['type']; ?> </span></td>
										<td align="left"  style="padding-left:10px;"><span style=" font-weight:bold"><?php echo $data_outstand['amount']; ?></span></td>
                        ...
                        <tr><td colspan="2" align="center" style=" font-size:12px; font-weight:bold"><strong>Action (Enrollment Related)</strong></td></tr>
                             ...
                             <tr><td colspan="2">
							<table align="center" border="0px" width="100%" cellpadding="4" cellspacing="0" bgcolor="#EFEFEF">
                        ...
                        <tr>
							...
							<tr>
								<td colspan="2">
									...
									<?php
									$sel_courses="SELECT course_id,course_status FROM enrollment where 1 and ref_id='".$record_id."' or enroll_id='".$record_id."' ".$_SESSION['where']." ";
									...
									while($data_course=mysql_fetch_array($ptr_courses))
									{
										...
										"<br/>".$select_name="select course_name,course_id,is_parent from courses where course_id='".$data_course['course_id']."'";
										...
										echo'</td>';
										echo '<td>';
										echo "<b>".$data_name['course_name']."</b><input type='hidden' name='course_id_".$c."' id='course_id_".$c."' value='".$data_name['course_id']."' ><br/>";
										echo '</td>';
										"<br/>".$sel_data="select status,theory_grade,practical_grade,course_status_date from action_certificate where course_id='".$data_name['course_id']."'";
										...
										$sel_child="select course_name,course_id from courses where parent_id='".$data_name['course_id']."'";
										...
										if($totals_course=mysql_num_rows($ptr_child))
										{
											...
											while($data_child=mysql_fetch_array($ptr_child))
											{
												...
												echo '<tr>';
												echo '<td></td>';
												echo '<td><span style="padding-left:15px">'.$ch.') '.$data_child['course_name'].'</span><input type="hidden" name="course_id_'.$c.'_'.$ch.'" id="course_id_'.$c.'_'.$ch.'" value="'.$data_child['course_id'].'" ><br/></td>';
												...
												echo '<td><input type="text" name="theory_grade_'.$c.'_'.$ch.'" '.$disabled_grades.' value="'.$theory_grade.'" /></td>';
												echo '<td><input type="text" name="practical_grade_'.$c.'_'.$ch.'" '.$disabled_grades.' value="'.$practical_grade.'" /></td>';
												echo '</tr>';
												$ch++;
											}
										}
										echo'<input type="hidden" name="total_course_'.$c.'" id="total_course_'.$c.'" value="'.$totals_course.'" >';
										echo '<tr><td colspan="6"><hr class="hr_line"></td></tr>';
										...
										<tr>
											<td colspan="6" align="center"><input type="button" name="print certificate" <?php echo $disable_issue_certificate; ?> value="Print Certificate" onclick="get_url();"></td>
										</tr>
										<?php
