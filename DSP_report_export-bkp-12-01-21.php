 ...
 $objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow('3','3', 'Mo No','3');
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow('13','3', 'Status','3');*/
	...
	//=========================1======================
		...
		while($data_couc=mysql_fetch_array($ptr_counc))
		{
			$select_inst="select enroll_id from enrollment where 1 and ref_id='0' and assigned_to='".$data_couc['admin_id']."' ".$_SESSION['where']." ".$search_cm_id."  ".$added_date." ";
		...
		while($data_couc=mysql_fetch_array($ptr_counc))
		{
			$select_enroll="select enroll_id from enrollment where 1 and ref_id='0' and assigned_to='".$data_couc['admin_id']."' ".$_SESSION['where']." ".$search_cm_id." and DATE(`added_date`) >= '".$date_for_month."-01'  ".$end_added_date." ";
		...
		while($data_couc=mysql_fetch_array($ptr_counc))
		{
			$select_enroll="select enroll_id from enrollment where 1 and ref_id!='0' and assigned_to='".$data_couc['admin_id']."' ".$_SESSION['where']." ".$search_cm_id."  ".$added_date." ";
			$query_enroll=mysql_query($select_enroll);
		...
		while($data_couc=mysql_fetch_array($ptr_counc))
		{
			$sel_exst_foll="SELECT * FROM inquiry where 1 and status = 'Enquiry' and employee_id='".$data_couc['admin_id']."' ".$search_cm_id." <strong></strong> and (response !='7' and response!='8' or response is NULL) ".$followup_from_date." ".$end_followup_date." order by inquiry_id desc";
		...
		while($data_couc=mysql_fetch_array($ptr_counc))
		{
			...
			$sel_recv_amnt="select SUM(i.installment_amount) as total_amnt from installment i, enrollment e where 1 and i.enroll_id=e.enroll_id and e.assigned_to='".$data_couc['admin_id']."' ".$search_cm_id_e."  and DATE(i.installment_date) >= '".$date_for_month."-01'  ".$last_installment_date_i." and (e.added_date NOT BETWEEN ('".$first_date_month."') and ('".$last_date_month."')) ";
		...
		while($data_couc=mysql_fetch_array($ptr_counc))
		{
			$sel_recv_amnt="select SUM(i.installment_amount) as total_amnt from installment i, enrollment e where 1 and i.enroll_id=e.enroll_id and e.assigned_to='".$data_couc['admin_id']."' ".$search_cm_id_e."  ".$from_last_installment_month." ".$to_last_installment_month." ";
			$query_recv_amnt=mysql_query($sel_recv_amnt);
			$data_recv_amnt=mysql_fetch_array($query_recv_amnt);
		...
		while($data_couc=mysql_fetch_array($ptr_counc))
		{
			$sel_recv_amnt="select SUM(i.installment_amount) as total_amnt from installment i, enrollment e where 1 and i.enroll_id=e.enroll_id and e.assigned_to='".$data_couc['admin_id']."' ".$search_cm_id_e." ".$from_second_last_installment_month." ".$to_second_last_installment_month." ";
			$query_recv_amnt=mysql_query($sel_recv_amnt);
			$data_recv_amnt=mysql_fetch_array($query_recv_amnt);
		...
		while($data_couc=mysql_fetch_array($ptr_counc))
		{
			$sel_recv_amnt="select SUM(i.installment_amount) as total_amnt from installment i, enrollment e where 1 and i.enroll_id=e.enroll_id and e.assigned_to='".$data_couc['admin_id']."' ".$search_cm_id_e." ".$from_second_last_installment_month." ".$end_installment_date_i." ";
			$query_recv_amnt=mysql_query($sel_recv_amnt);
			$data_recv_amnt=mysql_fetch_array($query_recv_amnt);
		...
		while($data_couc=mysql_fetch_array($ptr_counc))
		{
			...
			$sel_tot="select enroll_id,net_fees from enrollment where 1 and assigned_to='".$data_couc['admin_id']."' ".$search_cm_id." ".$_SESSION['where']." ".$first_day_of_current_month." ".$to_last_day_of_current_month." ";
		...
		while($data_couc=mysql_fetch_array($ptr_counc))
		{
			$select_rev="select * from action_final i, enrollment e where 1 and i.enroll_id=e.enroll_id and i.google_action='yes' and e.employee_id='".$data_couc['admin_id']."' ".$_SESSION['where']." ".$cm_ids." ".$search_cm_id_e." ".$added_date_i." ";
		...
		{
			$crs_price ='';
			$select_ni="select * from action_final i, enrollment e where 1 and i.enroll_id=e.enroll_id and i.video_action='yes' and e.employee_id='".$data_couc['admin_id']."' ".$_SESSION['where']." ".$cm_ids." ".$search_cm_id_e." ".$added_date_i." ";
			$query_ni=mysql_query($select_ni);
