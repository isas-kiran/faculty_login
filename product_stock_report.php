...
<?php
$edit_access='';
$sel_acc="select * from edit_previleges where admin_id='".$_SESSION['admin_id']."' and privilege_id='348'";
  ...
  <tr class="head_td">
        ...
        <form method="get" name="search">
			<table border="0" cellspacing="0" cellpadding="0" width="99%" align="center">
              <tr>
				...
				<td> <a href="product_stock_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>  
    ...
    <?php
						...
						{*/
							...
							//and (p.product_name like '%".$keyword."%' or p.product_code like '%".$keyword."%' or p.description like '%".$keyword."%' or p.size like '%".$keyword."%' or p.commission like '%".$keyword."%' or p.price like '%".$keyword."%' or pc.pcategory_name like '%".$keyword."%' or sub.sub_name like '%".$keyword."%' )
                        ...
                        if($no_of_records)
                        {
                           ...
                           // $pager = new PS_Pagination($sql_query,$_SESSION['show_records'],$_SESSION['show_records_pages'],$query_string1);
                            ...
                            <tr class="grey_td" >
                                ...
                                <td width="3%" align="center"><strong>Branch Name</strong></td>
                                ...
                                <!--<td width="4%" align="center"><strong>Purchase Qty</strong></td>
                                <td width="3%" align="center"><strong>Sold Quantity</strong></td>
                                <td width="3%" align="center"><strong>Issued Quantity</strong></td>-->
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
								...
								echo '<td >'.$data_br['branch_name'].'</td>';
                                echo '<td >'.$val_query['product_name'].'</td>';							
								
								$sel_purchase="select SUM(ip.sin_product_qty) as purchase_quantity from inventory_product_map ip, inventory i where ip.product_id='".$listed_record_id."' and ip.inventory_id=i.inventory_id";
								$ptr_purchase=mysql_query($sel_purchase);
								$data_purchase=mysql_fetch_array($ptr_purchase);
								
								$sel_sales="select SUM(sp.product_qty) as sales_quantity from sales_product_map sp, sales_product s where sp.product_id='".$listed_record_id."' and sp.sales_product_id=s.sales_product_id";
								$ptr_sales=mysql_query($sel_sales);
								$data_sales=mysql_fetch_array($ptr_sales);
								
								$sel_checkout="select SUM(issue_qty) as issue_qty from checkout_product_map where product_id='".$listed_record_id."'";
								$ptr_checkout=mysql_query($sel_checkout);
								$data_checkout=mysql_fetch_array($ptr_checkout);
								
								/*echo '<td align="center">'.$data_purchase['purchase_quantity'].'</td>';
								echo '<td align="center">'.$data_sales['sales_quantity'].'</td>';
								echo '<td align="center">'.$data_checkout['issue_qty'].'</td>';*/
