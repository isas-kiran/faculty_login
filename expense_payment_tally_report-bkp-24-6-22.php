...
<title>Expense Payment Tally Report</title>
...
?>   
    ...
    <tr>
        ...
        <td><a href="expense_payment_tally_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>
    </tr>          
</table>
</form>	
    </td>
	...
	{
		$pay_type=" and i.payment_mode_id='".$_REQUEST['pay_type']."'";
	}
	$bank_ids="";
	if($_REQUEST['bank_id'] !='')
	{
	...
	$select_directory=' order by DATE(i.added_Date) asc,DATE(i.ext_invoice_no) desc';
	
	$sql_query= "select i.* from expense i where 1 ".$search_cm_id." ".$pre_keyword_i." ".$pay_type." ".$bank_ids." ".$paid_from_date." ".$paid_to_date." ".$select_directory." "; //and amount>0
	...
	if($no_of_records)
	{
        ...
        <tr class="grey_td" >
            ...
            <td width="12%" align="center"><strong>To</strong></td>
            ...
            while($val_query=mysql_fetch_array($my_db))
            {
				...
				echo '<td align="center">'.round($val_query['total_price'],2).'</td>';
				echo '<td align="center">Paid for expenses</td>';
