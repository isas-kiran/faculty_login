...
if($_POST['save_changes'])
{
	...
	?>
	<script>
		setTimeout('document.location.href="print_certificate_biotop.php?record_id=<?php echo $record_id; ?>&course_id=<?php echo $course_id; ?>";',1000);
	</script>
	<?php
}
	?>
<div class="container">
	<img src="images/biotop.jpg" alt="Certificate Level" style="width:100%;">
