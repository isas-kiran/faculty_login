  ...
  <tr class="head_td">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="99%" align="center">
     ...
     <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='firstname'))
                        {
                         ...
                         $sql_query= "select enroll_id,admission_date from enrollment where 1 ".$_SESSION['where']." ".$search_cm_id." ".$pre_from_date."  ".$pre_to_date."  ".$select_directory.""; 
                       
					   	$db=mysql_query($sql_query);
                        $no_of_records=mysql_num_rows($db);
						
						 $select_enquiry="select inquiry_id from inquiry where 1 ".$_SESSION['where']." ".$search_cm_id." ".$enquiry_from_date." ".$enquiery_to_date."";
    ...
    <form method="post"  name="frmTakeAction"  action="<?php echo $_SERVER['PHP_SELF'].'?#msgbox';?>">
					...
					//	echo ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>".$c_month=;
						...
						?>
                        <td width="10%" align="center"><strong><?php echo $m; ?></strong></td>
