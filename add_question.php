...
if($_REQUEST['record_id'])
{
    ...
    $sql_record= "SELECT * FROM PB_questions where question_id='".$record_id."'";
...
<title><?php if($record_id) echo "Edit"; else echo "Add";?> Question</title>
    ...
    <td class="mid_mid">
        ...
        <?php
            ...
            <tr><td> <br></br>
                            ...
                            {
                                $success=1;
                                $data_record['question'] =nl2br($title);
                                $data_record['answer'] =strip_tags($description); 
                                $data_record['course_id']=$category;

                               if($record_id)
                                {
                                    $where_record=" question_id='".$record_id."'";
                                    $db->query_update("questions", $data_record,$where_record);
                                    echo '<br></br><div id="msgbox" style="width:40%;">Record updated successfully</center></div><br></br>';
                                }
                                else
                                {
                                    $data_record['added_date'] =date("Y-m-d H:i:s");
                                    $record_id=$db->query_insert("questions", $data_record);
	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%">
            ...
            <tr>
              ...
              <tr>
                ...
                <td width="70%"><input type="text"  class="validate[required] input_text" name="title" id="title" value="<?php if($_POST['save_changes']) echo $_POST['title']; else echo $row_record['question'];?>" /></td> 
                <td width="10%"></td>
              </tr>
             <tr>
                  ...
                  <td>
                      <?php
                                    ...
                                    if($_POST['save_changes'])
                                        ...
                                        $oFCKeditor->Value		= stripslashes($row_record['answer']);
              ...
              <tr>
                  <td>&nbsp;</td>
                  <td><input type="submit" class="input_btn" value="<?php if($record_id) echo "Update"; else echo "Add";?> Questions" name="save_changes"  /></td>
                  <td></td>
              </tr>
        </table>
        </form>
