...
$sel_log="select course_id from logsheet where logsheet_id='".$record_id."'";
...
{
	alert(no);
	var new_id='extraval'+no;
	var i=parseInt(document.getElementById(new_id).value);
	alert(i);
	i=i+1;
	alert(i);
	var next = parseInt(i+1);
	var idss=no;
	var next_id='extratopic'+i;
	var next_topic='extratopic'+next;
	if(document.getElementById(next_id).style.display=='none')
	{
		alert("hello");
	...
	else
	{
		...
		var value='<div id="extratopic'+i+'"><table class="table_class" width="100%"  cellspacing="0" cellpadding="2"> <tr><td valign="top" width="8%" align="center"><input type="text" name="day_'+no+'_'+i+'" id="day_'+no+'_'+i+'" style="width:40px" value="'+no+'" required/></td><td valign="top" width="20%" align="center"><select name="subject_'+no+'_'+i+'" id="subject_'+no+'_'+i+'" style="width:200px" onchange="select_topics('+no+',this.value)"><option value="">Select Subject '+no+'</option>'+res+'</select></td><td valign="top" width="20%" align="center" id="topic_val_'+no+'_'+i+'"><select name="topic_'+no+'_'+i+'" id="topic_'+no+'_'+i+'" style="width:200px" ><option value="">Select Topic '+no+'</option></select></td><td valign="top" width="30%" align="center"><textarea name="topic_content_'+no+'_'+i+'" placeholder="Topic Contetnt '+no+'" id="topic_content_'+no+'_'+i+'" title="Topic Content '+no+'" value="" style="width:100%;height:30px"></textarea></td><td valign="top" width="12%" align="center"><input type="text" name="model_'+no+'_'+i+'" id="model_'+no+'_'+i+'" style="width:50px" ></td></tr></table></div> <div id="'+next_topic+'"></div>';
		document.getElementById(next_id).innerHTML= value;
		document.getElementById(new_id).value=i;
	}
}  
</script>
</head>
	...
	?>
                      ...
                      <?php
                            ...
                            <tr>
                                ...
                                <td width="40%" class="customized_select_box"><input type="text" name="logsheet" id="logsheet" class="validate[required] input_text" style="width:400px" /></td>
                            </tr>
                            <tr>
                                <td colspan="3">
                                        ...
                                        <tr>
                                            ...
                                            if($record_id)
                                            {
												...
												{ 
													...
													<tr>
													<td width="10%" align="center"><input type="text" name="day<?php echo $t; ?>" id="day<?php echo $t; ?>" value="<?php echo $data_exclusive['day'] ?>" style="width:40px" /></td>
                                                    ...
                                                    <textarea name="topic_content<?php echo $t; ?>" placeholder="Topic Contetnt" id="topic_content<?php echo $t; ?>" title="Topic Content <?php echo $t; ?>" value="" style="width:100%;height:30px"><?php echo $data_exclusive['topic_content']; ?></textarea></td>
...
if($record_id!='')
{
	...
	//alert(vendor_id);
	setTimeout(select_course(course_id),500);
    //create_floor('add');
