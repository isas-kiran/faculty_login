...
<title>Purchase Tally Report</title>
						...
						<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
              				<tr>
                				<td class="width5"></td>
                        			...
                        			<td><a href="purchase_tally_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>  
            					</tr>          
        					</table>
        				</form>	
    				</td>
		...
		while($val_query=mysql_fetch_array($my_db))
		{
			...
			if($tot_prod=mysql_num_rows($ptr_prod))
			{
				while($data_prod=mysql_fetch_array($ptr_prod))
				{
					...
					{
						$tot_disc=number_format(($data_prod['total_val'] * $val_query['discount'] ) / 100,3,'.','');
						$tot_disc_price=number_format($data_prod['total_val'] - $tot_disc,3,'.','') ;
						$disc=$val_query['discount'];
					}
					if(($data_prod['total_val'] <=0 || $data_prod['total_val']='') && $data_prod['product_disc']=='100')
					{
			...
			echo '<td align="center" width="10%"></td>';
			echo '<td align="center" width="10%"></td>';
			//echo "<br/>".$tot_disc_price_gst."-".$tot_disc_price_igst."-".$tot_disc_price."-".$tot_cgst."-".$tot_sgst."-".$tot_igst;
