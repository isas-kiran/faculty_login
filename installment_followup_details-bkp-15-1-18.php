  ...
  <tr class="head_td">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="99%" align="center">
              <tr>
                ...
                <td  align="right"><a href="installment_followup_summery.php?record_id= <?php echo $record_id; ?>"><input type="button" name="update_followup" value="Update Followup" /></a></td>
                <td  align="right"><a href="installment_followup_summery.php"><input type="button" name="back" value="Back" /></a></td>
                <td class="rightAlign" > 
    ...
    <?php
                        ...
                        $sql_query= "select * from installment_followup_details where student_id ='".$record_id."' ".$_SESSION['where']." ".$pre_keyword." ".$select_directory.""; 
						//echo $sql_query;
					   	$db=mysql_query($sql_query);
