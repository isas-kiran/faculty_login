 ...
 function validme()
	 {
		 ...
		 return true;
                      ...
                      <?php
                                $sql_records= "SELECT * FROM payment_mode where 1 ".$pre_transcation_id." order by payment_mode_id asc";
								...
								<tr align="center" class="grey_td" ><td width="7%" class="tr-header"><strong>Sr.</strong></td><td width="11%" class="tr-header"><strong>Name</strong></td><td width="12%" class="tr-header"><strong>Action</strong></td></tr><?php
