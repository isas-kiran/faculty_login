                            ...
                            if($diff)
                            {
                                ...
                                for($i=0;$i<$data_difs;$i++)
                                {
                                    ...
                                    while($data_pur=mysql_fetch_array($ptr_pur))
                                    {
                                        ...
                                        echo "<span style='color:blue'>".$tot_gst_inv."</span> - ".$data_pur['payable_amount']." ".$qty."/ ".$data_pur['cgst_tax_in_per']."% + ".$data_pur['sgst_tax_in_per']."% <span style='color:brown'>(".$pay_type['payment_mode'].")</span> - (".$data_v_name['name'].")<br/>";
                                        $tot_pur +=$tot_gst_inv;
                                    }
                                    if($tot_pur>0)
