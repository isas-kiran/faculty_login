...
$select_directory='order by enroll_id desc';                      
  ...
  $sel_for_Num_rows="SELECT * FROM enrollment where 1 and ref_id='0' ".$_SESSION['where']." ".$country." ".$state." ".$city." ".$search_cm_id." ".$pre_keyword." ".$select_directory."";
...
//$objPHPExcel->setActiveSheetIndex(0);
 ...
 $objPHPExcel->setActiveSheetIndex(0)->SetCellValue('D4', 'Email ID','6');
  ...
  $objPHPExcel->setActiveSheetIndex(0)->SetCellValue('L4', 'Country','6');
  $objPHPExcel->setActiveSheetIndex(0)->SetCellValue('M4', 'State','6');
  $objPHPExcel->setActiveSheetIndex(0)->SetCellValue('N4', 'City','6');
  $objPHPExcel->setActiveSheetIndex(0)->SetCellValue('O4', 'Date','6');
 

	$select_directory='order by enroll_id desc';                      
	$sql_query= "SELECT * FROM enrollment where 1 and ref_id='0' ".$_SESSION['where']." ".$country." ".$state." ".$city." ".$search_cm_id." ".$pre_keyword." ".$select_directory.""; 
	...
	while($val_query=mysql_fetch_array($query_order))
	{
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('L'.$rowCount, $data_country['name']);
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('M'.$rowCount, $data_states['name']);
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('N'.$rowCount, $data_city['name']);	 
		/************************************Item rate******************************************/
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('O'.$rowCount, $val_query['added_date']);	
		/************************************Plan Date******************************************/
