...
<td class="width5"></td>
  ...
  if($page_name == 'create_question.php')
            ...
            <tr>
                <td class="tab2_left"></td>
                <td class="tab2_mid"><a href="create_question.php" style="color:#7CA32F;">Add Subject Quations </a></td>
                <td class="tab2_right"></td>
            </tr>
            <?php
            }
            ...
            <tr>
                <td class="tab_left"></td>
                <td class="tab_mid"><a href="create_question.php" style="color:#666666;">Add Subject Quations </a></td>
                <td class="tab_right"></td>
            </tr>
            <?php
            }
