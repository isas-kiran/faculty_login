        ...
        <?php
                        ...
                        if($_POST['save_changes'])
                        {
                            ...
                            else
                            {
								...
								//	$data_record_type2['exam_stoped'] ='yes';
								//	$data_record_type2['exam_intrupted'] ='yes';
								//	$data_record_type2['reattempt_permission'] ='yes';
									$data_record_type2['added_date'] =date('Y-m-d');
									
									$record_ids2=$db->query_insert("ex_stud_login", $data_record_type2);
									
									$sel = "select enroll_no from ex_student_exam_registration where enroll_no='".$_POST['new_selected'][$h]."'";
            ...
            <table border="0" cellspacing="15" cellpadding="0" width="100%">
                        ...
                        <td height="0" valign="top">Search <span class="orange_font"></span></td>
                  		<td colspan="3">           
                            <select name="search" id="search">
                                ...
                                <option value="enroll_no">enroll_no</option>
                    ...
                    <tr>
                        ...
                        <input type="hidden" name="total_ques_cnt" id="total_ques_cnt"  value="<?php if($record_id){ echo $row_record['total_ques'];} ?>" />
                        	<table width=100% style="border:1px solid; margin:0; padding:0" class="table"><tr><td width="10%" align="center">Enroll number</td><td width="10%">Student Name</td><td width="70%" align="center">course</td><td width="10%" align="center">Remove</td></tr>     
                            <tr><td colspan="4">   
