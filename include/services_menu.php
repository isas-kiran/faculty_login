    ...
    if($_SESSION['type'] =='S')
	{
	   ?>
		<td>
			<table border="0" cellspacing="0" cellpadding="0">
				<?php 
				if($page_name == 'manage_service_inquiry.php')
				{
				?>
				<tr>
					<td class="tab2_left"></td>
					<td class="tab2_mid"><a href="manage_service_inquiry.php" style="color:#7CA32F;">Manage Service Inquiry</a></td>
				...
				<tr>
					...
					<td class="tab_mid"><a href="manage_service_inquiry.php" style="color:#666666;">Manage Service Inquiry</a></td>
...
<td>
	<table border="0" cellspacing="0" cellpadding="0">
		<?php 
		if($page_name == 'service_inquiry.php')
		{
		?>
		<tr>
			<td class="tab2_left"></td>
			<td class="tab2_mid"><a href="service_inquiry.php" style="color:#7CA32F;">Add Inquiry</a></td>
			<td class="tab2_right"></td>
		</tr>
		<?php
		}
		...
		<tr>
			<td class="tab_left"></td>
			<td class="tab_mid"><a href="service_inquiry.php" style="color:#666666;">Add Inquiry</a></td>
			<td class="tab_right"></td>
		</tr>
		<?php
		}            
...
<td>
	<table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="tab2_left"></td>
                <td class="tab2_mid"><a href="manage_memb_package_voucher.php" style="color:#7CA32F;">Manage Voucher/Package</a></td>
                <td class="tab2_right"></td>
            </tr>
            <?php
            }
            ...
            <tr>
                <td class="tab_left"></td>
                <td class="tab_mid"><a href="manage_memb_package_voucher.php" style="color:#666666;">Manage Voucher/Package</a></td>
                <td class="tab_right"></td>
            </tr>
            <?php
            }            
...
<td>
	<table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="tab2_left"></td>
                <td class="tab2_mid"><a href="sale_memb_package_voucher.php" style="color:#7CA32F;">Sale Voucher/Package</a></td>
                <td class="tab2_right"></td>
            </tr>
            <?php
            }
            ...
            <tr>
                <td class="tab_left"></td>
                <td class="tab_mid"><a href="sale_memb_package_voucher.php" style="color:#666666;">Sale Voucher/Package</a></td>
                <td class="tab_right"></td>
            </tr>
            <?php
            }            
...
<td>
	<table border="0" cellspacing="0" cellpadding="0">
		<?php
        if($page_name == 'import_campaign_services.php')
        {
        ?>
        <tr>
            <td class="tab2_left"></td>
            <td class="tab2_mid"><a href="import_campaign_services.php" style="color:#7CA32F;">Import Campaign Services</a></td>
            <td class="tab2_right"></td>
        </tr>
        <?php
        }
        ...
        <tr>
            <td class="tab_left"></td>
            <td class="tab_mid"><a href="import_campaign_services.php" style="color:#666666;">Import Campaign Services</a></td>
            <td class="tab_right"></td>
        </tr>
        <?php
        }
...
<td>
	<table border="0" cellspacing="0" cellpadding="0">
		<?php
        //if($page_name == 'dsr_service_menu.php')
        //{
        ?>
        <tr>
            <td class="tab2_left"></td>
            <td class="tab2_mid"><a href="dsr_service_menu.php" style="color:#7CA32F;">DSR Service Report</a></td>
            <td class="tab2_right"></td>
        </tr>
        <?php
        /*}
        ...
        */?>
        <tr>
            <td class="tab_left"></td>
            <td class="tab_mid"><a href="dsr_service_menu.php" style="color:#666666;">DSR Service Report</a></td>
            <td class="tab_right"></td>
        </tr>
        <?php
        //}
			...
			for($f=0;$f<count($array_prev[$e]);$f++)
			{
				...
				?>
					...
					<table border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td class="tab2_left"></td>
							<td class="tab2_mid"><a href="service_inquiry.php" style="color:#7CA32F;">Service Inquiry</a></td>
							<td class="tab2_right"></td>
						</tr>
						<?php
						}
						...
						<tr>
							<td class="tab_left"></td>
							<td class="tab_mid"><a href="service_inquiry.php" style="color:#666666;">Service Inquiry</a></td>
							<td class="tab_right"></td>
						</tr>
						<?php
						}
...
/*else if($array_prev[$e][$f]['privilege_id']==287)
{
	...
	<td>
		<table border="0" cellspacing="0" cellpadding="0">
			<?php
			if($page_name == 'dsr_service_report.php')
			{
			?>
			<tr>
				<td class="tab2_left"></td>
				<td class="tab2_mid"><a href="dsr_service_report.php" style="color:#7CA32F;">DSR Service Report</a></td>
				<td class="tab2_right"></td>
			</tr>
			<?php
			}
			...
			<tr>
				<td class="tab_left"></td>
				<td class="tab_mid"><a href="dsr_service_report.php" style="color:#666666;">DSR Service Report</a></td>
				<td class="tab_right"></td>
			</tr>
			<?php
			}
