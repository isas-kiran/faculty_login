...
$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('D1', 'Product Category','6');
$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('E1', 'Product Sub Category','6');
$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('F1', 'Product Description','6');
$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('G1', 'Size','6');
$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('H1', 'Unit','6');
$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('I1', 'Commission (in %)','6');
...
$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('P1', 'Product ID','6');
