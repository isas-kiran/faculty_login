        ...
        <td colspan="3" style="padding-bottom:30px"><table style="border-top:1px solid #0066cc;" width="100%">
			...
			?>  
              <tr>
                ...
                <table width="100%">
                	<tr><td colspan="2"> <?php
				echo "<input class='input_btn' type='button' name='print' value='Print' title='Print' border='0' onclick=\"window.open('report_all_print_ques_ans_mgmt.php".$sep_url_string."','View Invoice','scrollbars=yes','resizable=yes','width=900,height=600')\" style='cursor:pointer;float:right' >";
				?></td></tr>
                     <?php
				    	/* $paper_id=$_GET['papers_id'];
					...
					?>
                  	<tr>
					   ...
					   ?>
                           <td colspan="2"> Unit Name:<?php echo $topic_name['topic_name']; ?></td>
