...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
        ...
        <?php
                    ...
                    <?php
                        ...
                        else
                        {
                           ...
                           "<br/>".$sel_sms_cnt="select name,enroll_id,contact from enrollment where enroll_id='".$_POST['requirment_id'][$h]."'";
									$ptr_sel_sms=mysql_query($sel_sms_cnt);
								 while($data_sel_cnt=mysql_fetch_array($ptr_sel_sms))
									{
										
											//send_sms_function($data_sel_cnt['contact'],$_POST['text']);
											send_sms_function($data_sel_cnt['contact'],$_POST['text'],$_POST['sms_type']);
						 ...
						 if($_POST['send_by']=='email')
						  ...
						  for($h=0;$h<count($_POST['requirment_id']);$h++)
							 ...
							 "<br/>".$sel_sms_cnt="select name,mail,enroll_id,contact from enrollment where enroll_id='".$_POST['requirment_id'][$h]."'";
							$ptr_sel_sms=mysql_query($sel_sms_cnt);
							while($data_sel_cnt=mysql_fetch_array($ptr_sel_sms))
									{
										
										$insert_sms="insert into sms_log_history (`name`,`mobile_no`,`sms_text`,`sms_type`,`cm_id`,`added_date`) values('".$data_sel_cnt['name']."','".$data_sel_cnt['mail']."','".$_POST['mail_text']."','".$_POST['send_by']."','".$cm_id."','".$start_date."')";
										$ptr_sms=mysql_query($insert_sms);
						 if(isset($data_sel_cnt['mail'])) {					
 
    // EDIT THE 2 LINES BELOW AS REQUIRED
    "</br>".$email_to = $data_sel_cnt['mail'];
    "</br>".$email_subject = $_POST['subject'];
	...
	$email_from="tejashwishinde09@gmail.com";
...
@mail($email_to, $email_subject, $email_message, $headers);  
	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%">
            ...
            <tr>
                ...
                <td width="38%" >
                    <select name="batch_id" id="batch_id" class="validate[required] input_select" onChange="course_ajax(this.value);">  
