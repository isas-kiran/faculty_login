...
?>
  ...
  <tr class="head_td">
    ...
    <?php
						...
						if($_SESSION['type']=='AG')
						{             
                       		$sql_query= "SELECT * FROM enrollment where 1 and inquiry_added_by='".$_SESSION['admin_id']."' ".$record_cat_id." and ref_id='0' ".$_SESSION['where']." ".$enquiry_src." ".$assigned_to." ".$from_date." ".$to_date." ".$country." ".$state." ".$city." ".$search_cm_id." ".$pre_keyword." ".$source_id." ".$select_directory.""; 
						}
						else
						{
							$sql_query= "SELECT * FROM enrollment where 1 ".$record_cat_id." and ref_id='0' ".$_SESSION['where']." ".$enquiry_src." ".$assigned_to." ".$from_date." ".$to_date." ".$country." ".$state." ".$city." ".$search_cm_id." ".$pre_keyword." ".$source_id." ".$select_directory.""; 
						}
						//echo $sql_query;
