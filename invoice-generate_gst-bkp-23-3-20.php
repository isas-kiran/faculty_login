    ...
    <div class="heightSpacer"></div>
                        ...
                        <table align="center" border="1px"  width="786" cellpadding="0" cellspacing="0" bgcolor="#EFEFEF" style=" border:1px solid;" >
	                       	<tr>
                                ...
                                <td width="24%" align="left"  style="padding-left:10px;width:20%"><span style="font-size:15px; font-weight:bold">GST Tax No.</span></td><td width="29%" width:20% align="center"><font size="2px;"><strong><?php echo $gst_no; ?></strong></font> </td>
							</tr>
                            <tr>
                            	<td align="left"  style="padding-left:10px; width:20%"><span style="font-size:15px; font-weight:bold">Last Receipt No.</span></td><td width:20% align="center">
								<?php if($data_last_invoice_id['invoice_id']) echo $data_last_invoice_id['invoice_id']; else echo '#'; ?>
                                </td>
                                <td align="left"  style="padding-left:10px;width:20%"><span style="font-size:15px; font-weight:bold">Invoice No.</span></td><td width:20% align="center"><font size="2px;">
								<?php
