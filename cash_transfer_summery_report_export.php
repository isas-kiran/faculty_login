...
$total_found =0;	
	...
	if($_REQUEST['keyword']!="Keyword")
  	...
  	$sel_for_Num_rows="select * from receipt where 1 and category ='cash_transfer' and cash_transfer_mode!='inword' ".$pre_keyword_i." ".$category." ".$bank_ids." ".$paid_from_date." ".$paid_to_date." ".$select_directory." ";	
...
$objPHPExcel->setActiveSheetIndex(0);
 ...
 $objPHPExcel->setActiveSheetIndex()->setCellValueByColumnAndRow('3','3', 'Mo No','3');
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValueByColumnAndRow('13','3', 'Status','3');*/
	...
	$branch_id='';
	$select_directory='order by DATE(added_Date) desc';                         
	 $sql_query= "select * from receipt where 1 and category ='cash_transfer' and cash_transfer_mode!='inword' ".$pre_keyword_i." ".$category." ".$bank_ids." ".$paid_from_date." ".$paid_to_date." ".$select_directory." "; 
...
header('Content-Disposition: attachment;filename="cash_summury_report.xls"');
