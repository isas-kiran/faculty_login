...
<title>Certificate Makeup</title>
...
{
	  $insert_into_cer= "INSERT INTO `action_print_certificate` (`enroll_id`, `reg_no`, `certificate_no`,`awarded_on`,`name`,`from_date`,`to_date`, `cm_id`,`admin_id`, `added_date`) VALUES ('".$record_id."','".$_POST['reg_no']."', '".$_POST['cer_no']."', '".$_POST['award_on']."', '".$_POST['name']."','".$_POST['from_date']."','".$_POST['to_date']."','".$_SESSION['cm_id']."','".$_SESSION['admin_id']."', '".date('Y-m-d')."')";
	$ptr_isert_invp = mysql_query($insert_into_cer);
	?>
	<script>
		setTimeout('document.location.href="print_certificate_makeup.php?record_id=<?php echo $record_id; ?>&course_id=<?php echo $course_id; ?>";',1000);
	</script>
	<?php
}
	?>
<div class="container">
	<img src="images/makeup.jpg" alt="Certificate Level" style="width:100%;">
