...
<?php require 'PHPMailer-5.2.14/class.phpmailer.php';	
	...
	try {
		...
		$mail->Username = 'erp.isas@gmail.com';                   // SMTP username //info@isasbeautyschool.com //isas@08info
		...
		if($_POST['action']=='inquiry')
		{
			...
			$mail->Subject = 'Thank you for registering in ISAS Beauty School for '.$_POST['branch_name'].' Branch 1 ';
