...
$ptr_sel_sms=mysql_query($sel_sms_cnt,$link1);
...
while($data_sel_cnt=mysql_fetch_array($ptr_sel_sms))
{
	...
	$ptr_cnt=mysql_query($sel_act,$link1);
...
$ptr_mail_text=mysql_query($sel_mail_text,$link1);
...
function show_mobile_no(cust_ids,type)
{
	...
	else if(cust_ids=='4379')
	{
		var data2="action_for=Bangalore&customer_id="+cust_ids;
		$.ajax({
			url: "get_stockist.php", type: "post", data: data2, cache: false,
			success: function (html)
			{
	...
	else if(cust_ids=='4381')
	{
		var data2="action_for=Gandhinagar&customer_id="+cust_ids;
		$.ajax({
			url: "get_stockist.php", type: "post", data: data2, cache: false,
			success: function (html)
			{
    ...
    <td class="mid_mid">
		...
		if($_POST['save_changes'])
		{
			...
			else
			{
				...
				else
				{
					...
					$ptr_inv=mysql_query($sel_inv,$link1);
					...
					$ins_sales_data="INSERT INTO `sales_product`(cm_id,admin_id,customer_id,product_price,discount, discount_price,discount_type,total_price,tot_price_withou_tax,payable_amount,remaining_amount,added_date,show_gst,billing_address,delivery_address,payment_mode_id,chaque_no,chaque_date,credit_card_no,bank_ref_no,bank_id,ref_invoice_no,type,ext_invoice_no) VALUES ('".$data_record['cm_id']."','".$data_record['admin_id']."','".$customer_id."','".$product_price."','".$discount."','".$discount_price."','".$discount_type."','".$total_price."','".$tot_price_withou_tax."','".$_POST['payable_amount']."','".$remaining_amount."','".$added_date."','".$show_gst."','".$billing_address."','".$delivery_address."','".$payment_mode_id."','".$chaque_no."','".$chaque_date."','".$credit_card_no."','".$bank_ref_no."','".$bank_name."','".$ref_invoice_no."','".$type."','".$data_record['ext_invoice_no']."')";
					$ptr_ins=mysql_query($ins_sales_data,$link1);
					$record_id=mysql_insert_id($link1);
					
					$sales_ins_id=$record_id;// For Manual customer
					for($i=1;$i<=$total_floor;$i++)
					{
						$data_record_service['sales_product_id'] =$sales_ins_id; 
						...
						$ins_sales_data="INSERT INTO `sales_product_map`(sales_product_id,product_id,prod_price,base_prod_price,disc_type,product_qty,discounted_price,staff_id,cgst_tax_in_per,cgst_tax,sgst_tax_in_per,sgst_tax,igst_tax_in_per,igst_tax,service_tax_in_per, service_tax,product_disc, sales_product_price) VALUES ('".$sales_ins_id."','".$data_record_service['product_id']."','".$data_record_service['prod_price']."','".$data_record_service['base_prod_price']."','".$data_record_service['disc_type']."','".$data_record_service['product_qty']."','".$data_record_service['discounted_price']."','".$data_record_service['staff_id']."','".$data_record_service['cgst_tax_in_per']."','".$data_record_service['cgst_tax']."','".$data_record_service['sgst_tax_in_per']."','".$data_record_service['sgst_tax']."','".$data_record_service['igst_tax_in_per']."','".$data_record_service['igst_tax']."','".$data_record_service['service_tax_in_per']."','".$data_record_service['service_tax']."','".$data_record_service['product_disc']."','".$data_record_service['sales_product_price']."')";
						$ptr_ins_data=mysql_query($ins_sales_data,$link1);
						$customer_service_id=mysql_insert_id($link1); 
						//$customer_service_id=$db->query_insert("sales_product_map", $data_record_service);
						
						$quantity_total=intval($_POST['product_total_qty'.$i]);
						$select_quantity="select SUM(`product_qty`) as qty from `sales_product_map` where `sales_product_id`='".$record_id."' and `product_id`='".$data_record_service['product_id']."'";
						$query_quantity=mysql_query($select_quantity,$link1);
						...
						$update_prod="update product set quantity='".$data_qty_record['quantity']."' where product_id='".$_POST['product_id'.$i]."' ";
						$ptr_up_prod=mysql_query($update_prod,$link1);
					...
					$ptr_recpt=mysql_query($sel_recpt,$link1);
					...
					if($payment_mode_id=='2' || $payment_mode_id=='4' || $payment_mode_id=='5')
					{
						...
						$bank_query=mysql_query($bank,$link1);  
					}
					if($sales_ins_id >0)
					{
						?>
					...
					if($customer_id=="18")
					{
						...
						$insert_inventory="INSERT INTO `inventory` (`vendor_id`,`price`,`discount_type`,`discount`,`discount_price`,`amount1`,`total_cost`,`payable_amount`,`remaining_amount`, `payment_mode_id`, `bank_id`,`chaque_no`,`chaque_date`,`credit_card_no`,`bank_ref_no`,`admin_id`,`added_date`,`cm_id`, `ext_invoice_no`) VALUES ('".$data_record_ahm['vendor_id']."','".$product_price."','".$discount_type."','".$discount."','".$discount_price."','".$total_price."','".$total_price."','".$_POST['payable_amount']."','".$_POST['remaining_amount']."','".$payment_mode_id."','".$bank_name."','".$chaque_no."','".$chaque_date."','".$credit_card_no."','".$bank_ref_no."','".$data_record_ahm['admin_id']."','".$added_date."','".$cm_ids."','".$data_record_ahm['ext_invoice_no']."')";
						$ptr_sales_invoice = mysql_query($insert_inventory,$link1);
						$record_id=mysql_insert_id($link1);
						...
						for($i=1;$i<=$total_floor;$i++)
						{
							if(trim($_POST['product_id'.$i])>0)
							{
								...
								$inser_prod="insert into inventory_product_map (inventory_id,sin_product_price,sin_product_base_price,discounted_price,sin_product_disc,sin_prod_disc_price,sin_product_total,sin_product_qty,cgst_tax_in_per,cgst_tax,sgst_tax_in_per,sgst_tax,igst_tax_in_per,igst_tax,service_tax_in_per,service_tax,product_id,admin_id) values ('".$record_id."','".$data_record_service_inv['sin_product_price']."','".$data_record_service_inv['sin_product_base_price']."','".$data_record_service_inv['discounted_price']."','".$data_record_service_inv['sin_product_disc']."','".$data_record_service_inv['sin_prod_disc_price']."','".$data_record_service_inv['sin_product_total']."','".$data_record_service_inv['sin_product_qty']."','".$data_record_service_inv['cgst_tax_in_per']."','".$data_record_service_inv['cgst_tax']."','".$data_record_service_inv['sgst_tax_in_per']."','".$data_record_service_inv['sgst_tax']."','".$data_record_service_inv['igst_tax_in_per']."','".$data_record_service_inv['igst_tax']."','".$data_record_service_inv['service_tax_in_per']."','".$data_record_service_inv['service_tax']."','".$product_id."','".$data_record_service_inv['admin_id']."')";
								$ptr_mysql_prod=mysql_query($inser_prod,$link1);
								$customer_service_id=mysql_insert_id($link1);
						...
						$ptr_cus_name=mysql_query($sel_cust,$link1);
						...
						$ptr_inq=mysql_query($sel_inq,$link1);
						$txt_msg='';
					...
					if($customer_id=="4381")
					{
						if($_SESSION['branch_name']=="Pune")
						{
							$data_record_ahm['vendor_id']="1604"; // ISAS Pune
							$cm_ids="286";//Gandhinagar
							$data_record_ahm['cm_id']=$cm_ids;
						}
						/*elseif($_SESSION['branch_name']=="Ahmedabad")
						{
					...
					if($customer_id=="2915")
					{
						...
						for($i=1;$i<=$total_floor;$i++)
						{
							if(trim($_POST['product_id'.$i]) !='')
							{
								...
								$sel_qty="select quantity from product where product_id='".$_POST['product_id'.$i]."' ";
								$ptr_qty=mysql_query($sel_qty,$link1);
								$data_qty=mysql_fetch_array($ptr_qty,$link1);
							}
						}
					...
					if($customer_id=="4322")
					{
						...
						$sel_inv="select ext_invoice_no from inventory where cm_id='".$data_record_ahm['cm_id']."' and ext_invoice_no IS NOT NULL order by ext_invoice_no desc limit 0,1";
						$ptr_inv=mysql_query($sel_inv,$link2);
						$data_inv=mysql_fetch_array($ptr_inv);
						
						$recp=explode("/",$data_inv['ext_invoice_no']);
						$inv_no=intval($recp[2])+1;
						$preinv=$recp[0].'/'.$recp[1].'/';
						$data_record_ahm['ext_invoice_no']=$preinv.$inv_no;
						$data_record_ahm['price']=$product_price;
						$data_record_ahm['discount_type']=$discount_type;
						$data_record_ahm['discount']=$discount;
						$data_record_ahm['discount_price']=$discount_price;
						...
						$insert_inventory="INSERT INTO `inventory` (`vendor_id`,`price`,`discount_type`,`discount`,`discount_price`,`amount1`,`total_cost`,`payable_amount`,`remaining_amount`, `payment_mode_id`, `bank_id`,`chaque_no`,`chaque_date`,`credit_card_no`,`bank_ref_no`,`admin_id`,`added_date`,`cm_id`, `ext_invoice_no`) VALUES ('108','".$product_price."','".$discount_type."','".$discount."','".$discount_price."','".$total_price."','".$total_price."','".$_POST['payable_amount']."','".$_POST['remaining_amount']."','".$payment_mode_id."','".$bank_name."','".$chaque_no."','".$chaque_date."','".$credit_card_no."','".$bank_ref_no."','".$data_record_ahm['admin_id']."','".$added_date."','".$cm_ids."','".$data_record_ahm['ext_invoice_no']."')";
						$ptr_sales_invoice = mysql_query($insert_inventory,$link2);
						$record_id=mysql_insert_id($link2);
						//$record_id=$db->query_insert("inventory", $data_record_ahm);
						for($i=1;$i<=$total_floor;$i++)
						{
							if(trim($_POST['product_id'.$i])>0)
							{
								...
								$inser_prod="insert into inventory_product_map (inventory_id,sin_product_price,sin_product_base_price,discounted_price,sin_product_disc,sin_prod_disc_price,sin_product_total,sin_product_qty,cgst_tax_in_per,cgst_tax,sgst_tax_in_per,sgst_tax,igst_tax_in_per,igst_tax,service_tax_in_per,service_tax,product_id,admin_id) values ('".$record_id."','".$data_record_service_inv['sin_product_price']."','".$data_record_service_inv['sin_product_base_price']."','".$data_record_service_inv['discounted_price']."','".$data_record_service_inv['sin_product_disc']."','".$data_record_service_inv['sin_prod_disc_price']."','".$data_record_service_inv['sin_product_total']."','".$data_record_service_inv['sin_product_qty']."','".$data_record_service_inv['cgst_tax_in_per']."','".$data_record_service_inv['cgst_tax']."','".$data_record_service_inv['sgst_tax_in_per']."','".$data_record_service_inv['sgst_tax']."','".$data_record_service_inv['igst_tax_in_per']."','".$data_record_service_inv['igst_tax']."','".$data_record_service_inv['service_tax_in_per']."','".$data_record_service_inv['service_tax']."','".$product_id."','".$data_record_service_inv['admin_id']."')";
								$ptr_mysql_prod=mysql_query($inser_prod,$link2);
								$inv_pm_ids=mysql_insert_id($link2);
								//$customer_service_id=$db->query_insert("inventory_product_map", $data_record_service_inv);
						...
						$sel_recpt="select receipt_no from inventory_invoice where cm_id='".$cm_ids."' and (receipt_no IS NOT NULL and receipt_no !='') order by receipt_no desc limit 0,1";
						$ptr_recpt=mysql_query($sel_recpt,$link2);
						$data_receipt=mysql_fetch_array($ptr_recpt);
						...
						$insert_sales_invoice = "INSERT INTO `inventory_invoice` (`inventory_id`,`receipt_no`, `price`,`total_cost`,`amount1`,`payable_amount`,`remaining_amount`,`paid_type`,`bank_id`,`cheque_detail`,`chaque_date`, `credit_card_no`,`bank_ref_no`,`admin_id`,`added_date`,`status`,`cm_id`,`total_paid`) VALUES ('".$record_id."','".$receipt_no."', '".$product_price."', '".$total_price."', '".$amount1."', '".$_POST['payable_amount']."','".$_POST['remaining_amount']."', '".$payment_mode_id."','".$bank_name."', '".$chaque_no."', '".$sep_check_date."','".$credit_card_no."','".$bank_ref_no."', '".$data_record_ahm['admin_id']."','".$added_date."','".$status."','".$cm_ids."','".$_POST['payable_amount']."'); ";
						$ptr_sales_invoice = mysql_query($insert_sales_invoice,$link2);
						/*echo "<br/>Invntory invoice Insert ID-> ".*/$invs_ids=mysql_insert_id($link2);
						
						$update_inv="update inventory set invoice_no='".$invs_ids."' where inventory_id='".$record_id."'";
						$ptr_invs=mysql_query($update_inv,$link2);
                        ...
                        <td colspan="6">
                            ...
                            <tr>
                                ...
                                if($record_id!='')
                                {
                                    ...
                                    $ptr_fs=mysql_query($select_exc,$link1);
                                    $t=1;
                                        ...
                                        <table cellspacing="5" id="tbl<?php echo $t; ?>" width="100%">
                                            <tr>
                                                ...
                                                <select name="product_id<?php echo $t; ?>" id="product_id<?php echo $t; ?>" style="width:200px" onChange="show_product_qty(this.value,<?php echo $t; ?>)"><option value="">Select Product</option><?php
                                                    ...
                                                    $query_tel=mysql_query($sel_tel,$link1);
                                                    $qty_in_stock='';
                                                    while($data_prod=mysql_fetch_array($query_tel))
                                                    {
                                                        ...
                                                        $sel_emp="select name from site_setting where admin_id='".$data['admin_id']."'";
                                                        $ptr_admin_id=mysql_query($sel_emp,$link1);
                                                        $data_name=mysql_fetch_array($ptr_admin_id);
                                                        $name= "(".$data_name['name'].")";
                                                ...
                                                ?>
													...
													<?php
													$sel_staff ="select admin_id,name from site_setting where 1 and system_status='Enabled' ".$_SESSION['where']." order by admin_id asc";
													$query_staff = mysql_query($sel_staff,$link1);
													if($total_staff=mysql_num_rows($query_staff))
													{
														while($data=mysql_fetch_array($query_staff))
														{
        ...
        <tr>
           ...
           <tr>
                ...
                $ptr_payment_mode=mysql_query($sel_payment_mode,$link1);
