...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
    ...
    <td class="mid_mid" align="center">
        		...
        		<form method="get" name="search">
					<table border="0" cellspacing="0" cellpadding="0" width="99%" align="center">
                        ...
                        <	/select></td>-->
                            ...
                            <td width="5%">Added by<span class="orange_font">*</span></td>
                            <td class="customized_select_box" width="10%">
        ...
        $sql_query= "SELECT * FROM enrollment where 1 and (student_status ='Active' or student_status is NULL) ".$_SESSION['where']." ".$where_course." ".$where_assign_to." ".$where_added_by." ".$where_type." ".$search_cm_id." ".$enquiry_from_date." ".$enquiry_to_date."  ".$select_directory."";
        ...
        if($no_of_records)
        {
            ...
            <form method="post"  name="frmTakeAction"  action="<?php echo $_SERVER['PHP_SELF'].'?#msgbox';?>">
                ...
                <tr class="grey_td" >
                    ...
                    <td width="3%" align="center"><strong>Enroll Key Id</strong></td>
                    <td width="4%" align="center"><strong>Enroll Id</strong></td>
                    <td width="4%" align="center"><strong>Enroll No.</strong></td>
                    <td width="3%" align="center"><strong>Bill No.</strong></td>
                    <td width="9%" align="center"><strong>Name</strong></td>
                    <td width="8%" align="center"><strong>Course Name</strong></td>
                    <td width="4%" align="center"><strong>Course Price</strong></td>
                    <td width="4%" align="center"><strong>Down Payment</strong></td>
                    <td width="4%" align="center"><strong>Total Paid</strong></td>
                    <td width="4%" align="center"><strong>Balance Fee</strong></td>
                    <td width="18%" align="center"><strong>Receipt Details</strong></td>
                    <td width="16%" align="center"><strong>Installments</strong></td>
                    <td width="5%" align="center"><strong>Assign to</strong></td>
                ...
                while($val_query=mysql_fetch_array($all_records))
                {
                    ...
                    echo '<tr '.$bgcolor.'>';
                        ...
                        echo '<td align="center">'.$val_query['down_payment'].'</td>';
                        echo '<td align="center">'.round(intval($val_query['net_fees'])-intval($val_query['balance_amt'])).'</td>';
                        ...
                        if($total=mysql_num_rows($ptr_installment))
                        {
                            ...
                            {
                                $originalDate = $data_invs['added_date'];
                                $newDate = date("d-m-Y", strtotime($originalDate));
                                echo $mm=$m.") ".$data_invs['receipt_no'].' - '.$data_invs['amount'].'/- '.$newDate.' : '.$data_invs['status']."<br/>";
                                $m++;
                            }
                        }
                        echo '</td>';
