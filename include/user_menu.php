...
<td class="width5"></td>
  ...
  if($page_name == 'add_user.php')
   ...
   else
   {
    ...
    {
        if($array_previ_parent[$e]['privilege_id']==14) //'for only change password'
        {
...
if($array_prev[$e][$f]['privilege_id']==94)//'General Setting'
    {
	?>
    <td>
	<table border="0" cellspacing="0" cellpadding="0">
            <?php
  if($page_name == 'add_user.php' || $page_name ==  'add_user_edit.php')
            {
            ?>
            <tr>
                <td class="tab2_left"></td>
