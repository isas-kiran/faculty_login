...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  ...
  <tr class="head_td">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="99%" align="center">
              ...
              <tr>
                ...
                <td class="rightAlign" > 
                   <select name="inq"  >
              <option>--select by inquiry--</option>
              <?php
			 ...
			 { 
              ...
              <td class="width5"></td>
                ...
                <td><input type="image" src="images/search.jpg" name="search" value="Search" title="Search" class="example-fade"  /></td>
                 ...
                 <td class="rightAlign" > 
                   <select name="enroll"  >
              <option>--select by enrollment--</option>
              <?php
			 $sel_payment_mode="SELECT source_id,source_name FROM source where 1";
			 $ptr_payment_mode=mysql_query($sel_payment_mode);
			// $i=0;
			 ...
			 { 
			      $sel='';
			    if($_GET['enroll']==$data_payment_mode['source_id'])
				{
					$sel='selected="selected"';
				}
				echo '<option '.$sel.' value='.$data_payment_mode['source_id'].'>'.$data_payment_mode['source_name'].'</option>';
 ...
 <td><input type="image" src="images/search.jpg" name="search" value="Search" title="Search" class="example-fade"  /></td>
     ...
     <?php
						...
						if($inquiry)
						{
							$pre_keyword="and(source_id like '%".$inquiry."%')";
						}
						else{
							$pre_keyword="";
						}
                        ...
                        <td width="30%" align="center"><strong>Total</strong></td>
...

                            {
								...
								$total_source='';	       
								  ...
								  {
									  echo "hi";
									   echo "<br>".$sel_inq_source="select count(enquiry_source) as total_inq_src from inquiry where enquiry_source =".$inquiry." ".$_SESSION['where']." ".$enquiry_from_date." ".$enquiery_to_date."   ";
									  
								  }
								  else{
									  echo "hello";
                                 echo "<br>".$sel_inq_source="select count(enquiry_source) as total_inq_src from inquiry where enquiry_source =".$val_query['source_id']." ".$_SESSION['where']." ".$enquiry_from_date." ".$enquiery_to_date."   ";
								  }
