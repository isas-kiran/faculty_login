...
<td class="width5"></td>
 <td>
	<table border="0" cellspacing="0" cellpadding="0">
		<?php 
        if($page_name =='manage_emp_performance_report.php')
        {
			?>
			<tr>
				<td class="tab2_left"></td>
				<td class="tab2_mid"><a href="manage_emp_performance_report.php" style="color:#7CA32F;">Employee Performance Report</a></td>
				<td class="tab2_right"></td>
			</tr>
			<?php
        }
        else
        {
			...
			<tr>
				<td class="tab_left"></td>
				<td class="tab_mid"><a href="manage_emp_performance_report.php" style="color:#666666;">Employee Performance Report</a></td>
				<td class="tab_right"></td>
			</tr>
			<?php
        }
...
<td class="width5"></td>
 <td>
	<table border="0" cellspacing="0" cellpadding="0">
		<?php 
        if($page_name =='add_emp_performance.php')
        {
			?>
			<tr>
				<td class="tab2_left"></td>
				<td class="tab2_mid"><a href="add_emp_performance.php" style="color:#7CA32F;">Add Employee Performance</a></td>
				<td class="tab2_right"></td>
			</tr>
			<?php
        }
        else
        {
			...
			<tr>
				<td class="tab_left"></td>
				<td class="tab_mid"><a href="add_emp_performance.php" style="color:#666666;">Add Employee Performance</a></td>
				<td class="tab_right"></td>
			</tr>
			<?php
        }
...
<td class="width5"></td>
 <td>
	<table border="0" cellspacing="0" cellpadding="0">
		<?php 
        if($page_name =='manage_emp_utilization_report.php')
        {
			?>
			<tr>
				<td class="tab2_left"></td>
				<td class="tab2_mid"><a href="manage_emp_utilization_report.php" style="color:#7CA32F;">Employee Utilization Report</a></td>
				<td class="tab2_right"></td>
			</tr>
			<?php
        }
        else
        {
			...
			<tr>
				<td class="tab_left"></td>
				<td class="tab_mid"><a href="manage_emp_utilization_report.php" style="color:#666666;">Employee Utilization Report</a></td>
				<td class="tab_right"></td>
			</tr>
			<?php
        }
...
<td class="width5"></td>
 <td>
	<table border="0" cellspacing="0" cellpadding="0">
		<?php 
        if($page_name =='pr_daily_in_out_attendance.php')
        {
			?>
			<tr>
				<td class="tab2_left"></td>
				<td class="tab2_mid"><a href="pr_daily_in_out_attendance.php" style="color:#7CA32F;">Daily In-Out Report</a></td>
				<td class="tab2_right"></td>
			</tr>
			<?php
        }
        else
        {
			...
			<tr>
				<td class="tab_left"></td>
				<td class="tab_mid"><a href="pr_daily_in_out_attendance.php" style="color:#666666;">Daily In-Out Report</a></td>
				<td class="tab_right"></td>
			</tr>
			<?php
        }
