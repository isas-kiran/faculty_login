...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <!-- ================================================Start Table=============================================================================================-->
<?php
 $sql_query= "select customer_id,customer_service_id,followup_date,treatment_followup_date,followup_desc,admin_id,cm_id,added_date from customer_service_followups where customer_service_id ='".$record_id."'"; 
 $db=mysql_query($sql_query);
 $data_ptr=mysql_fetch_array($db);
 
 $sql_name= "select cust_name from customer where cust_id ='".$data_ptr['customer_id']."'"; 
 $db_name=mysql_query($sql_name);
 $data_name=mysql_fetch_array($db_name);
...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  ...
  <tr class="head_td">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="99%" align="center">
              <tr>
                ...
                <td><strong>Name- </strong><?php echo $data_name['cust_name']; ?></td>  
                
                <td  align="right"><a href="cust_service_followup_summery.php?record_id= <?php echo $record_id; ?>"><input type="button" name="update_followup" value="Update Followup" /></a></td>
                <td  align="right"><a href="manage_cust_services.php"><input type="button" name="back" value="Back" /></a></td>
                <td class="rightAlign" > 
    ...
    <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='followup_id'))
                        {
                           ...
                           $sql_query= "select * from customer_service_followups where customer_service_id ='".$record_id."' ".$_SESSION['where']." ".$pre_keyword." ".$select_directory.""; 
                       //echo $sql_query;
					   	$db=mysql_query($sql_query);
  ...
  <tr class="grey_td" >
    ...
    <td width="15%" align="center"><strong>Care call followup date</strong></td>  
	<td width="15%" align="center"><strong>Treatment call followup date</strong></td>  	
    ...
    <td width="10%" align="center"><strong>Added Date</strong></td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
								...
								$date_sep=explode("-",$val_query['followup_date']);
								$dates=$date_sep[2]."/".$date_sep[1]."/".$date_sep[0];								
								echo '<td align="center">'.$dates.'</td>';  
								$treat_date_sep=explode("-",$val_query['treatment_followup_date']);
								$tret_dates=$treat_date_sep[2]."/".$treat_date_sep[1]."/".$treat_date_sep[0];
								echo '<td align="center">'.$tret_dates.'</td>';  
                                echo '<td align="center">'.$val_query['followup_desc'].'</td>';
