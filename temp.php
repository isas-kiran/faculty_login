                            ...
                            if($record_id)
			{
				...
				for($z=1;$z<=$total_floor;$z++)
				{
					...
					if($_POST['del_floor'.$z]=='yes')
					{
						...
						{
							"<br />".$delete_row = "delete from pr_staff_service_incentive where staff_service_incentive_id='".$_POST['floor_id'.$z]."' ";
					...
					else
					{
						...
						$where_record="staff_service_incentive_id='".$_POST['floor_id'.$z]."'";
             	...
             	<td colspan="3">
				  ...
				  <table  width="100%" style="border:0px solid gray; ">
                    <tr>
						...
						<tr><td> <strong style="color:green;font-size:14px;">**** Staff Service Incentive ****</strong> </td><td align="left"></td></tr>
                    ...
                    <tr>
                        <td colspan="12">
							...
							<tr>
									<td valign="top" align="center" width="15%">Service Name</td>
									<td valign="top" align="center" width="8%">MRP</td>
									...
									<td valign="top" width="8%" align="center">Total</td>
									<td valign="top" width="6%" align="center" >Incentive %</td>
									<td valign="top" width="8%" align="center">Incentive </br> Amount</td>
									<td valign="top" width="6%" align="center">Adjustment </br> Amount</td>
									<td valign="top" width="6%" align="center">Final </br> Total</td>
...
if($record_id)
{
	...
	{ 
		...
		<tr>
		<td valign="" width="20%" align="center"><select name="service_id<?php echo $t; ?>" id="service_id<?php echo $t; ?>" style="width:140px" onChange="getprice(this.value,<?php echo $t; ?>)"><option value="">Select Service</option><?php
		$sel_tel = "select service_id,service_name,service_price,service_time from servies order by service_id asc";	 
		$query_tel = mysql_query($sel_tel);
		if($total=mysql_num_rows($query_tel))
		{
