...
if($_REQUEST['record_id'])
{
    ...
    $sql_record= "SELECT * FROM bp_social_programs where program_id='".$record_id."'";
...
{
    $update_news="update bp_social_programs set photo='' where program_id='".$record_id."'";
    //echo $update_events;
  ...
  <tr>
                        ...
                        if($_POST['save_changes'])
                        {
                            ...
                            if(count($errors)==0 && $_FILES['photo']["name"])
                            {
                                ...
                                if(strtolower($filetype) == "image/jpeg" || strtolower($filetype) == "image/pjpeg" || strtolower($filetype) == "image/GIF" || strtolower($filetype) == "image/gif" || strtolower($filetype) == "image/png")
                                {
                                    ...
                                    {
                                        $thump_target_path="../static_Page_photo/".$uploaded_url;
                               ...
                               if($record_id)
                                {
                                   ///print_r($data_record); //    exit;
                                    $where_record=" program_id='".$record_id."'";
                                    $db->query_update("social_programs", $data_record,$where_record);
                                    echo '<br></br><div id="msgbox" style="width:40%;">Record updated successfully</center></div><br></br>';
                                }
                                else
                                {
                                    $data_record['added_date'] =date("Y-m-d H:i:s");
                                    $record_id=$db->query_insert("social_programs", $data_record);
	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%">
			...
			<?php
                ...
                if($record_id && $row_record['photo'] && file_exists("../static_Page_photo/".$row_record['photo']))
                echo '<img height="77px" width="77px" src="../static_Page_photo/'.$row_record['photo'].'"><br>
		    ...
		    ?> 
              ...
              <tr>
                  <td>&nbsp;</td>
                  <td><input type="submit" class="input_btn" value="<?php if($record_id) echo "Update"; else echo "Add";?> Social Programs" name="save_changes"  /></td>
                  <td></td>
              </tr>
        </table>
        </form>
