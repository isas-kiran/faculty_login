...
<title>Sales Product Payment Details</title>
  ...
  <tr>
    ...
    <td class="mid_mid">
                      ...
                      <?php
						...
						$sql_records= "SELECT * FROM sales_product_invoice where sales_product_id=".$record_id." ";
						...
						if($no_of_records)
						{
							...
							<tr><td valign="middle" align="right">
                                    ...
                                    <?php
										...
										$sel_sale_pro="select customer_id, sales_product_id, discount, total_price, product_price, remaining_amount from sales_product where sales_product_id='".$record_id."'";
										$quer_sale_prod=mysql_query($sel_sale_pro);
										$fetch_query_sales=mysql_fetch_array($quer_sale_prod);
									
                                        $select_customer = " select cust_name, cust_id from customer where cust_id='".$fetch_query_sales['customer_id']."' ";
								...
								<tr align="center" class="grey_td" >
                                    ...
                                    while($val_record=mysql_fetch_array($all_records))
                                    {
									    ...
									    echo '<td align="center">'.$fetch_query_sales['product_price'].'</td>'; 
										...
										onclick=\"window.open('invoice_generate_sales_prod.php?record_id=".$val_record['invoice_id']."','View Invoice','scrollbars=yes','resizable=yes','width=900,height=600')\" style='cursor:pointer' >
										</td>";
										echo "<td align='center'><img src='images/print1.jpeg'
								onclick=\"window.open('invoice_generate_sales_prod.php?record_id=".$val_record['invoice_id']."&action=print','View Invoice','width=750,height=700')\"style='cursor:pointer'title='Print Invoice' border='0'></td>";
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                        <?php
                                        if($fetch_query_sales['remaining_amount'] !=0)
										{
											
											echo '<td>';
											echo'<a href="add_sales_prod_payment.php?record_id='.$record_id.'"><strong><font size="+1">Add Payment</font></strong></a>'; 
											echo '</td>';
											echo '<td>';
											echo  '<a href="add_sales_prod_payment.php?record_id='.$record_id.'">
