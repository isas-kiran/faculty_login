...
<?php
$edit_access='';
$sel_acc="select * from edit_previleges where admin_id='".$_SESSION['admin_id']."' and privilege_id='208'";
                        ...
                        if($no_of_records)
                        {
                           ...
                           // $pager = new PS_Pagination($sql_query,$_SESSION['show_records'],$_SESSION['show_records_pages'],$query_string1);
							...
							while($val_query=mysql_fetch_array($all_records))
                            {
                                ...
                                $select_event= "select * from pr_add_event where event_id = '".$val_query['event_id']."' ";                                $val_event = $db->fetch_array($db->query($select_event));
