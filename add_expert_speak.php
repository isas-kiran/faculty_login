...
if($_REQUEST['record_id'])
{
    ...
    $sql_record= "SELECT * FROM PB_expert_speak where expert_speak_id='".$record_id."'";
...
<title><?php if($record_id) echo "Edit"; else echo "Add";?> Expert Speak</title>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
        ...
        <?php
                        ...
                        if($_POST['save_changes'])
                        {
                                ...
                                if(strtolower($filetype) == "image/jpeg" || strtolower($filetype) == "image/pjpeg" || strtolower($filetype) == "image/GIF" || strtolower($filetype) == "image/gif" || strtolower($filetype) == "image/png")
                                {
                                    ...
                                    if(move_uploaded_file($source1, $target_path1))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            $obj_img1->NewWidth = 60;
                                            $obj_img1->NewHeight = 66;
                            ...
                            else
                            {
                               ...
                               if($record_id)
                                {
                                    $where_record=" expert_speak_id='".$record_id."'";
                                    $db->query_update("expert_speak", $data_record,$where_record);
                                    echo '<br></br><div id="msgbox" style="width:40%;">Record updated successfully</center></div><br></br>';
                                }
                                else
                                {
                                    $data_record['added_date'] =date("Y-m-d H:i:s");
                                    $record_id=$db->query_insert("expert_speak", $data_record);
	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%">
              ...
              <tr>
                  <td width="20%" valign="top">Expert Name<span class="orange_font">*</span></td>
                <td width="40%"><input type="text"  class="validate[required] input_text" name="name" id="name" value="<?php if($_POST['save_changes']) echo $_POST['name']; else echo $row_record['expert_name'];?>" /></td> 
                <td width="40%"></td>
              </tr>
              <tr>
             ...
             <tr>
              ...
              <tr>
                    ...
                    if($record_id && $row_record['image_url'] && file_exists("../UploadedData/".$row_record['image_url']))
                        echo '<img height="77px" width="77px" src="../UploadedData/'.$row_record['image_url'].'"><br>
              ...
              <tr>
                  <td>&nbsp;</td>
                  <td><input type="submit" class="input_btn" value="<?php if($record_id) echo "Update"; else echo "Add";?> Expert Speak" name="save_changes"  /></td>
                  <td></td>
              </tr>
        </table>
        </form>
