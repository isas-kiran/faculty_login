...
if(mysql_num_rows($ptr_fs)) 
{
	...
	<table id="example" class="table1" width="95%" cellspacing="0" style="margin-left: 0px;">
        ...
        <tr>
            ...
            <th class="th1">Action <input type="checkbox" name="Check_All" id="Check_All" value="Check All" onClick="CheckAll(document.jqueryForm.check_list)"></th>
            <th class="th1">Add in Expense<input type="checkbox" name="Check_All_Expense" id="Check_All_Expense" value="Check Expense" onClick="CheckExpense(document.jqueryForm.check_list_expense)"></th>
        </tr>
        </thead>
		<tbody>	
			<?php
			...
			{ 
				...
				<tr <?php echo $style; ?>>
                    ...
                    <td class="td1 td2">
            		<?php if($val_query['expense_action']==1)
            		{ ?>
               		 	<img src="images/active_icon.png">
                		<?php 
            		} 
            		...
            		{ ?>
                		<input type="checkbox" name="expense_action<?php echo $t; ?>" id="check_list_expense" value="" />
                		<?php 
            		} ?>
            		</td>
