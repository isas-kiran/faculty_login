...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
    ...
    <img src='images/print1.jpeg'
								...
								<tr align="center" class="grey_td" ><td width="7%" class="tr-header"><strong>Sr.</strong></td><td width="11%" class="tr-header"><strong>Invoice No.</strong></td><td width="12%" class="tr-header"><strong>Inst. Paid</strong></td><td width="15%" class="tr-header"><strong>Balance Amount</strong></td><td width="20%"  class="tr-header"><strong>Installment</strong></td><td width="10%"  class="tr-header"><strong>Payment Mode</strong></td><td width="8%" class="tr-header"><strong> Date </strong></td><td width="6%" class="tr-header"><strong> Status </strong></td><td width="9%" class="tr-header"><strong>View</strong></td><td width="12%" class="tr-header"><strong>Print</strong></td></tr><?php
                                    while($val_record=mysql_fetch_array($all_records))
                                    {
									   ...
									   echo '<td align="center">';
										...
										if($data_select['service_tax'] >0)
										{
										echo"<img src='images/print1.jpeg'
								onclick=\"window.open('invoice-generate.php?record_id=".$val_record['invoice_id']."&action=print','View Invoice','width=750,height=700')\"style='cursor:pointer'title='Print Invoice' border='0'>";
										}
										else if($data_select['cgst_tax'] >0)
										{
											echo"<img src='images/print1.jpeg'
								onclick=\"window.open('invoice-generate_gst.php?record_id=".$val_record['invoice_id']."&action=print','View Invoice','width=750,height=700')\"style='cursor:pointer'title='Print Invoice' border='0'>";
										}
										echo"</td>";
									...
									$(document).ready(function(){
                                        ...
                                        if($data_select['balance_amt'] !=0)
										{
											...
											echo '</td>';
											echo '<td align="center">';
											echo '<a href="edit_installment.php?record_id='.$enroll_id.'"><strong><font size="+1">Edit Installment </font></strong></a>';
											echo '</td>';
											echo '<td align="center">';
