  ...
  <tr>
    ...
    <td class="mid_mid">
    						...
    						if($_POST['save_changes'])
                        	{
                                ...
                                {
									$success=1;
									$insert_followup = "INSERT INTO `followup_details` (`student_id`,`lead_category_followup`,`followup_date`,`lead_grade`,`followup_details`,`response`, `added_date`,`cm_id`,`admin_id`) VALUES ('$student_id','$lead_category_followup', '$followup_date', '$lead_grade','$followup_details','".$response."','".date('Y-m-d H:i:s')."','".$cm_id."','".$admin_id."')";
									$ptr_followup = mysql_query($insert_followup);
									
									$update_rec="update inquiry set followup_date='".$followup_date."',lead_grade='".$lead_grade."',lead_category_followup='".$lead_category_followup."' where inquiry_id='$student_id'";
									$ptr_update=mysql_query($update_rec);
									
									//===================================================SEND SMS===================================================================
									
									
									"<br/>".$insert_sms="insert into sms_log_history (`sent_name`,`sent_mobile`,`sent_desc`,`user_type`,`sms_type`,`cm_id`,`added_date`) values('".$student_name."','".$mobile_no."','".$desc."','student','follwup_message','".$cm_id."','".date('Y-m-d H:i:s')."')";
									...
									setTimeout('document.location.href="followup_details.php?record_id=<?php echo $record_id; ?>";',2000);
									</script>
								...
								?>
                                    ...
                                    <?
                                    	...
                                    	<tr style="padding-left:10px">
                                        	<td width="146"><strong>Student Name :&nbsp;&nbsp;&nbsp;</strong><?php echo $data_enroll['firstname'].' '.$data_enroll['middlename'].' '.$data_enroll['lastname']; ?> <input type="hidden" name="student_name" value="<?php echo $data_enroll['firstname'];?>"></td>
                                         ...
                                         <tr>
                                        	<td><strong>Mobile No :&nbsp;&nbsp;&nbsp;</strong><?php echo $data_enroll['mobile1']; ?><input type="hidden" name="mobile_no" value="<?php echo $data_enroll['mobile1']?>"></td>
                                            <td><strong>Email ID :&nbsp;&nbsp;&nbsp;</strong><?php echo $data_enroll['email_id']; ?></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><strong>Lead Grade :&nbsp;&nbsp;&nbsp;</strong><? echo $data_enroll['lead_grade']; ?></td>
                                        </tr>
                                        <tr>
                                        	<td><strong>Enquiry Date :&nbsp;&nbsp;&nbsp;</strong><? echo $data_enroll['enquiry_date']; ?></td>
                                            <td><strong>Followup Date :&nbsp;&nbsp;&nbsp;</strong><? echo $data_enroll['followup_date']; ?></td>
                                        </tr>
                                    </table>
                                    </td></tr>
  ...
  <tr class="head_td">
    ...
    <?php
						if($_REQUEST['from_date'] && $_REQUEST['from_date']!=="0000-00-00" && $_REQUEST['from_date']!="From Date")
						 {
						  	$pre_from_date=" and followup_date >='".date('Y-m-d',strtotime($_REQUEST['from_date']))."'";
						 }
						else
						{
							$pre_from_date="";                            
						...
						if($_REQUEST['to_date'] && $_REQUEST['to_date']!=="0000-00-00" && $_REQUEST['to_date']!="To Date")
							$pre_to_date=" and followup_date<='".date('Y-m-d',strtotime($_REQUEST['to_date']))."'";
						else
							$pre_to_date="";
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='firstname'))
                        {
                         ...
                         $sql_query= "select inquiry_id,firstname,middlename,lastname, course_id, mobile1, followup_date from inquiry where status = 'Enquiry'  and   followup_date >= '".date('Y-m-d')."' and followup_date <='".date('Y-m-d', strtotime('+2 days'))."' ".$_SESSION['where']." ".$pre_from_date." ".$pre_to_date." ".$pre_lead_grade." ".$select_directory.""; 
                       //echo $sql_query;
...
//                                $val_contry = $db->fetch_array($db->query($select_country));
								...
								echo '<a href="followup_details.php?record_id='.$val_query['inquiry_id'].'">
            '.$val_query['firstname'].' ' .$val_query['lastname'].'</a>';
								echo'</td>';
