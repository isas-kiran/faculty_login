...
<body>
    <div class="heightSpacer"></div>
						...
						$sel="select cust_name,mobile1 from customer where cust_id='".$row_record['customer_id']."'";
                    ...
                    <table align="center" width="100%">
                    	<tr>
							...
							<?php
						 		...
						 		{
						 		?>
									<a href="job-card-generate_new.php?record_id=<?php echo $record_id ?>&action=print" style="text-decoration:none"><input type="button" name="print" value="Print" /></a>
									<?php } ?>
                    		</td>
                        </tr>
                    </table>
					<table width="100%" height="48" border="0" align="center" style="border:solid 0.6mm; border-radius:5px; margin:10px">
                        <tr>
                        	<td width="272">
                            <table width="100%">
                                <tr>
                                    <td valign="top" width="97"><img src="images/logo.jpg" width="94" height="36" title="Isasbeautyschool "/></td>
                                    <td align="left" colspan="2">
                                        <table width="99%"><strong><span style="font-size:14px;">ISAS Beautyschool,
                                           <?php 
										   if($_SESSION['type']=='S')
                                           {
						...
						?>
                           <td>
                           	<table width="100%" style="border:1px solid black; border-collapse:collapse; font-size:12px" border="1px">
                                <tr>
                                    <td width="41%" align="left"  style="padding-left:10px; "><span style="font-size:12px; font-weight:bold">Receipt No.:</span></td><td width="59%" align="center"><font size="2px;"><?php echo $receipt_no;?></font></td>
								...
								?>
								<tr>
                                    <td width="41%" align="left"  style="padding-left:10px; "><span style="font-size:12px; font-weight:bold">Invoice No.:</span></td><td width="59%" align="center"><font size="2px;"><?php echo $invoice_no;?></font></td>
								...
								?>
                                <tr>
                                	 <td width="41%" align="left"  style="padding-left:10px;"><span style="font-size:12px; font-weight:bold">Date:</span></td><td width="59%"  align="center"><font size="2px;"><?php echo $newDate." ".$time_in_12_hour_format ; ?></font> </td>
                                </tr>
                                <tr>
                                        <td align="left"  style="padding-left:10px; " ><span style="font-size:12px; font-weight:bold">Customer Name:</span></td>
                                        <td><?php echo $cust_name;?></td>
                                </tr>
                                <tr>
                                        <td align="left"  style="padding-left:10px; "  ><span style="font-size:12px; font-weight:bold">Mobile No:</span></td>
                                        <td><?php echo $mobile1;?></td>
                                </tr>
								<tr>
                                        <td align="left"  style="padding-left:10px; "  ><span style="font-size:12px; font-weight:bold">Book by</span></td>
                         ...
                         <tr>
                           <td>
							  ...
							  else if($row_record['cgst_tax'] >0 || $row_record['sgst_tax'] >0)
							  {
							  ?>
							  <tr>
