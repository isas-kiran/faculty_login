...
function show_product_qty(product_id,id)
{
	...
	$.ajax({
		...
		success: function(prod_data)
		{
			...
			var exit_cgst=document.getElementById("sin_product_cgst"+id).value = 0;
			var exit_sgst=document.getElementById("sin_product_sgst"+id).value = 0;
...
function calc_product_price(prod_id)
{
	...
	//{
		...
		if(cgst_percent >0)
		{
			...
			//total_price_cgst=parseFloat(Number(total_price)+Number(cgst_value)).toFixed(2);
...
function show_mobile_no(cust_ids)
{
	...
	else if(cust_ids == '18')
	{
		...
		//setTimeout( $("#stockist_id").chosen({allow_single_deselect:true}),800);
		$("#stockist_id").chosen({allow_single_deselect:true});
	}
}
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
                               ...
                               if($record_id)
                                ...
                                else
                                {
									...
									if($customer_id=="18")
									{
										...
										$data_record_ahm['amount1'] = $amount1;
            	...
            	<td colspan="2">
                    ...
                    <input type="hidden" name="no_of_floor" id="no_of_floor" class="inputText" size="1" onKeyUp="create_floor();" value="0" />
                     ...
                     <script language="javascript">
                                ...
                                {
                                    var shows_data='<div id="floor_id'+idss+'"><table cellspacing="3" id="tbl'+idss+'" width="100%"><tr><td width="40%" align="left"><input type="hidden" name="exclusive_id'+idss+'" id="exclusive_id'+idss+'" value="'+idss+'" /><select name="product_id'+idss+'" id="product_id'+idss+'" style="width:200px" onchange="show_product_qty(this.value,'+idss+')"><option value="">Select Product</option>				<?php
									...
									while($data=mysql_fetch_array($query_tel))
									{
									 ...
									 ?>
									 </select></td><td width="3%" align="center"><input type="text" name="prod_price'+idss+'" id="prod_price'+idss+'" onkeyup="calc_product_price('+idss+')" style="width:80px" /></td><td width="2%" align="center"><input type="text" name="product_total_qty'+idss+'" id="product_total_qty'+idss+'" readonly="readonly" style="width:60px" /></td><td width="4%" align="center"><input type="text" name="product_qty'+idss+'" id="product_qty'+idss+'" onkeyup="calc_product_price('+idss+')" style="width:50px" /></td><td width="4%" align="center"><input type="text" name="product_disc'+idss+'" id="product_disc'+idss+'" onkeyup="calc_product_price('+idss+')" style="width:80px" /><input type="hidden" name="prod_disc_price'+idss+'" id="prod_disc_price'+idss+'" /></td><td width="5%" align="center"><input type="text" onkeyup="calc_product_price('+idss+')" name="sin_product_cgst'+idss+'" id="sin_product_cgst'+idss+'" style=" width:60px"><input type="hidden" name="sin_prod_cgst_price'+idss+'" id="sin_prod_cgst_price'+idss+'" /></td><td width="5%" align="center"><input type="text" name="sin_product_sgst'+idss+'" onkeyup="calc_product_price('+idss+')" id="sin_product_sgst'+idss+'" style=" width:60px"><input type="hidden" name="sin_prod_sgst_price'+idss+'" id="sin_prod_sgst_price'+idss+'" /></td><td width="5%" align="center"><input type="text" name="sin_product_igst'+idss+'" onkeyup="calc_product_price('+idss+')" id="sin_product_igst'+idss+'" style=" width:60px"><input type="hidden" name="sin_prod_igst_price'+idss+'" id="sin_prod_igst_price'+idss+'" /></td><td width="4%" align="center"><input type="text" name="sales_product_price'+idss+'" id="sales_product_price'+idss+'" onkeyup="calc_product_price('+idss+')" style="width:80px" /><input type="hidden" name="total_sales_product[]" id="total_sales_product'+idss+'" /><input type="hidden" name="row_deleted'+idss+'" id="row_deleted'+idss+'" value="" /></td><tr></table></div>';
    ...
    <tr>
                        ...
                        <tr>
                        <td valign="top" align="center" width="26%" >Product Name</td>
                         <td valign="top" align="center" width="12%" >Product Price</td>
                        <td valign="top" width="8%" align="center">Total Qty</td>
