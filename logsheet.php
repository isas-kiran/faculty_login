    ...
    <td class="mid_mid">
    					<?php
    						if($_POST['save_changes'])
                        	{
								...
								$data_record_update['course_status']='finished';
                ...
                ?>
                      <tr>
						...
						{
							?>
							<option value="<?php echo $row_branch['branch_name'];?>"  <?php if($_GET['branch_name']==$row_branch['branch_name']) echo 'selected="selected"'; else if($row_branch['branch_name']==$data_branch_nmae['branch_name']) echo 'selected="selected"' ?> /><?php echo $row_branch['branch_name']; ?> 
							</option>
							<?php
						}
							echo '</select>';
      			...
      			<?php }?>
                                ...
                                <td width="23%" ><strong>Select Course </strong> </td>
                                 <td width="63%" ><select name="course_id" id="course_id" class="input_select" onChange="show_course(this.value);" >  
                        <option value=""> Select Course </option>
                         ...
                         <?php
						 {
							...
							if($_REQUEST['branch_name']!="")
							{
                          	...
                          	$sql_records= "SELECT * FROM enrollment where 1 ".$cm_ids." ".$pre_transcation_id."  order by course_id  desc";// order by year(added_date) desc,month(added_date) desc,day(added_date) asc";
