...
<table cellspacing="0" cellpadding="0" class="table" width="98%">
  ...
  <tr class="grey_td" >
   ...
   <!-- <td width="15%" align="center"><a href="<?php echo $_SERVER['PHP_SELF'];?>?order=<?php echo $order."&orderby=name".$query_string;?>" class="table_font"><strong>Name</strong></a> <?php echo $img1;?></td>-->
    ...
    <td width="13%" align="center"><strong>Installments</strong></td>
   ...
   ?>
	...
	?>
	<td width="10%" align="center" class="centerAlign"><strong>Verification Status</strong></td>
  </tr>
                            <?php
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                               ...
                               /* echo '<td ><a href="enroll.php?record_id='.$listed_record_id.'" class="table_font">'.$val_query['name'].'<br /> <img src="images/mobile-phone-8-16.ico">'.$val_query['contact'].' <br /> <img src="images/mail.png">'.$val_query['mail'].'</a></td>';*/
								...
								if($val_query['ref_id'] ==0)
								{
									...
									echo '<td><center><a href="add_new_course.php?record_id='.$listed_record_id.'"><img src="images/course.png" border="0" width="30px" height="30px" title="Add New Course"></a></center></td>';
								}
								else
								{
								...
								if($val_query['action_status']!="not_verify")
								{
									$url_pay_strt='<a href="action.php?record_id='.$listed_record_id.'">';
									$url_pay_end='</a>';
								}
								echo '<td><center>'.$url_pay_strt.'<img src="images/action.jpg" border="0" width="30px" height="30px" title="View Payment">'.$url_pay_end.'</center></td>';
								...
								if($_SESSION['type'] =='S' || $_SESSION['type'] =='A' || $_SESSION['type'] =='AC')
								{
									...
									if($val_query['action_status']=="not_verify" || $val_query['action_status']=="")
									{
										...
										echo'<span>'.$urlstr.'Enrollment Verify Pending</a></span>';
									}
									else if ($val_query['action_status']!="not_verify" || $val_query['action_status']=="verified" )
									{
										echo'<div class="middle"><img src="images/verified_all.png" border="0" width="20px" height="20px" title="Verified"> Enroll Verified</div>';
									}
									...
									if($val_query['action_status']=="verified")
									{
										...
										echo'<span><center>'.$urlstrt.'Acknowledgement Pending</a></center></span>';
									}
									else if($val_query['action_status']=="acknowledgement")
									{
										echo'<div class="middle"><img src="images/verified_all.png" border="0" width="20px" height="20px" title="Verified"> Acknowledged</div>';
									}
									else
									{}
									echo'</td>';
