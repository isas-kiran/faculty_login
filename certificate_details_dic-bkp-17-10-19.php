...
<div class="container">
	...
	<div class="beauty"><input type="text" name="beauty_grade" Placeholder="Beauty Grade" value="<?php if($_POST['beauty_grade']!='') echo $_POST['beauty_grade']; else if($beauty_grade!='') echo $beauty_grade; else if($row_record['beauty_grade'])echo $row_record['beauty_grade']; ?>" style="width:150px"></div>
	<div class="make_up"><input type="text" name="makeup_grade" Placeholder="Make up Grade" value="<?php if($_POST['makeup_grade']!='') echo $_POST['makeup_grade']; else if($makeup_grade!='') echo $makeup_grade; else if($row_record['makup_grade'])echo $row_record['makup_grade']; ?>" style="width:150px"></div>
	<div class="hair"><input type="text" name="hair_grade" Placeholder="Hair Grade" value="<?php if($_POST['hair_grade']!='') echo $_POST['hair_grade']; else if($hair_grade!='') echo $hair_grade; else if($row_record['hair_grade'])echo $row_record['hair_grade']; ?>" style="width:150px"></div>
