...
if(document.getElementById('inst_student_id'))
	var invoice_no =document.getElementById('inst_student_id').value;
else
	var invoice_no ='';
	...
	<tr>
                        ...
                        else
                        {
						   ...
						   // $data_record['service_tax']=$service_tax;
                            ...
                            if($record_id)
                            {
								...
								"<br/>".$data_record['installment_display_id']=$inst_student_id;
                                ...
                                $comma_separated = implode("/", $array);
						       	...
						       	"<br/>". $update_enroll_id=" update enrollment set installment_display_id='".$inst_student_id."' where enroll_id='".$student_id."' ";
	   ...
	   ?>
                ...
                <tr>
                    ...
                    <td width="40%"><input type="text" class="validate[required] input_text" name="home_contact" id="home_contact" value="<?php if($_POST['home_contact']) echo $_POST['home_contact']; ?>" onKeyPress="return isNumber(event)" maxlength="12"/></td> 
                    <td width="40%"><b>Note-</b> Should be 10-12 digit allowed. </td>
                </tr>
                <tr>
