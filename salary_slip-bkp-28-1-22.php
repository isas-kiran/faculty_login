...
<title id="title">Salary Slip</title>
...
{
	for($z=1;$z<=$_REQUEST['days'];$z++)
	{				                       
		$data_record_type1['holidays'] =addslashes(trim($_POST['holidays'.$z]));
		$data_record_type1['comment'] =addslashes(trim($_POST['comment'.$z]));
		$data_record_type1['present_day'] =addslashes(trim($_POST['present_day'.$z]));
		$where_record="attendance_id='".$_POST['floor_id'.$z]."'";
		$db->query_update("pr_import_attendance", $data_record_type1,$where_record);
	}
}
?>
</head>
            	...
            	<tr>
					...
					<table border="0" cellspacing="15" cellpadding="0" width="100%">
						...
						{ ?>
                			...
                			<td style="width: 15%;padding-left:0px;" colspan="2" align="left" >
							<?php
						...
						{ ?>
	                		...
	                		<td colspan="2">
								...
								<td><input style="margin-right: 0px;margin-left: 0px;width:100%;" type="button" class="input_btn" onClick="getsalaryslip()" value="Generate" name=""  /></td>
							</tr>
                        </table>
                        </tr> 
 						</table>
