...
$edit_access='';
$sel_acc="select * from edit_previleges where admin_id='".$_SESSION['admin_id']."' and privilege_id='326'";
...
<title>Add Grade Calculation</title>
    ...
    <td class="mid_mid">
     <?php 
                    if($_REQUEST['deleteRecord'])
                    {
                        ...
                        $sql_query= "SELECT grade_id FROM grade_calculation where grade_id='".$del_record_id."'";
                        if(mysql_num_rows($db->query($sql_query)))
                        {                           
							$delete_query="delete from grade_calculation where grade_id='".$del_record_id."'";
...
/* function validme()
	 {
		 ...
		 return true;
                      ...
                      <?php
                                $sql_records= "SELECT * FROM grade_calculation where 1 ".$_SESSION['where']." order by grade_id asc";
                                ...
                                if($no_of_records)
                                {
									...
									<tr align="center" class="grey_td" ><td width="7%" class="tr-header"><strong>Sr.</strong></td><?php if($_SESSION['type']=='S' || $_SESSION['type']=='Z' || $_SESSION['type']=='LD'){ ?><td width="11%" class="tr-header"><strong>branch name</strong></td><?php } ?><td width="11%" class="tr-header"><strong>Grade name</strong></td><td width="11%" class="tr-header"><strong>Starting Marks From(in %)</strong></td><td width="11%" class="tr-header"><strong>Ending Marks From(in %)</strong></td><?php if($_SESSION['type']=='S' || $edit_access=='yes' ) {?><td width="12%" class="tr-header"><strong>Action</strong></td> <?php }?></tr><?php
                                    while($val_record=mysql_fetch_array($all_records))
                                    {
										...
										$paid_totas=0;
                                       	$listed_record_id=$val_record['grade_id'];
										...
										echo "<td align='center'>".$val_record['grade']."</td>";
										echo "<td align='center'>".$val_record['starting_marks_from']."</td>";
										echo "<td align='center'>".$val_record['ending_marks_to']."</td>";
							...
							if($_POST['save_changes'])
							{
								...
								else
								{
									...
									for($j=1;$j<=$total_floor;$j++)
									{
										if($_POST['grade'.$j] !='')
										{
											$data_record_type1['grade'] = addslashes(trim($_POST['grade'.$j]));
											$data_record_type1['starting_marks_from'] = $_POST['starting_marks_from'.$j];
											$data_record_type1['ending_marks_to'] = $_POST['ending_marks_to'.$j];
											$data_record_type1['admin_id'] = $_SESSION['admin_id'];
											$data_record_type1['added_date']=$added_date;
											$record_ids=$db->query_insert("grade_calculation",$data_record_type1);
									...
									$( "#statusChangesDiv" ).dialog({
							 		...
							 		//setTimeout('document.location.href="add_grading_calculation.php";',1000);
									</script>
				 					<?php
								}
							}
                                ...
                                <td colspan="3">
                                	<table  width="100%" style="border:0px solid gray; ">
                                        ...
                                        <table cellpadding="5" width="100%" >
                                            ...
                                            {
                                            	var shows_data='<div id="floor_id'+idss+'"><table cellspacing="3" id="tbl'+idss+'" width="100%"><tr><td valign="top" width="40%" align="center"><input type="text" name="grade'+idss+'" id="grade'+idss+'" style="width:90%" required/></td><td valign="top" width="20%" align="center"><input type="text" name="starting_marks_from'+idss+'" class="input_text " placeholder="Starting Marks From" id="starting_marks_from'+idss+'" title="Starting Marks From" value=""></td><td valign="top" width="20%" align="center"><input type="text" name="ending_marks_to'+idss+'" class="input_text" placeholder="Ending Marks To" id="ending_marks_to'+idss+'" title="Ending Marks To" value=""></td><input type="hidden" name="row_deleted'+idss+'" id="row_deleted'+idss+'" value="" /><tr></table></div>';
                                        ...
                                        <tr><td align="center"></td><td align="center"></td><td align="center"></td></tr>
                  						...
                  						<tr>
                                            ...
                                            <tr>
                                            <td valign="top" width="40%" align="center">Grade</td>
                                            <td valign="top" width="20%" align="center">Starting Marks From (in %)</td>
											<td valign="top" width="20%" align="center">Ending Marks to (in %)</td>
                                        </tr>
                                    </table>
