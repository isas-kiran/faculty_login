        ...
        <?php
			...
			$success=0;
                    ...
                    if($_POST['save_changes'])
                    {
						...
						$chk_exist ="select username,attendence_id,email,contact_phone from site_setting where 1 and (username='".$username."' or attendence_id='".$attendence_id."' or email='".$email."' or contact_phone='".$contact_phone."') ".$admin_id." and branch_name='".$branch_name."' and system_status='Enabled' ";
						$ptr_chk_exit=mysql_query($chk_exist);
						$data_exist=mysql_fetch_array($ptr_chk_exit);

						$user_exist=trim($data_exist['username']);
						$att_exist=trim($data_exist['attendence_id']);
						...
						if($att_exist==trim($attendence_id))
						{
							 $success=0;
                             $errors[$i++]="Attendence ID Already Exist.";
						} 
...
*/
                        ...
                        else
                        {
                            ...
                            else
                            {
								...
								$data_record['system_status']="Enabled";
	...
	<table border="0" cellspacing="15" cellpadding="0" width="100%">
                ...
                <select  multiple="multiple" name="edit_privilege_id[]" id="edit_pre_id" class="input_select" style="width:150px;">
                        <?php 
                            ...
                            { 
									...
									if($record_id)
									{
										$sql_sub_cat="select * from edit_previleges where admin_id='".$row_record['admin_id']."' and privilege_id='".$data_faculty['privilege_id']."' ";
										$ptr_sub_cat=mysql_query($sql_sub_cat);
            ...
            <tr>
                ...
                <td width="40%"><input type="text" class="datepicker input_text" name="leaving_date" id="leaving_date" value="<?php if($_POST['save_changes']) echo $_POST['leaving_date']; else echo $row_record['leaving_date'];?>" />
                </td> 
                <td width="40%" ></td>
            </tr>
            <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                         ...
                         <script language="javascript">
                           ...
                           <td align="right"><input type="button" name="Add"  class="addBtn" onClick="javascript:create_floor('add');" alt="Add(+)" > <input type="button" name="Add"  class="delBtn"  onClick="javascript:create_floor('delete');" alt="Delete(-)" >
							</td></tr>
