  ...
  <tr>
    ...
    <td class="mid_mid">
                      ...
                      <?php
						...
						$sql_records= "SELECT * FROM pr_staff_advance_invoice where staff_advance_salary_id=".$record_id." ";
						...
						if($no_of_records)
						{
							...
							<tr><td valign="middle" align="right">
                                    ...
                                    <?php
                                        ...
                                        $select_customer = " select name,attendence_id from site_setting where attendence_id='".$fetch_query_cust_service['staff_id']."' ";
									...
									?>
                                    	...
                                    	<tr style="padding-left:10px">
                                        	<td width="20"><strong>Customer Name :</strong></td><td width="330"><?php echo $data_customer['name']; ?></td>
								...
								<tr align="center" class="grey_td" >
									...
									<td width="11%" class="tr-header"><strong> Payable Amount </strong></td>
                                   ...
                                   <!-- <td width="9%" class="tr-header"><strong>View</strong></td>
                                    ...
                                    while($val_record=mysql_fetch_array($all_records))
                                    {
										...
										echo "<td align='center'>".$val_record['invoice_id']."</td>";
										 echo '<td align="center">'.$val_record['amount'].'</td>';
									  
									   
								        echo '<td align="center">'.$val_record['total_paid'].'</td>';
										...
										onclick=\"window.open('invoice_generate_advance_deduction.php?record_id=".$val_record['invoice_id']."','View Invoice','scrollbars=yes','resizable=yes','width=900,height=600')\" style='cursor:pointer' >
										</td>";
                                       /*  echo "<td align='center'>
										<img src='images/view.jpeg' title='View Invoice' border='0' 
										onclick=\"window.open('invoice_generate_cust_serv.php?record_id=".$val_record['invoice_id']."','View Invoice','scrollbars=yes','resizable=yes','width=900,height=600')\" style='cursor:pointer' >
										</td>";
										echo "<td align='center'><img src='images/print1.jpeg'
								onclick=\"window.open('invoice_generate_cust_serv.php?record_id=".$val_record['invoice_id']."&action=print','View Invoice','width=750,height=700')\"style='cursor:pointer'title='Print Invoice' border='0'></td>"; */
                                    ...
                                    ?>
                                        ...
                                        if($fetch_query_cust_service['remaining_amount'] !=0)
										{
											...
											echo '<td>';
											echo'<a href="staff_advance_payment.php?record_id='.$record_id.'"><strong><font size="+1">Add Payment</font></strong></a>'; 
											echo '</td>';
											echo '<td>';
											echo  '<a href="staff_advance_payment.php?record_id='.$record_id.'">
											<img src="images/add1-.png" border="0" title="Add Payment"></a>';
											echo '</td>';
										}
										else
										{
											echo "<center><b><span style='font-size:18px;color:green;'>Advance Payment Done.</span></b></center>";
										}
								?>
                                		</tr>
										<tr>
										<td>
											<a href="manage_advance_deduction.php"><strong><font size="+1">Back</font></strong></a>
											</td>
										
										<td>
											<a href="manage_advance_deduction.php">
											<img class="img_back" src="images/back_arrow.png" border="0" title="Back"></a>
										</td>
									</tr>
                                		</table>
                                    </td></tr>
