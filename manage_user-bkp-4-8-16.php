...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
    ...
    <?php
                        ...
                        if($_GET['order'] !='' && ($_GET['orderby']=='course_name'))
                        {
                            ...
                            $select_directory='order by admin_id desc';                      
                        	 $sql_query= "SELECT * FROM site_setting where admin_id !='".$_SESSION['admin_id']."' and  1  ".$pre_keyword." ".$course_keyword." ".$branch_keyword." ".$_SESSION['where_admin_id-cm_id']." ".$select_directory.""; 
                       //echo $sql_query;
  ...
  <tr class="grey_td" >
    ...
    <td width="8%"><strong>Basic Pay</strong></td>
    ...
    <td width="7%" class="centerAlign"><strong>Action</strong></td>
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
                                ...
                                */
                                ...
                                echo '<td align="center"><a href="add_user.php?record_id='.$listed_record_id.'" ><img src="images/edit_icon.png" title="Edit Record" class="example-fade"/></a>&nbsp;&nbsp;
