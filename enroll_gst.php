...
//=============================================================
	...
	success: function(rettax)
	{
		...
		sgst=taxes[3];
		<?php
		if($row_record['cgst_tax_in_percent']>0 && $row_record['sgst_tax_in_percent']>0)
		{
			?>
    ...
    <td class="mid_mid">
        ...
        <?php
			...
			if($_POST['save_records'] && $_POST['randcheck']==$_SESSION['rand'])
            {
				...
				$is_upgrade=( true== isset($_POST['is_upgrade'])) ? $_POST['is_upgrade'] : "";
				$upgrade_from=( true== isset($_POST['upgrade_from'])) ? $_POST['upgrade_from'] : "";
				...
				if($payment_type =="select")
				{
                    ...
                    <?php
                        ...
                        else
                        {
                            ...
                            $data_record['is_upgrade']=$is_upgrade;
							$data_record['upgrade_from']=$upgrade_from;
			...
			<tr>
				<td width="20%"class="orange_font">* Date Format should be [ DD/MM/YYYY ]</td>
					   ...
					   ?>
                            ...
                            <tr>
                                <td width="22%">Is Upgrade</td>
                                <td width="38%">
                                <input type="radio" name='is_upgrade' id="is_upgrade" <?php if($_POST['is_upgrade'] =="yes") echo 'checked="checked"'; else if($row_record['is_upgrade'] =='yes') echo 'checked="checked"'; ?> value="is_upgrade"  />Yes
                                <input type="radio" name='is_upgrade' id="is_upgrade" <?php if($_POST['is_upgrade'] =="no") echo 'checked="checked"'; else if($row_record['is_upgrade'] =='no') echo 'checked="checked"'; else echo 'checked="checked"'; ?> value="no" />No
                                <input type="hidden" name="upgrade_from" id="upgrade_from" value="<?php echo $row_record['course_id']; ?>"  />
                                </td>                
                            </tr>
                            <tr>
                            ...
                            <tr>                              
                                ...
                                <td width="49%"><div id=total_fees><input type="text" class="input_text" name="total_fees" <?php echo $readonly; echo $bg;?> id="toal_fees"  onblur="show_record(this.value,1)"  value="<?php if($_POST['total_fees']) echo $_POST['total_fees']; else echo $row_record['course_fees'];?>" /></div>
                                </td>                
                                <td width="31%">
                                ...
                                <input type="hidden" name="discount_record" id="discount_record" value="<?php if($row_record['discount'] !=0) echo $row_record['discount']; else echo 0; ?>" />
                                <input type="hidden" name="discount_record_type" id="discount_record_type" value="<?php if($row_record['discount'] >0) echo 'yes'; else echo 'no' ?>" />
                            ...
                            <tr>
                                ...
                                <td width="38%">
                                <input type="radio" name='now_disc' id="normal_disc" <?php if($_POST['now_disc'] =="normal_disc") echo 'checked="checked"'; else if($row_record['current_discount_type'] =='normal_disc') echo 'checked="checked"'; ?> value="normal_disc" onChange="show_now_discount()" />Normal Discount
                                <input type="radio" name='now_disc' id="now_disc" <?php if($_POST['now_disc'] =="now_disc") echo 'checked="checked"'; else if($row_record['current_discount_type'] =='now_disc') echo 'checked="checked"'; ?> value="now_disc" onChange="show_now_discount()" />Now Discount
                                </td>                
...
function show_now_discount()
{
	...
	if(frm.now_disc[0].checked == true)
	{
	...
	if(frm.now_disc[1].checked == true)
	{
		if(paid_type=='one_time')
		{
...
{    
	...
	if(course_exist !='')
	{
		if(frm.now_disc[1].checked == true)
		{
			if(paid_type=='installments')
			{
				...
				else
				{
					...
					document.getElementById('toal_fees').value=toatl_one_time;
		...
		var coupon_disc=document.getElementById("discount_coupon_price").value;
		...
		//==================changes as added Service Tax & GST on 29-1-21
		<?php
		if($row_record['cgst_tax_in_percent']>0 && $row_record['sgst_tax_in_percent']>0)
		{
			?>
		...
		{
			?>
			var total_down_gst_tax=roundNumber(Down_GST_Amount,3);
...
if($record_id)
{
	...
	setTimeout(show_record,3000,toal_fees,'1')
	<?php
