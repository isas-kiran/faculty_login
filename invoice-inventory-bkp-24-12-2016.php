...
?>
                        <?php
						  ...
						  $sql_vendor= "SELECT name,email,contact,address,tax_no,lbt_no from vendor where vendor_id ='".$data_bill_master['vendor_id']."'";
						  $ptr_vendor =mysql_query($sql_vendor);
						  $data_vendor=mysql_fetch_array($ptr_vendor);
						  
						  $sel_pay_mode="select payment_mode from payment_mode where payment_mode_id='".$data_bill_master['payment_mode_id']."'";
...
<table align="center" border="1px"  width="786" style="border-left:solid #999 1px; border-right:solid #999 1px; border-top:solid #999 1px;border-radius:5px; border-collapse:collapse">
             ...
             <table align="center" border="1px"  width="786" cellpadding="5" cellspacing="2"  style=" border:1px solid; border-collapse:collapse" >
				...
				$amount='';
				   ...
				   "<br>". $select_product="select product_name,product_code,brand,description,size,price from product where product_id='".$data_inventoty['product_id']."' ";
					...
					//echo $tot_dis_price;
					 ...
					 $total_qty_price=$data_product['price']*$data_inventoty['sin_product_qty'];
					 
					 $total_rate=$total_rate+$data_product['price'];
					...
					'<br/>'.$total_discount_price =$total_discount_price+$tot_dis_price;
					 ...
					 echo '<tr>';
						...
						echo '<td width="5%" align="center"><span style="font-size:10px;">'.$data_product['price'].'</span></td>';
				...
				?>          	
                  <tr bgcolor="#EFEFEF">
                      <td colspan="5" align="center"><span style="font-size:12px; font-weight:bold">Total</span></td>
...
-->                  </tr> 
                  ...
                  <tr>
                  <td colspan="3" align="left"><span style="font-size:12px; font-weight:bold">Bill Amount : <?php echo $data_bill_master['amount1']?> /-</span></td>
