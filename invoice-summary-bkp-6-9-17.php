...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
    ...
    <img src='images/print1.jpeg'
                                ...
                                <td class="tr-header"><strong>Total</strong></td><td  class="tr-header"><strong>Discount</strong></td><td class="tr-header"><strong>Down Pay.</strong></td>--><td width="12%" class="tr-header"><strong>Inst. Paid</strong></td><td width="15%" class="tr-header"><strong>Balance Amount</strong></td><td width="20%"  class="tr-header"><strong>Installment</strong></td><td width="10%"  class="tr-header"><strong>Payment Mode</strong></td><td width="8%" class="tr-header"><strong> Date </strong></td><td width="6%" class="tr-header"><strong> Status </strong></td><td width="9%" class="tr-header"><strong>View</strong></td><td width="12%" class="tr-header"><strong>Print</strong></td></tr><?php
								...
								onclick=\"window.open('invoice-generate.php?record_id=".$val_record['invoice_id']."&action=print','View Invoice','width=750,height=700')\"style='cursor:pointer'title='Print Invoice' border='0'></td>";
									...
									$(document).ready(function(){
                                        ...
                                        if($data_select['balance_amt'] !=0)
										{
											...
											echo '</td></tr>';
											echo'<tr><td><font size="+1">(For old Payment Recovery)</font></td></tr>';
