...
<title>Purchase Payment Tally Report</title>
...
?>   
	...
	?>
           	<tr>
                ...
                <td><a href="purchase_payment_tally_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>
            </tr>          
        </table>
        </form>	
    </td>
	...
	if($no_of_records)
	{
        ...
        <tr class="grey_td" >
            ...
            while($val_query=mysql_fetch_array($my_db))
            {
				...
				echo '<td align="center">'.$data_name['name'].' - '.$val_query['vendor_id'].'</td>';
				echo '<td align="center">'.round($val_query['payable_amount'],2).'</td>';
				echo '<td align="center">Paid for product purchase</td>';
