...
$message.='</table>';
						...
						$subject = " Daily Stack Report for PCMC Branch - ISAS BEAUTY SCHOOL ";
						...
						//===================================================//21-12-17=====================================================
							...
							try {
									...
									$sel_sms_cnt="select * from sms_mail_configuration_map where previlege_id='283'";
									...
									$mail->Subject = 'Daily Stack Report Report For PCMC Branch- '.date('Y-m-d').'';
