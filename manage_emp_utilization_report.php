    				...
    				<td colspan="17">
        				<form method="get" name="search">
							<table border="0" cellspacing="0" cellpadding="0" width="99%" align="center">
                                ...
                                <td width="4%" align="center"> <a href="emp_utilization_report_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>
               ...
               // $pager = new PS_Pagination($sql_query,$_SESSION['show_records'],$_SESSION['show_records_pages'],$query_string1);
                ...
                <tr>
                    ...
                    while($data_couc=mysql_fetch_array($ptr_counc))
                    {
                        ...
                        ?>
                        <td align="center"><strong><?php echo ($data_per['timesheet_mark']); ?></strong></td>
                        <?php
                    }
                    ?>
                </tr>
                ...
                <tr>
                    ...
                    while($data_couc=mysql_fetch_array($ptr_counc))
                    {
						...
						$data_per=mysql_fetch_array($ptr_per);
                        ?>
                        <td align="center"><strong><?php echo ($data_per['utilisation_mark']); ?></strong></td>
                        <?php
                    }
                    ?>
                </tr>
                ...
                <tr>
                    ...
                    while($data_couc=mysql_fetch_array($ptr_counc))
                    {
						...
						$data_per=mysql_fetch_array($ptr_per);
                        ?>
                        <td align="center"><strong><?php echo ($data_per['presence']); ?></strong></td>
                        <?php
                    }
                    ?>
                </tr>
                ...
                <tr>
                    ...
                    while($data_couc=mysql_fetch_array($ptr_counc))
                    {
						...
						$data_per=mysql_fetch_array($ptr_per);
                        ?>
                        <td align="center"><strong><?php echo ($data_per['working_hrs']); ?></strong></td>
                        <?php
                    }
                    ?>
                </tr>
                ...
                <tr>
                    ...
                    while($data_couc=mysql_fetch_array($ptr_counc))
                    {
						...
						$data_per=mysql_fetch_array($ptr_per);
                        ?>
                        <td align="center"><strong><?php echo ($data_per['task_mark']); ?></strong></td>
                        <?php
                    }
                    ?>
                </tr>
                ...
                <tr>
                    ...
                    while($data_couc=mysql_fetch_array($ptr_counc))
                    {
						...
						$data_per=mysql_fetch_array($ptr_per);
                        ?>
                        <td align="center"><strong><?php echo ($data_per['quality_work_mark']); ?></strong></td>
                        <?php
                    }
                    ?>
                </tr>
                ...
                <tr>
                    ...
                    while($data_couc=mysql_fetch_array($ptr_counc))
                    {
                        ...
                        ?>
                        <td align="center"><strong><?php echo ($rules_foll);?></strong></td>
                        <?php
                    }
                    ?>
                </tr>
                            ...
                            <tr>
                                ...
                                while($data_couc=mysql_fetch_array($ptr_counc))
                                {
                                    ...
                                    $data_per=mysql_fetch_array($ptr_per);
                                    ?>
                                    <td align="center"><strong><?php echo ($data_per['class_start_time_mark']);?></strong></td>
                                    <?php
                                }
                                ?>
                            </tr>
                            ...
                            <tr>
                                ...
                                while($data_couc=mysql_fetch_array($ptr_counc))
                                {
                                    ...
                                    $data_per=mysql_fetch_array($ptr_per);
                                    ?>
                                    <td align="center"><strong><?php echo ($data_per['class_end_time_r_mark']);?></strong></td>
                                    <?php
                                }
                                ?>
                            </tr>
                            ...
                            <tr>
                                ...
                                while($data_couc=mysql_fetch_array($ptr_counc))
                                {
                                    ...
                                    $data_per=mysql_fetch_array($ptr_per);
                                    ?>
                                    <td align="center"><strong><?php echo ($data_per['faculty_grooming_r_mark']);?></strong></td>
                                    <?php
                                }
                                ?>
                            </tr>
                            ...
                            <tr>
                                ...
                                while($data_couc=mysql_fetch_array($ptr_counc))
                                {
                                    ...
                                    $data_per=mysql_fetch_array($ptr_per);
                                    ?>
                                    <td align="center"><strong><?php echo ($data_per['logsheet_send_r_mark']);?></strong></td>
                                    <?php
                                }
                                ?>
                            </tr>
                            ...
                            <tr>
                                ...
                                while($data_couc=mysql_fetch_array($ptr_counc))
                                {
                                    ...
                                    $data_per=mysql_fetch_array($ptr_per);
                                    ?>
                                    <td align="center"><strong><?php echo ($data_per['mobile_used_r_mark']);?></strong></td>
                                    <?php
                                }
                                ?>
                            </tr>
                            ...
                            <tr>
                                ...
                                while($data_couc=mysql_fetch_array($ptr_counc))
                                {
                                    ...
                                    $data_per=mysql_fetch_array($ptr_per);
                                    ?>
                                    <td align="center"><strong><?php echo ($data_per['timetable_followed_r_mark']);?></strong></td>
                                    <?php
                                }
                                ?>
                            </tr>
                            ...
                            <tr>
                                ...
                                while($data_couc=mysql_fetch_array($ptr_counc))
                                {
                                    ...
                                    $data_per=mysql_fetch_array($ptr_per);
                                    ?>
                                    <td align="center"><strong><?php echo ($data_per['student_decoram_r_mark']);?></strong></td>
                                    <?php
                                }
                                ?>
                            </tr>
                ...
                <tr>
                    ...
                    while($data_couc=mysql_fetch_array($ptr_counc))
                    {
						...
						$data_per=mysql_fetch_array($ptr_per);
                        ?>
                        <td align="center"><strong><?php echo ($data_per['negative_remarks']); ?></strong></td>
                        <?php
                    }
                    ?>
                </tr>
                            ...
                            <tr>
                                ...
                                while($data_couc=mysql_fetch_array($ptr_counc))
                                {
                                    ...
                                    $data_per=mysql_fetch_array($ptr_per);
                                    ?>
                                    <td align="center"><strong><?php echo ($data_per['late_login_without_info_mark']);?></strong></td>
                                    <?php
                                }
                                ?>
                            </tr>
                            ...
                            <tr>
                                ...
                                while($data_couc=mysql_fetch_array($ptr_counc))
                                {
                                    ...
                                    $data_per=mysql_fetch_array($ptr_per);
                                    ?>
                                    <td align="center"><strong><?php echo ($data_per['absent_without_info_mark']);?></strong></td>
                                    <?php
                                }
                                ?>
                            </tr>
                            ...
                            <tr>
                                ...
                                while($data_couc=mysql_fetch_array($ptr_counc))
                                {
                                    ...
                                    $data_per=mysql_fetch_array($ptr_per);
                                    ?>
                                    <td align="center"><strong><?php echo ($data_per['early_checkout_info_mark']);?></strong></td>
                                    <?php
                                }
                                ?>
                            </tr>
                            ...
                            <tr>
                                ...
                                while($data_couc=mysql_fetch_array($ptr_counc))
                                {
                                    ...
                                    $data_per=mysql_fetch_array($ptr_per);
                                    ?>
                                    <td align="center"><strong><?php echo ($data_per['misconduct_with_staff_mark']);?></strong></td>
                                    <?php
                                }
                                ?>
                            </tr>
                            ...
                            <tr>
                                ...
                                while($data_couc=mysql_fetch_array($ptr_counc))
                                {
                                    ...
                                    $data_per=mysql_fetch_array($ptr_per);
                                    ?>
                                    <td align="center"><strong><?php echo ($data_per['misconduct_with_student_mark']);?></strong></td>
                                    <?php
                                }
                                ?>
                            </tr>
                            ...
                            <tr>
                                ...
                                while($data_couc=mysql_fetch_array($ptr_counc))
                                {
                                    ...
                                    $data_per=mysql_fetch_array($ptr_per);
                                    ?>
                                    <td align="center"><strong><?php echo ($data_per['logsheet_not_checked_mark']);?></strong></td>
                                    <?php
                                }
                                ?>
                            </tr>
                            ...
                            <tr>
                                ...
                                while($data_couc=mysql_fetch_array($ptr_counc))
                                {
                                    ...
                                    $data_per=mysql_fetch_array($ptr_per);
                                    ?>
                                    <td align="center"><strong><?php echo ($data_per['other_issue_mark']);?></strong></td>
                                    <?php
                                }
                                ?>
                            </tr>
                ...
                <tr>
                    ...
                    while($data_couc=mysql_fetch_array($ptr_counc))
                    {
						...
						$data_per=mysql_fetch_array($ptr_per);
                        ?>
                        <td align="center"><strong><?php echo ($data_per['points']); ?></strong></td>
                        <?php
                    }
                    ?>
                </tr>
                ...
                <tr>
                    ...
                    while($data_couc=mysql_fetch_array($ptr_counc))
                    {
						...
						$data_per=mysql_fetch_array($ptr_per);
                        ?>
                        <td align="center"><strong><?php echo ($data_per['monthly_points']); ?></strong></td>
                        <?php
                    }
                    ?>
                </tr>
