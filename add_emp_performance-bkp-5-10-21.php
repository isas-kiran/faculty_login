...
<!--        <script src="../js/jquery.custom/development-bundle/jquery-1.4.2.js"></script>-->
	...
	function calculate_mark()
	{
		...
		var total_mark=parseFloat(timesheet_mark+utilisation_mark+task_mark+quality_work_mark+class_start_time_mark+class_end_time_r_mark+faculty_grooming_r_mark+logsheet_send_r_mark+mobile_used_r_mark+timetable_followed_r_mark+student_decoram_r_mark-negative_remark_mark);
        ...
        <?php
			...
			if($success==0)
			{
                ...
                <tr>
                	...
                	<td></td>
                    <td>Class Start on Time-  Yes<input type="radio" name="class_start_time_r"  onchange="calculate_cst(this.value)" id="class_start_time_r" class="input_radio" value="yes"> No<input type="radio" name="class_start_time_r" onblur="calculate_cst(this.value)" id="class_start_time_r" class="input_radio" value="no"> </td>
                    <td><input type="text" readonly="readonly" name="class_start_time_mark" style="text-align:center; width:100px" class="input_text" id="class_start_time_mark" value="<?php if($_POST['class_start_time_mark']) echo $_POST['class_start_time_mark']; else echo $row_record['class_start_time_mark']; ?>">
                	</td>
                </tr>
                <tr>
                	<td></td>
                    <td>Class End on Time-  Yes<input type="radio" name="class_end_time_r" id="class_end_time_r" onchange="calculate_cet(this.value)" class="input_radio" value="yes"> No<input type="radio" name="class_end_time_r" id="class_end_time_r" onblur="calculate_cet(this.value)" class="input_radio" value="no"> </td>
                ...
                <tr>
                	<td></td>
                    <td>Faculty Grooming-  Yes<input type="radio" name="faculty_grooming_r" id="faculty_grooming_r" onchange="calculate_fg(this.value)" class="input_radio" value="yes"> No<input type="radio" name="faculty_grooming_r" id="faculty_grooming_r" onblur="calculate_fg(this.value)" class="input_radio" value="no"></td>
                ...
                <tr>
                	<td></td>
                    <td>Logsheet Send-  Yes<input type="radio" name="logsheet_send_r" id="logsheet_send_r" onchange="calculate_ls(this.value)" class="input_radio" value="yes"> No<input type="radio" name="logsheet_send_r" id="logsheet_send_r" onblur="calculate_ls(this.value)" class="input_radio" value="no"></td>
                ...
                <tr>
                	<td></td>
                    <td>Mobile Not Used in Batch Hours-  Yes<input type="radio" name="mobile_used_r" id="mobile_used_r" onchange="calculate_mubh(this.value)" class="input_radio" value="yes"> No<input type="radio" name="mobile_used_r" id="mobile_used_r" onblur="calculate_mubh(this.value)" class="input_radio" value="no"> </td>
                ...
                <tr>
                	<td></td>
                    <td>Timetable Followed-  Yes<input type="radio" name="timetable_followed_r" id="timetable_followed_r" onchange="calculate_tf(this.value)" class="input_radio" value="yes"> No<input type="radio" name="timetable_followed_r" id="timetable_followed_r" onblur="calculate_tf(this.value)" class="input_radio" value="no"> </td>
                ...
                <tr>
                	<td></td>
                    <td>Student Decoram-  Yes<input type="radio" name="student_decoram_r" id="student_decoram_r" onchange="calculate_sd(this.value)" class="input_radio" value="yes"> No<input type="radio" name="student_decoram_r" id="student_decoram_r" onblur="calculate_sd(this.value)" class="input_radio" value="no"> </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="negative_remark_mark" id="negative_remark_mark" onblur="calculate_mark(this.value)"  class="input_text" title="Negative Remark Mark" value="<?php if($_POST['negative_remark_mark']) echo $_POST['negative_remark_mark']; else echo $row_record['negative_remark_mark']; ?>">
                    </td>
                    <td></td>
                </tr>
                <tr>
