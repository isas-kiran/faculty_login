...
$total_found =0;	
	...
	if($_REQUEST['keyword']!="Keyword")
  	...
  	$sel_for_Num_rows="select * from receipt where 1 and category !='cash_transfer' ".$pre_keyword_i." ".$category." ".$bank_ids." ".$paid_from_date." ".$paid_to_date." ".$select_directory." ";	
...
$objPHPExcel->setActiveSheetIndex(0);
 ...
 $objPHPExcel->setActiveSheetIndex()->setCellValueByColumnAndRow('3','3', 'Mo No','3');
  ...
  $objPHPExcel->setActiveSheetIndex()->setCellValueByColumnAndRow('13','3', 'Status','3');*/
	...
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('C4', 'Category','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('D4', 'Payment Type','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('E4', 'Bank Name','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('F4', 'Bank Details','6');
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('G4', 'Deposit Amount','6');
	...
	$branch_id='';
	$select_directory='order by DATE(added_Date) desc';                         
	 $sql_query= "select * from receipt where 1 and category !='cash_transfer' ".$pre_keyword_i." ".$category." ".$bank_ids." ".$paid_from_date." ".$paid_to_date." ".$select_directory." "; 
	...
	while($val_query=mysql_fetch_array($query_order))
	{
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('C'.$rowCount, $cat);		
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('D'.$rowCount, $payment_mode);
		...
		$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('E'.$rowCount,"Bank Name.-". $data_bank['bank_name']."\n Acc. No.- ".$data_bank['account_no']);						
		  ...
		  $objPHPExcel->setActiveSheetIndex(0)->SetCellValue('F'.$rowCount, $b_details."\n".$b_details1."\n".$b_details2."\n".$b_details3);
		  $objPHPExcel->setActiveSheetIndex(0)->SetCellValue('G'.$rowCount, $val_query['amount']);
	...
	$objPHPExcel->setActiveSheetIndex(0)->SetCellValue('G'.$rowCount,intval($totals_tds));
...
header('Content-Disposition: attachment;filename="receipt_summury_report.xls"');
