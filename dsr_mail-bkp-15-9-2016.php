 ...
 <tr style="background-color:#999;color: black">
    ...
    <td width="8%" align="center" style="border:1px solid #CCC"><strong>Cash In Hand</strong></td>
			 ...
			 $message.= '<tr>';
				...
				$message.= '<td align="center" style="border:1px solid #CCC">Fees- '.$data_ptr_sel['total_amt'].'<br /><hr />Product- '.$data_sel_recipt['total_amt'].'</td>';
				...
				$cash_in_hands=$opening_cash1 + $data_ptr_sel['total_amt'] +$data_sel_recipt['total_amt'] + /*$data_expense_taken['total_amt'] +*/ $data_cash_received_sir['total_amt'] - $data_total_expense['total_amt'] -  $data_cash_from_sir['total_amt'] - $tt + $data_cash_from_innocent['total_amt'];
				//==============================================================================
				$message.= $xx.'</td>';
