  ...
  <tr>
    ...
    <td class="mid_mid">
    					<?php
    						if($_POST['save_changes'])
                        	{
								...
								$action_counc_id=$_POST['action_counc_id'];
								...
								if($record_id)
								{
									...
									$insert_into_bop= "INSERT INTO `action_bop`(`action_counc_id`, `complete_action_done`,`added_date`,`admin_id`) VALUES ('".$action_counc_id."', 'done', '".date('Y-m-d H:i:s')."','".$data_record['admin_id']."')";
									$ptr_isert_invp = mysql_query($insert_into_bop);
													
									$update_en="UPDATE `action_councellor` SET `action_by_status`='done' where enroll_id='".$record_id."'";
									$ptr_query_en=mysql_query($update_en);
									
									$insert_en1="UPDATE `enrollment` SET `action_status`='done' where enroll_id='".$record_id."'";
									$ptr_query_en1=mysql_query($insert_en1);
									?>
                                    <script>
									alert("Action Done Succesfully..!");
									document.location.href="manage_task.php";
									</script>
    ...
    <img src='images/print1.jpeg'
								onclick="window.open('invoice-generate-company.php?action=print','View Invoice')" style='cursor:pointer'title='Print Invoice' border='0'>
                                    ...
                                    while($val_record=mysql_fetch_array($all_records))
                                    {
										...
										$phone_no ='';
									  	...
									  	$select_firstname = " select * from enrollment where enroll_id='".$record_id."' and action_status='pending' ";
                        ...
                        <tr><td colspan="2" align="center" style=" font-size:12px; font-weight:bold"><strong>Fees Details</strong></td></tr>	
                            ...
                            <tr>
                            	<td align="left"  style="padding-left:10px;"><span style="font-weight:bold">Schedule Induction</span><input type="hidden" name="action_counc_id" value=" <?php echo $data_sel['action_counc_id']; ?>" /></td>
                                <td align="left"  style="padding-left:10px;"><span style=" font-weight:bold"><input type="checkbox" disabled="disabled"  name="sche_action" <?php if($data_sel['schedule_Induction']=='yes') {echo 'checked="checked"' ;}else {}?> value="yes"/></span></td>
                                <td align="left"  style="padding-left:10px;"><span style="font-weight:bold"><input type="text" disabled="disabled" value="<?php if($_POST['save_changes']) echo $_POST['sche_date']; else echo $data_sel['schedule_date'];?>"  name="sche_date"  class="datepicker" placeholder="Action date "/></span></td>
                                <td align="left"  style="padding-left:10px;">
                                 <select  multiple="multiple" name="counc_id[]" disabled="disabled" id="user_id" class="input_select" style="width:150px;">                        
									<?php 
                                        ...
                                        if($class !='')                                    
                                        echo '<option value="'.$data_faculty['name'].'" '.$class.' >'.$data_faculty['name'].' </option>';     
                                        else
                                        echo '<option value="'.$data_faculty['name'].'" >'.$data_faculty['name'].' </option>';  
                                        }
                                        ?>        
                                </select>
                                </td>
                             ...
                             <tr>
                                ...
                                <td align="left"  style="padding-left:10px;"><span style=" font-weight:bold"><input type="checkbox" disabled="disabled"  name="batch_action"  <?php if($data_sel['schedule_Induction']=='yes') {echo 'checked="checked"' ;}else {}?>  value="yes" /></span></td>
                                <td align="left"  style="padding-left:10px;"><span style="font-weight:bold"><input type="text" disabled="disabled" name="batch_date" value="<?php if($_POST['save_changes']) echo $_POST['batch_date']; else echo $data_sel['batch_date'];?>" class="datepicker" placeholder="Action date "/></span></td>
                               <td align="left"  style="padding-left:10px;">
                                 <select  multiple="multiple" name="counc1_id[]" disabled="disabled" id="counc1_id" class="input_select" style="width:150px;">                        
									<?php 
                                        $select_faculty = "select * from site_setting where type='C' ".$_SESSION['cm_id_councellor']."  order by cm_id asc";
                                        $ptr_faculty = mysql_query($select_faculty);
                                        while($data_faculty = mysql_fetch_array($ptr_faculty))
                        	...
                        	<tr bgcolor="#EFEFEF">
                                ...
                                <td width="44%" align="left"  style="padding-left:10px;"><span style="font-weight:bold"><input type="checkbox" disabled="disabled" name="inform_bop" <?php if($data_sel['inform_bop']!='') {echo 'checked="checked"' ;}else {}?> value="inform_bop" /></span></td>
                                <td width="33%" >
                                 <select  multiple="multiple" name="inform_bop_id[]" id="inform_bop_id" disabled="disabled" class="input_select" style="width:150px;">                        
									<?php 
                            ...
                            <tr bgcolor="#EFEFEF">
                                ...
                                <td width="44%" align="left"  style="padding-left:10px;"><span style="font-weight:bold"><input type="checkbox" disabled="disabled" name="inform_counc" <?php if($data_sel['inform_councellor']!='') {echo 'checked="checked"' ;}else {}?> value="inform_counc" /></span></td>
                                 <td width="33%" >
                                 <select  multiple="multiple" name="inform_counc_id[]" id="inform_counc_id" disabled="disabled" class="input_select" style="width:150px;">                        
									<?php 
                                        $select_faculty = "select * from site_setting where type='C' ".$_SESSION['cm_id_councellor']."  order by cm_id asc";
                                        $ptr_faculty = mysql_query($select_faculty);
                                        while($data_faculty = mysql_fetch_array($ptr_faculty))
                            ...
                            <tr bgcolor="#EFEFEF">
                                ...
                                <td width="44%" align="left"  style="padding-left:10px;"><span style="font-weight:bold"><input type="checkbox" disabled="disabled" name="inform_faculty" <?php if($data_sel['inform_faculty']!='') {echo 'checked="checked"' ;}else {}?> value="inform_faculty" /></span></td>
                                <td width="33%" >
                                 <select  multiple="multiple" name="inform_faculty_id[]" id="inform_faculty_id" disabled="disabled" class="input_select" style="width:150px;">                        
									<?php 
                                ...
                                ></tr>
                                        ...
                                        <tr>
                                        	<td colspan="2" align="center"> <input type="submit" name="save_changes" value="Done"  /></td>
                                        </tr>
                                        <?
                                       $bgColorCounter++;
                                    }
