...

		{
...

			{
...

				{
					...
					var date = new Date(admission_date); // some mock date

					var milliseconds = date.getTime(); 

					if(targets.getTime()<milliseconds)//targets.getTime()<=milliseconds
              ...
              <td width="20%"class="orange_font">* Date Format should be [ DD/MM/YYYY ]</td>
                       ...
                       <?php }?>
                            ...
                            <tr>
                                          ...
                                          <td width="49%"><input type="text" name="inst_student_id" class="input_text" value="<?php if($_POST['inst_student_id']) echo $_POST['inst_student_id']; elseif($record_id==''){ echo trim($comma_separated.'/'.$largestNumber) ;} else echo $row_record['installment_display_id']; ?>"  />
...
<input type="radio" name='paid_type' id="paid_type" value="installments_zero"  <?php if($_POST['paid_type'] =="installments_zero")  echo 'checked="checked"'; else if($row_record['paid_type'] == "installments_zero") echo 'checked="checked"';  ?> onChange="show_record()" />Installment 0% add
   ...
   <!--============================================================================================================================================================-->                                         
                                            ...
                                            <tr>
                                                  ...
                                                  <td><input type="text" class="validate[required] input_text" readOnly name="final_amt" id="final_amt" value="<?php  if($_POST['final_amt']) echo $_POST['final_amt']; else echo $row_record['balance_amt'];?>" /></td>
