...
<title>Product-Receipt Tally Report</title>
    			...
    			<td colspan="17">
        			<form method="get" name="search">
                        ...
                        <tr>
                            ...
                            <td><a href="product_receipt_tally_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>
						</tr>          
					</table>
        		</form>	
    		</td>
	...
	if($no_of_records)
	{
        ...
        <tr class="grey_td" >
            ...
            while($val_query=mysql_fetch_array($my_db))
            {
				...
				echo '<td align="center">Product Amount Collected</td>';
