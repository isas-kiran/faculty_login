...
<title>Expense Outgoing GST</title>
	...
	?>
              <tr>
                ...
                <!--<td width="20%">
                        ...
                        <td><a href="expense_outgoing_gst_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>  
            </tr>          
        </table>
        </form>	
    </td>
				...
				<form method="post"  name="frmTakeAction"  action="<?php echo $_SERVER['PHP_SELF'].'?#msgbox';?>">
                     <input type="hidden" name="formAction" id="formAction" value=""/>
                      <tr class="grey_td" >
						...
						<table width="100%">
						<tr><td colspan="4" align="center"><strong>Expense Details</strong></td></tr>
						<tr><td width="40%" align="center">Expense Name</td><td width="10%" align="center">Price (Excl. GST)</td><td width="25%" align="center">GST in %</td><td width="25%" align="center">GST in value</td></tr>
						</table>
                        ...
                        <td width="14%" align="center"><strong>Installments</strong></td>-->
                            ...
                            while($val_query=mysql_fetch_array($all_records))
                            {
								...
								"<br/>".$sel_inst_amnt="select * from expense_map where 1 and expense_id='".$val_query['expense_id']."' and (cgst_tax_in_per >0 or sgst_tax_in_per >0)";
								...
								if($total_inst=mysql_num_rows($ptr_ins_amnt))
								{
									...
									while($data_inst_amnt=mysql_fetch_array($ptr_ins_amnt))
									{
										...
										echo "<td width='40%' align='center'>".$data_inst_amnt['expense_name']."</td>";
