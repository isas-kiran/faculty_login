...
<title>Product Names Tally Report</title>
...
?>   
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
		<tr>
            ...
            <td><a href="product_name_tally_export.php<?php echo $sep_url_string; ?>"><img src="images/excel.png" height="30px" width="30px"/></a></td>  
            </tr>          
        </table>
        </form>	
    </td>
	...
	if($no_of_records)
	{
		...
		while($val_query=mysql_fetch_array($my_db))
		{
			...
			echo '<td align="center">'.$gst_no.'</td>';
