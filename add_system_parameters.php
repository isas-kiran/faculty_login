...
$edit_access='';
$sel_acc="select * from edit_previleges where admin_id='".$_SESSION['admin_id']."' and privilege_id='204'";
	...
	{ 
    	...
    	<tr>
    		...
    		<td class="mid_mid">
    			<table width="100%" cellspacing="0" cellpadding="0">  
                    ...
                    if($_POST['save_changes'])
                    {
						...
						$incentive_paid_month=( ($_POST['incentive_paid_month'])) ? $_POST['incentive_paid_month'] : "0";
						...
						$special_allowance1=( ($_POST['special_allowance1'])) ? $_POST['special_allowance1'] : "0";
						$special_allowance2=( ($_POST['special_allowance2'])) ? $_POST['special_allowance2'] : "0";
						$executive_allowance=( ($_POST['executive_allowance'])) ? $_POST['executive_allowance'] : "0";
						$basic_sal_type=( ($_POST['basic_sal_type'])) ? $_POST['basic_sal_type'] : "0";
						$house_rent_type=( ($_POST['house_rent_type'])) ? $_POST['house_rent_type'] : "0";
						...
						$special_allowance2_type=( ($_POST['special_allowance2_type'])) ? $_POST['special_allowance2_type'] : "0";
						$executive_allowance_type =( ($_POST['executive_allowance_type'])) ? $_POST['executive_allowance_type'] : "0";
                        ...
                        else
                        {
							...
							$data_record['special_allowance1']=$special_allowance1;
							$data_record['special_allowance2']=$special_allowance2;
							...
							$data_record['special_allowance1_type']=$special_allowance1_type;
							$data_record['special_allowance2_type']=$special_allowance2_type;
							$data_record['executive_allowance_type']=$executive_allowance_type ;
							...
							if($_SESSION['type']=='S' || $_SESSION['type']=='Z' || $_SESSION['type']=='LD')
							{
								...
								{	
									...
									"<br>".$insert="INSERT INTO `log_history`(`category`, `action`, `name`, `id`, `date`, `cm_id`, `admin_id`) VALUES ('Add_system_parameter','Edit','Salary Month','".$record_id."','".date('Y-m-d H:i:s')."','".$_SESSION['cm_id']."','".$_SESSION['admin_id']."')";
								...
								else
								{
									...
									"<br>".$insert="INSERT INTO `log_history`(`category`, `action`, `name`, `id`, `date`, `cm_id`, `admin_id`) VALUES ('Add_system_parameter','Add','Salary Month','".$slab_id."','".date('Y-m-d H:i:s')."','".$_SESSION['cm_id']."','".$_SESSION['admin_id']."')";
									$query=mysql_query($insert);
                    ...
                    if($success==0)
                    {
						...
						<tr><td colspan="4" class="orange_font">* Mandatory Fields</td></tr>
         			<?php if($_SESSION['type']=='S' || $_SESSION['type']=='Z' || $_SESSION['type']=='LD')
					{
					?>
					  <tr>
						<td style="width: 25%;">Select Branch</td>
						<td>
		  ...
		  <tr>
						...
						echo '<td style="width: 25%;">Incentive Salary Month</td><td>';
						?>
						...
						echo '<td style="width: 25%;">Select Paid Month</td><td>';
...
<?php
      ...
      <tr>
                <td style="width: 25%;">Payment Date <span class="orange_font"></span></td>
                <td width="">
         ...
         <tr>
						...
						echo '<td style="width: 25%;">Basic Salary <input type="radio" name="basic_sal_type" id="basic_sal_type" checked="checked" value="percentage" />in %
						</td></td><td>';
						?>
			 ...
			 <tr>
						...
						echo '<td style="width: 25%;">House Rent Allowance <input type="radio" name="house_rent_type" id="house_rent_type" checked="checked" value="percentage" />in %
						</td></td>
						<td>';
						?>
					...
					<tr>
 	    			<?php
						if($row_record['traveling_type']=="rupees") { $checked="checked='checked'"; } else { $checked1="checked='checked'"; }
						echo '<td style="width: 25%;">Conveyance Allowance <input type="radio" name="traveling_type" id="traveling_type" '.$checked1.' value="percentage" />in % <input type="radio" name="traveling_type" id="traveling_type" '.$checked.' value="rupees" />in Rs/-</td></td><td>';
						?>
					...
					<tr>
                		<?php
						if($row_record['medical_type']=="rupees") { $checked="checked='checked'"; } else  { $checked1="checked='checked'"; }
						echo '<td style="width: 25%;">Medical Allowance <input type="radio" name="medical_type" id="medical_type" '.$checked1.' value="percentage" />in % <input type="radio" name="medical_type" id="medical_type" '.$checked.' value="rupees" />in Rs/-</td></td><td>';
						?>
					...
					<tr>
               		<?php
						if($row_record['special_allowance1_type']=="rupees") { $checked="checked='checked'"; } else  { $checked1="checked='checked'"; }	echo '<td style="width: 25%;">Special Allowance<input type="radio" name="special_allowance1_type" id="special_allowance1_type" '.$checked1.' value="percentage" />in % <input type="radio" name="special_allowance1_type" id="special_allowance1_type" '.$checked.' value="rupees" />in Rs/-</td></td><td>';
						?>
						<input style="width:20%;" onKeyUp="get_total();" type="text" id="special_allowance1" name="special_allowance1" value="<?php echo $row_record['special_allowance1']; ?>" />
						</td>
					</tr>
					<tr>
         	       		<?php
						if($row_record['special_allowance2_type']=="rupees") { $checked="checked='checked'"; } else  { $checked1="checked='checked'"; } echo '<td style="width: 25%;">Education Allowance <input type="radio" name="special_allowance2_type" id="special_allowance2_type" '.$checked1.' value="percentage" />in % <input type="radio" name="special_allowance2_type" id="special_allowance2_type" '.$checked.' value="rupees" />in Rs/-</td></td><td>';
						?>
						<input style="width:20%;" onKeyUp="get_total();" type="text" id="special_allowance2" name="special_allowance2" value="<?php echo $row_record['special_allowance2']; ?>" />
						</td>
					</tr>
                    <tr>
         	       		<?php
						if($row_record['special_allowance2_type']=="rupees") { $checked="checked='checked'"; } else  { $checked1="checked='checked'"; } echo '<td style="width: 25%;">Executive Allowance<input type="radio" name="executive_allowance_type" id="executive_allowance_type" '.$checked1.' value="percentage" />in % <input type="radio" name="executive_allowance_type" id="executive_allowance_type" '.$checked.' value="rupees" />in Rs/-</td></td><td>';
						?>
						<input style="width:20%;" onKeyUp="get_total();" type="text" id="executive_allowance" name="executive_allowance" value="<?php echo $row_record['executive_allowance']; ?>" />
						</td>
					</tr>
...
<table cellspacing="0" cellpadding="0" class="table" width="95%">
  ...
  <tr class="head_td">
	...
	<td width="7%"><strong>Conveyance Allowance </strong></td>
	<td width="7%"><strong>Medical Allowance </strong></td>
	<td width="7%"><strong>Special Allowance</strong></td>
	<td width="7%"><strong>Education Allowance</strong></td>
    <td width="7%"><strong>Executive Allowance</strong></td>
	...
	while($val_query=mysql_fetch_array($all_records))
	{
		...
		*/
		...
		echo '<td >'.$val_query['special_allowance1'].'</td>';
		echo '<td >'.$val_query['special_allowance2'].'</td>';
		echo '<td ></td>';
		if($_SESSION['type']=='S' || $edit_access='yes')
		{
...
function getmonthdays(i)
{
 ...
 function get_total()
 {
	 ...
	 var tot=parseFloat(basic_sal_per)+parseFloat(house_rent_per)+parseFloat(travelling_per)+ parseFloat(medical_per)+ parseFloat(executive_allowance)+parseFloat(special_allowance1)+parseFloat(special_allowance2);
	/*  if(tot>100)
	 {
		 alert('Invalid Input');
		  $('#basic_sal_per').val('');
		   $('#house_rent_per').val('');
		    $('#travelling_per').val('');
			 $('#medical_per').val('');
			  $('#special_allowance1').val('');
			   $('#special_allowance2').val('');
	 } */
 }
</script>
<script language="javascript">
