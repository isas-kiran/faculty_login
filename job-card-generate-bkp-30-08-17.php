...
<body>
    <div class="heightSpacer"></div>
					...
					<table width="280" height="48" border="0" align="center" style="border:solid #999 1px; border-radius:5px;">
                        <tr>
                        	<td width="272">
                            <table width="100%">
                                <tr>
                                    <td valign="top" width="97"><img src="images/innocent.png" width="94" height="28" title="Isasbeautyschool "/></td>
                                    <td align="left" colspan="2">
                                        <table width="99%"><strong><span style="font-size:14px;">Innocent Beauty Saloon,
                                           <?php 
										   if($_SESSION['type']=='S')
                                           {
