...
<title>Customer Service Payment Details</title>
  ...
  <tr>
    ...
    <td class="mid_mid">
                      ...
                      <?php
						...
						$sql_records= "SELECT * FROM customer_service_invoice where customer_service_id=".$record_id." ";
						...
						if($no_of_records)
						{
							...
							<tr><td valign="middle" align="right">
								...
								<tr align="center" class="grey_td" >
                                    ...
                                    <td width="11%" class="tr-header"><strong>Total Service Price</strong></td>
                                    ...
                                    while($val_record=mysql_fetch_array($all_records))
                                    {
										...
										echo "<td align='center'>".$fetch_query_cust_service['customer_invoice_no']."</td>";
									    echo '<td align="center">'.$fetch_query_cust_service['service_price'].'</td>'; 
									    ...
									    echo '<td align="center">'.$fetch_query_cust_service['nonmemb_discount'].' ('.$discount_type.')</td>';
